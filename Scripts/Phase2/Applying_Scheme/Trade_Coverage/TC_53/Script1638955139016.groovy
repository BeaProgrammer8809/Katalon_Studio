...
Mobile.callTestCase(findTestCase('Phase2/Applying_Scheme/Trade_Coverage/Screenshot'), [('testCaseName') : 'TC_53'], FailureHandling.STOP_ON_FAILURE)

Mobile.comment('1.Screen should not be navigated to promotion slab screen')

Mobile.verifyElementExist(findTestObject('Phase2/BIApplyingSchemeScreen/Applying_Scheme_TextView'), 0)

Mobile.verifyElementVisible(findTestObject('Phase2/BIApplyingSchemeScreen/Applying_Scheme_TextView'), 0)

//Applying Scheme page
...
Title = Mobile.getText(findTestObject('Phase2/BIApplyingSchemeScreen/Applying_Scheme_TextView'), 0)

Mobile.verifyMatch(Title, findTestData('Phase2/TY_06/Applying Scheme/Navigation Page').getValue(2, 2), false)

Mobile.comment(' 2.Seller should not able to view the applied scheme')

Mobile.verifyElementNotVisible(findTestObject('Phase2/BISlabScreen/Done_Button'), 10)

Mobile.verifyElementNotExist(findTestObject('Phase2/BISlabScreen/Done_Button'), 10)

Mobile.verifyElementNotVisible(findTestObject('Phase2/BISlabScreen/Get_Qty_EditText'), 10)

Mobile.verifyElementNotExist(findTestObject('Phase2/BISlabScreen/Get_Qty_EditText'), 10)
