...
GlobalVariable.SchemeBuySkuName = findTestData('Phase2/TY_06/Invoice Summary/Invoice_Summary').getValue(5, 6)

GlobalVariable.SchemeGetSkuName1 = findTestData('Phase2/TY_06/Invoice Summary/Invoice_Summary').getValue(6, 6)
...
Mobile.verifyMatch(Title, findTestData('Phase2/TY_06/Invoice Summary/Invoice_Summary').getValue(2, 6), false)

Mobile.callTestCase(findTestCase('Phase2/Invoice_Summary/Trade_Coverage/Screenshot'), [('testCaseName') : 'TC_131'], FailureHandling.STOP_ON_FAILURE)

Mobile.comment('Scheme get sku should not be displayed on invoice summary screen')

GlobalVariable.index = findTestData('Phase2/Common_Data/CommonData').getValue(5, 2)

Mobile.verifyElementNotExist(findTestObject('Phase2/BIInvoiceSummaryScreen/BISummaryProductDetails/Product_TextView_Indexing'), 10)

Mobile.verifyElementNotVisible(findTestObject('Phase2/BIInvoiceSummaryScreen/BISummaryProductDetails/Product_TextView_Indexing'), 10)

Mobile.verifyElementNotExist(findTestObject('Phase2/BIInvoiceSummaryScreen/BISummaryProductDetails/Price_Value_Indexing'), 10)

Mobile.verifyElementNotVisible(findTestObject('Phase2/BIInvoiceSummaryScreen/BISummaryProductDetails/Price_Value_Indexing'), 10)
