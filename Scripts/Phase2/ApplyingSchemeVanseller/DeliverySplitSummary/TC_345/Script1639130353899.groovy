...
def Invoiceget = findTestData('Phase2/TY_05/Applying_Scheme').getValue(6, 22)

Mobile.verifyGreaterThan(InvoiceCount, Invoiceget)
...
def Expectedtoastmessage = findTestData('Phase2/TY_05/Applying_Scheme').getValue(5, 22)
...
Mobile.verifyElementNotVisible(findTestObject('Object Repository/Phase2/BISplitDeliverySummary01/DeliverySplitSummary_Screen_Title'), 
    0)

Mobile.verifyElementNotExist(findTestObject('Object Repository/Phase2/BISplitDeliverySummary01/DeliverySplitSummary_Screen_Title'), 
    0)


Mobile.callTestCase(findTestCase('Phase2/ApplyingSchemeVanseller/DeliverySplitSummary/Screenshot'), [('testCaseName') : 'TC_345'], FailureHandling.STOP_ON_FAILURE)
