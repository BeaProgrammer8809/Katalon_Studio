...
Mobile.setText(findTestObject('Phase2/BIDeliveryFinalSummaryScreen/Folio_No_EditText'), findTestData('Phase2/TY_08/ScriptsData').getValue(3, 23), 0)
...
String Actual = Mobile.getText(findTestObject('Phase2/BIPrintPreviewScreen/Print_Preview_TextView'), 0)

println(Actual)

Mobile.verifyEqual(Actual, findTestData('Phase2/TY_08/ScriptsData').getValue(4, 23), FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2/ApplyingSchemeVanseller/DeliveryFinalSummary/Screenshot'), [('testCaseName') : 'TC_334'], 
