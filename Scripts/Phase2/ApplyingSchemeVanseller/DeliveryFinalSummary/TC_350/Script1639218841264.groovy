...
BuyQtyText = Mobile.getText(findTestObject('Phase2/BIInvoiceSummaryScreen/BISummaryProductDetails/Pieces_Value_Indexing'), 
    0)
...
/*Mobile.callTestCase(findTestCase('Phase2/Delivery_Final_Summary/Trade_Coverage/Screenshot'), [('testCaseName') : 'TC_350'], 
    FailureHandling.STOP_ON_FAILURE)
*/
Mobile.comment(' verification for stock delivary quantity (Stock delivered qty should be 0)')

StockDeliveredQty = Mobile.getText(findTestObject('Phase2/BISplitDeliverySummary01/StockDelivered_Qty_Indexing'), 0)

Mobile.verifyElementText(findTestObject('Phase2/BISplitDeliverySummary01/StockDelivered_Qty_Indexing'), findTestData('Phase2/TY_06/Delivery_Final_Summary/Delivery final summary').getValue(
        7, 3))

Mobile.verifyMatch(StockDeliveredQty, findTestData('Phase2/TY_06/Delivery_Final_Summary/Delivery final summary').getValue(
        7, 3), false)
...
Mobile.verifyElementText(findTestObject('Phase2/BIDeliveryFinalSummaryScreen/Delivery_Final_Summary_ScreenTitle'), findTestData(
        'Phase2/TY_06/Delivery_Final_Summary/Delivery final summary').getValue(2, 3))

Title = Mobile.getText(findTestObject('Phase2/BIDeliveryFinalSummaryScreen/Delivery_Final_Summary_ScreenTitle'), 0)

Mobile.verifyMatch(Title, findTestData('Phase2/TY_06/Delivery_Final_Summary/Delivery final summary').getValue(2, 3), false)

Mobile.callTestCase(findTestCase('Phase2/ApplyingSchemeVanseller/DeliveryFinalSummary/Screenshot'), [('testCaseName') : 'TC_350'], 
    FailureHandling.STOP_ON_FAILURE)
