...
Mobile.verifyElementText(findTestObject('Object Repository/Phase2/BIDeliveryFinalSummaryScreen/Lines_Value_Indexing'), findTestData('Phase2/TY_05/Applying_Scheme').getValue(5, 16), FailureHandling.STOP_ON_FAILURE)
GlobalVariable.index=findTestData('Phase2/Common_Data/CommonData_05').getValue(7, 2)
 Mobile.verifyElementText(findTestObject('Object Repository/Phase2/BIDeliveryFinalSummaryScreen/Invoice Split_Indexing'), findTestData('Phase2/TY_05/Applying_Scheme').getValue(6, 16), FailureHandling.STOP_ON_FAILURE)
   

println('Lines qty against Invoice split-1 should displayed')


Mobile.callTestCase(findTestCase('Phase2/ApplyingSchemeVanseller/DeliveryFinalSummary/Screenshot'), [('testCaseName') : 'TC_321'], FailureHandling.STOP_ON_FAILURE)
