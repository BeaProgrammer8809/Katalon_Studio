...
int buy = BuyQtyText.toInteger()

GlobalVariable.index = findTestData('Phase2/Common_Data/CommonData').getValue(5, 2)

GetQtyText1 = Mobile.getText(findTestObject('Phase2/BIInvoiceSummaryScreen/BISummaryProductDetails/Pieces_Value_Indexing'), 
    0)

println(GetQtyText1)

int get1 = GetQtyText1.toInteger()

GlobalVariable.index = findTestData('Phase2/Common_Data/CommonData').getValue(5, 3)

GetQtyText2 = Mobile.getText(findTestObject('Phase2/BIInvoiceSummaryScreen/BISummaryProductDetails/Pieces_Value_Indexing'), 
    0)

println(GetQtyText2)

int get2 = GetQtyText2.toInteger()

int Total = (buy + get1) + get2
...
Mobile.callTestCase(findTestCase('Phase2/ApplyingSchemeVanseller/DeliveryFinalSummary/Screenshot'), [('testCaseName') : 'TC_310'], 
    FailureHandling.STOP_ON_FAILURE)
