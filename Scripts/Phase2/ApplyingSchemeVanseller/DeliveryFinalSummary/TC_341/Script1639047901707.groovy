...
def schemeBuyQty = findTestData('Phase2/TY_05/Applying_Scheme').getValue(3, 11)
...
Mobile.verifyElementText(findTestObject('Phase2/BISplitDeliverySummary01/DeliverySplitSummary_Screen_Title'), findTestData(
		'Phase2/TY_05/Applying_Scheme').getValue(4, 18), FailureHandling.STOP_ON_FAILURE)
Mobile.verifyElementVisible(findTestObject('Phase2/BISplitDeliverySummary01/DeliverySplitSummary_Screen_Title'), 0)
Mobile.verifyElementExist(findTestObject('Phase2/BISplitDeliverySummary01/DeliverySplitSummary_Screen_Title'), 0)
Mobile.verifyElementText(findTestObject('Object Repository/Phase2/BISplitDeliverySummary01/SchemeBuySKU_TextView'), findTestData(
		'Phase2/TY_05/Applying_Scheme').getValue(4, 16), FailureHandling.STOP_ON_FAILURE)
Mobile.verifyElementNotVisible(findTestObject('Object Repository/Phase2/BIInvoiceSummaryScreen/GetSchemeDetails/Get_SKU_2'),
	0)
Mobile.verifyElementNotExist(findTestObject('Object Repository/Phase2/BIInvoiceSummaryScreen/GetSchemeDetails/Get_SKU_2'),
	0)
GlobalVariable.index = findTestData('Phase2/Common_Data/CommonData_05').getValue(7, 2)
Mobile.verifyElementText(findTestObject('Object Repository/Phase2/BISplitDeliverySummary01/StockDelivered_Qty_Indexing'),
	findTestData('Phase2/TY_05/Applying_Scheme').getValue(5, 16), FailureHandling.STOP_ON_FAILURE)
Mobile.callTestCase(findTestCase('Phase2/ApplyingSchemeVanseller/DeliveryFinalSummary/Screenshot'), [('testCaseName') : 'TC_341'],
