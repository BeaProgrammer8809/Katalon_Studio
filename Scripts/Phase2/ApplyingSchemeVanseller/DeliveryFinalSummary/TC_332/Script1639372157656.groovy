...
GlobalVariable.SchemeBuySkuName = findTestData('Phase2/TY_03/TestData').getValue(5, 29)
...
Mobile.callTestCase(findTestCase('Phase2/ApplyingSchemeVanseller/DeliveryFinalSummary/Screenshot'), [('testCaseName') : 'TC_332_SummaryScreen'],
...
Mobile.callTestCase(findTestCase('Phase2/ApplyingSchemeVanseller/DeliveryFinalSummary/Screenshot'), [('testCaseName') : 'TC_332'],
	FailureHandling.STOP_ON_FAILURE)
