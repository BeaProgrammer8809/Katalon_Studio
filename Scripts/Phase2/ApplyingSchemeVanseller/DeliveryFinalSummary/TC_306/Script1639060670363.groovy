...
//def Expected_Amount=findTestData('Phase2/TY_01/Test_Data').getValue(10, 18)
...
//capture get sku price and show that is equal to 0 and not inclueded in amount
Mobile.verifyEqual(Actual_Amount, Expected_Amount, FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2/ApplyingSchemeVanseller/DeliveryFinalSummary/Screenshot'), [('testCaseName') : 'TC_306'], 
