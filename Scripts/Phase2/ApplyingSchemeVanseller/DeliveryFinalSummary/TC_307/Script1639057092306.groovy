...
String Buyvalue = Mobile.getText(findTestObject('Phase2/BIInvoiceSummaryScreen/Value_Value'), 0)
...
String Buyamt = Mobile.getAttribute(findTestObject('Phase2/BIDeliveryFinalSummaryScreen/Amount_Value_Indexing'),'text', 
    0)

println(Buyamt)


Mobile.verifyEqual(Buyvalue, Buyamt, FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2/ApplyingSchemeVanseller/DeliveryFinalSummary/Screenshot'), [('testCaseName') : 'TC_307'], 
