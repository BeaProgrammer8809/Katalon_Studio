...
Mobile.callTestCase(findTestCase('Phase2/ApplyingSchemeVanseller/Collection/Screenshot'), [('testCaseName') : 'TC_228_SummaryScreen'], FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyMatch(actualtoastmessage, findTestData('Phase2/TY_01/Test_Data').getValue(3, 8), false)

Mobile.verifyEqual(TotalValue, invAmt, FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2/ApplyingSchemeVanseller/Collection/Screenshot'), [('testCaseName') : 'TC_228'], FailureHandling.STOP_ON_FAILURE)
