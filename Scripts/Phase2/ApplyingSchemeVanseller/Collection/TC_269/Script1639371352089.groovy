...
GlobalVariable.Getsku = findTestData('Phase2/TY_06/Collection/Collection_Cheque').getValue(8, 8)
...
InvAmt = Mobile.getText(findTestObject('Phase2/BICollectionScreen01/InvAmt_TextView'), 0)
...
Mobile.setText(findTestObject('Phase2/BICollectionScreen01/BITransferenciasElectronicasScreen01/ReferenceNum_EditText'), 
    findTestData('Phase2/TY_06/Collection/Collection_Cheque').getValue(4, 8), 0)

Mobile.tap(findTestObject('Phase2/BICollectionScreen01/Submit_Button'), 0)

//Mobile.callTestCase(findTestCase('Phase2/Collection/Trade_Coverage/Screenshot'), [('testCaseName') : 'TC_269'], FailureHandling.STOP_ON_FAILURE)
Mobile.callTestCase(findTestCase('Phase2/ApplyingSchemeVanseller/Collection/Screenshot'), [('testCaseName') : 'TC_213'], 
    FailureHandling.STOP_ON_FAILURE)

Mobile.comment('Collection icon should be hidden after submitting the invoice amount in any collection modes')

Mobile.verifyElementNotVisible(findTestObject('Phase2/BICollectionScreen01/Collection_Title'), 10)

Mobile.verifyElementNotExist(findTestObject('Phase2/BICollectionScreen01/Collection_Title'), 10)
...
Mobile.verifyElementText(findTestObject('Phase2/BIDeliveryFinalSummaryScreen/Delivery_Final_Summary_ScreenTitle'), findTestData(
        'Phase2/TY_06/Collection/Collection_Cheque').getValue(2, 8))

Mobile.callTestCase(findTestCase('Phase2/ApplyingSchemeVanseller/Collection/Screenshot'), [('testCaseName') : 'TC_269(2)'], 
    FailureHandling.STOP_ON_FAILURE)
