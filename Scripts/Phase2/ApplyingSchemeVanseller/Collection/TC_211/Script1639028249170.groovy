...
def Actual_Net_Amount = Mobile.getText(findTestObject('Object Repository/Phase2/BIInvoiceSummaryScreen/BISummaryProductDetails/Price_Value_Indexing'), 0, FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2/ApplyingSchemeVanseller/Collection/Screenshot'), [('testCaseName') : 'TC_211A'], FailureHandling.STOP_ON_FAILURE)
...
//Verification to check Invoice amount is displayed the net amount of scheme buy qty
...
def Expected_GET_Qty= findTestData('Phase2/TY_02/Test_Data_Phase2').getValue(7, 5)

Mobile.verifyMatch(Actual_Net_Amount, Expected_Invoice_Amount, false, FailureHandling.STOP_ON_FAILURE)
Mobile.verifyMatch(Actual_GET_Qty, Expected_GET_Qty, false, FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2/ApplyingSchemeVanseller/Collection/Screenshot'), [('testCaseName') : 'TC_211'], FailureHandling.STOP_ON_FAILURE)

println(Expected_Invoice_Amount)
println(Actual_Net_Amount)
