...
Mobile.callTestCase(findTestCase('Phase2/ApplyingSchemeVanseller/Collection/Screenshot'), [('testCaseName') : 'TC_226'], FailureHandling.STOP_ON_FAILURE)

println('Balance should get updated with respect to the amount entered in total paid field from chCheque mode after switching from Efectivo mode')
