...
import org.bouncycastle.util.test.TestFailedException as TestFailedException
import org.openqa.selenium.WebElement as WebElement
import org.testng.Assert as Assert

//GlobalVariable.Bank(findTestData("Phase2/Common_Data/CommonData_08").getValue(7, 1))
...
GlobalVariable.DropdownName = findTestData('Phase2.1/CommonData/CommonData').getValue(7, 3)
...
//Mobile.verifyElementExist(findTestObject('Phase2/BICollectionScreen01/BIChequesScreen01/AnyBank - ICICI Bank'), 0)
//
//Mobile.delay(5, FailureHandling.STOP_ON_FAILURE)
//
//Mobile.verifyElementVisible(findTestObject('Phase2/BICollectionScreen01/BIChequesScreen01/AnyBank - ICICI Bank'), 0)
//
//Mobile.delay(5, FailureHandling.STOP_ON_FAILURE)

String Actual = Mobile.getText(findTestObject('Object Repository/Phase2/BIDropdown/Dropdown_Name'), 0)

println(Actual)

Mobile.verifyEqual(Actual, findTestData('Phase2/TY_08/ScriptsData').getValue(3, 13), FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2/ApplyingSchemeVanseller/Collection/Screenshot'), [('testCaseName') : 'TC_258'], FailureHandling.STOP_ON_FAILURE)
