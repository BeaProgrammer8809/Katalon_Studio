...
Mobile.setText(findTestObject('Phase2/BICollectionScreen01/BITransferenciasElectronicasScreen01/ReferenceNum_EditText'), 
    findTestData('Phase2/TY_05/Applying_Scheme').getValue(5, 21), 0)
...
def Expectedtoastmessage = findTestData('Phase2/TY_05/Applying_Scheme').getValue(4, 28)
...
Mobile.callTestCase(findTestCase('Phase2/ApplyingSchemeVanseller/Collection/Screenshot'), [('testCaseName') : 'TC_264'], FailureHandling.STOP_ON_FAILURE)
