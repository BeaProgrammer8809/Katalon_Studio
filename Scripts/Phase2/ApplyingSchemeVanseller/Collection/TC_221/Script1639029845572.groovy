...
//Mobile.tap(findTestObject('Phase2_Old/Collection_Page/Total_Paid_TextField'), 0)
...
Mobile.verifyEqual(ActualErrormessage, findTestData('Phase2/TY_08/ScriptsData').getValue(3, 9), FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2/ApplyingSchemeVanseller/Collection/Screenshot'), [('testCaseName') : 'TC_221'], FailureHandling.STOP_ON_FAILURE)
