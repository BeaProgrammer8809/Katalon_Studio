...
GlobalVariable.DropdownName = findTestData('Phase2.1/CommonData/CommonData').getValue(10, 3)

GlobalVariable.DropdownOption = findTestData('Phase2.1/CommonData/CommonData').getValue(9, 2)
...
Mobile.setText(findTestObject('Phase2/BICollectionScreen01/BIChequesScreen01/ChequeNum_EditText'), findTestData('Phase2/TY_08/ScriptsData').getValue(
        3, 12), 0)
...
Mobile.verifyEqual(actualtoastmessage, findTestData('Phase2/TY_08/ScriptsData').getValue(4, 12), FailureHandling.STOP_ON_FAILURE)

Mobile.delay(10, FailureHandling.STOP_ON_FAILURE)


GlobalVariable.DropdownName = findTestData('Phase2.1/CommonData/CommonData').getValue(10, 2)

String Branch =Mobile.getText(findTestObject('Object Repository/Phase2/BIDropdown/Dropdown_Name'), 0)

println(Branch)

Mobile.verifyEqual(Branch, findTestData('Phase2/TY_08/ScriptsData').getValue(5, 12), FailureHandling.STOP_ON_FAILURE)
...
String text = Mobile.getText(findTestObject('Phase2/BICollectionScreen01/Collection_Title'), 0)

println(text)

Mobile.verifyEqual(text, findTestData('Phase2/TY_08/ScriptsData').getValue(6, 12), FailureHandling.STOP_ON_FAILURE)


Mobile.callTestCase(findTestCase('Phase2/ApplyingSchemeVanseller/Collection/Screenshot'), [('testCaseName') : 'TC_242'], FailureHandling.STOP_ON_FAILURE)
