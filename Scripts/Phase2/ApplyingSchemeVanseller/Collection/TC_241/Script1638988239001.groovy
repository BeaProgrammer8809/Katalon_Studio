...
GlobalVariable.DropdownOption = findTestData('Phase2/Common_Data/CommonData_01').getValue('ChequeType', 1)
Mobile.tap(findTestObject('Object Repository/Phase2/BIDropdown/Dropdown_Option'), 0)

Mobile.setText(findTestObject('Phase2/BICollectionScreen01/BIChequesScreen01/ChequeNum_EditText'), findTestData('Phase2/TY_01/Test_Data').getValue(
        5, 10), 0)
...
Mobile.verifyMatch(actualtoastmessage, findTestData('Phase2/TY_01/Test_Data').getValue(3, 10), false)
...
Mobile.callTestCase(findTestCase('Phase2/ApplyingSchemeVanseller/Collection/Screenshot'), [('testCaseName') : 'TC_241'], FailureHandling.STOP_ON_FAILURE)
