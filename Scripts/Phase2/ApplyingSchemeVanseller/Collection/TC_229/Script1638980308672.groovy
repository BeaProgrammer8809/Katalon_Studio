...
Mobile.verifyElementExist(findTestObject('Phase2/BINumberKeyboardCollection01/1_NumButton'), 0)

Mobile.verifyElementVisible(findTestObject('Phase2/BINumberKeyboardCollection01/1_NumButton'), 0)

String Actual = Mobile.getText(findTestObject('Phase2/BINumberKeyboardCollection01/1_NumButton'), 0)

println(Actual)

Mobile.verifyEqual(Actual, findTestData('Phase2/TY_08/ScriptsData').getValue(3, 10), FailureHandling.STOP_ON_FAILURE)

Mobile.delay(5, FailureHandling.STOP_ON_FAILURE)

String ChequeMode = Mobile.getText(findTestObject('Phase2/BICollectionScreen01/Cheques_RadioButton'), 0)

println(ChequeMode)

Mobile.verifyEqual(ChequeMode, findTestData('Phase2/TY_08/ScriptsData').getValue(4, 10), FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2/ApplyingSchemeVanseller/Collection/Screenshot'), [('testCaseName') : 'TC_229'], FailureHandling.STOP_ON_FAILURE)
