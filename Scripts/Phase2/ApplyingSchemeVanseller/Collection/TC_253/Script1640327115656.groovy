...
def Expectedtoastmessage = findTestData('Phase2/TY_05/Applying_Scheme').getValue(4, 27)
...
Mobile.callTestCase(findTestCase('Phase2/ApplyingSchemeVanseller/Collection/Screenshot'), [('testCaseName') : 'TC_253'], FailureHandling.STOP_ON_FAILURE)
