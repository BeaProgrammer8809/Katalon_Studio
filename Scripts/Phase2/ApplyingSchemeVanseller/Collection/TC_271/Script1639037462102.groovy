...
//Verification to check User is able to submit the invoice amount in Efectivo and RTGS mode
...
Mobile.callTestCase(findTestCase('Phase2/ApplyingSchemeVanseller/Collection/Screenshot'), [('testCaseName') : 'TC_271'], FailureHandling.STOP_ON_FAILURE)
