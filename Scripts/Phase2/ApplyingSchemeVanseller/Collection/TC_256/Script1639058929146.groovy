...
def Expected = findTestData('Phase2/TY_04/Applying_Scheme').getValue(4, 14)
...
Mobile.callTestCase(findTestCase('Phase2/ApplyingSchemeVanseller/Collection/Screenshot'), [('testCaseName') : 'TC_256'], FailureHandling.STOP_ON_FAILURE)
