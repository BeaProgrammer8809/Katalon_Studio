...
def DeliveryAmount=Mobile.getText(findTestObject('Object Repository/Phase2/BIDeliveryFinalSummaryScreen/Amount_Value'), 0)
...
//Mobile.verifyMatch(DeliveryAmount, invAmt, false, FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyMatch(Amount, DeliveryAmount, false, FailureHandling.STOP_ON_FAILURE)
...
//def Amount1=Mobile.getText(findTestObject('Phase2/BICollectionScreen01/BIEfectivoScreen01/Amount_EditText'), 0)
//
//Mobile.verifyMatch(Amount1, DeliveryAmount, false, FailureHandling.STOP_ON_FAILURE)
...
//def Amount2=Mobile.getText(findTestObject('Phase2/BICollectionScreen01/BIEfectivoScreen01/Amount_EditText'), 0)
//
//Mobile.verifyMatch(Amount2, DeliveryAmount, false, FailureHandling.STOP_ON_FAILURE)
...
def TotalAmt3=Mobile.getText(findTestObject('Phase2/BICollectionScreen01/BIEfectivoScreen01/TotalPaid_TextView'), 0)
def TotaltAm3 = "Total Paid : "+invAmt
Mobile.verifyMatch(TotalAmt3, TotaltAm3, false, FailureHandling.STOP_ON_FAILURE)
Mobile.verifyElementVisible(findTestObject('Phase2/BICollectionScreen01/BIEfectivoScreen01/Amount_EditText'), 0)
