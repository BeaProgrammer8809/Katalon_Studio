...
def SummaryScreenTitle = Mobile.getText(findTestObject('Object Repository/Phase2/BIDeliverySummaryScreen/Delivery_Summary_Screen_Title'), 
    0)

Mobile.verifyNotMatch(SummaryScreenTitle, findTestData('Phase2/TY_07/Applying Scheme/Execute').getValue('Expected result', 
        24), false)

Mobile.callTestCase(findTestCase('Phase2/ApplyingSchemeVanseller/ApplyingScheme/Screenshot'), [('testCaseName') : 'TC_284'], 
