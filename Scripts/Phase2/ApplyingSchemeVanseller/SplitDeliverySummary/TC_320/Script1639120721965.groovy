...
def Expected_Invice_Split = findTestData('Phase2/TY_07/Applying Scheme/Execute').getValue(3, 18)

Mobile.verifyMatch(Actual_Invoice_split, Expected_Invice_Split, false)

Mobile.callTestCase(findTestCase('Phase2/ApplyingSchemeVanseller/ApplyingScheme/Screenshot'), [('testCaseName') : 'TC_320'], 
