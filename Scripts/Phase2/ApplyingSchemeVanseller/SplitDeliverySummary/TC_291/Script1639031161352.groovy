...
SRPPrice1 = Mobile.getText(findTestObject('Phase2/BIDeliverySummaryScreen/SRP_Text_Indexing'), 0)

/*Mobile.callTestCase(findTestCase('Phase2/Split_Delivery_summary/Trade_Coverage/Screenshot'), [('testCaseName') : 'TC_291'], 
    FailureHandling.STOP_ON_FAILURE)*/

Mobile.comment('1.SRP price should display same as in Order and invoice screen for scheme buy sku')

Mobile.verifyMatch(SRPPrice, SRPPrice1, false)

Mobile.verifyElementText(findTestObject('Phase2/BIDeliverySummaryScreen/SRP_Text_Indexing'), SRPPrice)

Mobile.comment('Scheme get sku should not displayed in delivered summary scren')

GlobalVariable.index = findTestData('Phase2/Common_Data/CommonData').getValue(5, 2)

Mobile.verifyElementNotExist(findTestObject('Phase2/BIDeliverySummaryScreen/Product_Name_Text_Indexing'), 10)

Mobile.verifyElementNotVisible(findTestObject('Phase2/BIDeliverySummaryScreen/Product_Name_Text_Indexing'), 10)

Mobile.callTestCase(findTestCase('Phase2/ApplyingSchemeVanseller/SplitDeliverySummary/Screenshot'), [('testCaseName') : 'TC_291'],
	FailureHandling.STOP_ON_FAILURE)
