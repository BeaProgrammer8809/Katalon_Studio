...
def Actual_Product_Name = Mobile.getText(findTestObject('Object Repository/Phase2/BIDeliverySummaryScreen/Product_Name_Text_Indexing'),
	0, FailureHandling.STOP_ON_FAILURE)

def Expected_Product_Name = findTestData('Phase2/TY_04/Applying_Scheme').getValue(4, 16)

Mobile.verifyEqual(Actual_Product_Name, Expected_Product_Name, FailureHandling.STOP_ON_FAILURE)

println(Actual_Product_Name)

Mobile.callTestCase(findTestCase('Phase2/ApplyingSchemeVanseller/SplitDeliverySummary/Screenshot'), [('testCaseName') : 'TC_289'], FailureHandling.STOP_ON_FAILURE)
