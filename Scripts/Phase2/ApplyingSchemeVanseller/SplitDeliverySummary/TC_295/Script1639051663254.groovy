...
//Mobile.verifyMatch(Scheme_Get_Sku, findTestData('Phase2/TY_01/Test_Data').getValue(3, 15), false)
Mobile.tap(findTestObject('Phase2/BISlabScreen/Done_Button'), 0)

Mobile.tap(findTestObject('Phase2/BIApplyingSchemeScreen/Next_Button'), 0)

Mobile.callTestCase(findTestCase('Phase2/ApplyingSchemeVanseller/SplitDeliverySummary/Screenshot'), [('testCaseName') : 'TC_295_SummaryScreen'], 
    FailureHandling.STOP_ON_FAILURE)
...
def Scheme_Buy_sku = Mobile.getText(findTestObject('Phase2/BIDeliverySummaryScreen/Product_Name_Text_Indexing'), 0)

println("$Scheme_Buy_sku")

//Mobile.verifyMatch(Scheme_Buy_sku, findTestData('Phase2/TY_01/Test_Data').getValue(4, 15), false)
Mobile.verifyMatch(Actual_Scheme_Buy_Sku, Scheme_Buy_sku, false, FailureHandling.STOP_ON_FAILURE)

println('Scheme get sku is not displayed in delivery summary screen')

Mobile.callTestCase(findTestCase('Phase2/ApplyingSchemeVanseller/SplitDeliverySummary/Screenshot'), [('testCaseName') : 'TC_295'], 
    FailureHandling.STOP_ON_FAILURE)
