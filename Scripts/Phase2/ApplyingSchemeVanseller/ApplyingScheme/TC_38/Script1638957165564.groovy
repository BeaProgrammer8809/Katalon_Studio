...
def Expected_SlabName1 = findTestData('Phase2/TY_01/Test_Data').getValue(4, 6)


def Expected_GET_SKU_Name1 = findTestData('Phase2/TY_01/Test_Data').getValue(5, 6)

def Expected_GET_SKU_Qty1 = findTestData('Phase2/TY_01/Test_Data').getValue(6, 6)

def Expected_GET_SKU_SIH_Logic1 = findTestData('Phase2/TY_01/Test_Data').getValue(7, 6)

def Expected_GET_SKU_MIN_Value1 = findTestData('Phase2/TY_01/Test_Data').getValue(8, 6)

def Expected_GET_SKU_MAX_Value1 = findTestData('Phase2/TY_01/Test_Data').getValue(9, 6)
...
Mobile.callTestCase(findTestCase('Phase2/ApplyingSchemeVanseller/ApplyingScheme/Screenshot'), [('testCaseName') : 'TC_38'], FailureHandling.STOP_ON_FAILURE)
