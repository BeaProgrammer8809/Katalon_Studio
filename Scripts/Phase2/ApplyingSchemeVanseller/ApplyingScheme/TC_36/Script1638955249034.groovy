...
def Expected_SlabName1 = findTestData('Phase2/TY_01/Test_Data').getValue(4, 4)

def Expected_GET_SKU_Name1 = findTestData('Phase2/TY_01/Test_Data').getValue(5, 4)

def Expected_GET_SKU_Qty1 = findTestData('Phase2/TY_01/Test_Data').getValue(6, 4)

def Expected_GET_SKU_SIH_Logic1 = findTestData('Phase2/TY_01/Test_Data').getValue(7, 4)

def Expected_GET_SKU_MIN_Value1 = findTestData('Phase2/TY_01/Test_Data').getValue(8, 4)

def Expected_GET_SKU_MAX_Value1 = findTestData('Phase2/TY_01/Test_Data').getValue(9, 4)
...
def Expected_SlabName2 = findTestData('Phase2/TY_01/Test_Data').getValue(10, 4)

def Expected_GET_SKU_Name2 = findTestData('Phase2/TY_01/Test_Data').getValue(11, 4)

def Expected_GET_SKU_Qty2 = findTestData('Phase2/TY_01/Test_Data').getValue(12, 4)

def Expected_GET_SKU_SIH_Logic2 = findTestData('Phase2/TY_01/Test_Data').getValue(13, 4)

def Expected_GET_SKU_MIN_Value2 = findTestData('Phase2/TY_01/Test_Data').getValue(14, 4)

def Expected_GET_SKU_MAX_Value2 = findTestData('Phase2/TY_01/Test_Data').getValue(15, 4)
...
//slabs should be verified
Mobile.callTestCase(findTestCase('Phase2/ApplyingSchemeVanseller/ApplyingScheme/Screenshot'), [('testCaseName') : 'TC_36'], FailureHandling.STOP_ON_FAILURE)
