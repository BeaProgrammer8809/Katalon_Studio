...
Mobile.verifyElementVisible(findTestObject('Phase2/BIApplyingSchemeScreen/View_Button_Indexing'), 0)

Mobile.delay(2, FailureHandling.STOP_ON_FAILURE)

String actual = Mobile.verifyElementHasAttribute(findTestObject('Phase2/BIApplyingSchemeScreen/View_Button_Indexing'), 'clickable', 0)

println(actual)

Mobile.verifyEqual(actual, findTestData('Phase2/TY_08/ScriptsData').getValue(3, 6), FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2/ApplyingSchemeVanseller/ApplyingScheme/Screenshot'), [('testCaseName') : 'TC_06'], FailureHandling.STOP_ON_FAILURE)
