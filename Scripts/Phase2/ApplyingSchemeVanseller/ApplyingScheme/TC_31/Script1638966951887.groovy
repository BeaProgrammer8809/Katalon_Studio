...
def Expected = findTestData('Phase2/TY_04/Applying_Scheme').getValue(7, 6)
...
Expected = findTestData('Phase2/TY_04/Applying_Scheme').getValue(11, 6)
...
Expected = findTestData('Phase2/TY_04/Applying_Scheme').getValue(9, 6)
...
Expected = findTestData('Phase2/TY_04/Applying_Scheme').getValue(6, 6)
...
Expected = findTestData('Phase2/TY_04/Applying_Scheme').getValue(5, 6)
...
Expected = findTestData('Phase2/TY_04/Applying_Scheme').getValue(4, 6)
...
Expected = findTestData('Phase2/TY_04/Applying_Scheme').getValue(8, 6)
...
Mobile.callTestCase(findTestCase('Phase2/ApplyingSchemeVanseller/ApplyingScheme/Screenshot'), [('testCaseName') : 'TC_31'], FailureHandling.STOP_ON_FAILURE)
