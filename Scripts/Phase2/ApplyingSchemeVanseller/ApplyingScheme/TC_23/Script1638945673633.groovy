...
GlobalVariable.SchemeName = findTestData('Phase2/TY_08/ScriptsData').getValue(3, 5)

println(GlobalVariable.SchemeName)

GlobalVariable.SchemeBuySkuName = findTestData('Phase2/TY_08/ScriptsData').getValue(4, 5)

println GlobalVariable.SchemeBuySkuName

GlobalVariable.SchemeGetSkuName1 = findTestData('Phase2/TY_08/ScriptsData').getValue(5, 5)
...
Mobile.callTestCase(findTestCase('Phase2/ApplyingSchemeVanseller/ApplyingScheme/Screenshot'), [('testCaseName') : 'TC_23_SchemeDetails'], FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyEqual(Actual, findTestData('Phase2/TY_08/ScriptsData').getValue(6, 5), FailureHandling.STOP_ON_FAILURE)


Mobile.verifyLessThanOrEqual(InvQty, schemeBuyQty, FailureHandling.STOP_ON_FAILURE)


Mobile.callTestCase(findTestCase('Phase2/ApplyingSchemeVanseller/ApplyingScheme/Screenshot'), [('testCaseName') : 'TC_23'], FailureHandling.STOP_ON_FAILURE)
