...
Mobile.callTestCase(findTestCase('Phase2/ApplyingSchemeVanseller/ApplyingScheme/Screenshot'), [('testCaseName') : 'TC_16_SchemeDetails'], 
...
Mobile.tap(findTestObject('Phase2/BINumberKeypad01/Num_3'), 0, FailureHandling.STOP_ON_FAILURE)

def replacementQty=Mobile.getText(findTestObject('Phase2/BINumberKeypad01/Num_3'), 0)

println("Replacement qty is "+replacementQty)

Mobile.verifyGreaterThanOrEqual(replacementQty,schemeBuyQty, FailureHandling.STOP_ON_FAILURE)

println('Entering replacement qty greater than scheme buy qty')
...
println('Screen is be navigated to order summary screen')

Mobile.callTestCase(findTestCase('Phase2/ApplyingSchemeVanseller/ApplyingScheme/Screenshot'), [('testCaseName') : 'TC_16'],
FailureHandling.STOP_ON_FAILURE)
