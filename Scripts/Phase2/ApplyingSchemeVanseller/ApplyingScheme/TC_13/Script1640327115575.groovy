...
Mobile.callTestCase(findTestCase('Phase2/ApplyingSchemeVanseller/ApplyingScheme/Screenshot'), [('testCaseName') : 'TC_13A'], FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyGreaterThanOrEqual(Invoice_Qty, schemeBuyQty, FailureHandling.STOP_ON_FAILURE)
...
def Expected = findTestData('Phase2/TY_05/Applying_Scheme').getValue(4, 5)
...
Mobile.callTestCase(findTestCase('Phase2/ApplyingSchemeVanseller/ApplyingScheme/Screenshot'), [('testCaseName') : 'TC_13'], FailureHandling.STOP_ON_FAILURE)
