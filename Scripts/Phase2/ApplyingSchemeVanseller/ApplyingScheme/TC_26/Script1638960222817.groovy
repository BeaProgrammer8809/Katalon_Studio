...
GlobalVariable.SchemeBuySkuName = findTestData('Phase2/TY_04/Applying_Scheme').getValue(8, 3)

GlobalVariable.SchemeGetSkuName1 = findTestData('Phase2/TY_04/Applying_Scheme').getValue(8, 3)

GlobalVariable.SchemeName = findTestData('Phase2/TY_04/Applying_Scheme').getValue(7, 3)
...
Mobile.callTestCase(findTestCase('Phase2/ApplyingSchemeVanseller/ApplyingScheme/Screenshot'), [('testCaseName') : 'TC_26A'], FailureHandling.STOP_ON_FAILURE)
...
def Actual_Screen_Title = Mobile.getText(findTestObject('Object Repository/Phase2/BIInvoiceSummaryScreen/Summary_ScreenTitle'), 
    0, FailureHandling.STOP_ON_FAILURE)

println(Actual_Screen_Title)

def Expected_Screen_Title = findTestData('Phase2/TY_04/Applying_Scheme').getValue(6, 3)

Mobile.verifyMatch(Actual_Screen_Title, Expected_Screen_Title, false, FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2/ApplyingSchemeVanseller/ApplyingScheme/Screenshot'), [('testCaseName') : 'TC_26'], FailureHandling.STOP_ON_FAILURE)
