...
//Mobile.callTestCase(findTestCase('Phase2/Applying_Scheme/Trade_Coverage/Screenshot'), [('testCaseName') : 'TC_45'], FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2/ApplyingSchemeVanseller/ApplyingScheme/Screenshot'), [('testCaseName') : 'TC_45'],
