...
GlobalVariable.SchemeName = findTestData('Phase2/TY_08/ScriptsData').getValue(3, 1)

println(GlobalVariable.SchemeName)

GlobalVariable.SchemeBuySkuName = findTestData('Phase2/TY_08/ScriptsData').getValue(4, 1)

println GlobalVariable.SchemeBuySkuName

GlobalVariable.SchemeGetSkuName1 = findTestData('Phase2/TY_08/ScriptsData').getValue(5, 1)
...
Mobile.callTestCase(findTestCase('Phase2/ApplyingSchemeVanseller/ApplyingScheme/Screenshot'), [('testCaseName') : 'TC_19_SchemeDetails'], FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyEqual(Actual, findTestData('Phase2/TY_08/ScriptsData').getValue(6, 1), FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2/ApplyingSchemeVanseller/ApplyingScheme/Screenshot'), [('testCaseName') : 'TC_19'], FailureHandling.STOP_ON_FAILURE)
