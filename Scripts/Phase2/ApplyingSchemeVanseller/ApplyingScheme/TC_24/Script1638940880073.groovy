...
GlobalVariable.SchemeBuySkuName = findTestData('Phase2/TY_04/Applying_Scheme').getValue(6, 1)

GlobalVariable.SchemeGetSkuName1 = findTestData('Phase2/TY_04/Applying_Scheme').getValue(6, 1)

GlobalVariable.SchemeName = findTestData('Phase2/TY_04/Applying_Scheme').getValue(5, 1)
...
Mobile.callTestCase(findTestCase('Phase2/ApplyingSchemeVanseller/ApplyingScheme/Screenshot'), [('testCaseName') : 'TC_24_SchemeDetails'], FailureHandling.STOP_ON_FAILURE)
...
println('scheme Buy Qty is ' + schemeBuyQty)
...
def Expected_Screen_Title = findTestData('Phase2/TY_04/Applying_Scheme').getValue(6, 2)

Mobile.verifyMatch(Actual_Screen_Title, Expected_Screen_Title, false, FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2/ApplyingSchemeVanseller/ApplyingScheme/Screenshot'), [('testCaseName') : 'TC_24'], FailureHandling.STOP_ON_FAILURE)


println('Applying Scheme screen is displayed')
