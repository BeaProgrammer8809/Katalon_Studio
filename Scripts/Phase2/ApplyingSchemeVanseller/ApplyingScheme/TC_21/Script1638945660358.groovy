...
GlobalVariable.SchemeName = findTestData('Phase2/TY_08/ScriptsData').getValue(3, 3)

println(GlobalVariable.SchemeName)

GlobalVariable.SchemeBuySkuName = findTestData('Phase2/TY_08/ScriptsData').getValue(4, 3)

println(GlobalVariable.SchemeBuySkuName)

GlobalVariable.SchemeGetSkuName1 = findTestData('Phase2/TY_08/ScriptsData').getValue(5, 3)
...
Mobile.callTestCase(findTestCase('Phase2/ApplyingSchemeVanseller/ApplyingScheme/Screenshot'), [('testCaseName') : 'TC_21_SchemeDetails'], FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyEqual(Actual, findTestData('Phase2/TY_08/ScriptsData').getValue(6, 3), FailureHandling.STOP_ON_FAILURE)

Mobile.verifyGreaterThanOrEqual(InvQTy, schemeBuyQty, FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2/ApplyingSchemeVanseller/ApplyingScheme/Screenshot'), [('testCaseName') : 'TC_21'], FailureHandling.STOP_ON_FAILURE)
