...
Mobile.callTestCase(findTestCase('Phase2/ApplyingSchemeVanseller/ApplyingScheme/Screenshot'), [('testCaseName') : 'TC_011'], FailureHandling.STOP_ON_FAILURE)
...
def schemeBuyQty1=findTestData('Phase2/TY_05/Applying_Scheme').getValue(3, 3)

def Invoice_Qty = Mobile.getText(findTestObject('Phase2/BIOrderAndInvoiceScreen01/Pieces_EditText'), 0)

Mobile.verifyEqual(Invoice_Qty, schemeBuyQty1, FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('Phase2/BIOrderAndInvoiceScreen01/Next_Button'), 0)

Mobile.tap(findTestObject('Phase2/BIProductBuyingScreen01/Next_Button'), 0)

def Actual = Mobile.getText(findTestObject('Phase2/BIApplyingSchemeScreen/Applying_Scheme_TextView'), 0)

println('Actualresult=' + Actual)

def Expected = findTestData('Phase2/TY_05/Applying_Scheme').getValue(4, 3)
...
Mobile.callTestCase(findTestCase('Phase2/ApplyingSchemeVanseller/ApplyingScheme/Screenshot'), [('testCaseName') : 'TC_11'], FailureHandling.STOP_ON_FAILURE)
