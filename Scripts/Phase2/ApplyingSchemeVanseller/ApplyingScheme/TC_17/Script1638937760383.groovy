...
Mobile.callTestCase(findTestCase('Phase2/ApplyingSchemeVanseller/ApplyingScheme/Screenshot'), [('testCaseName') : 'TC_17_SchemeDetails'],
...
def productBuyingQty= Mobile.getText(findTestObject('Phase2/BINumberKeypad01/Num_2'), 0)

Mobile.tap(findTestObject('Phase2/BINumberKeypad01/OK_Button'), 0)

Mobile.tap(findTestObject('Phase2/BIReturnProductBuyingScreen01/Done_Button'), 0)

println productBuyingQty

Mobile.verifyEqual(schemeBuyQty, productBuyingQty, FailureHandling.STOP_ON_FAILURE)

println "Entering product buying qty equal to scheme buy qty"
...
Mobile.callTestCase(findTestCase('Phase2/ApplyingSchemeVanseller/ApplyingScheme/Screenshot'), [('testCaseName') : 'TC_17'],
FailureHandling.STOP_ON_FAILURE)
