...
def Expected = findTestData('Phase2/TY_04/Applying_Scheme').getValue(7, 8)
...
Expected = findTestData('Phase2/TY_04/Applying_Scheme').getValue(11, 8)
...
Expected = findTestData('Phase2/TY_04/Applying_Scheme').getValue(9, 8)
...
Expected = findTestData('Phase2/TY_04/Applying_Scheme').getValue(6, 8)
...
Expected = findTestData('Phase2/TY_04/Applying_Scheme').getValue(5, 8)
...
Expected = findTestData('Phase2/TY_04/Applying_Scheme').getValue(4, 8)
...
Expected = findTestData('Phase2/TY_04/Applying_Scheme').getValue(8, 8)
...
Mobile.callTestCase(findTestCase('Phase2/ApplyingSchemeVanseller/ApplyingScheme/Screenshot'), [('testCaseName') : 'TC_33'], FailureHandling.STOP_ON_FAILURE)
