...
Mobile.callTestCase(findTestCase('Phase2/ApplyingSchemeVanseller/ApplyingScheme/Screenshot'), [('testCaseName') : 'TC_09A'], FailureHandling.STOP_ON_FAILURE)
...
def ExpectedGetSku = findTestData('Phase2/TY_05/Applying_Scheme').getValue(4, 1)
...
Mobile.verifyMatch(ActualGetSku, ExpectedGetSku, false, FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2/ApplyingSchemeVanseller/ApplyingScheme/Screenshot'), [('testCaseName') : 'TC_09'], FailureHandling.STOP_ON_FAILURE)

println('Scheme buy sku should not be displayed on promotion slab screen')
