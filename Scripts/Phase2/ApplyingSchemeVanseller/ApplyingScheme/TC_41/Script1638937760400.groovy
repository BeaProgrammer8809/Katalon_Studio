...
Mobile.tap(findTestObject('Phase2/BIOrderAndInvoiceScreen01/Next_Button'), 2)
...
def ExpectedScreenTitle = findTestData('Phase2/TY_03/TestData').getValue(3, 3)
...
def ExpectedSlabName = findTestData('Phase2/TY_03/TestData').getValue(4, 3)
...
def ExpectedSchemeName = findTestData('Phase2/TY_03/TestData').getValue(8, 3)
...
Mobile.callTestCase(findTestCase('Phase2/ApplyingSchemeVanseller/ApplyingScheme/Screenshot'), [('testCaseName') : 'TC_41_ApplyingScheme'], 
...
def ExpectedSchemeSKU_name = findTestData('Phase2/TY_03/TestData').getValue(5, 3)
...
def ExpectedSIH_Remaining = findTestData('Phase2/TY_03/TestData').getValue(6, 3)
...
def ExpectedSchemeGetQty = findTestData('Phase2/TY_03/TestData').getValue(7, 3)
...
def ExpectedSchemeLogicTextView = findTestData('Phase2/TY_03/TestData').getValue(9, 3)
...
def ExpectedMinGetQty = findTestData('Phase2/TY_03/TestData').getValue(10, 3)

println(ExpectedMinGetQty)

//Mobile.verifyEqual(ActualMinGetQty, findTestData('Phase2/TY_03/TestData').getValue(10, 3), FailureHandling.STOP_ON_FAILURE)
...
def ExpectedMaxGetQty = findTestData('Phase2/TY_03/TestData').getValue(11, 3)
...
Mobile.callTestCase(findTestCase('Phase2/ApplyingSchemeVanseller/ApplyingScheme/Screenshot'), [('testCaseName') : 'TC_41'], FailureHandling.STOP_ON_FAILURE)
