...
GlobalVariable.SchemeName = findTestData('Phase2/TY_08/ScriptsData').getValue(3, 2)

println(GlobalVariable.SchemeName)

GlobalVariable.SchemeBuySkuName = findTestData('Phase2/TY_08/ScriptsData').getValue(4, 2)

println GlobalVariable.SchemeBuySkuName

GlobalVariable.SchemeGetSkuName1 = findTestData('Phase2/TY_08/ScriptsData').getValue(5, 2)
...
Mobile.callTestCase(findTestCase('Phase2/ApplyingSchemeVanseller/ApplyingScheme/Screenshot'), [('testCaseName') : 'TC_20_SchemeDetails'], FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyElementExist(findTestObject('Phase2/BIInvoiceSummaryScreen/Summary_ScreenTitle'), 0, FailureHandling.OPTIONAL)

Mobile.verifyElementVisible(findTestObject('Phase2/BIInvoiceSummaryScreen/Summary_ScreenTitle'), 0, FailureHandling.CONTINUE_ON_FAILURE)
...
Mobile.verifyEqual(Actual, findTestData('Phase2/TY_08/ScriptsData').getValue(6, 2), FailureHandling.STOP_ON_FAILURE)

Mobile.verifyLessThanOrEqual(InvQty, schemeBuyQty, FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2/ApplyingSchemeVanseller/ApplyingScheme/Screenshot'), [('testCaseName') : 'TC_20'], FailureHandling.STOP_ON_FAILURE)
