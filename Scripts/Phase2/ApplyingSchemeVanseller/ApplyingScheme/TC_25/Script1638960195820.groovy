...
GlobalVariable.SchemeBuySkuName = findTestData('Phase2/TY_04/Applying_Scheme').getValue(8, 2)

GlobalVariable.SchemeGetSkuName1 = findTestData('Phase2/TY_04/Applying_Scheme').getValue(8, 2)

GlobalVariable.SchemeName = findTestData('Phase2/TY_04/Applying_Scheme').getValue(7, 2)
...
Mobile.callTestCase(findTestCase('Phase2/ApplyingSchemeVanseller/ApplyingScheme/Screenshot'), [('testCaseName') : 'TC_25_SchemeDetails'], FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2/ApplyingSchemeVanseller/ApplyingScheme/Screenshot'), [('testCaseName') : 'TC_25'], FailureHandling.STOP_ON_FAILURE)
