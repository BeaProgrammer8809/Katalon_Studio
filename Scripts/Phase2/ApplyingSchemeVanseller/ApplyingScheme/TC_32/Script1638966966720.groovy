...
def Actual = Mobile.getText(findTestObject('Phase2/BIApplyingSchemeScreen/Slab_TextView'), 0)

println('Actualresult=' + Actual)

def Expected = findTestData('Phase2/TY_04/Applying_Scheme').getValue(7, 7)
...
Expected = findTestData('Phase2/TY_04/Applying_Scheme').getValue(11, 7)
...
Expected = findTestData('Phase2/TY_04/Applying_Scheme').getValue(9, 7)
...
Expected = findTestData('Phase2/TY_04/Applying_Scheme').getValue(6, 7)
...
Expected = findTestData('Phase2/TY_04/Applying_Scheme').getValue(5, 7)
...
Expected = findTestData('Phase2/TY_04/Applying_Scheme').getValue(4, 7)
...
Expected = findTestData('Phase2/TY_04/Applying_Scheme').getValue(8, 7)
...
Expected = findTestData('Phase2/TY_04/Applying_Scheme').getValue(12, 7)
...
Expected = findTestData('Phase2/TY_04/Applying_Scheme').getValue(13, 7)
...
Expected = findTestData('Phase2/TY_04/Applying_Scheme').getValue(15, 7)
...
Expected = findTestData('Phase2/TY_04/Applying_Scheme').getValue(14, 7)
...
Mobile.callTestCase(findTestCase('Phase2/ApplyingSchemeVanseller/ApplyingScheme/Screenshot'), [('testCaseName') : 'TC_32'],
