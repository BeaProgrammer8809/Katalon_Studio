...
retailerName = findTestData('Phase2/TY_06/Onsite Invoice/Onsite_Invoice').getValue(6, 1)
...
Mobile.setText(findTestObject('Phase2/BIOrderAndInvoiceScreen01/Search_Edit_Text'), findTestData('Phase2/TY_06/Onsite Invoice/Onsite_Invoice').getValue(
        3, 1), 0)
...
Mobile.setText(findTestObject('Phase2/BIDeliveryFinalSummaryScreen/Folio_NO_Indexing'), findTestData('Phase2/TY_06/Onsite Invoice/Onsite_Invoice').getValue(
        5, 1), 0)
...
Mobile.callTestCase(findTestCase('Phase2/Onsite_Invoice/Trade_Coverage/Screenshot'), [('testCaseName') : 'TC_283'], FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyElementText(findTestObject('Phase2/BIDeliveryFinalSummaryScreen/PrintPreview_Title'), findTestData('Phase2/TY_06/Onsite Invoice/Onsite_Invoice').getValue(
        2, 1))

Mobile.callTestCase(findTestCase('Phase2/ApplyingSchemeVanseller/OnsiteSummary/Screenshot'), [('testCaseName') : 'TC_283'],
