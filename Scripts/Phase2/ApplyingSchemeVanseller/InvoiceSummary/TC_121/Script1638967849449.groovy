...
Mobile.verifyElementText(findTestObject('Phase2/BIInvoiceSummaryScreen/BISummaryProductDetails/Product_TextView_Indexing'), 
    findTestData('Phase2/TY_06/Invoice Summary/Invoice_Summary').getValue(5, 5))
...
Mobile.verifyElementText(findTestObject('Phase2/BIInvoiceSummaryScreen/BISummaryProductDetails/Pieces_Value_Indexing'), 
    findTestData('Phase2/TY_06/Invoice Summary/Invoice_Summary').getValue(4, 5))

buypiece = Mobile.getText(findTestObject('Phase2/BIInvoiceSummaryScreen/BISummaryProductDetails/Pieces_Value_Indexing'), 
    0)
