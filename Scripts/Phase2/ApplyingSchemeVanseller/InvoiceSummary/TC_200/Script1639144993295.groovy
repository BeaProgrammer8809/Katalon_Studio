...
GlobalVariable.ProductName = findTestData('Phase2/Common_Data/CommonData_03').getValue(6, 65)
...
def expTotalPrice = Double.parseDouble(buySkuUnitPrice) * Double.parseDouble(buySkuQty)
...
println('Total price is as expected')
...
Mobile.callTestCase(findTestCase('Phase2/ApplyingSchemeVanseller/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC_200'],
