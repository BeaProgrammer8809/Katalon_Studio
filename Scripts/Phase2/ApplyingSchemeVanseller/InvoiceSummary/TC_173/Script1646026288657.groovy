...
Mobile.comment('Slab3 should applied successfully')

Mobile.callTestCase(findTestCase('Phase2/ApplyingSchemeVanseller/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC_173(1)'],
	FailureHandling.STOP_ON_FAILURE)

Mobile.verifyElementExist(findTestObject('Phase2/BIApplyingSchemeScreen/Slab_Indexing'), 0, FailureHandling.STOP_ON_FAILURE)

Mobile.verifyElementExist(findTestObject('Phase2/BIApplyingSchemeScreen/Slab_Indexing'), 0, FailureHandling.STOP_ON_FAILURE)

Mobile.verifyElementText(findTestObject('Phase2/BIApplyingSchemeScreen/Slab_Indexing'), findTestData('Phase2.1/TY_06/Invoice_Summary/InvoiceSummary2').getValue(
        4, 4), FailureHandling.STOP_ON_FAILURE)
...
def Getquantity2 = Mobile.getText(findTestObject('Object Repository/Phase2/BISlabScreen/Get_Qty_EditText'), 0, FailureHandling.STOP_ON_FAILURE)

def GetSchemeSku2 = Mobile.getText(findTestObject('Object Repository/Phase2/BISlabScreen/Scheme_Buy_SKU_TextView'), 0)
...
Mobile.callTestCase(findTestCase('Phase2/ApplyingSchemeVanseller/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC_173(2)'],
	FailureHandling.STOP_ON_FAILURE)
...
'verifying the Get quantity for slab 3'
...
def UGetPriceText2 = Mobile.getText(findTestObject('Phase2/BIInvoiceSummaryScreen/BISummaryProductDetails/U.Price_Value_Indexing'),
	0)

double UGetPrice2 = Double.parseDouble(UGetPriceText2)

def GetPieceText2 = Mobile.getText(findTestObject('Phase2/BIInvoiceSummaryScreen/BISummaryProductDetails/Pieces_Value_Indexing'),
	0)

double GetPiece2 = Double.parseDouble(GetPieceText2)

def GetTotalText2 = Mobile.getText(findTestObject('Phase2/BIInvoiceSummaryScreen/BISummaryProductDetails/Price_Value_Indexing'),
	0)

double GetTotal2 = Double.parseDouble(GetTotalText2)

double expectedGetTotal2 = UGetPrice2 * GetPiece2
...
'verifying the Get quantity for slab 1'
Mobile.verifyMatch(Getquantity2, GetPieceText2, false, FailureHandling.STOP_ON_FAILURE)

'Verifing the get Product price was 0 / free Sku'
Mobile.verifyEqual(GetTotal2, findTestData('Phase2.1/TY_06/Invoice_Summary/InvoiceSummary2').getValue(4, 1), FailureHandling.STOP_ON_FAILURE)

'verifying the buy SkuTotal'
Mobile.verifyEqual(GetTotal2, expectedGetTotal2, FailureHandling.STOP_ON_FAILURE)
