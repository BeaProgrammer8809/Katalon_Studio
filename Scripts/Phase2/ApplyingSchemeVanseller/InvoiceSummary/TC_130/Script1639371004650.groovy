...
Mobile.getText(findTestObject('Phase2/BIInvoiceSummaryScreen/BuySchemeDetails/Buy_Pieces_Value'), 0)

Mobile.getText(findTestObject('Phase2/BIInvoiceSummaryScreen/GetSchemeDetails/Get_Pieces_Value'), 0)

GlobalVariable.index = findTestData('Phase2/Common_Data/CommonData').getValue(Number, 2)

Mobile.getText(findTestObject('Object Repository/Phase2/BIInvoiceSummaryScreen/BISummaryProductDetails/Pieces_Value_Indexing'), 
    0)
...
String Actual = Mobile.getText(findTestObject('Phase2/BIDeliverySummaryScreen/Total_Qty_Text'), 0)

println(Actual)

Mobile.callTestCase(findTestCase('Phase2/ApplyingSchemeVanseller/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC_130'],
