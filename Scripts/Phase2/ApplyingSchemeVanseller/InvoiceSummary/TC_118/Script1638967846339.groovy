...
Mobile.verifyElementText(findTestObject('Phase2/BIInvoiceSummaryScreen/BISummaryProductDetails/Product_TextView_Indexing'), 
    findTestData('Phase2/TY_06/Invoice Summary/Invoice_Summary').getValue(5, 2))

SchemeName = Mobile.getText(findTestObject('Phase2/BIInvoiceSummaryScreen/BISummaryProductDetails/Product_TextView_Indexing'), 
    0)
...
Mobile.verifyElementText(findTestObject('Phase2/BIInvoiceSummaryScreen/BISummaryProductDetails/Pieces_Value_Indexing'), 
    findTestData('Phase2/TY_06/Invoice Summary/Invoice_Summary').getValue(4, 2), FailureHandling.STOP_ON_FAILURE)

buypieces = Mobile.getText(findTestObject('Phase2/BIInvoiceSummaryScreen/BISummaryProductDetails/Pieces_Value_Indexing'), 
    0)
