...
ExpBuySkuName =Mobile.getText(findTestObject('Object Repository/Phase2/BIOrderAndInvoiceScreen01/Schem_Buy_SKU_Text_view'), 0)
...
Mobile.callTestCase(findTestCase('Phase2/ApplyingSchemeVanseller/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC_205_Scheme'],
...
Mobile.callTestCase(findTestCase('Phase2/ApplyingSchemeVanseller/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC_205_GetScheme'],
	FailureHandling.STOP_ON_FAILURE)
...
'sku having no category  discount and  5% item discount '
...
def actualTaxPercentage = findTestData('Phase2.1/Common_Data/CommonData').getValue(18, 1)
...
println('Tax IVA and IEPS is applied for sku')
...
println('Tax  IEPS and IVA is not included in total price calculation')

Mobile.callTestCase(findTestCase('Phase2/ApplyingSchemeVanseller/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC_205'],FailureHandling.STOP_ON_FAILURE)
