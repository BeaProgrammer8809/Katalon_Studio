...
GlobalVariable.ProductName = findTestData('Phase2.1/Common_Data/CommonData').getValue(6, 52)
...
Mobile.callTestCase(findTestCase('Phase2/ApplyingSchemeVanseller/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC_198_Actual_Pieces_Value'], FailureHandling.STOP_ON_FAILURE)
...
def Actual_Piece = findTestData('Phase2.1/TY_02/Test_Data_Phase2').getValue(3, 256)
...
Mobile.callTestCase(findTestCase('Phase2/ApplyingSchemeVanseller/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC_198_Actual_Values'], FailureHandling.STOP_ON_FAILURE)
...
//Verification to check the Category discount not applied
...
//Verification to check that get SKU Scheme is free(100%)
Mobile.verifyEqual(Actual_Piece, TotalOrderValue, FailureHandling.STOP_ON_FAILURE)
