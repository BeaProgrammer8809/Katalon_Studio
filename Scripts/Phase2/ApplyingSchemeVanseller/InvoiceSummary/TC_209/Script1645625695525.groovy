...
GlobalVariable.ProductName = findTestData('Phase2/Common_Data/CommonData_03').getValue(6, 58)
...
def actualBuySku = Mobile.getText(findTestObject('Object Repository/Phase2/BIOrderAndInvoiceScreen01/Schem_Buy_SKU_Text_view'), 
    0)
...
def expBuySku = Mobile.getText(findTestObject('Object Repository/Phase2/BIInvoiceSummaryScreen/BISummaryProductDetails/Product_TextView_Indexing'), 
    0)
...
def expGetSku = Mobile.getText(findTestObject('Object Repository/Phase2/BIInvoiceSummaryScreen/BISummaryProductDetails/Product_TextView_Indexing'), 
    0)
...
def CategoryDisc = CustomKeywords.'com.ty.keywords.MobileKeywords.category10_Percent'(GrossAmt)

def expTotalPrice = (Double.parseDouble(buySkuUnitPrice) * Double.parseDouble(buySkuQty)) - CategoryDisc
...
Mobile.callTestCase(findTestCase('Phase2/ApplyingSchemeVanseller/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC_209'], 
