...
GlobalVariable.SchemeBuySkuName = findTestData('Phase2/TY_06/Invoice Summary/Invoice_Summary').getValue(5, 4)

GlobalVariable.SchemeGetSkuName1 = findTestData('Phase2/TY_06/Invoice Summary/Invoice_Summary').getValue(6, 4)
...
//Mobile.verifyMatch(schemeBuyQty, orderqty, false)
...
getprice = Mobile.getText(findTestObject('Phase2/BIInvoiceSummaryScreen/BISummaryProductDetails/Price_Value_Indexing'), 
    0)

println(getprice)

//Mobile.callTestCase(findTestCase('Phase2/Invoice_Summary/Trade_Coverage/Screenshot'), [('testCaseName') : 'TC_120'], FailureHandling.STOP_ON_FAILURE)

Mobile.comment('Sku order qty should be displayed in pieces')

GlobalVariable.index = findTestData('Phase2/Common_Data/CommonData').getValue(5, 1)

Mobile.verifyElementText(findTestObject('Phase2/BIInvoiceSummaryScreen/BISummaryProductDetails/Pieces_Value_Indexing'), 
    findTestData('Phase2/TY_06/Invoice Summary/Invoice_Summary').getValue(4, 4), FailureHandling.STOP_ON_FAILURE)

Buypieces = Mobile.getText(findTestObject('Phase2/BIInvoiceSummaryScreen/BISummaryProductDetails/Pieces_Value_Indexing'), 
    0)

Mobile.verifyMatch(Buypieces, findTestData('Phase2/TY_06/Invoice Summary/Invoice_Summary').getValue(4, 4), false)

Mobile.verifyMatch(orderqty, Buypieces, false)

Mobile.callTestCase(findTestCase('Phase2/ApplyingSchemeVanseller/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC_120'], 
