...
Mobile.callTestCase(findTestCase('Phase2/ApplyingSchemeVanseller/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC_169(1)'], 
...
Mobile.verifyElementText(findTestObject('Phase2/BIApplyingSchemeScreen/Slab_TextView'), findTestData('Phase2.1/TY_06/Invoice_Summary/InvoiceSummary2').getValue(
        4, 3), FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2/ApplyingSchemeVanseller/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC_169(2)'], 
    FailureHandling.STOP_ON_FAILURE)
