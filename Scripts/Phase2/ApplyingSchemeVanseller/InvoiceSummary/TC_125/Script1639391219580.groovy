...
GlobalVariable.Buysku = findTestData('Phase2/TY_11/TestData').getValue(2, 4)

GlobalVariable.SchemeBuySkuName = findTestData('Phase2/TY_11/TestData').getValue(2, 4)

GlobalVariable.SchemeName = findTestData('Phase2/TY_11/TestData').getValue(4, 4)

Mobile.longPress(findTestObject('Phase2/BIOrderAndInvoiceScreen01/Schem_Buy_SKU_Text_view'), 0)

Mobile.callTestCase(findTestCase('Phase2/ApplyingSchemeVanseller/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC_125_SchemeDetails'],
...
def ExpectedSalesReturn = Mobile.getText(findTestObject('Object Repository/Phase2/BIReturnProductBuyingScreen01/Pieces_Edit_Text'), 0)
...
Mobile.verifyMatch(ActualSalesReturn, ExpectedSalesReturn, false, FailureHandling.STOP_ON_FAILURE)
...
def ActualSchemeBuySKU_Name= Mobile.getText(findTestObject('Object Repository/Phase2/BIInvoiceSummaryScreen/BISummaryProductDetails/Product_TextView_Indexing'), 0)

Mobile.verifyMatch(ActualSchemeBuySKU_Name, SchemeBuySKU_Name, false, FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2/ApplyingSchemeVanseller/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC_125'], FailureHandling.STOP_ON_FAILURE)
