...
GlobalVariable.SchemeBuySkuName = findTestData('Phase2/TY_06/Invoice Summary/Invoice_Summary').getValue(5, 3)

GlobalVariable.SchemeGetSkuName1 = findTestData('Phase2/TY_06/Invoice Summary/Invoice_Summary').getValue(6, 3)
...
Getquantity = Mobile.getText(findTestObject('Phase2/BISlabScreen/Get_Qty_EditText'), 0)
...
Mobile.verifyElementText(findTestObject('Phase2/BIInvoiceSummaryScreen/BISummaryProductDetails/Pieces_Value_Indexing'), 
    findTestData('Phase2/TY_06/Invoice Summary/Invoice_Summary').getValue(7, 3))

pieces = Mobile.getText(findTestObject('Phase2/BIInvoiceSummaryScreen/BISummaryProductDetails/Pieces_Value_Indexing'), 0)

//Mobile.callTestCase(findTestCase('Phase2/Invoice_Summary/Trade_Coverage/Screenshot'), [('testCaseName') : 'TC_119'], FailureHandling.STOP_ON_FAILURE)
Mobile.comment('verifying scheme get quantity')

Mobile.verifyMatch(pieces, findTestData('Phase2/TY_06/Invoice Summary/Invoice_Summary').getValue(7, 3), false)

Mobile.verifyMatch(Getquantity, pieces, false)

Mobile.verifyElementExist(findTestObject('Phase2/BIInvoiceSummaryScreen/BISummaryProductDetails/Product_TextView_Indexing'), 
    0)

Mobile.checkElement(findTestObject('Phase2/BIInvoiceSummaryScreen/BISummaryProductDetails/Product_TextView_Indexing'), 0)

Mobile.verifyElementText(findTestObject('Phase2/BIInvoiceSummaryScreen/BISummaryProductDetails/Product_TextView_Indexing'), 
    findTestData('Phase2/TY_06/Invoice Summary/Invoice_Summary').getValue(6, 3))

getskuName = Mobile.getText(findTestObject('Phase2/BIInvoiceSummaryScreen/BISummaryProductDetails/Product_TextView_Indexing'), 
    0)

Mobile.comment('verifying the scheme getsku')

Mobile.verifyMatch(getskuName, findTestData('Phase2/TY_06/Invoice Summary/Invoice_Summary').getValue(6, 3), false)

Mobile.callTestCase(findTestCase('Phase2/ApplyingSchemeVanseller/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC_119'], 
