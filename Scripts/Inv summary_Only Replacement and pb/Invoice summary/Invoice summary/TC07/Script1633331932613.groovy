...
Mobile.callTestCase(findTestCase('Reusable Cases/Mobile/Inv summary_invoice and pb/Credit Retailer Navigation'), [:], FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Inv summary_Only Replacement and pb/Invoice summary/Reusables/Screenshot'), [('testCaseName') : 'TC07'], 
...
Mobile.callTestCase(findTestCase('Inv summary_Only Replacement and pb/Invoice summary/Reusables/Screenshot'), [('testCaseName') : 'TC07(2)'], 
    FailureHandling.STOP_ON_FAILURE)
