...
folioNoLength = txtFolioNo.length()

Mobile.verifyEqual('15', folioNoLength, FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Inv summary_Invoice rep and pb/Invoice summary/Screenshot'), [('testCaseName') : 'TC_ID_178'], 
...
Mobile.callTestCase(findTestCase('Inv summary_Invoice rep and pb/Invoice summary/Screenshot'), [('testCaseName') : 'TC_ID_179_180_395'], 
    FailureHandling.STOP_ON_FAILURE)
