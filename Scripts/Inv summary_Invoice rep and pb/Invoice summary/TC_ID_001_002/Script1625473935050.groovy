...
txtMenuTradeCoverage = Mobile.getText(findTestObject('Phase 1.1/Resource3/Order and Invoice/Menu/Menu_Trade Coverage'), 
    0)

Mobile.verifyMatch('Trade Coverage', txtMenuTradeCoverage, false)

Mobile.callTestCase(findTestCase('Inv summary_Invoice rep and pb/Invoice summary/Screenshot'), [('testCaseName') : 'TC_ID_001'], 
...
Mobile.verifyElementVisible(findTestObject('Phase 1.1/Resource3/Order and Invoice/Trade Coverage/Trade Coverage Screen/header_Trade Coverage'), 
    0)
...
txtOrderandInvoice = Mobile.getText(findTestObject('Phase 1.1/Resource3/Order and Invoice/Trade Coverage/Store Activities Screeen/Order And Invoice Screen/title_Order and  Invoice'), 
    0)

println(txtOrderandInvoice)
...
Mobile.verifyElementVisible(findTestObject('Phase 1.1/Resource3/Product Buying/btn_Next'), 0)

Mobile.verifyElementExist(findTestObject('Phase 1.1/Resource3/Product Buying/btn_Next'), 0)

Mobile.tap(findTestObject('Phase 1.1/Resource3/Product Buying/btn_Next'), 0)

Mobile.verifyElementVisible(findTestObject('Phase 1.1/Resource3/Product Buying/Product Buying_Popup/txtView_No Items Added'), 
    0)

Mobile.verifyElementExist(findTestObject('Phase 1.1/Resource3/Product Buying/Product Buying_Popup/txtView_No Items Added'), 
    0)

Mobile.verifyElementText(findTestObject('Phase 1.1/Resource3/Product Buying/Product Buying_Popup/txtView_No Items Added'), 
    'No Items Added')

Mobile.verifyElementVisible(findTestObject('Phase 1.1/Resource3/Product Buying/Product Buying_Popup/btn_OK'), 0)

Mobile.verifyElementExist(findTestObject('Phase 1.1/Resource3/Product Buying/Product Buying_Popup/btn_OK'), 0)

Mobile.verifyElementText(findTestObject('Phase 1.1/Resource3/Product Buying/Product Buying_Popup/btn_OK'), 'OK')

'TC_ID_002--> Check whether able to navigate to Invoice summary screen without doing Invoice, replacement and product buying for any sku'
Mobile.callTestCase(findTestCase('Inv summary_Invoice rep and pb/Invoice summary/Screenshot'), [('testCaseName') : 'TC_ID_002'], 
    FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('Phase 1.1/Resource3/Product Buying/Product Buying_Popup/btn_OK'), 0)
