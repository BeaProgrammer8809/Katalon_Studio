...
txtlblRefNo = Mobile.getText(findTestObject('Phase 1.1/Resource3/Product Buying/Summary/Delivery Summary/Devlivery Final Summary/Collection/TE/txtView-Reference Num'), 
    0)
...
Mobile.verifyMatch('Reference Num', txtlblRefNo, false)

Mobile.callTestCase(findTestCase('Inv summary_Invoice rep and pb/Invoice summary/Screenshot'), [('testCaseName') : 'TC_ID_489'], 
...
Mobile.verifyMatch(RefNo, txtRefNo, false)

Mobile.verifyNotMatch(txtlblRefNo, txtRefNo, false)

Mobile.callTestCase(findTestCase('Inv summary_Invoice rep and pb/Invoice summary/Screenshot'), [('testCaseName') : 'TC_ID_489_1'], 
    FailureHandling.STOP_ON_FAILURE)
...
String refNo1 = '12345678901234567890123456789012'
...
Mobile.verifyEqual('30', afterPassRefNo, FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Inv summary_Invoice rep and pb/Invoice summary/Screenshot'), [('testCaseName') : 'TC_ID_490_1'], 
    FailureHandling.STOP_ON_FAILURE)

if (Mobile.verifyEqual('30', afterPassRefNo, FailureHandling.STOP_ON_FAILURE)) {
    println('Reference number only accepted 30 Char')

    Mobile.verifyNotEqual(reflength, afterPassRefNo, FailureHandling.STOP_ON_FAILURE)
}
...
Mobile.callTestCase(findTestCase('Inv summary_Invoice rep and pb/Invoice summary/Screenshot'), [('testCaseName') : 'TC_ID_490_2'], 
    FailureHandling.STOP_ON_FAILURE)
