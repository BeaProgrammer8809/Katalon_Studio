...
Mobile.takeScreenshot('.\\Screenshot\\Run Time Images\\Run Time\\toastReferenceAlreadyEx.png')
...
String testvalues = CustomKeywords.'com.android.keywords.ReadImage.crackingImage'('.\\Screenshot\\Run Time Images\\Run Time\\toastReferenceAlreadyEx.png')
...
if (Mobile.verifyMatch('Reference number already used', RNAU, false, FailureHandling.OPTIONAL)) {
    Mobile.verifyMatch('Reference number already used', RNAU, false //String testvalues = CustomKeywords.'com.android.keywords.ReadImage.crackingImage'('G:\\Bimbo Mobile Testing\\Bimbo Mobile\\Screenshot\\Run Time Images\\Run Time\\SelectBankTabandhold.png')
        )
} else {
    Mobile.tap(findTestObject('Phase 1.1/Resource3/Product Buying/Summary/Delivery Summary/Devlivery Final Summary/Collection/Cheques/btn_Submit'), 
        0)
    ...
    Mobile.takeScreenshot('.\\Screenshot\\Run Time Images\\Run Time\\toastReferenceAlreadyEx1.png')
    ...
    String testvalues1 = CustomKeywords.'com.android.keywords.ReadImage.crackingImage'('.\\Screenshot\\Run Time Images\\Run Time\\toastReferenceAlreadyEx1.png')
