...
refNo = Mobile.getText(findTestObject('Phase 1.1/Resource3/Product Buying/Summary/Delivery Summary/Devlivery Final Summary/Collection/TE/txtView-Reference Num'), 
    0)

println(refNo)

Mobile.verifyMatch("Reference Num", refNo, false, FailureHandling.STOP_ON_FAILURE)
