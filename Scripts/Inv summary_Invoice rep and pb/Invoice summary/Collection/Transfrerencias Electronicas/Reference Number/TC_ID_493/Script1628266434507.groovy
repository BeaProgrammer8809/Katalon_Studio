...
txtBeforeAddSC = Mobile.getText(findTestObject('Phase 1.1/Resource3/Product Buying/Summary/Delivery Summary/Devlivery Final Summary/Collection/TE/txtView-Reference Num'), 
    0)
...
Mobile.verifyNotMatch(txtBeforeAddSC, txtRefNo, false, FailureHandling.STOP_ON_FAILURE)

if (Mobile.verifyMatch(txtBeforeAddSC, txtRefNo, false, FailureHandling.STOP_ON_FAILURE)) {
    println('Reference number field should not accepts special characters.')

    Mobile.callTestCase(findTestCase('Inv summary_Invoice rep and pb/Invoice summary/Screenshot'), [('testCaseName') : 'TC_ID_493'], 
