...
txtModifiedAmount = Mobile.getText(findTestObject('Phase 1.1/Resource3/Product Buying/Summary/Delivery Summary/Devlivery Final Summary/Collection/Efectivo/Efectivo_CollectionTextbox'), 
    0)

println(txtModifiedAmount)

txtTotalPaidAmount = Mobile.getText(findTestObject('Phase 1.1/Resource3/Product Buying/Summary/Delivery Summary/Devlivery Final Summary/Collection/Efectivo/totalPaid'), 
    0)

println(txtTotalPaidAmount)

String[] splitPaidAmt = txtTotalPaidAmount.split('Total Paid : ')

println(splitPaidAmt[1])

Mobile.verifyMatch(txtModifiedAmount, splitPaidAmt[1], false, FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Inv summary_Invoice rep and pb/Invoice summary/Screenshot'), [('testCaseName') : 'TC_ID_101'], 
    FailureHandling.STOP_ON_FAILURE)

if (Mobile.verifyMatch(txtModifiedAmount, splitPaidAmt[1], false, FailureHandling.STOP_ON_FAILURE)) {
    println('The Modified amount in Total paid field should be displayed across Total paid label')
}
...
Mobile.verifyMatch('Enter amount', returntoastmsg1, false, FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Inv summary_Invoice rep and pb/Invoice summary/Screenshot'), [('testCaseName') : 'TC_ID_102'], 
    FailureHandling.STOP_ON_FAILURE)
