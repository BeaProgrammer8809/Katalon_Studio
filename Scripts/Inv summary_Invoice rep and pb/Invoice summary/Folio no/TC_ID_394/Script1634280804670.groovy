...
String foliono = 'Testing_123-0901'

folionolen1 = foliono.length()
...
Mobile.callTestCase(findTestCase('Inv summary_Invoice rep and pb/Invoice summary/Screenshot'), [('testCaseName') : 'TC_ID_390'], 
...
folioNoLen = txtFolioNo.length()

Mobile.verifyEqual('15', folioNoLen, FailureHandling.STOP_ON_FAILURE)

Mobile.verifyNotEqual(folionolen1, folioNoLen, FailureHandling.STOP_ON_FAILURE)
