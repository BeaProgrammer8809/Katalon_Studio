...
Mobile.takeScreenshot('.\\Screenshot\\Run Time Images\\Run Time\\toastEffTotalpaidamountlesser1.png')
...
String testvalues = CustomKeywords.'com.android.keywords.ReadImage.crackingImage'('G:\\Bimbo Mobile Testing\\Bimbo Mobile\\Screenshot\\Run Time Images\\Run Time\\toastEffTotalpaidamountlesser1.png')
...
if (Mobile.verifyMatch(actToastMsg, expToastmsg, false, FailureHandling.OPTIONAL)) {
    ...
    Mobile.takeScreenshot('.\\Screenshot\\Run Time Images\\Run Time\\toastEffTotalpaidamountlesser01.png')
    ...
    String testvalues1 = CustomKeywords.'com.android.keywords.ReadImage.crackingImage'('.\\Screenshot\\Run Time Images\\Run Time\\toastEffTotalpaidamountlesser01.png')
