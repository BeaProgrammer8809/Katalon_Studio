...
'TC_ID_003--> Check whether able to navigate to Invoice summary screen after taking Invoice, Rep and Product buying for any sku'
Mobile.verifyElementExist(findTestObject('Phase 1.1/Resource3/Product Buying/Summary/txtView_Header_Summary'), 0)

'TC_ID_004--> 1.Screen title should be Summary'
if (Mobile.verifyElementVisible(findTestObject('Phase 1.1/Resource3/Product Buying/Summary/txtView_Header_Summary'), 0, 
    ...
    Mobile.callTestCase(findTestCase('Inv summary_Invoice rep and pb/Invoice summary/Screenshot'), [('testCaseName') : 'TC_ID_003'], 
        FailureHandling.STOP_ON_FAILURE)
}
...
'TC_ID_004--> Invoice No should be generated and displayed in centre.'
...
Mobile.callTestCase(findTestCase('Inv summary_Invoice rep and pb/Invoice summary/Screenshot'), [('testCaseName') : 'TC_ID_004'], 
    FailureHandling.STOP_ON_FAILURE)
