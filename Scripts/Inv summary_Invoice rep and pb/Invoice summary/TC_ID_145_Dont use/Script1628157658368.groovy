...
if (Mobile.verifyElementVisible(findTestObject('Phase 1.1/Resource3/Product Buying/Summary/Delivery Summary/Devlivery Final Summary/Collection/Efectivo/toast_Locator'), 
    0, FailureHandling.OPTIONAL)) {
    ...
    Mobile.callTestCase(findTestCase('Inv summary_Invoice rep and pb/Invoice summary/Screenshot'), [('testCaseName') : 'TC_ID_098'], 
        FailureHandling.STOP_ON_FAILURE)
} else {
    Mobile.tap(findTestObject('Phase 1.1/Resource3/Product Buying/Summary/Delivery Summary/Devlivery Final Summary/Collection/Cheques/btn_Submit'), 
        0)
    ...
    try {
        ...
        String tstmsg1 = 'Please Pay Total Balance Amount $'

        String actToastMsg1 = tstmsg1 + paidMinusValue

        println(actToastMsg1)

        Mobile.verifyMatch(actToastMsg1, returntoastmsg1, false, FailureHandling.STOP_ON_FAILURE)
