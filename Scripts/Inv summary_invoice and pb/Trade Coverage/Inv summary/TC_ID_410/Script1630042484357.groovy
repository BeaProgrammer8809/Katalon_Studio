...
val = Double.parseDouble(Inv_Amount_Collection)
...
Mobile.callTestCase(findTestCase('Inv summary_invoice and pb/Trade Coverage/Inv summary/Screenshot'), [('testCaseName') : 'TC_ID_410'], 
    FailureHandling.STOP_ON_FAILURE)
