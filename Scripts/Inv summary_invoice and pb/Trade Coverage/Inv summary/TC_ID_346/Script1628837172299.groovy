...
if(Mobile.verifyElementVisible(findTestObject('Phase 1.1/Resource1/Van Seller/Delivery Final Summary/2nd Row input Folio No.'), 0, FailureHandling.STOP_ON_FAILURE))
{
...
errormsg = 'Please Collect Cash Before Invoice'
...
Mobile.callTestCase(findTestCase('Inv summary_invoice and pb/Trade Coverage/Inv summary/Screenshot'), [('testCaseName') : 'TC_ID_346'], 
