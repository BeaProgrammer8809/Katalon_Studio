...
Mobile.callTestCase(findTestCase('Inv summary_invoice and pb/Trade Coverage/Inv summary/Screenshot'), [('testCaseName') : 'TC_ID_277'], 
...
Mobile.callTestCase(findTestCase('Inv summary_invoice and pb/Trade Coverage/Inv summary/Screenshot'), [('testCaseName') : 'TC_ID_277_278'], 
    FailureHandling.STOP_ON_FAILURE)
...
Min_Amount_Collection = Mobile.getText(findTestObject('Phase 1.1/Resource1/Van Seller/Collection/value_Min.Amt'), 0)

println(Min_Amount_Collection)

Mobile.verifyMatch(Inv_Amount_Collection, summary_Total, false)

Mobile.verifyMatch(Min_Amount_Collection, summary_Total, false)

Mobile.callTestCase(findTestCase('Inv summary_invoice and pb/Trade Coverage/Inv summary/Screenshot'), [('testCaseName') : 'TC_ID_277_278(1)'], 
    FailureHandling.STOP_ON_FAILURE)
