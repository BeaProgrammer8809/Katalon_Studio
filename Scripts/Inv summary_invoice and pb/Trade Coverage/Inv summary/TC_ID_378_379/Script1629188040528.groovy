...
Mobile.verifyElementExist(findTestObject('Phase 1.1/Resource2/Order and Invoice/Summary Screen/Delivery Final Summary/Efectivo - CheckBox'), 
    0)

Mobile.tap(findTestObject('Phase 1.1/Resource2/Order and Invoice/Summary Screen/Delivery Final Summary/Efectivo - CheckBox'), 
    0)
...
Mobile.setText(findTestObject('Phase 1.1/Resource1/Van Seller/Delivery Final Summary/1st Row Folio Input Field'), '123456', 0)

Mobile.callTestCase(findTestCase('Inv summary_invoice and pb/Trade Coverage/Inv summary/Screenshot'), [('testCaseName') : 'TC_ID_379'], 
...
if (Mobile.verifyElementVisible(findTestObject('Phase 1.1/Resource1/Van Seller/Delivery Final Summary/2nd Row input Folio No.'), 
    ...
    Mobile.setText(findTestObject('Phase 1.1/Resource1/Van Seller/Delivery Final Summary/2nd Row input Folio No.'), '123456', 
        0)
}
...
Mobile.tap(findTestObject('Phase 1.1/Resource1/Van Seller/Delivery Final Summary/Popup OK Button'), 0, FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('Phase 1.1/Resource1/Van Seller/Delivery Final Summary/OK - Spliited Invoice Saved'), 0, FailureHandling.STOP_ON_FAILURE)

Mobile.delay(3, FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Inv summary_invoice and pb/Trade Coverage/Inv summary/Screenshot'), [('testCaseName') : 'TC_ID_378'], 
    FailureHandling.STOP_ON_FAILURE)
