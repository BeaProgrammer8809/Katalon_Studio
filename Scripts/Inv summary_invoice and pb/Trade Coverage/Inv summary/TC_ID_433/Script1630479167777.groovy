...
Mobile.sendKeys(findTestObject('Phase 1.1/Resource1/Van Seller/Collection Transferencias Electronica/input_Reference Num'), '123')

Mobile.tap(findTestObject('Phase 1.1/Resource1/Van Seller/Collection/button_Submit'), 0)

totalsummary = Double.parseDouble(Inv_Amount_Collection)
...
errormsg = ('Please Pay Total Balance Amount $' + paidamt)
...
Mobile.callTestCase(findTestCase('Inv summary_invoice and pb/Trade Coverage/Inv summary/Screenshot'), [('testCaseName') : 'TC_ID_433'], 
