...
Mobile.startApplication(findTestData('Login Credentials/Mobile/Login Info').getValue(4, 1), false)
...
Mobile.verifyElementVisible(findTestObject('Phase 1.1/Resource2/Order and Invoice/Summary Screen/Delivery Final Summary/EditText - Folio Number text field'), 
    0)

Mobile.callTestCase(findTestCase('Inv summary_invoice and pb/Trade Coverage/Inv summary/Screenshot'), [('testCaseName') : 'TC_ID_370'], 
