...
Mobile.verifyElementVisible(findTestObject('Phase 1.1/Resource1/Van Seller/Collection/Header_Collection'), 0)

Mobile.verifyElementText(findTestObject('Phase 1.1/Resource1/Van Seller/Collection/Header_Collection'), 'Collection')

Mobile.callTestCase(findTestCase('Inv summary_invoice and pb/Trade Coverage/Inv summary/Screenshot'), [('testCaseName') : 'TC_ID_459'], 
