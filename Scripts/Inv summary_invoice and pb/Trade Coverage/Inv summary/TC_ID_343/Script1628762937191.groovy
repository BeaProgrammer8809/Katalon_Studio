...
sum_Total = Double.parseDouble(summary_Total)

summar_amt1 = (sum_Total / 2)

String summary_amt1 = String.format('%.2f', summar_amt1)

Mobile.tap(findTestObject('Phase 1.1/Resource1/Van Seller/Collection/checkbox_Efectivo'), 0)

println(summary_amt1)

Mobile.sendKeys(findTestObject('Phase 1.1/Resource1/Van Seller/Collection/input_value_Total Amount'), summary_amt1)

Mobile.callTestCase(findTestCase('Inv summary_invoice and pb/Trade Coverage/Inv summary/Screenshot'), [('testCaseName') : 'TC_ID_343'], 
...
Mobile.sendKeys(findTestObject('Phase 1.1/Resource1/Van Seller/Collection Cheque/input_ChequeNo.'), '123456789')

Mobile.clearText(findTestObject('Phase 1.1/Resource1/Van Seller/Collection/input_value_Total Amount'), 0)

Mobile.sendKeys(findTestObject('Phase 1.1/Resource1/Van Seller/Collection/input_value_Total Amount'), summary_amt1)

Mobile.callTestCase(findTestCase('Inv summary_invoice and pb/Trade Coverage/Inv summary/Screenshot'), [('testCaseName') : 'TC_ID_343_1'], 
    FailureHandling.STOP_ON_FAILURE)
