...
Mobile.verifyElementVisible(findTestObject('Phase 1.1/Resource1/Van Seller/Collection Cheque/button_Select Bank'), 0)

Mobile.tap(findTestObject('Phase 1.1/Resource1/Van Seller/Collection Cheque/button_Select Bank'), 0)

Mobile.callTestCase(findTestCase('Inv summary_invoice and pb/Trade Coverage/Inv summary/Screenshot'), [('testCaseName') : 'TC_ID_327'], 
...
Mobile.verifyElementExist(findTestObject('Phase 1.1/Resource1/Van Seller/Collection Cheque/drop_1st Bank'), 0)

Mobile.tap(findTestObject('Phase 1.1/Resource1/Van Seller/Collection Cheque/drop_1st Bank'), 0)

Mobile.callTestCase(findTestCase('Inv summary_invoice and pb/Trade Coverage/Inv summary/Screenshot'), [('testCaseName') : 'TC_ID_328'], 
    FailureHandling.STOP_ON_FAILURE)
