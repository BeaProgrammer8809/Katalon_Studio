...
Mobile.sendKeys(findTestObject('Phase 1.1/Resource1/Van Seller/Collection/input_value_Total Amount'), '21')
...
Mobile.verifyMatch('Amount exceeds the balance, please check.', txtSuccessmsg, false)

if (toast == null) {
    KeywordUtil.markFailed('ERROR: Toast object not found!')
}

Mobile.callTestCase(findTestCase('Inv summary_invoice and pb/Trade Coverage/Inv summary/Screenshot'), [('testCaseName') : 'TC_ID_325'], 
    FailureHandling.STOP_ON_FAILURE)
