...
Mobile.callTestCase(findTestCase('Reusable Cases/Mobile/Inv summary_invoice and pb/Wild Card Retailer Navigation'), [:], 
...
Mobile.verifyElementVisible(findTestObject('Phase 1.1/Resource1/Van Seller/Wild Card Retailer Summary Screen/Reason Title'), 
    0)

Mobile.verifyElementExist(findTestObject('Phase 1.1/Resource1/Van Seller/Wild Card Retailer Summary Screen/Reason Title'), 0)

Mobile.verifyElementText(findTestObject('Phase 1.1/Resource1/Van Seller/Wild Card Retailer Summary Screen/Reason Title'), 'Reason')

Mobile.verifyElementVisible(findTestObject('Phase 1.1/Resource1/Van Seller/Wild Card Retailer Summary Screen/info. icon bottom'), 
    0)

Mobile.verifyElementExist(findTestObject('Phase 1.1/Resource1/Van Seller/Wild Card Retailer Summary Screen/info. icon bottom'), 
    0)

Mobile.verifyElementVisible(findTestObject('Phase 1.1/Resource1/Van Seller/Wild Card Retailer Summary Screen/Please collect cash Check box'), 
    0)

Mobile.verifyElementExist(findTestObject('Phase 1.1/Resource1/Van Seller/Wild Card Retailer Summary Screen/Please collect cash Check box'), 
    0)

Mobile.verifyElementText(findTestObject('Phase 1.1/Resource1/Van Seller/Wild Card Retailer Summary Screen/Please collect cash Check box'), 
    'Please collect cash')
...
Mobile.callTestCase(findTestCase('Inv summary_invoice and pb/Trade Coverage/Inv summary/Screenshot'), [('testCaseName') : 'TC_ID_005'], 
    FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('Phase 1.1/Resource1/Van Seller/Wild Card Retailer Summary Screen/Dropdown - --Select--'), 0)

Mobile.callTestCase(findTestCase('Inv summary_invoice and pb/Trade Coverage/Inv summary/Screenshot'), [('testCaseName') : 'TC_ID_005(1)'], 
    FailureHandling.STOP_ON_FAILURE)
