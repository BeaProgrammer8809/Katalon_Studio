...
salable1 = Mobile.getText(findTestObject('Phase 1.1/Resource1/Van Seller/Return Screen/Non-Salable'), 0)
...
Mobile.callTestCase(findTestCase('Inv summary_invoice and pb/Trade Coverage/Inv summary/Screenshot'), [('testCaseName') : 'TC_ID_271'], 
...
salable2 = Mobile.getText(findTestObject('Phase 1.1/Resource1/Van Seller/Return Screen/Non-Salable'), 0)

println(salable2)

Mobile.verifyMatch(salable1, salable2, false)

Mobile.callTestCase(findTestCase('Inv summary_invoice and pb/Trade Coverage/Inv summary/Screenshot'), [('testCaseName') : 'TC_ID_271(1)'], 
    FailureHandling.STOP_ON_FAILURE)
