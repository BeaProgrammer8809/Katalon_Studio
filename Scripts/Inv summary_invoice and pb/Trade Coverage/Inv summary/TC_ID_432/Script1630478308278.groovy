...
date = Mobile.getText(findTestObject('Phase 1.1/Resource1/Van Seller/Collection Cheque/button_Date'), 0)
...
Mobile.verifyMatch(date, dateInString, false)

Mobile.callTestCase(findTestCase('Inv summary_invoice and pb/Trade Coverage/Inv summary/Screenshot'), [('testCaseName') : 'TC_ID_432'], 
