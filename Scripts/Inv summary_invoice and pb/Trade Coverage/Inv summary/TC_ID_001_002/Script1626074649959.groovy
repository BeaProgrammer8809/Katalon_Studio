...
Mobile.verifyElementText(findTestObject('Phase 1.1/Resource1/Van Seller/Menus/Trade Coverage'), 'Trade Coverage')
...
Mobile.callTestCase(findTestCase('Inv summary_invoice and pb/Trade Coverage/Inv summary/Screenshot'), [('testCaseName') : 'TC_ID_001_002'], 
