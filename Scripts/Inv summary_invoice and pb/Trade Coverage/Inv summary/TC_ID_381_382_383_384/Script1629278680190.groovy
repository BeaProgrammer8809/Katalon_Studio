...
Mobile.callTestCase(findTestCase('Inv summary_invoice and pb/Trade Coverage/Inv summary/Screenshot'), [('testCaseName') : 'TC_ID_281_282(1)'], 
...
Mobile.verifyMatch(Inv_Amount_Collection, inv_Amt, false)

Mobile.verifyMatch(Min_Amount_Collection, inv_Amt, false)

Mobile.verifyMatch(Balance_Amt, '0', false)

Mobile.verifyMatch(Total_Paid_Inputamt, summary_Total, false)

Mobile.callTestCase(findTestCase('Inv summary_invoice and pb/Trade Coverage/Inv summary/Screenshot'), [('testCaseName') : 'TC_ID_381_382_383_384(2)'], 
    FailureHandling.STOP_ON_FAILURE)
