...
Mobile.callTestCase(findTestCase('Inv summary_invoice and pb/Trade Coverage/Inv summary/Screenshot'), [('testCaseName') : 'TC_ID_351'], 
...
//BIMBO S.A. DE C.V
if (invoiceContent.contains('BIMBO S.A')) {
