...
Mobile.callTestCase(findTestCase('Inv summary_invoice and pb/Trade Coverage/Inv summary/Screenshot'), [('testCaseName') : 'TC_ID_385'], 
...
Total_Paid_Inputamt = Mobile.getText(findTestObject('Phase 1.1/Resource1/Van Seller/Collection/value_Total Paid'), 0)

println(Total_Paid_Inputamt)

Total_Paid_Inputamt = Total_Paid_Inputamt.substring(Total_Paid_Inputamt.indexOf(':') + 2)

println(Total_Paid_Inputamt)

Mobile.verifyMatch(Total_Paid_Inputamt, summary_Total, false)

Mobile.callTestCase(findTestCase('Inv summary_invoice and pb/Trade Coverage/Inv summary/Screenshot'), [('testCaseName') : 'TC_ID_385(1)'], 
    FailureHandling.STOP_ON_FAILURE)
