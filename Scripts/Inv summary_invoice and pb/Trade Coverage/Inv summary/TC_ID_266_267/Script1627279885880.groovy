...
skuName1 = Mobile.getText(findTestObject('Phase 1.1/Resource1/Van Seller/Order and Invoice Screen/1st Row Sku Name'), 0)
...
peiceCount1 = Mobile.getText(findTestObject('Phase 1.1/Resource1/Van Seller/Order and Invoice Screen/input_1st Row Piece'), 0)

println(peiceCount1)

Mobile.delay(3, FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Inv summary_invoice and pb/Trade Coverage/Inv summary/Screenshot'), [('testCaseName') : 'TC_ID_266_267'], 
...
skuName2 = Mobile.getText(findTestObject('Phase 1.1/Resource1/Van Seller/Order and Invoice Screen/1st Row Sku Name'), 0)

println(skuName2)

peiceCount2 = Mobile.getText(findTestObject('Phase 1.1/Resource1/Van Seller/Order and Invoice Screen/input_1st Row Piece'), 0)

println(peiceCount2)

Mobile.verifyMatch(skuName1, skuName2, false)

Mobile.verifyMatch(peiceCount1, peiceCount2, false)

Mobile.callTestCase(findTestCase('Inv summary_invoice and pb/Trade Coverage/Inv summary/Screenshot'), [('testCaseName') : 'TC_ID_266_267(1)'], 
    FailureHandling.STOP_ON_FAILURE)
