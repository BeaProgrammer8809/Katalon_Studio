...
Mobile.callTestCase(findTestCase('Inv summary_invoice and pb/Trade Coverage/Inv summary/Screenshot'), [('testCaseName') : 'TC_ID_281'], 
...
Mobile.tap(findTestObject('Phase 1.1/Resource1/Van Seller/Collection/checkbox_Credit Note'), 0)
...
Mobile.callTestCase(findTestCase('Inv summary_invoice and pb/Trade Coverage/Inv summary/Screenshot'), [('testCaseName') : 'TC_ID_280_281(1)'], 
    FailureHandling.STOP_ON_FAILURE)
