...
Mobile.sendKeys(findTestObject('Phase 1.1/Resource1/Van Seller/Collection/input_value_Total Amount'), '2')
...
Mobile.sendKeys(findTestObject('Phase 1.1/Resource1/Van Seller/Collection Transferencias Electronica/input_Reference Num'), '1234')

Mobile.callTestCase(findTestCase('Inv summary_invoice and pb/Trade Coverage/Inv summary/Screenshot'), [('testCaseName') : 'TC_ID_430'], 
    FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('Phase 1.1/Resource1/Van Seller/Collection Transferencias Electronica/input_Reference Num'), 0)

Mobile.sendKeys(findTestObject('Phase 1.1/Resource1/Van Seller/Collection Transferencias Electronica/input_Reference Num'), '1234.5')

Mobile.callTestCase(findTestCase('Inv summary_invoice and pb/Trade Coverage/Inv summary/Screenshot'), [('testCaseName') : 'TC_ID_431'], 
    FailureHandling.STOP_ON_FAILURE)
