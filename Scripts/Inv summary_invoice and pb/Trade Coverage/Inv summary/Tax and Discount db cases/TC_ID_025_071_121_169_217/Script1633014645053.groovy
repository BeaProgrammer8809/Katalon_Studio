...
Mobile.callTestCase(findTestCase('Inv summary_invoice and pb/Trade Coverage/Inv summary/Screenshot'), [('testCaseName') : 'TC_ID_121_169_217'], 
...
Mobile.callTestCase(findTestCase('Inv summary_invoice and pb/Trade Coverage/Inv summary/Screenshot'), [('testCaseName') : 'TC_ID_025_071'], 
    FailureHandling.STOP_ON_FAILURE)
...
Mobile.tap(findTestObject('Phase 1.1/Resource1/Van Seller/Delivery Final Summary/OK - Spliited Invoice Saved'), 70)

Mobile.delay(20, FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Inv summary_invoice and pb/Trade Coverage/Inv summary/Screenshot'), [('testCaseName') : 'TC_ID_025_071_121(1)'], 
    FailureHandling.STOP_ON_FAILURE)
