...
Mobile.callTestCase(findTestCase('Inv summary_invoice and pb/Trade Coverage/Inv summary/Screenshot'), [('testCaseName') : 'TC_ID_150'], 
...
Mobile.callTestCase(findTestCase('Inv summary_invoice and pb/Trade Coverage/Inv summary/Screenshot'), [('testCaseName') : 'TC_ID_065_100'], 
    FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Inv summary_invoice and pb/Trade Coverage/Inv summary/Screenshot'), [('testCaseName') : 'TC_ID_065_100_150(1)'], 
    FailureHandling.STOP_ON_FAILURE)
...
totalValue_Amount = ((total_Amount + ivaamt) + iepsamt)

println(totalValue_Amount)

String total = String.format('%.2f', total_Amount)

String totalValue = String.format('%.2f', totalValue_Amount)
