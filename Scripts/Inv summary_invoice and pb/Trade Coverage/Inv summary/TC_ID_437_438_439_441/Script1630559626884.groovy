...
Inv_Amount_Collection = Mobile.getText(findTestObject('Phase 1.1/Resource1/Van Seller/Collection/input_value_Total Amount'), 
    0)
...
Mobile.callTestCase(findTestCase('Inv summary_invoice and pb/Trade Coverage/Inv summary/Screenshot'), [('testCaseName') : 'TC_ID_437'], 
    FailureHandling.STOP_ON_FAILURE)

Mobile.sendKeys(findTestObject('Phase 1.1/Resource1/Van Seller/Collection/input_value_Total Amount'), Inv_Amount_Collection)

'30 digits'
Mobile.sendKeys(findTestObject('Phase 1.1/Resource1/Van Seller/Collection Transferencias Electronica/input_Reference Num'), '123456789012345678901234567890')
...
Mobile.callTestCase(findTestCase('Inv summary_invoice and pb/Trade Coverage/Inv summary/Screenshot'), [('testCaseName') : 'TC_ID_438'], 
    FailureHandling.STOP_ON_FAILURE)

Mobile.clearText(findTestObject('Phase 1.1/Resource1/Van Seller/Collection/input_value_Total Amount'), 0)

'30 digits'
Mobile.sendKeys(findTestObject('Phase 1.1/Resource1/Van Seller/Collection Transferencias Electronica/input_Reference Num'), '123abcd34566')

Mobile.callTestCase(findTestCase('Inv summary_invoice and pb/Trade Coverage/Inv summary/Screenshot'), [('testCaseName') : 'TC_ID_439'], 
    FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Inv summary_invoice and pb/Trade Coverage/Inv summary/Screenshot'), [('testCaseName') : 'TC_ID_439_441'], 
    FailureHandling.STOP_ON_FAILURE)
