...
Mobile.callTestCase(findTestCase('Inv summary_invoice and pb/Trade Coverage/Inv summary/Screenshot'), [('testCaseName') : 'TC_ID_022'], 
...
Summary_totalValue = Mobile.getText(findTestObject('Phase 1.1/Resource1/Van Seller/Summary Amount split up(info-icon)/Total Value'), 
    0)
...
Mobile.verifyNotMatch(totalValue_Summary, total_ValuePB, false)

Mobile.callTestCase(findTestCase('Inv summary_invoice and pb/Trade Coverage/Inv summary/Screenshot'), [('testCaseName') : 'TC_ID_022(1)'], 
    FailureHandling.STOP_ON_FAILURE)
