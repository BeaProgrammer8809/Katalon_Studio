...
net_Amt = Mobile.getText(findTestObject('Phase 1.1/Resource1/Van Seller/Delivery Final Summary/1st Row Amt Value'), 0)
...
Mobile.verifyElementVisible(findTestObject('Phase 1.1/Resource1/Van Seller/Collection/checkbox_Transferencias Electrnicas'), 
    0)
...
Mobile.verifyMatch(Inv_Amount_Collection, net_Amt, false)

Mobile.verifyMatch(Min_Amount_Collection, net_Amt, false)

Mobile.callTestCase(findTestCase('Inv summary_invoice and pb/Trade Coverage/Inv summary/Screenshot'), [('testCaseName') : 'TC_ID_419_420_421'], 
