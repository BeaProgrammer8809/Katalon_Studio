...
Mobile.tap(findTestObject('Phase 1.1/Resource1/Van Seller/Collection/Back return arrow -Collection'), 0)

Mobile.verifyElementVisible(findTestObject('Phase 1.1/Resource1/Van Seller/Collection/label_Do you want to delete payment transaction'), 
    0)

Mobile.verifyElementExist(findTestObject('Phase 1.1/Resource1/Van Seller/Collection/label_Do you want to delete payment transaction'), 
    0)

Mobile.verifyElementText(findTestObject('Phase 1.1/Resource1/Van Seller/Collection/label_Do you want to delete payment transaction'), 
    'Do you want to delete payment transaction?')

Mobile.verifyElementVisible(findTestObject('Phase 1.1/Resource1/Van Seller/Collection/button-return_Yes'), 0)

Mobile.verifyElementExist(findTestObject('Phase 1.1/Resource1/Van Seller/Collection/button-return_Yes'), 0)

Mobile.verifyElementText(findTestObject('Phase 1.1/Resource1/Van Seller/Collection/button-return_Yes'), 'Yes')

Mobile.verifyElementVisible(findTestObject('Phase 1.1/Resource1/Van Seller/Collection/button_return_Cancel'), 0)

Mobile.verifyElementExist(findTestObject('Phase 1.1/Resource1/Van Seller/Collection/button_return_Cancel'), 0)

Mobile.verifyElementText(findTestObject('Phase 1.1/Resource1/Van Seller/Collection/button_return_Cancel'), 'Cancel')

Mobile.callTestCase(findTestCase('Inv summary_invoice and pb/Trade Coverage/Inv summary/Screenshot'), [('testCaseName') : 'TC_ID_364'], 
    FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('Phase 1.1/Resource1/Van Seller/Collection/button_return_Cancel'), 0)

Mobile.tap(findTestObject('Phase 1.1/Resource1/Van Seller/Collection/button_Submit'), 0)

Mobile.verifyElementVisible(findTestObject('Phase 1.1/Resource1/Van Seller/Delivery Final Summary/Delivery Final Summary Screen Title'), 
    0)
...
Mobile.callTestCase(findTestCase('Inv summary_invoice and pb/Trade Coverage/Inv summary/Screenshot'), [('testCaseName') : 'TC_ID_365'], 
    FailureHandling.STOP_ON_FAILURE)
