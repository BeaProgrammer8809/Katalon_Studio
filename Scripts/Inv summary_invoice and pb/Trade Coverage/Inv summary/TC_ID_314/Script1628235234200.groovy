...
not_run: Mobile.verifyElementVisible(findTestObject('Phase 1.1/Resource1/Van Seller/Collection Cheque/button_Select Cheque Type'), 
    0)

not_run: Mobile.tap(findTestObject('Phase 1.1/Resource1/Van Seller/Collection Cheque/button_Select Cheque Type'), 0)

not_run: Mobile.verifyElementVisible(findTestObject('Phase 1.1/Resource1/Van Seller/Collection Cheque/drop_FOREIGN_checque Type'), 
    0)

not_run: Mobile.tap(findTestObject('Phase 1.1/Resource1/Van Seller/Collection Cheque/drop_FOREIGN_checque Type'), 0)
...
Mobile.callTestCase(findTestCase('Inv summary_invoice and pb/Trade Coverage/Inv summary/Screenshot'), [('testCaseName') : 'TC_ID_314'], 
