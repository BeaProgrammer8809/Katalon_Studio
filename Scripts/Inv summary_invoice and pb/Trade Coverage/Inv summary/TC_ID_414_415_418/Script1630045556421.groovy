...
Mobile.sendKeys(findTestObject('Phase 1.1/Resource1/Van Seller/Collection/input_value_Total Amount'), '1')
...
Mobile.callTestCase(findTestCase('Inv summary_invoice and pb/Trade Coverage/Inv summary/Screenshot'), [('testCaseName') : 'TC_ID_414'], 
    FailureHandling.STOP_ON_FAILURE)

Mobile.sendKeys(findTestObject('Phase 1.1/Resource1/Van Seller/Collection Cheque/input_ChequeNo.'), '12345678901234567890')

chequeno = Mobile.getText(findTestObject('Phase 1.1/Resource1/Van Seller/Collection Cheque/input_ChequeNo.'), 0)

println(chequeno.length())

if (chequeno.length() == 20) {
    Mobile.verifyMatch('1', '1', false, FailureHandling.STOP_ON_FAILURE)
} else {
    println('Length is not equal to 20(Maxinum Length)')

    Mobile.verifyMatch('1', '0', false, FailureHandling.STOP_ON_FAILURE)
}

Mobile.callTestCase(findTestCase('Inv summary_invoice and pb/Trade Coverage/Inv summary/Screenshot'), [('testCaseName') : 'TC_ID_415'], 
    FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Inv summary_invoice and pb/Trade Coverage/Inv summary/Screenshot'), [('testCaseName') : 'TC_ID_418'], 
    FailureHandling.STOP_ON_FAILURE)
