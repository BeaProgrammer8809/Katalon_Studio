...
Mobile.callTestCase(findTestCase('Inv summary_invoice and pb/Trade Coverage/Inv summary/Screenshot'), [('testCaseName') : 'TC_ID_268_269'], 
...
Mobile.tap(findTestObject('Phase 1.1/Resource1/Van Seller/Number Pad Return Screen/4'), 0)
...
Mobile.verifyNotMatch(peiceCount1, peiceCount2, false)

Mobile.callTestCase(findTestCase('Inv summary_invoice and pb/Trade Coverage/Inv summary/Screenshot'), [('testCaseName') : 'TC_ID_268_269(1)'], 
    FailureHandling.STOP_ON_FAILURE)
