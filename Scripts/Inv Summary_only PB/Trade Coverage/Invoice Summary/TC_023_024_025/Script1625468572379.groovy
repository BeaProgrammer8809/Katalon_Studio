...
ValueAmt = Mobile.getText(findTestObject('Phase 1.1/Resource1/Van Seller/Product Buying/Value amout'), 0)
...
SummaryAmt = Mobile.getText(findTestObject('Phase 1.1/Resource1/Van Seller/Summary Screen/U.Price Value 1st row'), 0)

Mobile.verifyMatch(SummaryAmt, ValueAmt, false)

Mobile.callTestCase(findTestCase('Inv Summary_only PB/Trade Coverage/Invoice Summary/Screenshot'), [('testCaseName') : 'TC_023_024_025'], 
