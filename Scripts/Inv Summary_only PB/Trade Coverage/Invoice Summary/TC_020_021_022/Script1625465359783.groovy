...
Mobile.callTestCase(findTestCase('Inv Summary_only PB/Trade Coverage/Invoice Summary/Screenshot'), [('testCaseName') : 'TC_021_022'], 
    FailureHandling.STOP_ON_FAILURE)

Mobile.verifyElementVisible(findTestObject('Phase 1.1/Resource1/Van Seller/Summary Screen/Cancel Button Popup'), 0)

Mobile.verifyElementVisible(findTestObject('Phase 1.1/Resource1/Van Seller/Summary Screen/OK Button Popup'), 0)

Mobile.tap(findTestObject('Phase 1.1/Resource1/Van Seller/Summary Screen/Cancel Button Popup'), 0)

Mobile.verifyElementNotVisible(findTestObject('Phase 1.1/Resource1/Van Seller/Summary Screen/Invoice created successfully Message popup'), 
    0)

Mobile.callTestCase(findTestCase('Inv Summary_only PB/Trade Coverage/Invoice Summary/Screenshot'), [('testCaseName') : 'TC_021(1)'], 
    FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyElementText(findTestObject('Phase 1.1/Resource1/Van Seller/Summary Screen/Invoice created successfully Message popup'), 
    'Invoice created successfully.')

Mobile.callTestCase(findTestCase('Inv Summary_only PB/Trade Coverage/Invoice Summary/Screenshot'), [('testCaseName') : 'TC_022(1)'], 
    FailureHandling.STOP_ON_FAILURE)
