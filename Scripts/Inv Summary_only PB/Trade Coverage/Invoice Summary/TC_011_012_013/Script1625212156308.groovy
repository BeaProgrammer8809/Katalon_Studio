...
Mobile.tap(findTestObject('Phase 1.1/Resource1/Van Seller/Summary Screen/Piece Value 1st row'), 0)

Mobile.verifyElementText(findTestObject('Phase 1.1/Resource1/Van Seller/Summary Screen/Piece Value 1st row'), '0')

Mobile.verifyElementVisible(findTestObject('Phase 1.1/Resource1/Van Seller/Summary Screen/Bag Value 1st Row'), 0)

Mobile.tap(findTestObject('Phase 1.1/Resource1/Van Seller/Summary Screen/Bag Value 1st Row'), 0)

Mobile.verifyElementText(findTestObject('Phase 1.1/Resource1/Van Seller/Summary Screen/Bag Value 1st Row'), '0')

Mobile.verifyElementVisible(findTestObject('Phase 1.1/Resource1/Van Seller/Summary Screen/Actual return Value 1st Row'), 0)

Mobile.verifyElementExist(findTestObject('Phase 1.1/Resource1/Van Seller/Summary Screen/Actual return Value 1st Row'), 0)

Mobile.tap(findTestObject('Phase 1.1/Resource1/Van Seller/Summary Screen/Actual return Value 1st Row'), 0)

Mobile.verifyElementText(findTestObject('Phase 1.1/Resource1/Van Seller/Summary Screen/Actual return Value 1st Row'), '0')

Mobile.verifyElementVisible(findTestObject('Phase 1.1/Resource1/Van Seller/Summary Screen/Value value bottom'), 0)

Mobile.verifyElementExist(findTestObject('Phase 1.1/Resource1/Van Seller/Summary Screen/Value value bottom'), 0)

Mobile.tap(findTestObject('Phase 1.1/Resource1/Van Seller/Summary Screen/Value value bottom'), 0)

Mobile.verifyElementText(findTestObject('Phase 1.1/Resource1/Van Seller/Summary Screen/Value value bottom'), '0')

Mobile.verifyElementVisible(findTestObject('Phase 1.1/Resource1/Van Seller/Summary Screen/Total Qty Value Bottom'), 0)

Mobile.verifyElementExist(findTestObject('Phase 1.1/Resource1/Van Seller/Summary Screen/Total Qty Value Bottom'), 0)

Mobile.tap(findTestObject('Phase 1.1/Resource1/Van Seller/Summary Screen/Total Qty Value Bottom'), 0)

Mobile.verifyElementText(findTestObject('Phase 1.1/Resource1/Van Seller/Summary Screen/Total Qty Value Bottom'), '0')

Mobile.verifyElementVisible(findTestObject('Phase 1.1/Resource1/Van Seller/Summary Screen/Invoice Button'), 0)

Mobile.callTestCase(findTestCase('Inv Summary_only PB/Trade Coverage/Invoice Summary/Screenshot'), [('testCaseName') : 'TC_011_012_013'], 
