...
Mobile.callTestCase(findTestCase('Inv Summary_only PB/Trade Coverage/Invoice Summary/Screenshot'), [('testCaseName') : 'TC_060'], 
...
Mobile.callTestCase(findTestCase('Inv Summary_only PB/Trade Coverage/Invoice Summary/Screenshot'), [('testCaseName') : 'TC_064'], 
    FailureHandling.STOP_ON_FAILURE)
