...
PB_SkuName = Mobile.getText(findTestObject('Phase 1.1/Resource1/Van Seller/Product Buying/Sku name 1st row - Copy'), 0)

println(PB_SkuName)

PB_Skupcs = Mobile.getText(findTestObject('Phase 1.1/Resource1/Van Seller/Product Buying/Total Piece 1st Row'), 0)

PB_Skupcs = PB_Skupcs.substring(0, PB_Skupcs.indexOf('.'))

println(PB_Skupcs)

Mobile.callTestCase(findTestCase('Inv Summary_only PB/Trade Coverage/Invoice Summary/Screenshot'), [('testCaseName') : ''], 
...
Summary_SkuName = Mobile.getText(findTestObject('Phase 1.1/Resource1/Van Seller/Summary Screen/Sku Name 1st Row'), 0)

println(Summary_SkuName)

Summary_Skupc = Mobile.getText(findTestObject('Phase 1.1/Resource1/Van Seller/Summary Screen/Sales Return Value 1st Row'), 0)

println(Summary_Skupc)

Mobile.verifyMatch(PB_SkuName, Summary_SkuName, false)

Mobile.verifyMatch(PB_Skupcs, Summary_Skupc, false)
