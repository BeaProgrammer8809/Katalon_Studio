...
totalValue = Mobile.getText(findTestObject('Phase 1.1/Resource1/Van Seller/Summary Amount split up(info-icon)/Total Value'), 
    0)
...
Mobile.verifyMatch(distDiscValue, '0', false)

Mobile.verifyMatch(compValue, '0', false)

Mobile.verifyMatch(orderValue, '0', false)

Mobile.verifyMatch(totalValue, '0', false)
