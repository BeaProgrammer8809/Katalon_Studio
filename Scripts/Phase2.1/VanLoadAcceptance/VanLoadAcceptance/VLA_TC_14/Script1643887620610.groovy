...
Mobile.verifyElementVisible(findTestObject('Object Repository/Phase 1.1/Resource3/Order and Invoice/Store Profile Screen/Profile_Odometer Journey not started'), 
    0)

Mobile.verifyElementExist(findTestObject('Object Repository/Phase 1.1/Resource3/Order and Invoice/Store Profile Screen/Profile_Odometer Journey not started'), 
    0)
...
Mobile.callTestCase(findTestCase('Phase2.1/VanLoadAcceptance/VanLoadAcceptance/Screenshot'), [('testCaseName') : 'VLA_TC_14'], 
