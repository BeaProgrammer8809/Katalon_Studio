...
def actualText = Mobile.getText(findTestObject('Phase2/BIEndOfTheDay/Stock Downloaded Successfully-PopupTitle'), 0)

def expectedText = findTestData('Phase2.1/TY_14/Testdata').getValue( 'Data', 78)

Mobile.verifyMatch(actualText, expectedText, false, FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2.1/VanLoadAcceptance/VanLoadAcceptance/Screenshot'), [('testCaseName') : 'VLA_TC_89'], FailureHandling.STOP_ON_FAILURE)
