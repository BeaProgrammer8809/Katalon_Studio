...
Mobile.tap(findTestObject('Phase2/BIStoreScreen01/OkButton_VanLoadAcceptanceNotDonePopup'), 0)
...
Mobile.verifyElementNotExist(findTestObject('Object Repository/Phase2/BIStartOfTheDay01/Start_Of_The_Day_Button'), 0)

Mobile.callTestCase(findTestCase('Phase2.1/VanLoadAcceptance/VanLoadAcceptance/Screenshot'), [('testCaseName') : 'VLA_TC_11'], 
