...
Mobile.verifyElementNotVisible(findTestObject('Phase2/BIStoreScreen01/VanLoadAcceptamceIsNotDone_PopupTitle'), 0 , FailureHandling.STOP_ON_FAILURE)

Mobile.verifyElementNotExist(findTestObject('Phase2/BIStoreScreen01/VanLoadAcceptamceIsNotDone_PopupTitle'), 0, FailureHandling.STOP_ON_FAILURE)
...
if (Mobile.verifyElementVisible(findTestObject('Object Repository/Phase2/BIBlueLabelProcess01/Blue_Label_Process_Screen_Title'), 
    ...
    Mobile.tap(findTestObject('Object Repository/Phase2/BIBlueLabelProcess01/Back_Button'), 0)
}

Mobile.callTestCase(findTestCase('Phase2.1/VanLoadAcceptance/VanLoadAcceptance/Screenshot'), [('testCaseName') : 'VLA_TC_18'], 
