...
Mobile.verifyElementVisible(findTestObject('Object Repository/Phase2/BIVanloadAcceptance01/Reject_TextView'), 0, FailureHandling.STOP_ON_FAILURE)

Mobile.verifyElementExist(findTestObject('Object Repository/Phase2/BIVanloadAcceptance01/Reject_TextView'), 0, FailureHandling.STOP_ON_FAILURE)


Mobile.verifyMatch(Rejection, RejectField, false, FailureHandling.STOP_ON_FAILURE)

println "All the allocated stock should be updated in rejection field"

Mobile.callTestCase(findTestCase('Phase2.1/VanLoadAcceptance/VanLoadAcceptance/Screenshot'), [('testCaseName') : 'TC_115'], FailureHandling.STOP_ON_FAILURE)
