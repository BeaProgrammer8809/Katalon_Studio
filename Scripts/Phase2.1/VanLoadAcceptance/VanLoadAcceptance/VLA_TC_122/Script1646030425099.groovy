...
def MissionTextfield = Mobile.getText(findTestObject('Object Repository/Phase2/BIVanloadRejection01/Missing_EditText'), 0)
...
Mobile.verifyMatch(MissionTextfield, RejectField, false, FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('Object Repository/Phase2/BIVanloadAcceptance01/Submit_Button'), 0)

Mobile.tap(findTestObject('Object Repository/Phase2/BIVanloadAcceptance01/Enter_Your_Password/Password_EditText'), 0)
Mobile.setText(findTestObject('Object Repository/Phase2/BIVanloadAcceptance01/Enter_Your_Password/Password_EditText'), findTestData('Phase2.1/TY_05/Collection').getValue('Number', 2), 0)

Mobile.tap(findTestObject('Object Repository/Phase2/BIVanloadAcceptance01/Enter_Your_Password/Approve_Button'), 0)

AppiumDriver driver1 = MobileDriverFactory.getDriver()

def Actualtoastmessage = driver1.findElementByXPath('//android.widget.Toast[1]').getText()

println('Actualresult=' + Actualtoastmessage)

def Expectedtoastmessage = findTestData('Phase2.1/TY_05/Collection').getValue(4, 79)
...
println "Stock should be accepted successfully"

Mobile.callTestCase(findTestCase('Phase2.1/VanLoadAcceptance/VanLoadAcceptance/Screenshot'), [('testCaseName') : 'TC_122'], FailureHandling.STOP_ON_FAILURE)
