...
if (Mobile.verifyElementExist(findTestObject('Phase2/BIVanloadAcceptance01/Checkbox'), 0, FailureHandling.OPTIONAL)) {
    ...
    for (int i = 0; i < size; i++) {
        ...
        Mobile.verifyElementExist(findTestObject('Object Repository/Phase2/BIVanloadAcceptance01/Vanload Acceptance_TextView'), 
            0, FailureHandling.STOP_ON_FAILURE)

        Mobile.verifyElementVisible(findTestObject('Object Repository/Phase2/BIVanloadAcceptance01/Vanload Acceptance_TextView'), 
            0, FailureHandling.STOP_ON_FAILURE)

        println('User able to submit the vanload')
    }
}

Mobile.callTestCase(findTestCase('Phase2.1/VanLoadAcceptance/VanLoadAcceptance/Screenshot'), [('testCaseName') : 'VLA_TC_125'],
