...
Mobile.verifyElementText(findTestObject('Object Repository/Phase2/BIEndOfTheDay/BIStockProposalScreen/It will sync immediately. Do you want to continue TextView'),
	findTestData('Phase2.1/TY_05/TestData_04D').getValue('Data1', 6))

Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitOnlyPB/DeliveryFinalSummary/Screenshot'), [('testCaseName') : 'SP_TC_27'],
