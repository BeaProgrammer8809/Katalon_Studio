...
def sdf = new SimpleDateFormat('MM/dd/yyyy'+" "+'HH:mm')
...
Mobile.verifyMatch(ActualDate1,findTestData('Phase2.1/TY_02/TestData_01B').getValue(
		'Data2', 9),false, FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2.1/StockProposal/EndOfDay/Screenshot'), [('testCaseName') : 'SP_TC_60'],
