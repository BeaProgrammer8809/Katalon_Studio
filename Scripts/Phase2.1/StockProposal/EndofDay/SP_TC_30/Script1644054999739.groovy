...
Mobile.tap(findTestObject('Object Repository/Phase2/BIEndOfTheDay/BIStockProposalScreen/DoYouWannaContinue Cancel_Button'),0)

Mobile.verifyElementExist(findTestObject('Object Repository/Phase2/BIEndOfTheDay/BIStockProposalScreen/Stock_Proposal_Header'),0)

Mobile.verifyElementText(findTestObject('Object Repository/Phase2/BIEndOfTheDay/BIStockProposalScreen/Stock_Proposal_Header'),
	findTestData('Phase2.1/TY_05/TestData_04D').getValue('Title', 7))


Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitOnlyPB/DeliveryFinalSummary/Screenshot'), [('testCaseName') : 'SP_TC_30'],
