...
def PieceQty = Mobile.getText(findTestObject('Phase2/BIEndOfTheDay/BIStockProposalScreen/OP_EditText'), 0)

int pieceQty = Integer.parseInt(PieceQty)

def SRPPrice=Mobile.getText(findTestObject('Phase2/BIEndOfTheDay/BIStockProposalScreen/SRP_Price'), 0, FailureHandling.STOP_ON_FAILURE)

double SRPprice= Double.parseDouble(SRPPrice)

def totalValue = pieceQty*SRPprice
...
Mobile.verifyElementText(findTestObject('Phase2/BIPrintPreviewScreen/Print_Preview_TextView'), findTestData('Phase2.1/TY_01/TestData_01B').getValue(
        'Data2', 2), FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2.1/StockProposal/EndOfDay/Screenshot'), [('testCaseName') : 'SP_TC_54'], 
...
Mobile.verifyMatch(ActualTotalValue1, findTestData('Phase2.1/TY_01/TestData_01B').getValue('data3', 2), false, FailureHandling.STOP_ON_FAILURE)
