...
Mobile.tap(findTestObject('Object Repository/Phase2/BIEndOfTheDay/BIStockProposalScreen/DoYouWannaContinue OK_Button'), 
    0)

Mobile.tap(findTestObject('Phase2/BIEndOfTheDay/BIStockProposalScreen/UploadFailed OK_Button'), 0)

def printTxt = Mobile.getText(findTestObject('Phase2/BIEndOfTheDay/BIStockProposalScreen/SavedSuccesfully. PrintButton'), 
    0)

//Println printTxt

Mobile.verifyElementText(findTestObject('Phase2/BIEndOfTheDay/BIStockProposalScreen/SavedSuccesfully. PrintButton'), findTestData('Phase2.1/TY_03/TestData_02B').getValue(1, 4))
...
Mobile.callTestCase(findTestCase('Phase2.1/StockProposal/EndofDay/Screenshot'), [('testCaseName') : 'SP_TC_38'], FailureHandling.STOP_ON_FAILURE)
