...
def BagQtyBeforeProvidingQty=Mobile.getText(findTestObject('Object Repository/Phase2/BIEndOfTheDay/BIStockProposalScreen/Bag_EditText'), 0)

'Provide Bag quantity'
Mobile.tap(findTestObject('Object Repository/Phase2/BIEndOfTheDay/BIStockProposalScreen/Bag_EditText'), 0,FailureHandling.OPTIONAL)
...
def BagQtyAfterProvingQty=Mobile.getText(findTestObject('Object Repository/Phase2/BIEndOfTheDay/BIStockProposalScreen/Bag_EditText'), 0)

Mobile.callTestCase(findTestCase('Phase2.1/StockProposal/EndofDay/Screenshot'), [('testCaseName') : 'SP_TC_21'], FailureHandling.STOP_ON_FAILURE)

'Before and after stock proposal should be same'
Mobile.verifyMatch(BagQtyBeforeProvidingQty, BagQtyAfterProvingQty, false, FailureHandling.STOP_ON_FAILURE)

'Verifyed with default quantity'
Mobile.verifyMatch(BagQtyAfterProvingQty, findTestData('Phase2.1/TY_06/StockProposal/EndOfDay').getValue(3, 3), false, FailureHandling.STOP_ON_FAILURE)
