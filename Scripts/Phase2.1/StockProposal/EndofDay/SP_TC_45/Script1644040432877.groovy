...
Mobile.tap(findTestObject('Phase2/BIEndOfTheDay/BIStockProposalScreen/Ok_Button_DoYouWantToGoBackPopup'), 0)

Mobile.verifyElementNotExist(findTestObject('Phase2/BIEndOfTheDay/BIStockProposalScreen/Stock_Proposal_Header'), 0)

Mobile.callTestCase(findTestCase('Phase2.1/StockProposal/EndofDay/Screenshot'), [('testCaseName') : 'SP_TC_45'],
