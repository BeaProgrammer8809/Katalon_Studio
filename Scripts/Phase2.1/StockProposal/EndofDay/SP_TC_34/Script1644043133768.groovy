...
Mobile.tap(findTestObject('Phase2/BIEndOfTheDay/BIStockProposalScreen/SavedSuccesfully. CancelButton'), 0)

Mobile.delay(5)

Mobile.verifyElementExist(findTestObject('Phase2/BIEndOfTheDay/End_Of_The_Day_ScreenTitle'), 3)

//Mobile.verifyElementNotExist(findTestObject('Phase2/BIPrintPreviewScreen/Print_Preview_TextView'), 3)
Mobile.verifyElementNotExist(findTestObject('Phase2/BIPrintPreviewScreen/Invoice_Sheet'), 10)

//Mobile.verifyElementNotExist(findTestObject('Phase2/BIEndOfTheDay/BIStockProposalScreen/SavedSuccesfully. PrintButton'), 
// 0)
// To capture Screenshot
Mobile.callTestCase(findTestCase('Phase2.1/StockProposal/EndofDay/Screenshot'), [('testCaseName') : 'SP_TC_34'], FailureHandling.STOP_ON_FAILURE)
