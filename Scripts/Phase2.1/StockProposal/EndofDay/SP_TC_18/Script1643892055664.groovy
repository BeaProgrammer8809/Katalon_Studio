...
Mobile.callTestCase(findTestCase('Phase2.1/StockProposal/EndofDay/Screenshot'), [('testCaseName') : 'SP_TC_18'], FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyMatch(BagQtyAfterProvingQty, findTestData('Phase2.1/TY_06/StockProposal/EndOfDay').getValue(3, 2), false, FailureHandling.STOP_ON_FAILURE)
