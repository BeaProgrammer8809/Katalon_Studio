...
Mobile.tap(findTestObject('Phase2/BIEndOfTheDay/BIStockProposalScreen/OC_EditText'), 1)
...
Mobile.verifyElementExist(findTestObject('Phase2/BIEndOfTheDay/BIStockProposalScreen/PleaseSelectAnItem_PopupTitle'), 0)

// To capture Screenshot
Mobile.callTestCase(findTestCase('Phase2.1/StockProposal/EndofDay/Screenshot'), [('testCaseName') : 'SP_TC_35'], FailureHandling.STOP_ON_FAILURE)
