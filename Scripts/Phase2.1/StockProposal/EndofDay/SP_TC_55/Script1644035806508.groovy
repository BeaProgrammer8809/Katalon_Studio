...
String []str = deliveryDate.split("/")

for( String values : str )
      println(values)

def actualDate = str[1]+"/"+str[2]+"/"+str[0]
...
boolean expRes=PrintPreviewScreen.contains(actualDate)
...
Mobile.callTestCase(findTestCase('Phase2.1/StockProposal/EndOfDay/Screenshot'), [('testCaseName') : 'SP_TC_55'], 
