...
ExpectedProdBuySplit = findTestData('Phase2.1/TY_12/InvoiceSplitOnlyPB/Testdata').getValue(2, 4)

boolean Expected = ProdBuysplit.contains(ExpectedProdBuySplit)

Mobile.verifyMatch(Expected.toString(), findTestData('Phase2.1/TY_12/InvoiceSplitOnlyPB/Testdata').getValue(3, 4), false, 
...
ExpectedProdBuySplit2 = findTestData('Phase2.1/TY_12/InvoiceSplitOnlyPB/Testdata').getValue(2, 5)

boolean Expected2 = ProdBuysplit2.contains(ExpectedProdBuySplit2)

Mobile.verifyMatch(Expected2.toString(), findTestData('Phase2.1/TY_12/InvoiceSplitOnlyPB/Testdata').getValue(3, 4), false, 
    FailureHandling.STOP_ON_FAILURE)
...
ExpectedProdBuySplit3 = findTestData('Phase2.1/TY_12/InvoiceSplitOnlyPB/Testdata').getValue(2, 6)

boolean Expected3 = ProdBuysplit3.contains(ExpectedProdBuySplit3)

Mobile.verifyMatch(Expected3.toString(), findTestData('Phase2.1/TY_12/InvoiceSplitOnlyPB/Testdata').getValue(3, 4), false, 
    FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitOnlyPB/ProductBuyingDeliveryFinalSummary/Screenshot'), [('testCaseName') : 'TC_58'], 
    FailureHandling.STOP_ON_FAILURE)
