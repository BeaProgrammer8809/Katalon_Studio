...
GlobalVariable.index = findTestData('Phase2.1/Common_Data/CommonData').getValue('Number', 1)
def FolioNum1= Mobile.clearText(findTestObject('Phase2/BIDeliveryFinalSummaryScreen/Folio_NO_Indexing'), 0)
...
Mobile.verifyMatch(FolioNum, AcceptFolioNum, false, FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitOnlyPB/ProductBuyingDeliveryFinalSummary/Screenshot'), [('testCaseName') : 'TC_86'], FailureHandling.STOP_ON_FAILURE)
