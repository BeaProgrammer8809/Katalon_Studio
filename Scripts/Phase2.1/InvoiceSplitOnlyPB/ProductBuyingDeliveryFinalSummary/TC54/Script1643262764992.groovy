...
def ActualInvoiceName = Mobile.getText(findTestObject('Object Repository/Phase2/BIDeliveryFinalSummaryScreen/Invoice Split_Indexing'), 
    0)

def ExpectedInvoiceName = findTestData('Phase2.1/TY_14/TestData').getValue('Data', 76)

Mobile.verifyMatch(ActualInvoiceName, ExpectedInvoiceName, false, FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitOnlyPB/ProductBuyingDeliveryFinalSummary/Screenshot'), [('testCaseName') : 'TC_054'], FailureHandling.STOP_ON_FAILURE)
