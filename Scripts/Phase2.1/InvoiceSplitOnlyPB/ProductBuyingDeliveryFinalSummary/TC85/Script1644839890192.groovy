...
def AcceptFolioNum= findTestData('Phase2.1/TY_05/Collection').getValue(4, 78)

Mobile.verifyMatch(FolioNum, AcceptFolioNum, false, FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitOnlyPB/ProductBuyingDeliveryFinalSummary/Screenshot'), [('testCaseName') : 'TC_85'], FailureHandling.STOP_ON_FAILURE)
