...
Mobile.verifyMatch(spliName1, findTestData('Phase2.1/TY_11/TestData').getValue(4, 85), false, FailureHandling.STOP_ON_FAILURE)

Mobile.verifyMatch(spliName2, findTestData('Phase2.1/TY_11/TestData').getValue(5, 85), false, FailureHandling.STOP_ON_FAILURE)


Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitOnlyPB/ProductBuyingDeliveryFinalSummary/Screenshot'), [('testCaseName') : 'TC47'],
	FailureHandling.STOP_ON_FAILURE)
