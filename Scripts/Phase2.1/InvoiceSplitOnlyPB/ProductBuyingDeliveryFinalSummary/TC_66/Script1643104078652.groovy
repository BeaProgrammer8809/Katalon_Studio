...
def taxPrice = Double.parseDouble(totalValue) * (taxIVA / 100)
...
Mobile.verifyEqual(actualTax, taxPrice, FailureHandling.STOP_ON_FAILURE)

println('Tax included for product buying sku')
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitOnlyPB/ProductBuyingDeliveryFinalSummary/Screenshot'), ['testCaseName':'TC_66_DeliveryFinalSummaryScreen'], FailureHandling.STOP_ON_FAILURE)
