...
Mobile.callTestCase(findTestCase('Reusable Cases/Mobile/Phase2.1/EnteringProductBuyingQuantity'), [('ProductName') : findTestData(
			'Phase2.1/Common_Data/CommonData').getValue('ProductName', 31), ('DropdownName') : findTestData('Phase2.1/Common_Data/CommonData').getValue(
...
def ExpectedInvoiceName = findTestData('Phase2.1/TY_14/TestData').getValue('Data1',76)

Mobile.verifyMatch(ActualInvoiceName, ExpectedInvoiceName, false, FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitOnlyPB/ProductBuyingDeliveryFinalSummary/Screenshot'), [('testCaseName') : 'TC_056'], FailureHandling.STOP_ON_FAILURE)
