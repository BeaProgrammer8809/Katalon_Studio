...
def actualAmount = Mobile.getText(findTestObject('Object Repository/Phase2/BIDeliveryFinalSummaryScreen/Amount_Value_Indexing'), 
    0)

def expAmount = secondGrossAmt- catDisc +tax

expAmount=df.format(expAmount)

Mobile.verifyEqual(actualAmount, expAmount, FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitOnlyPB/ProductBuyingDeliveryFinalSummary/Screenshot'), [('testCaseName') : 'TC_63_DeliveryFinalSummaryScreen'], 
