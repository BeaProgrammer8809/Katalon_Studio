...
Mobile.verifyElementVisible(findTestObject('Phase2/BIDeliveryFinalSummaryScreen/PreTicket_Print_Preview_Title'),0)
Mobile.verifyElementText(findTestObject('Phase2/BIDeliveryFinalSummaryScreen/PreTicket_Print_Preview_Title'), findTestData('Phase2.1/TY_05/TestData_04D').getValue(
	'Title', 2))

Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitOnlyPB/DeliveryFinalSummary/Screenshot'), [('testCaseName') : 'TC_34'],
