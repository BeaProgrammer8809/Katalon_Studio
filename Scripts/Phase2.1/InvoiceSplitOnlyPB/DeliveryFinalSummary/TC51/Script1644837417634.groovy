...
Mobile.verifyEqual(InvoiceName, findTestData('Phase2.1/TestData/Test_Data').getValue(5, 85), FailureHandling.OPTIONAL)

Mobile.verifyEqual(Title, findTestData('Phase2.1/TestData/Test_Data').getValue(4, 9), FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitOnlyPB/DeliveryFinalSummary/Screenshot'), [('testCaseName') : 'TC_51'], 
