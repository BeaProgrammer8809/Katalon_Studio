...
Mobile.verifyElementText(findTestObject('Phase2/BIDeliveryFinalSummaryScreen/Preticket_PopUp_OK_Button'), findTestData('Phase2.1/TY_03/TestData_02B').getValue(
		'data', 3))

Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitOnlyPB/DeliveryFinalSummary/Screenshot'), [('testCaseName') : 'TC_ID_31'],
