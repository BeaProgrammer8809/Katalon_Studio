...
Mobile.verifyElementExist(findTestObject('Phase2/BIOrderAndInvoiceScreen01/BIFunnelFilter/Filter_BarcelOption'), 0)

Mobile.tap(findTestObject('Phase2/BIOrderAndInvoiceScreen01/BIFunnelFilter/Filter_BarcelOption'), 0)

Mobile.delay(5, FailureHandling.STOP_ON_FAILURE)

def companyName = Mobile.getText(findTestObject('Phase2/BIOrderAndInvoiceScreen01/BIFunnelFilter/Filter_BarcelOption'),
	0)

println(companyName)

Mobile.verifyMatch(companyName, findTestData('Phase2.1/TY_01/TestData_01B').getValue('data1', 8), false, FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitOnlyPB/DeliveryFinalSummary/Screenshot'), [('testCaseName') : 'TC_16'],
