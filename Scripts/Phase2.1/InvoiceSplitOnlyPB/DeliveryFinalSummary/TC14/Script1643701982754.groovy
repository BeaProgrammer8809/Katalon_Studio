...
Mobile.verifyMatch(companyName, findTestData('Phase2.1/TY_01/TestData_01B').getValue('data1', 6), false, FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitOnlyPB/DeliveryFinalSummary/Screenshot'), [('testCaseName') : 'TC_14'],
