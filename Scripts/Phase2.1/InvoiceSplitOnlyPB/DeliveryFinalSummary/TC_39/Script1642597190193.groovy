...
Mobile.verifyElementText(findTestObject('Phase2/BIDeliveryFinalSummaryScreen/Invoice_Split_Text'),findTestData('null').getValue('Data1',1))


Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitOnlyPB/DeliveryFinalSummary/Screenshot'), [('testCaseName') : 'TC_39'],
