...
Mobile.verifyElementExist(findTestObject('Phase2/BIDeliveryFinalSummaryScreen/Tag_Icon'), 0)
...
Mobile.verifyElementText(findTestObject('Phase2/BIDeliveryFinalSummaryScreen/Delivery_Final_Summary_ScreenTitle'), findTestData(
		'Phase2.1/TY_03/TestData_02B').getValue('data', 2))

Mobile.tap(findTestObject('Phase2/BIDeliveryFinalSummaryScreen/Tag_Icon'), 0)

Mobile.verifyElementExist(findTestObject('Phase2/BIDeliveryFinalSummaryScreen/Do_you_want_to_edit_invoice_TextView'), 0)

Mobile.tap(findTestObject('Phase2/BIDeliveryFinalSummaryScreen/Edit_Invoice_PopUp_OK_Button'), 0)

Mobile.verifyElementExist(findTestObject('Phase2/BIProductBuyingScreen01/Product_Buying_Screen_Title'), 0)

def Total_pieces=Mobile.getText(findTestObject('Phase2/BIProductBuyingScreen01/Total_Pieces_Qty'), 0)

println Total_pieces

def expected=findTestData('Phase2.1/TY_03/TestData_02B').getValue(1, 5).toString()

Mobile.verifyMatch(Total_pieces, expected, false, FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitOnlyPB/DeliveryFinalSummary/Screenshot'), [('testCaseName') : 'TC_ID_26'],
