...
Mobile.verifyElementExist(findTestObject('Phase2/BIOrderAndInvoiceScreen01/BIFunnelFilter/Filter_RicolinoOption'), 0)

Mobile.tap(findTestObject('Phase2/BIOrderAndInvoiceScreen01/BIFunnelFilter/Filter_RicolinoOption'), 0)

Mobile.delay(5, FailureHandling.STOP_ON_FAILURE)

def companyName = Mobile.getText(findTestObject('Phase2/BIOrderAndInvoiceScreen01/BIFunnelFilter/Filter_RicolinoOption'),
	0)

println(companyName)

Mobile.verifyMatch(companyName, findTestData('Phase2.1/TY_05/TestData_03B').getValue('Data3', 1), false, FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyElementText(findTestObject('Phase2/BIDeliveryFinalSummaryScreen/Delivery_Final_Summary_ScreenTitle'), findTestData(
	'Phase2.1/TY_05/TestData_03B').getValue('Data2', 2))

Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitOnlyPB/DeliveryFinalSummary/Screenshot'), [('testCaseName') : 'TC_ID_18'],
