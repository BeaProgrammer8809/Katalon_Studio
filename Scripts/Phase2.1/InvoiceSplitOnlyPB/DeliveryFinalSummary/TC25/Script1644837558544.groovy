...
Mobile.verifyElementText(findTestObject('Phase2/BIProductBuyingScreen01/Product_Buying_Screen_Title'), findTestData('Phase2.1/TY_03/TestData_02B').getValue(
        'data', 1))

Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitOnlyPB/DeliveryFinalSummary/Screenshot'), [('testCaseName') : 'TC_ID_25'], 
