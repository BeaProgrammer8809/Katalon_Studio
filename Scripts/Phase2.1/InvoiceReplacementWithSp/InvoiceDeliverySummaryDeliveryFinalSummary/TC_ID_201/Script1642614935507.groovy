...
Mobile.verifyEqual(Actual_Invoice_split, findTestData('Phase2.1/TY_01/TestData2').getValue(4, 41), FailureHandling.STOP_ON_FAILURE)

//Mobile.verifyEqual(Invoice_Split_LineValue, findTestData('Phase2.1/TY_01/TestData2').getValue(5, 32), FailureHandling.STOP_ON_FAILURE)
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'),
	[('testCaseName') : 'TC_ID_201'], FailureHandling.STOP_ON_FAILURE)
