...
Mobile.verifyMatch(ActualExtraInv1Name, findTestData('Phase2.1/TY_13/Invoice, Replacement with Sp').getValue(2, 12), false)
...
Mobile.verifyMatch(ActualExtraInv2Name , findTestData('Phase2.1/TY_13/Invoice, Replacement with Sp').getValue(3, 12), false)
...
Mobile.verifyMatch(ActualExtraInv3Name, findTestData('Phase2.1/TY_13/Invoice, Replacement with Sp').getValue(4, 12), false)
...
println('TC_ID_135 - We are able to enter the Partial qty in a single ExtraInv Grouped SKU\'s')
