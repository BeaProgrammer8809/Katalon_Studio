...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), [('testCaseName') : 'TC_ID_230_Actual_Pieces_&_Return_Qty'], FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), [('testCaseName') : 'TC_ID_230_Expected_Values'], FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), [('testCaseName') : 'TC_ID_230_Delivery_Final_Screen'], FailureHandling.STOP_ON_FAILURE)
...
def Actaul_Line_Value1 = Mobile.getText(findTestObject('Object Repository/Phase2/BIDeliveryFinalSummaryScreen/Lines_Value_Indexing'), 0)
def Expected_Line_Value1 = findTestData('Phase2.1/TY_02/Test_Data_Phase2').getValue(4, 107)
...
def Actaul_Line_Value2 = Mobile.getText(findTestObject('Object Repository/Phase2/BIDeliveryFinalSummaryScreen/Lines_Value_Indexing'), 0)
def Expected_Line_Value2 = findTestData('Phase2.1/TY_02/Test_Data_Phase2').getValue(4, 107)
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), [('testCaseName') : 'TC_ID_230_Replacement_Qty_Is_Added'], FailureHandling.STOP_ON_FAILURE)

//Verification to check that Line values are displayed for replacement SKU
Mobile.verifyMatch(Actaul_Line_Value1, Expected_Line_Value1, false, FailureHandling.STOP_ON_FAILURE)
Mobile.verifyMatch(Actaul_Line_Value2, Expected_Line_Value2, false, FailureHandling.STOP_ON_FAILURE)
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), [('testCaseName') : 'TC_ID_230_Line_Value_For_Replacement_Qty'], FailureHandling.STOP_ON_FAILURE)
