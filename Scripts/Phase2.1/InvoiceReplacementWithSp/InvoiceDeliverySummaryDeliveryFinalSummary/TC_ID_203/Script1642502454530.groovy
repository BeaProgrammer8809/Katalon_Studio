...
def InvoiceSplitSKUQty = Mobile.getText(findTestObject('Phase2/BIDeliveryFinalSummaryScreen/SKUs_Qty_Indexing'), 0)

println(InvoiceSplitSKUQty)

println "SKU Qty is generated that belongs to SplitGroup"
...
Mobile.verifyMatch(Actual_Invoice_split, findTestData('Phase2.1/TY_01/TestData2').getValue(4, 43), false, FailureHandling.STOP_ON_FAILURE)

Mobile.verifyMatch(DefaultInv1, findTestData('Phase2.1/TY_01/TestData2').getValue(5, 43), false, FailureHandling.STOP_ON_FAILURE)

Mobile.verifyMatch(DefaultInv2, findTestData('Phase2.1/TY_01/TestData2').getValue(6, 43), false, FailureHandling.STOP_ON_FAILURE)

Mobile.verifyMatch(DefaultInv3, findTestData('Phase2.1/TY_01/TestData2').getValue(7, 43), false, FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'),
	[('testCaseName') : 'TC_ID_203'], FailureHandling.STOP_ON_FAILURE)
