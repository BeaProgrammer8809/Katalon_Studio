...
def halfinvAmt = Double.parseDouble(invAmt) / 2
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), 
    [('testCaseName') : 'TC_ID_309_CollectionScreen'], FailureHandling.STOP_ON_FAILURE)
...
println('User is able to submit the amount in effectivo and Cheque mode')

Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), 
    [('testCaseName') : 'TC_ID_309_D.F.SummaryScreen'], FailureHandling.STOP_ON_FAILURE)
