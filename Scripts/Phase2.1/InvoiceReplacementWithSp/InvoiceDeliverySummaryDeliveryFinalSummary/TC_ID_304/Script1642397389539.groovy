...
def actualmaxDigit=refNum.length()

def expMaxDigit=findTestData('Phase2/Common_Data/CommonData_03').getValue(5, 11)

Mobile.verifyEqual(actualmaxDigit, expMaxDigit, FailureHandling.STOP_ON_FAILURE)

println "Length of Reference number is 10 digits "
...
println('User is able to submit the amount in RTGS mode with max reference number of 10 digit ')

Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), 
    [('testCaseName') : 'TC_ID_304_CollectionScreen'], FailureHandling.STOP_ON_FAILURE)
