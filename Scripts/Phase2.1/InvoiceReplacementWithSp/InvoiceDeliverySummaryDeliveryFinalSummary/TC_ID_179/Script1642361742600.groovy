...
Mobile.callTestCase(findTestCase('Reusable Cases/Mobile/Phase2.1/Trade_Coverage_Generic'), [('retailerName') : findTestData(
            'Phase2.1/Common_Data/CommonData').getValue(3, 1)], FailureHandling.STOP_ON_FAILURE)
...
def Expected_Invoice_Split = findTestData('Phase2.1/TY_04/Phase2.1_Sheet3').getValue(16, 39)
...
def Expected_Default_Invoice1 = findTestData('Phase2.1/TY_04/Phase2.1_Sheet3').getValue(17, 39)

def Actual_Default_Invoice1 = Mobile.getText(findTestObject('Phase2/BIDeliveryFinalSummaryScreen/Invoice Split_Indexing'), 0)

println('Actual_Default_Invoice1')

Mobile.verifyMatch(Actual_Default_Invoice1, Expected_Default_Invoice1, false, FailureHandling.STOP_ON_FAILURE)

GlobalVariable.index = findTestData('Phase2.1/Common_Data/CommonData').getValue(5, 3)

def Expected_Default_Invoice2 = findTestData('Phase2.1/TY_04/Phase2.1_Sheet3').getValue(18, 39)
...
def Expected_Default_Invoice3 = findTestData('Phase2.1/TY_04/Phase2.1_Sheet3').getValue(19, 39)
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), 
    [('testCaseName') : 'TC_ID_178'], FailureHandling.STOP_ON_FAILURE)
