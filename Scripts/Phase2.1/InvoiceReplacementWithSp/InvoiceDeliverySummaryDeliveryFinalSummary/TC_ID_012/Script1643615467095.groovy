...
def actualTitle = Mobile.getText(findTestObject('Phase2/BIDeliveryFinalSummaryScreen/Delivery_Final_Summary_ScreenTitle'),
	0)
def expectedTitle = findTestData('Phase2.1/TY_14/TestData').getValue('Title', 79)
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), 
    [('testCaseName') : 'TC_ID_012'], FailureHandling.STOP_ON_FAILURE)
