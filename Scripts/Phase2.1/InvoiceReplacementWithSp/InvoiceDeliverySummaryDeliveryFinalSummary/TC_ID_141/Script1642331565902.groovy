...
Mobile.verifyElementAttributeValue(findTestObject('Phase2/BISplitDeliverySummary01/ExtraInv1_EditView_Indexing'), 'enabled', findTestData('Phase2.1/TY_04/Phase2.1_Sheet3').getValue(
		12, 1), 0)
...
println('If first prduct is entered with Qty then to 2nd and 3rd product user not able to enter the Qty')

Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), 
    [('testCaseName') : 'TC_ID_141'], FailureHandling.STOP_ON_FAILURE)
