...
println "Pesito commission ‘3’ should not show automatically inTransferenciasElectronicas TransferenciasElectronicas collection mode while granting the pesito"
...
println "It should display only the balance amount in invoice ."
