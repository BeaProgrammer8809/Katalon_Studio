...
Double remainingAmt1=Double.parseDouble(invamt)-Double.parseDouble(PesitioAmt)

DecimalFormat df1 = new DecimalFormat('0.00')

 def remainingAmt= df1.format(remainingAmt1)

def PesitoCommission=Double.parseDouble(findTestData('Phase2.1/TY_05/Collection').getValue(5, 74))
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), [('testCaseName') : 'TC_368'], FailureHandling.STOP_ON_FAILURE)
