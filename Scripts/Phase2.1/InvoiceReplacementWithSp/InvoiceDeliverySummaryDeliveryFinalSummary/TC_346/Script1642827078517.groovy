...
println "User should able to do other type of collections without granting pesito."

Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), [('testCaseName') : 'TC_346'], FailureHandling.STOP_ON_FAILURE)
