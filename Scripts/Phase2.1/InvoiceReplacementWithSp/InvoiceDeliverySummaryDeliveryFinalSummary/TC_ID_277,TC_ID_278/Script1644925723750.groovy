...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'),
	[('testCaseName') : 'TC_ID_277'], FailureHandling.STOP_ON_FAILURE)

Mobile.comment('TC_ID_277:-Verification of Toast Msg')
...
Mobile.verifyMatch(actualtoastmessage, findTestData('Phase2.1/TY_06/Invoice, Replacement with Sp/invoice-Delivery Summary-Delivery Final Summary').getValue(
        3, 17), false, FailureHandling.STOP_ON_FAILURE)

Mobile.comment('TC_ID_277:-collection popup should be in open')
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'),
	[('testCaseName') : 'TC_ID_278'], FailureHandling.STOP_ON_FAILURE)

Mobile.comment('TC_ID_278:-Verification of Toast Msg')

Mobile.verifyMatch(actualtoastmessage, findTestData('Phase2.1/TY_06/Invoice, Replacement with Sp/invoice-Delivery Summary-Delivery Final Summary').getValue(
		3, 18), false, FailureHandling.STOP_ON_FAILURE)

Mobile.comment('TC_ID_278:-collection popup should be in open')
