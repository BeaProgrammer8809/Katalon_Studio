...
def PesitocommAmt=Mobile.getText(findTestObject('Object Repository/Phase2/BIInvoiceSummaryScreen/BICollectionScreen01/Amount_EditText'), 0)
Mobile.verifyMatch(PesitocommAmt, invamt, false, FailureHandling.STOP_ON_FAILURE)
...
def ActualEffcomm=Mobile.getText(findTestObject('Object Repository/Phase2/BIInvoiceSummaryScreen/BICollectionScreen01/PesitoCommission_TextView'), 0)
println "$ActualEffcomm"
def ExpectEffcomm=findTestData('Phase2.1/TY_05/Collection').getValue(4, 72)
...
Mobile.verifyMatch(ActualEffcomm, ExpectEffcomm, false, FailureHandling.STOP_ON_FAILURE)
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), [('testCaseName') : 'TC_344'], FailureHandling.STOP_ON_FAILURE)
