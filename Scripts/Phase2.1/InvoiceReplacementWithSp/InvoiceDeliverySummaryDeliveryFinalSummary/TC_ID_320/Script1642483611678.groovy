...
def pesitoCommission = Mobile.getText(findTestObject('Phase2/BIInvoiceSummaryScreen/BICollectionScreen01/PesitoCommission_TextView'),
	0)

println('Pesito commission applied is ' + pesitoCommission)

def splitPesito = pesitoCommission.split('of ')

def PesitoComAmtActual = splitPesito[1]
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'),
	[('testCaseName') : 'TC_ID_320_CollectionScreen'], FailureHandling.STOP_ON_FAILURE)
