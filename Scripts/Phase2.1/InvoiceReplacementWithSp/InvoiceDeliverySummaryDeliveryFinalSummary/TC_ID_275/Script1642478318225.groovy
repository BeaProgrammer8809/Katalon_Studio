...
def AmountInChequeText=Mobile.getText(findTestObject('Object Repository/Phase2/BICollectionScreen01/BIChequesScreen01/Amount_EditText'), 0)

double AmountInCheque = Double.parseDouble(AmountInChequeText)

double restAmt=Amt-AmountInCheque
...
Mobile.setText(findTestObject('Object Repository/Phase2/BICollectionScreen01/BIChequesScreen01/ChequeNum_EditText'),findTestData('Phase2.1/TY_06/Invoice, Replacement with Sp/invoice-Delivery Summary-Delivery Final Summary').getValue(
        3, 14) , 0)
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'),
	[('testCaseName') : 'TC_ID_275'], FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyLessThan(AmountInCheque, Double.parseDouble(invAmt), FailureHandling.STOP_ON_FAILURE)
