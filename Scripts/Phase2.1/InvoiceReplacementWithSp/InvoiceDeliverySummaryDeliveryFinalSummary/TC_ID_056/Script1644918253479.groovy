...
println('actualStockDelivered'+actualStockDelivered)

def totalQty= Mobile.getText(findTestObject('Phase2/BIDeliverySummaryScreen/Total_Qty_Text'), 0)
println('totalQty'+totalQty)

Mobile.verifyMatch(actualStockDelivered, totalQty, false, FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), 
    [('testCaseName') : 'TC_056'], FailureHandling.STOP_ON_FAILURE)
