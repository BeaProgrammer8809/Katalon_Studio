...
def commiAmt = Mobile.getText(findTestObject('Phase2/BINumberKeyboardCollection01/3_NumButton'), 0)
...
def Collection = Mobile.getText(findTestObject('Phase2/BICollectionScreen01/Collection_Title'), 0)

Mobile.tap(findTestObject('Phase2/BICollectionScreen01/Submit_Button'), 0)

def Summary = Mobile.getText(findTestObject('Phase2/BIDeliveryFinalSummaryScreen/Delivery_Final_Summary_ScreenTitle'), 0)

Mobile.verifyNotEqual(Collection, Summary, FailureHandling.STOP_ON_FAILURE)

println('Collection popup closed')

Mobile.verifyEqual(commiAmt, findTestData('Phase2.1/TestData/Test_Data').getValue(3, 14), FailureHandling.STOP_ON_FAILURE)

Mobile.verifyEqual(Summary, findTestData('Phase2.1/TestData/Test_Data').getValue(4, 9), FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), 
    [('testCaseName') : 'TC_378'], FailureHandling.STOP_ON_FAILURE)
