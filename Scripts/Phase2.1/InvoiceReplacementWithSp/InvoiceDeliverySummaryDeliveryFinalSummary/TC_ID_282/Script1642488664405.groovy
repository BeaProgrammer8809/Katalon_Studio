...
def CurrentDate = Mobile.getText(findTestObject('Phase2/BICollectionScreen01/BIChequesScreen01/Calendar_Button'), 0)
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), 
    [('testCaseName') : 'TC_ID_282'], FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyNotEqual(ProvideChequeDateText, CurrentDate, FailureHandling.STOP_ON_FAILURE)

/*Mobile.callTestCase(findTestCase('Reusable Cases/Mobile/Phase2.1/PastDateVerification'), [('CollectionDate') : 'ProvideChequeDateText'], 
    FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Reusable Cases/Mobile/Phase2.1/FutureDateVerification'), [('CollectionDate') : 'ProvideChequeDateText'], FailureHandling.STOP_ON_FAILURE)*/
