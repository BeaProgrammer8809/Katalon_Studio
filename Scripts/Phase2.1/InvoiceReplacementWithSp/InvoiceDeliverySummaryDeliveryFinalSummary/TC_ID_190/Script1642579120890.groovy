...
def actualLineValue1=Mobile.getText(findTestObject('Object Repository/Phase2/BIDeliveryFinalSummaryScreen/Lines_Value_Indexing'), 0)

println "Line value for invoiced sku is "+actualLineValue1

def expLineValue1=findTestData('Phase2/Common_Data/CommonData_03').getValue(5, 1)

Mobile.verifyEqual(actualLineValue1, expLineValue1, FailureHandling.STOP_ON_FAILURE)

println " Line value is as expected "
...
def actualLineValue2=Mobile.getText(findTestObject('Object Repository/Phase2/BIDeliveryFinalSummaryScreen/Lines_Value_Indexing'), 0)

println "Line value for invoiced sku is "+actualLineValue2

def expLineValue2=findTestData('Phase2/Common_Data/CommonData_03').getValue(5, 1)

Mobile.verifyEqual(actualLineValue2, expLineValue2, FailureHandling.STOP_ON_FAILURE)
...
def actualLineValue3=Mobile.getText(findTestObject('Object Repository/Phase2/BIDeliveryFinalSummaryScreen/Lines_Value_Indexing'), 0)

println "Line value for invoiced sku is "+actualLineValue3

def expLineValue3=findTestData('Phase2/Common_Data/CommonData_03').getValue(5, 1)

Mobile.verifyEqual(actualLineValue3, expLineValue3, FailureHandling.STOP_ON_FAILURE)

println " Line value is as expected "

Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'),
	[('testCaseName') : 'TC_ID_190_DelieverySummaryScreen'], FailureHandling.STOP_ON_FAILURE)
