...
Mobile.verifyElementNotExist(findTestObject('Phase2/BISplitDeliverySummary01/ExtraInv2_TextView'), 0)

Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), 
    [('testCaseName') : 'TC_ID_114'], FailureHandling.STOP_ON_FAILURE)

println("On giving Invoice Count as 1, only ExtraInv1 is being displayed.")
