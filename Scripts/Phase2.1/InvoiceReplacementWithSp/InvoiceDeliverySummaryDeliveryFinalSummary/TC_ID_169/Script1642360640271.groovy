...
Mobile.setText(findTestObject('Phase2/BISplitDeliverySummary01/ExtraInv1_EditView_Indexing'), findTestData(
		'Phase2.1/TY_04/Phase2.1_Sheet3').getValue(3, 29), 0)
...
Mobile.verifyElementAttributeValue(findTestObject('Phase2/BISplitDeliverySummary01/ExtraInv1_EditView_Indexing'), 'enabled',
	findTestData('Phase2.1/TY_04/Phase2.1_Sheet3').getValue(12, 29), 0)
...
def Fst_ExtInv = Integer.parseInt(Fst_ExtInv1) + Integer.parseInt(Fst_ExtInv2) + Integer.parseInt(Fst_ExtInv3) + Integer.parseInt(Fst_ExtInv4) + Integer.parseInt(Fst_ExtInv5)
...
def Sku_Qty = Integer.parseInt(Sku_Qty1) + Integer.parseInt(Sku_Qty2) + Integer.parseInt(Sku_Qty3) + Integer.parseInt(Sku_Qty4) + Integer.parseInt(Sku_Qty5)
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'),
	[('testCaseName') : 'TC_ID_169'], FailureHandling.STOP_ON_FAILURE)
