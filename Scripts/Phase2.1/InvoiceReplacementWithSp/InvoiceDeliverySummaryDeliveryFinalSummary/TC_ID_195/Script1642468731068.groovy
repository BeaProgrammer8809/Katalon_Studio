...
Mobile.verifyEqual(Actual_Invoice_split, findTestData('Phase2.1/TY_01/TestData2').getValue(4, 35), FailureHandling.STOP_ON_FAILURE)

Mobile.verifyMatch(Invoice_Split_LineValue, findTestData('Phase2.1/TY_01/TestData2').getValue(5, 35), false, FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), 
    [('testCaseName') : 'TC_ID_195'], FailureHandling.STOP_ON_FAILURE)
