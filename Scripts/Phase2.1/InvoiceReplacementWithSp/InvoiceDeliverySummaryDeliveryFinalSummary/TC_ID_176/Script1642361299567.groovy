...
def SRP_Value = Mobile.getText(findTestObject('Object Repository/Phase2/BIDeliverySummaryScreen/SRP_Text_Indexing'), 0, FailureHandling.STOP_ON_FAILURE)
...
Mobile.getText(findTestObject('Phase2/BISplitDeliverySummary01/ExtraInv6_EditView_Indexing'), 0)

Mobile.tap(findTestObject('Phase2/BISplitDeliverySummary01/ExtraInv6_EditView_Indexing'), 0)

Mobile.setText(findTestObject('Phase2/BISplitDeliverySummary01/ExtraInv6_EditView_Indexing'), findTestData('Phase2.1/TY_04/Phase2.1_Sheet3').getValue(
        24, 36), 0)

def Fst_ExtInv = Mobile.getText(findTestObject('Phase2/BISplitDeliverySummary01/ExtraInv6_EditView_Indexing'), 0)
...
Mobile.verifyElementAttributeValue(findTestObject('Phase2/BISplitDeliverySummary01/ExtraInv6_EditView_Indexing'), 'enabled', 
    findTestData('Phase2.1/TY_04/Phase2.1_Sheet3').getValue(12, 36), 0)
...
Mobile.verifyLessThanOrEqual(Amount, Total_Val, FailureHandling.STOP_ON_FAILURE)
//Mobile.verifyMatch(Amount.toString(), Total_Val.toString(), false, FailureHandling.STOP_ON_FAILURE)

println('Column Amount contain Sum of line level SKUs Qty*SRP under ExtraInvoice6')

Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), 
    [('testCaseName') : 'TC_ID_176'], FailureHandling.STOP_ON_FAILURE)
