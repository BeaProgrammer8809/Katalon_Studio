...
Mobile.verifyElementNotExist(findTestObject('Phase2/BISplitDeliverySummary01/ExtraInv5_TextView'), 0)

Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), 
    [('testCaseName') : 'TC_ID_117'], FailureHandling.STOP_ON_FAILURE)

println("On giving Invoice Count as 4, only ExtraInv1, ExtraInv2, ExtraInv3 and ExtraInv4 is being displayed.")
