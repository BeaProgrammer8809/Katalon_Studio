...
def actualTitle=Mobile.getText(findTestObject('Phase2/BICollectionScreen01/DeletePayment_PopupTitle'), 0)

println "Message displayed in popup title is "+actualTitle

Mobile.tap(findTestObject('Object Repository/Phase2/BICollectionScreen01/Yes_ButtonPopup'), 0)

Mobile.verifyElementNotChecked(findTestObject('Object Repository/Phase2/BIDeliveryFinalSummaryScreen/Payment_CheckBox'), 0, FailureHandling.STOP_ON_FAILURE)

println "Payment check box is unchecked so payment is reset"
...
println('User is able to navigate back to delivery final summary screen and payment is reset')

Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), 
    [('testCaseName') : 'TC_ID_323_DeliveryFinalSummaryScreen'], FailureHandling.STOP_ON_FAILURE)
