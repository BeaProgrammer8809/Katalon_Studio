...
def remainingAmt = Double.parseDouble(invamt) - Double.parseDouble(PesitioAmt)
println remainingAmt
...
def remainingAmt1 = df1.format(Amount)
...
def effectiveAmount=Mobile.getText(findTestObject('Object Repository/Phase2/BIInvoiceSummaryScreen/BICollectionScreen01/Amount_EditText'), 0)
Mobile.verifyEqual(effectiveAmount, remainingAmt1.toString(), FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), [('testCaseName') : 'TC_369_Collection'], FailureHandling.STOP_ON_FAILURE)
...
println('Please Pay Total Balance Amount  Toast message should not be shown and collection popup should be closed')
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), [('testCaseName') : 'TC_369'], FailureHandling.STOP_ON_FAILURE)
