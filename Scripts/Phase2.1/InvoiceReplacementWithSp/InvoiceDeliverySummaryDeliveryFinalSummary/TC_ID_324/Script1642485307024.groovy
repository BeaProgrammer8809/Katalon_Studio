...
Mobile.tap(findTestObject('Object Repository/Phase2/BICollectionScreen01/Cancel_ButtonPopup'), 0)
...
def actTitle=Mobile.getText(findTestObject('Object Repository/Phase2/BICollectionScreen01/Collection_Title'), 0)

println "Actual screen title is "+actTitle

def expTitle=findTestData('Phase2/TY_03/TestData_Phase2.1').getValue(2, 19)

println "Expected screen title is "+expTitle

Mobile.verifyMatch(actTitle, expTitle, false, FailureHandling.STOP_ON_FAILURE)

println "Collection screen is visible after cancelling the transaction"

Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), 
    [('testCaseName') : 'TC_ID_324_CollectionScreen'], FailureHandling.STOP_ON_FAILURE)
