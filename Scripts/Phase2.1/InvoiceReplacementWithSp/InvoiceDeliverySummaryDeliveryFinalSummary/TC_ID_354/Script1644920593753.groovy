...
Mobile.setText(findTestObject('Object Repository/Phase2/BIInvoiceSummaryScreen/BICollectionScreen01/Amount_EditText'), findTestData('Phase2.1/TY_05/Collection').getValue(4, 74) , 0)
...
findTestData('Phase2.1/TY_05/Collection').getValue(4, 74), FailureHandling.STOP_ON_FAILURE)

DecimalFormat df1 = new DecimalFormat('0.00')


def remainingAmt1=Double.parseDouble(CashAmount)-Double.parseDouble(PesitioAmt)
def remainingAmt = df1.format(remainingAmt1)
...
def Expectedtoastmessage = findTestData('Phase2.1/TY_05/Collection').getValue(3, 59)+remainingAmt.toString()
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), [('testCaseName') : 'TC_354'], FailureHandling.STOP_ON_FAILURE)
