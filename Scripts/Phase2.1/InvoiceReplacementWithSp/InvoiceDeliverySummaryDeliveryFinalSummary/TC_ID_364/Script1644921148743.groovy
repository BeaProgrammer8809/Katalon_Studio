...
Mobile.setText(findTestObject('Object Repository/Phase2/BIInvoiceSummaryScreen/BICollectionScreen01/Amount_EditText'), findTestData('Phase2.1/TY_05/Collection').getValue(3, 66) , 0)
...
findTestData('Phase2.1/TY_05/Collection').getValue(3, 66), FailureHandling.STOP_ON_FAILURE)
...
def Pesitocomm=Mobile.getText(findTestObject('Object Repository/Phase2/BIInvoiceSummaryScreen/BICollectionScreen01/PesitoCommission_TextView'), 0)

println "$Pesitocomm"

def Pesitocommission= Pesitocomm.substring(20, 25)
 
 Boolean Pesitolabel= Pesitocomm.contains(Pesitocommission)
 
 Mobile.verifyMatch(Pesitolabel.toString(),findTestData('Phase2.1/TY_05/Collection').getValue(6, 69), false,FailureHandling.STOP_ON_FAILURE)
 
 Mobile.verifyElementText(findTestObject('Phase2/BIInvoiceSummaryScreen/BICollectionScreen01/PesitoCommission_TextView'), findTestData('Phase2.1/TY_05/Collection').getValue(4, 72), FailureHandling.STOP_ON_FAILURE)
 

 Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), [('testCaseName') : 'TC_364'], FailureHandling.STOP_ON_FAILURE)
