...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), 
    [('testCaseName') : 'TC_ID_111'], FailureHandling.STOP_ON_FAILURE)

println('User is navigated back to Delivery Summary screen when clicking on back button in Delivery Split Summary Screen when only invoice is Taken for Ungrouped SKUs')
