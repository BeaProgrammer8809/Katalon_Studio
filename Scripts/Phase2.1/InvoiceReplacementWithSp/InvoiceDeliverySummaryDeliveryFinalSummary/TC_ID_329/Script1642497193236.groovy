...
Mobile.setText(findTestObject('Object Repository/Phase2/BIDeliveryFinalSummaryScreen/Folio_No_EditText'), findTestData('Phase2/TY_03/TestData_Phase2.1').getValue(2, 22), 0)
...
def expFolioSize=GlobalVariable.Number = findTestData('Phase2/Common_Data/CommonData_03').getValue(5, 16)

Mobile.verifyEqual(folioSize, expFolioSize, FailureHandling.STOP_ON_FAILURE)

println "Folio number length is upto 15 digits"

Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), 
    [('testCaseName') : 'TC_ID_329_DeliveryFinalSummaryScreen'], FailureHandling.STOP_ON_FAILURE)
