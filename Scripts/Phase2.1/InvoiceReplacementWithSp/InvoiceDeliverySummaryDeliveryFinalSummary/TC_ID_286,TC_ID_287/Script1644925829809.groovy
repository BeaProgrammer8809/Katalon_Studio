...
Mobile.comment('Verify the Invoice Amount')
...
def InvAmtValueText = Mobile.getText(findTestObject('Phase2/BICollectionScreen01/InvAmt_TextView'), 0)

double InvAmtValue = Double.parseDouble(InvAmtValueText)

InvAmtValue = InvAmtValue.round()

Mobile.comment('Inv. Amt should also display the Net amount (value) displayed')

Mobile.verifyEqual(InvAmtValue, Value, FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), 
    [('testCaseName') : 'TC_ID_286_287'], FailureHandling.STOP_ON_FAILURE)
...
def MinAmtValueText = Mobile.getText(findTestObject('Phase2/BICollectionScreen01/MinAmt_TextView'), 0)

double MinAmtValue = Double.parseDouble(MinAmtValueText)

MinAmtValue = MinAmtValue.round()

Mobile.comment('Min. Amt should also display the Net amount (value) displayed')

Mobile.verifyEqual(MinAmtValue, Value, FailureHandling.STOP_ON_FAILURE)
