...
Mobile.verifyMatch(Actual_Invoice_split, findTestData('Phase2.1/TY_01/TestData2').getValue(4, 31), false, FailureHandling.STOP_ON_FAILURE)

Mobile.verifyMatch(DefaultInv1, findTestData('Phase2.1/TY_01/TestData2').getValue(5, 31), false, FailureHandling.STOP_ON_FAILURE)

Mobile.verifyMatch(DefaultInv2, findTestData('Phase2.1/TY_01/TestData2').getValue(6, 31), false, FailureHandling.STOP_ON_FAILURE)

Mobile.verifyMatch(DefaultInv3, findTestData('Phase2.1/TY_01/TestData2').getValue(7, 31), false, FailureHandling.STOP_ON_FAILURE)

Mobile.verifyMatch(InvoiveSplitLineValue, findTestData('Phase2.1/TY_01/TestData2').getValue(8, 31), false, FailureHandling.STOP_ON_FAILURE)

Mobile.verifyMatch(DefaultInv1LineValue, findTestData('Phase2.1/TY_01/TestData2').getValue(9, 31), false, FailureHandling.STOP_ON_FAILURE)

Mobile.verifyMatch(DefaultInv2LineValue, findTestData('Phase2.1/TY_01/TestData2').getValue(10, 31), false, FailureHandling.STOP_ON_FAILURE)

Mobile.verifyMatch(DefaultInv3LineValue, findTestData('Phase2.1/TY_01/TestData2').getValue(11, 31), false, FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'),
	[('testCaseName') : 'TC_ID_191'], FailureHandling.STOP_ON_FAILURE)
