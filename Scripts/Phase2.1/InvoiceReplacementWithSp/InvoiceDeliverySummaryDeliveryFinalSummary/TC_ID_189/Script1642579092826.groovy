...
println " Invoice name is invoice split as bimbo split is created for products"

def actualLineValue=Mobile.getText(findTestObject('Object Repository/Phase2/BIDeliveryFinalSummaryScreen/Lines_Value_Indexing'), 0)

println "Line value for invoiced sku is "+actualLineValue

def expLineValue=findTestData('Phase2/Common_Data/CommonData_03').getValue(5, 2)

Mobile.verifyEqual(actualLineValue, expLineValue, FailureHandling.STOP_ON_FAILURE)
...
def expInvName2 = findTestData('Phase2/TY_03/TestData_Phase2.1').getValue(2, 25)+"4"
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'),
	[('testCaseName') : 'TC_ID_189_DelieverySummaryScreen'], FailureHandling.STOP_ON_FAILURE)
