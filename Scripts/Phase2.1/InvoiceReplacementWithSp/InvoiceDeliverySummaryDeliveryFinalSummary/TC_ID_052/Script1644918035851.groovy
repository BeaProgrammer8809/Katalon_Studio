...
def expectedProductName = Mobile.getText(findTestObject('Phase2/BIOrderAndInvoiceScreen01/Search_Edit_Text'), 0)
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'),
	[('testCaseName') : 'TC_052order&invoice'] , FailureHandling.STOP_ON_FAILURE)
...
def actualProductName = Mobile.getText(findTestObject('Phase2/BIDeliverySummaryScreen/Product_Name_Text'), 0)

def actualPiecesQty = Mobile.getText(findTestObject('Phase2/BIDeliverySummaryScreen/Stock_Delivered_Text'), 0)

Mobile.verifyMatch(actualProductName, expectedProductName, false, FailureHandling.STOP_ON_FAILURE)

Mobile.verifyMatch(actualPiecesQty, expectedPieceQty, false, FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'),
	[('testCaseName') : 'TC_052'] , FailureHandling.STOP_ON_FAILURE)
