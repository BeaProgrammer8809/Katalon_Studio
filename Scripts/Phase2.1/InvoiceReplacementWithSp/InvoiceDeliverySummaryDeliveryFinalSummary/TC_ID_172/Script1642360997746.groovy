...
Mobile.getText(findTestObject('Phase2/BISplitDeliverySummary01/ExtraInv2_EditView_Indexing'), 0)

Mobile.tap(findTestObject('Phase2/BISplitDeliverySummary01/ExtraInv2_EditView_Indexing'), 0)

Mobile.setText(findTestObject('Phase2/BISplitDeliverySummary01/ExtraInv2_EditView_Indexing'), findTestData('Phase2.1/TY_04/Phase2.1_Sheet3').getValue(
        24, 32), 0)

def Fst_ExtInv = Mobile.getText(findTestObject('Phase2/BISplitDeliverySummary01/ExtraInv2_EditView_Indexing'), 0)
...
Mobile.verifyElementAttributeValue(findTestObject('Phase2/BISplitDeliverySummary01/ExtraInv2_EditView_Indexing'), 'enabled', 
    findTestData('Phase2.1/TY_04/Phase2.1_Sheet3').getValue(12, 32), 0)
...
//Mobile.verifyMatch(Total_Val.toString(), Amount.toString(), false, FailureHandling.STOP_ON_FAILURE)

println('Column Amount contain Sum of line level SKUs Qty*SRP under ExtraInvoice2')

Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), 
    [('testCaseName') : 'TC_ID_172'], FailureHandling.STOP_ON_FAILURE)
