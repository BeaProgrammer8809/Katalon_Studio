...
def TransfAmt = Mobile.getText(findTestObject('Phase2/BIInvoiceSummaryScreen/BICollectionScreen01/Amount_EditText'), 0)
...
println('Error message did not display since collection popup closed and DeliveryFinalSummary screen displayed')

Mobile.verifyEqual(InvAmount, TransfAmt, FailureHandling.STOP_ON_FAILURE)

println('invoice Amount paid  in Transfercia mode ')
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), 
    [('testCaseName') : 'TC_379'], FailureHandling.STOP_ON_FAILURE)
