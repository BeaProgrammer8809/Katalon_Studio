...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), 
    [('testCaseName') : 'TC_ID_284'], FailureHandling.STOP_ON_FAILURE)
...
Mobile.comment('Payment checkbox should be checked')

Mobile.verifyElementChecked(findTestObject('Phase2/BIDeliveryFinalSummaryScreen/Payment_CheckBox'), 0)
