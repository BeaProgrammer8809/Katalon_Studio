...
println "Please Pay Total Balance Amount  Toast message should pay in Efectivo Toast message should not display"

Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), [('testCaseName') : 'TC_355'], FailureHandling.STOP_ON_FAILURE)
