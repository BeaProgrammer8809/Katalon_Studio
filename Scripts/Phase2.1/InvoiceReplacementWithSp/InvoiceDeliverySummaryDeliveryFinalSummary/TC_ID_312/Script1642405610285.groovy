...
println('Entered invoice qty lesser than product buying qty')
...
Mobile.verifyElementHasAttribute(findTestObject('Object Repository/Phase2/BICollectionScreen01/CreditNote_RadioButton'), 'selected', 0, FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), 
    [('testCaseName') : 'TC_ID_312_CollectionScreen'], FailureHandling.STOP_ON_FAILURE)
