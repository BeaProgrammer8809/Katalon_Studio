...
def Inv_Count = 'ExtraInv3'

Count_Frame.contains(Inv_Count)

println('ExtraInvoice3 count is displayed')
...
def Expected_ExtraInv = findTestData('Phase2.1/TY_04/Phase2.1_Sheet3').getValue(16, 14)
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'),
	[('testCaseName') : 'TC_ID_154'], FailureHandling.STOP_ON_FAILURE)
