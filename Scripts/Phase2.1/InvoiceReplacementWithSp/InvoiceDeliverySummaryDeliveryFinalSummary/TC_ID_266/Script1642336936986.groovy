...
'User should not allow to navigate to other page without providing bank detail'

Mobile.comment('Select bank was a mandatory field')
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'),
	[('testCaseName') : 'TC_ID_266'], FailureHandling.STOP_ON_FAILURE)
