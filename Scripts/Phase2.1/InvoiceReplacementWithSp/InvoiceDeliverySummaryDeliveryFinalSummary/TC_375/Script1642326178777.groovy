...
def PesitoinvAmt = Mobile.getText(findTestObject('Phase2/BIInvoiceSummaryScreen/BICollectionScreen01/Amount_EditText'), 
    0)
...
Mobile.verifyEqual(InvAmount, PesitoinvAmt, FailureHandling.STOP_ON_FAILURE)

println('Entered omplete  invoice Amount paid in Transfercia mode ')
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), 
    [('testCaseName') : 'TC_375'], FailureHandling.STOP_ON_FAILURE)
