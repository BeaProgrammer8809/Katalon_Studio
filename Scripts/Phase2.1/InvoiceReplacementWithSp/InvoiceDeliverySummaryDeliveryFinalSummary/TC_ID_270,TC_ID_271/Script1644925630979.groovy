...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'),
	[('testCaseName') : 'TC_ID_270'], FailureHandling.STOP_ON_FAILURE)

'Select cheque type was a mandatory field so user will not navigate to another page'
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'),
	[('testCaseName') : 'TC_ID_271'], FailureHandling.STOP_ON_FAILURE)
...
'DropDown Contains more tham one option'

Mobile.comment('Verify that select cheque type was a drop down')
Mobile.verifyGreaterThan(DDoption.size(), 1, FailureHandling.STOP_ON_FAILURE)

Mobile.comment('Select Cheque type dropdown should have Foreign and Local options')

Mobile.verifyMatch(DDoption[1].getText(), findTestData('Phase2.1/TY_06/Invoice, Replacement with Sp/invoice-Delivery Summary-Delivery Final Summary').getValue(
        3, 11), false, FailureHandling.STOP_ON_FAILURE)

Mobile.verifyMatch(DDoption[2].getText(), findTestData('Phase2.1/TY_06/Invoice, Replacement with Sp/invoice-Delivery Summary-Delivery Final Summary').getValue(
