...
Mobile.setText(findTestObject('Phase2/BICollectionScreen01/BITransferenciasElectronicasScreen01/ReferenceNum_EditText'), 
    findTestData('Phase2/TY_03/TestData_Phase2.1').getValue(2, 14), 0)
...
Mobile.tap(findTestObject('Object Repository/Phase2/BICollectionScreen01/BITransferenciasElectronicasScreen01/Calendar_Button'), 0)
...
def pastDate=Mobile.getAttribute(findTestObject('Object Repository/Phase2/BICollectionScreen01/BITransferenciasElectronicasScreen01/Calendar_Button'),'text', 0)
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'),
	[('testCaseName') : 'TC_ID_305_CollectionScreen'], FailureHandling.STOP_ON_FAILURE)
...
def ExpectedScreenTitle = findTestData('Phase2/TY_03/TestData_Phase2.1').getValue(3, 14)

println(ExpectedScreenTitle)

Mobile.verifyMatch(actualScreenTitle, ExpectedScreenTitle,false , FailureHandling.STOP_ON_FAILURE)

println('User is able to submit the amount in RTGS mode with past date')

Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), 
    [('testCaseName') : 'TC_ID_305_D.F.SummaryScreen'], FailureHandling.STOP_ON_FAILURE)
