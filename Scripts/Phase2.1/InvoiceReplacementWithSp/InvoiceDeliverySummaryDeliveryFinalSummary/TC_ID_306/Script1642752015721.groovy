...
Mobile.verifyElementNotChecked(findTestObject('Phase2/BIDeliveryFinalSummaryScreen/Payment_CheckBox'), 0, FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'),
	[('testCaseName') : 'TC_ID_306_DeliveryFinalSummaryScreen'], FailureHandling.STOP_ON_FAILURE)
...
println('Payment checkbox is checked after submitting the amount in RTGS mode')
