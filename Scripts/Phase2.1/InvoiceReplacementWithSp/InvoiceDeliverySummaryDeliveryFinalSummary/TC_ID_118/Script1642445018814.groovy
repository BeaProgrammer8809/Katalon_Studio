...
Mobile.verifyElementNotExist(findTestObject('Phase2/BISplitDeliverySummary01/ExtraInv6_TextView'), 0)

Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), 
    [('testCaseName') : 'TC_ID_118'], FailureHandling.STOP_ON_FAILURE)

println("On giving Invoice Count as 5, only ExtraInv1, ExtraInv2, ExtraInv3, ExtraInv4 and ExtraInv5 is being displayed.")
