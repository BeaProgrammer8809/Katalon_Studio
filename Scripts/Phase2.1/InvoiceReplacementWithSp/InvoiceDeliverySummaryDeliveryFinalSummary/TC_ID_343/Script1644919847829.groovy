...
def Pesitocommission= Pesitocomm.substring(20, 25)
 ...
 Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), [('testCaseName') : 'TC_343'], FailureHandling.STOP_ON_FAILURE)
