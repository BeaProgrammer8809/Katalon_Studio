...
def ExpectEffcomm=findTestData('Phase2.1/TY_05/Collection').getValue(3, 14)
...
Mobile.verifyElementText(findTestObject('Phase2/BIInvoiceSummaryScreen/BICollectionScreen01/PesitoCommission_TextView'), findTestData('Phase2.1/TY_05/Collection').getValue(3, 14), FailureHandling.STOP_ON_FAILURE)
Mobile.verifyMatch(ActualEffcomm, ExpectEffcomm, false, FailureHandling.STOP_ON_FAILURE)
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), [('testCaseName') : 'TC_345'], FailureHandling.STOP_ON_FAILURE)
