...
Mobile.getText(findTestObject('Phase2/BISplitDeliverySummary01/ExtraInv4_EditView_Indexing'), 0)

Mobile.tap(findTestObject('Phase2/BISplitDeliverySummary01/ExtraInv4_EditView_Indexing'), 0)

Mobile.setText(findTestObject('Phase2/BISplitDeliverySummary01/ExtraInv4_EditView_Indexing'), findTestData('Phase2.1/TY_04/Phase2.1_Sheet3').getValue(
        24, 34), 0)

def Fst_ExtInv = Mobile.getText(findTestObject('Phase2/BISplitDeliverySummary01/ExtraInv4_EditView_Indexing'), 0)
...
Mobile.verifyElementAttributeValue(findTestObject('Phase2/BISplitDeliverySummary01/ExtraInv4_EditView_Indexing'), 'enabled', 
    findTestData('Phase2.1/TY_04/Phase2.1_Sheet3').getValue(12, 34), 0)
...
println('Column Amount contain Sum of line level SKUs Qty*SRP under ExtraInvoice4')

Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), 
    [('testCaseName') : 'TC_ID_174'], FailureHandling.STOP_ON_FAILURE)
