...
Mobile.verifyEqual(actualtoastmessage, findTestData('Phase2.1/TY_01/TestData2').getValue(4, 21), FailureHandling.STOP_ON_FAILURE)

println "Please enter folio no error is display and user is not allowing  to submit the invoice without providing the folio no "

Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'),
	[('testCaseName') : 'TC_ID_334'], FailureHandling.STOP_ON_FAILURE)
