...
def commiAmt = Mobile.getText(findTestObject('Phase2/BIInvoiceSummaryScreen/BICollectionScreen01/Amount_EditText'), 0)
...
Mobile.verifyEqual(commiAmt, findTestData('Phase2.1/TestData/Test_Data').getValue(3, 13), FailureHandling.STOP_ON_FAILURE)

Mobile.verifyNotEqual(actualtoastmessage, findTestData('Phase2.1/TestData/Test_Data').getValue(2, 10), FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), 
    [('testCaseName') : 'TC_386'], FailureHandling.STOP_ON_FAILURE)
