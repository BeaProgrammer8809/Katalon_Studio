...
Mobile.setText(findTestObject('Phase2/BISplitDeliverySummary01/ExtraInv1_EditView_Indexing'), findTestData(
		'Phase2.1/TY_04/Phase2.1_Sheet3').getValue(3, 30), 0)
...
Mobile.verifyElementAttributeValue(findTestObject('Phase2/BISplitDeliverySummary01/ExtraInv1_EditView_Indexing'), 'enabled',
	findTestData('Phase2.1/TY_04/Phase2.1_Sheet3').getValue(12, 30), 0)
...
def Fst_ExtInv2 = Mobile.getText(findTestObject('Phase2/BISplitDeliverySummary01/ExtraInv2_EditView_Indexing'), 0)
...
Mobile.setText(findTestObject('Phase2/BISplitDeliverySummary01/ExtraInv3_EditView_Indexing'), findTestData(
		'Phase2.1/TY_04/Phase2.1_Sheet3').getValue(3, 30), 0)

def Fst_ExtInv3 = Mobile.getText(findTestObject('Phase2/BISplitDeliverySummary01/ExtraInv3_EditView_Indexing'), 0)

println(Fst_ExtInv3)

Mobile.tap(findTestObject('Phase2/BISplitDeliverySummary01/ExtraInv4_EditView_Indexing'), 0)

Mobile.setText(findTestObject('Phase2/BISplitDeliverySummary01/ExtraInv4_EditView_Indexing'), findTestData(
		'Phase2.1/TY_04/Phase2.1_Sheet3').getValue(3, 30), 0)

def Fst_ExtInv4 = Mobile.getText(findTestObject('Phase2/BISplitDeliverySummary01/ExtraInv4_EditView_Indexing'), 0)

println(Fst_ExtInv4)

Mobile.tap(findTestObject('Phase2/BISplitDeliverySummary01/ExtraInv5_EditView_Indexing'), 0)

Mobile.setText(findTestObject('Phase2/BISplitDeliverySummary01/ExtraInv5_EditView_Indexing'), findTestData(
		'Phase2.1/TY_04/Phase2.1_Sheet3').getValue(3, 30), 0)

def Fst_ExtInv5 = Mobile.getText(findTestObject('Phase2/BISplitDeliverySummary01/ExtraInv5_EditView_Indexing'), 0)

println(Fst_ExtInv5)

Mobile.tap(findTestObject('Phase2/BISplitDeliverySummary01/ExtraInv6_EditView_Indexing'), 0)

Mobile.setText(findTestObject('Phase2/BISplitDeliverySummary01/ExtraInv6_EditView_Indexing'), findTestData(
		'Phase2.1/TY_04/Phase2.1_Sheet3').getValue(3, 30), 0)

def Fst_ExtInv6 = Mobile.getText(findTestObject('Phase2/BISplitDeliverySummary01/ExtraInv6_EditView_Indexing'), 0)

println(Fst_ExtInv6)

def Fst_ExtInv = Integer.parseInt(Fst_ExtInv1) + Integer.parseInt(Fst_ExtInv2) + Integer.parseInt(Fst_ExtInv3) + Integer.parseInt(Fst_ExtInv4) + Integer.parseInt(Fst_ExtInv5) + Integer.parseInt(Fst_ExtInv6)
...
def Sku_Qty3 = Mobile.getText(findTestObject('Phase2/BIDeliveryFinalSummaryScreen/SKUs_Qty_Indexing'), 0)

println(Sku_Qty3)

GlobalVariable.index = findTestData('Phase2.1/Common_Data/CommonData').getValue(5, 7)

def Sku_Qty4 = Mobile.getText(findTestObject('Phase2/BIDeliveryFinalSummaryScreen/SKUs_Qty_Indexing'), 0)

println(Sku_Qty4)

GlobalVariable.index = findTestData('Phase2.1/Common_Data/CommonData').getValue(5, 8)

def Sku_Qty5 = Mobile.getText(findTestObject('Phase2/BIDeliveryFinalSummaryScreen/SKUs_Qty_Indexing'), 0)

println(Sku_Qty5)

GlobalVariable.index = findTestData('Phase2.1/Common_Data/CommonData').getValue(5, 9)

def Sku_Qty6 = Mobile.getText(findTestObject('Phase2/BIDeliveryFinalSummaryScreen/SKUs_Qty_Indexing'), 0)

println(Sku_Qty6)

def Sku_Qty = Integer.parseInt(Sku_Qty1) + Integer.parseInt(Sku_Qty2) + Integer.parseInt(Sku_Qty3) + Integer.parseInt(Sku_Qty4) + Integer.parseInt(Sku_Qty5) + Integer.parseInt(Sku_Qty6)
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'),
	[('testCaseName') : 'TC_ID_170'], FailureHandling.STOP_ON_FAILURE)
