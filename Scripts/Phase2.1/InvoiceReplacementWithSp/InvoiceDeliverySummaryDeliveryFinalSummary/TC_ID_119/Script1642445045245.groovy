...
Mobile.verifyElementVisible(findTestObject('Phase2/BISplitDeliverySummary01/ExtraInv1_TextView'), 0)

Mobile.verifyElementVisible(findTestObject('Phase2/BISplitDeliverySummary01/ExtraInv2_TextView'), 0)

Mobile.verifyElementVisible(findTestObject('Phase2/BISplitDeliverySummary01/ExtraInv3_TextView'), 0)

Mobile.verifyElementVisible(findTestObject('Phase2/BISplitDeliverySummary01/ExtraInv4_TextView'), 0)

Mobile.verifyElementVisible(findTestObject('Phase2/BISplitDeliverySummary01/ExtraInv5_TextView'), 0)

Mobile.verifyElementVisible(findTestObject('Phase2/BISplitDeliverySummary01/ExtraInv6_TextView'), 0)

Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), 
    [('testCaseName') : 'TC_ID_119'], FailureHandling.STOP_ON_FAILURE)

println("On giving Invoice Count as 6, only ExtraInv1, ExtraInv2, ExtraInv3, ExtraInv4, ExtraInv5 and ExtraInv6 is being displayed.")
