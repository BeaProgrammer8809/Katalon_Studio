...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), 
    [('testCaseName') : 'TC_ID_112'], FailureHandling.STOP_ON_FAILURE)

println('User is navigated back to Delivery Summary screen when clicking on back button in Delivery Split Summary Screen when both invoice and replacement is Taken for Ungrouped SKUs')
