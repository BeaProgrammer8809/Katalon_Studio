...
def Pesitogranted= Mobile.getText(findTestObject('Object Repository/Phase2/BIInvoiceSummaryScreen/BICollectionScreen01/Amount_EditText'),
0)

Double PesitograntAmt = ((Pesitogranted) as Double)
...
Mobile.verifyElementText(findTestObject('Object Repository/Phase2/BIInvoiceSummaryScreen/BICollectionScreen01/Amount_EditText'),
findTestData('Phase2.1/TY_05/Collection').getValue(2, 73), FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyElementVisible(findTestObject('Object Repository/Phase2/BICollectionScreen01/BITransferenciasElectronicasScreen01/Balance_TextView'), 0, FailureHandling.STOP_ON_FAILURE)

Mobile.verifyElementExist(findTestObject('Object Repository/Phase2/BICollectionScreen01/BITransferenciasElectronicasScreen01/Balance_TextView'), 0, FailureHandling.STOP_ON_FAILURE)
...
int Balance = InvoiceAmt - PesitograntAmt

println(Balance)

def Expected = (('Balance : ' + Balance) + ' of ') + "$invamt"
...
def AmountExpected=findTestData('Phase2.1/TY_05/Collection').getValue(5, 74)

Mobile.verifyElementText(findTestObject('Object Repository/Phase2/BIInvoiceSummaryScreen/BICollectionScreen01/Amount_EditText'),
findTestData('Phase2.1/TY_05/Collection').getValue(5, 74), FailureHandling.STOP_ON_FAILURE)

Mobile.verifyMatch(Amount, AmountExpected, false, FailureHandling.STOP_ON_FAILURE)


println "Pesito commission should be displayed only in Efectivo mode"

Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), [('testCaseName') : 'TC_350'], FailureHandling.STOP_ON_FAILURE)
