...
Mobile.verifyGreaterThanOrEqual(EfectAmot.toString(), ChequeAmt.toString(), FailureHandling.STOP_ON_FAILURE)

Mobile.verifyEqual(ChequeAmt, findTestData('Phase2.1/TestData/Test_Data').getValue(3, 19), FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), 
    [('testCaseName') : 'TC_384'], FailureHandling.STOP_ON_FAILURE)
