...
println "Pesito commission ‘3’  should not add in Efectivo mode while user switch from Pesito credit mode"

Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementwithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), [('testCaseName') : 'TC_348'], FailureHandling.STOP_ON_FAILURE)
