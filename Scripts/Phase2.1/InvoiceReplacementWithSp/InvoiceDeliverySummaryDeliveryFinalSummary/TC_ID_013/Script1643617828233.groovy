...
Mobile.verifyElementText(findTestObject('Phase2/BIDeliveryFinalSummaryScreen/Delivery_Final_Summary_ScreenTitle'), findTestData(
		'Phase2.1/TY_13/Invoice, Replacement with Sp').getValue(4, 8))

def ExpectedInvoiceText = findTestData('Phase2.1/TY_13/Invoice, Replacement with Sp').getValue(5, 8)
...
Mobile.verifyMatch(InvResult.toString(), findTestData('Phase2.1/TY_13/Invoice, Replacement with Sp').getValue(6, 8), false,
	FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'),
	[('testCaseName') : 'TC_ID_013'], FailureHandling.STOP_ON_FAILURE)
