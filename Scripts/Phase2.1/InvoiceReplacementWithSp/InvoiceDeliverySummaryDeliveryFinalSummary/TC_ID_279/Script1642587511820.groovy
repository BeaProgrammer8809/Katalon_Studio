...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'),
	[('testCaseName') : 'TC_ID_279'], FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyMatch(actualtoastmessage, findTestData('Phase2.1/TY_06/Invoice, Replacement with Sp/invoice-Delivery Summary-Delivery Final Summary').getValue(
		3, 19), false, FailureHandling.STOP_ON_FAILURE)

Mobile.comment('TC_ID_279:-collection popup should be in open')
