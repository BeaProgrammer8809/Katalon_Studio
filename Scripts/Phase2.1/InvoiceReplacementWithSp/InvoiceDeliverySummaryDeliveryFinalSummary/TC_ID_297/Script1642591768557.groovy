...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), 
    [('testCaseName') : 'TC_ID_297'], FailureHandling.STOP_ON_FAILURE)
...
Mobile.comment('Decimal should  should not be allowed to enter inside the Reference No field')

Mobile.verifyMatch(ReferenceNo, findTestData('Phase2.1/TY_06/Invoice, Replacement with Sp/invoice-Delivery Summary-Delivery Final Summary').getValue(
        3, 37), false, FailureHandling.STOP_ON_FAILURE)
