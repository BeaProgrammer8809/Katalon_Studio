...
Mobile.verifyEqual(InvAmount, ChequeAmt, FailureHandling.STOP_ON_FAILURE)

println('invoice Amount paid in cheque mode without granting pesito')
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), 
    [('testCaseName') : 'TC_374'], FailureHandling.STOP_ON_FAILURE)
