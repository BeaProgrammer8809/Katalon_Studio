...
Mobile.setText(findTestObject('Object Repository/Phase2/BICollectionScreen01/BIChequesScreen01/Amount_EditText'), (Amt * 
    Amt).toString(), 0)

//def AmountInChequeText = Mobile.getText(findTestObject('Object Repository/Phase2/BICollectionScreen01/BIChequesScreen01/Amount_EditText'),
//0)
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), 
    [('testCaseName') : 'TC_ID_276'], FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyGreaterThan(Amt * Amt, Double.parseDouble(invAmt), FailureHandling.STOP_ON_FAILURE)
