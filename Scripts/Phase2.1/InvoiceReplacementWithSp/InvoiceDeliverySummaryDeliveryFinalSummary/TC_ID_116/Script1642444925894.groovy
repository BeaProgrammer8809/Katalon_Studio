...
Mobile.verifyElementNotExist(findTestObject('Phase2/BISplitDeliverySummary01/ExtraInv4_TextView'), 0)

Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), 
    [('testCaseName') : 'TC_ID_116'], FailureHandling.STOP_ON_FAILURE)

println("On giving Invoice Count as 3, only ExtraInv1, ExtraInv2 and ExtraInv3 is being displayed.")
