...
Mobile.callTestCase(findTestCase('Reusable Cases/Mobile/Phase2.1/EnterPiecesQuantity'), [('ProductName') : findTestData(
			'Phase2.1/Common_Data/CommonData').getValue('ProductName', 52)], FailureHandling.STOP_ON_FAILURE)
...
def TotalValueofPiecesAndSRP = piecesValue1 * SRPValue1

println('TotalValueofPiecesAndSRP' + TotalValueofPiecesAndSRP)

def totalValue1=Mobile.getText(findTestObject('Phase2/BIDeliverySummaryScreen/Total_Text'), 0)

double totalValue = Double.parseDouble(totalValue1)

Mobile.verifyEqual(TotalValueofPiecesAndSRP, totalValue, FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'),
	[('testCaseName') : 'TC_057'], FailureHandling.STOP_ON_FAILURE)
