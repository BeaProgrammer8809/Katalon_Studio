...
def Expsplitname1 = findTestData('Phase2.1/TY_11/TestData').getValue(4, 79)
...
def Expsplitname2 = findTestData('Phase2.1/TY_11/TestData').getValue(5, 79)
...
def Expsplitname3 = findTestData('Phase2.1/TY_11/TestData').getValue(6, 79)

Actualsplitname3.contains(Expsplitname3)
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'),
	[('testCaseName') : 'TC_ID_096'], FailureHandling.STOP_ON_FAILURE)
