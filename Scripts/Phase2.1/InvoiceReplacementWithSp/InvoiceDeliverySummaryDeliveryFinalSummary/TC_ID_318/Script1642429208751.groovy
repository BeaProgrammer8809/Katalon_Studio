...
def expPesitoComAmt=findTestData('Phase2/Common_Data/CommonData_03').getValue(5, 3)

Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), 
    [('testCaseName') : 'TC_ID_318_CollectionScreen'], FailureHandling.STOP_ON_FAILURE)

Mobile.verifyEqual(PesitoComAmtActual, expPesitoComAmt,  FailureHandling.STOP_ON_FAILURE)

println('Pesito commission is coming based on web application ')
