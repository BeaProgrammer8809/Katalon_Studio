...
Mobile.verifyEqual(ActualFolioNumText, findTestData('Phase2.1/TY_01/TestData2').getValue(4, 22), FailureHandling.STOP_ON_FAILURE)

println " folio number length is  up to 15 digits"

Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'),
	[('testCaseName') : 'TC_ID_335'], FailureHandling.STOP_ON_FAILURE)
