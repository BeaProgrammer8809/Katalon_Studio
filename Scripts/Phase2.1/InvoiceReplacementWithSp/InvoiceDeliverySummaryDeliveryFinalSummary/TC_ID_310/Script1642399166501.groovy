...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), 
    [('testCaseName') : 'TC_ID_310_CollectionScreen'], FailureHandling.STOP_ON_FAILURE)
...
println('User is able to submit the amount in effectivo and RTGS mode')

Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), 
    [('testCaseName') : 'TC_ID_310_D.F.SummaryScreen'], FailureHandling.STOP_ON_FAILURE)
