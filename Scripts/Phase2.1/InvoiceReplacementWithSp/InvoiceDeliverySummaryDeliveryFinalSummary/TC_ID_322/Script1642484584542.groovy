...
def expTitle=findTestData('Phase2/TY_03/TestData_Phase2.1').getValue(2, 18)

Mobile.verifyMatch(actualTitle, expTitle, false, FailureHandling.STOP_ON_FAILURE)

println('Displaying Alert popup as expected with message and YES Cancel button')

Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), 
    [('testCaseName') : 'TC_ID_322_CollectionScreen'], FailureHandling.STOP_ON_FAILURE)
