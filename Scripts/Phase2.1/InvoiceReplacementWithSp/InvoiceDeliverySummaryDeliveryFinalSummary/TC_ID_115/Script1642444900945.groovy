...
Mobile.verifyElementNotExist(findTestObject('Phase2/BISplitDeliverySummary01/ExtraInv3_TextView'), 0)

Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), 
    [('testCaseName') : 'TC_ID_115'], FailureHandling.STOP_ON_FAILURE)

println("On giving Invoice Count as 2, only ExtraInv1 and ExtraInv2 is being displayed.")
