...
Mobile.getText(findTestObject('Phase2/BISplitDeliverySummary01/ExtraInv5_EditView_Indexing'), 0)

Mobile.tap(findTestObject('Phase2/BISplitDeliverySummary01/ExtraInv5_EditView_Indexing'), 0)

Mobile.setText(findTestObject('Phase2/BISplitDeliverySummary01/ExtraInv5_EditView_Indexing'), findTestData('Phase2.1/TY_04/Phase2.1_Sheet3').getValue(
        24, 35), 0)
...
Mobile.verifyElementAttributeValue(findTestObject('Phase2/BISplitDeliverySummary01/ExtraInv5_EditView_Indexing'), 'enabled', 
    findTestData('Phase2.1/TY_04/Phase2.1_Sheet3').getValue(12, 35), 0)
...
println('Column Amount contain Sum of line level SKUs Qty*SRP under ExtraInvoice5')

Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), 
    [('testCaseName') : 'TC_ID_175'], FailureHandling.STOP_ON_FAILURE)
