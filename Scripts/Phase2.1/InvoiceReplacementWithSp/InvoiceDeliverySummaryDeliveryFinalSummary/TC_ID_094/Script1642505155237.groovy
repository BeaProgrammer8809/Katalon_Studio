...
def Expsplitname1 = findTestData('Phase2.1/TY_11/TestData').getValue(4, 76)+GlobalVariable.index
...
def Expsplitname2 = findTestData('Phase2.1/TY_11/TestData').getValue(4, 76)+GlobalVariable.index
...
def Actualsplitname3 = Mobile.getText(findTestObject('Phase2/BIDeliveryFinalSummaryScreen/Invoice Split_Indexing'), 0)

def Expsplitname3 = findTestData('Phase2.1/TY_11/TestData').getValue(4, 76)+GlobalVariable.index

Mobile.verifyMatch(Actualsplitname3, Expsplitname3, false, FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), 
    [('testCaseName') : 'TC_ID_093'], FailureHandling.STOP_ON_FAILURE)
