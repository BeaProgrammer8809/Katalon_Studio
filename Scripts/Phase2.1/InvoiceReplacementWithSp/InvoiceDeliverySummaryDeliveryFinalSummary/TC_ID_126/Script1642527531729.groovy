...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), 
    [('testCaseName') : 'TC_ID_126ToastMsg'], FailureHandling.STOP_ON_FAILURE)
...
def Expected_ToastMessage = findTestData('Phase2.1/TY_13/Invoice, Replacement with Sp').getValue(3, 3)
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), 
    [('testCaseName') : 'TC_ID_126AftterEnteringExtrainvCount'], FailureHandling.STOP_ON_FAILURE)
