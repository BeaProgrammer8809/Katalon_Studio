...
def Invoice_Qty_Before = Mobile.getText(findTestObject('Phase2/BIDeliverySummaryScreen/Invoice_Count_EditText'), 0)
...
def Invoice_Qty_After = Mobile.getText(findTestObject('Phase2/BIDeliverySummaryScreen/Invoice_Count_EditText'), 0)

Mobile.verifyNotEqual(Invoice_Qty_Before, Invoice_Qty_After, FailureHandling.STOP_ON_FAILURE)

println('User is allow to remove entered qty')

Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), 
    [('testCaseName') : 'TC_ID_142'], FailureHandling.STOP_ON_FAILURE)
