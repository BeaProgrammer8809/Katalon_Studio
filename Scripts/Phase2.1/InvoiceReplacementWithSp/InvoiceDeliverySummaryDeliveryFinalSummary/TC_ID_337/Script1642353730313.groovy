...
Mobile.verifyEqual(actualtoastmessage, findTestData('Phase2.1/TY_01/TestData2').getValue(4, 24), FailureHandling.STOP_ON_FAILURE)

println "Folio number should be at least 6 characters message is displaying  when user enter folio number less than 6 digits"

Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'),
	[('testCaseName') : 'TC_ID_337'], FailureHandling.STOP_ON_FAILURE)
