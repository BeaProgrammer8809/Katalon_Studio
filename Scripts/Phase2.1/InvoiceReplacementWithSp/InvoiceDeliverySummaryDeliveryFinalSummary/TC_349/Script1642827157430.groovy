...
println "Pesito commission ‘3’ should not show automatically in Cheque collection mode while granting the pesito"
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), [('testCaseName') : 'TC_349'], FailureHandling.STOP_ON_FAILURE)
