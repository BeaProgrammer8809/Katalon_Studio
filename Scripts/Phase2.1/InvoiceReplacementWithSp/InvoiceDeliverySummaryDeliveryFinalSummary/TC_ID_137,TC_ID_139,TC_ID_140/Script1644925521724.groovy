...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), 
    [('testCaseName') : 'TC_ID_140AfterAddingqtyforExtraInv2'], FailureHandling.STOP_ON_FAILURE)
...
println('TC_ID_139-ExtraInv1 field is marked as read only for SKU2 ')

Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), 
    [('testCaseName') : 'TC_ID_137SKU2Extrainv1Count'], FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), 
    [('testCaseName') : 'TC_ID_140AfterAddingqtyforExtraInv3'], FailureHandling.STOP_ON_FAILURE)
...
println('TC_ID_139-ExtraInv1 field is marked as read only for SKU3 ')

Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), 
    [('testCaseName') : 'TC_ID_137SKU3inv1Count'], FailureHandling.STOP_ON_FAILURE)

println('TC_ID_137 - 1 extra invoice is applicable to deliver only one company\'s stock')

println('TC_ID_140 - ExtraInv 2 and 3 are free for Sku2 and ExtraInv 3 is free for Sku3')
