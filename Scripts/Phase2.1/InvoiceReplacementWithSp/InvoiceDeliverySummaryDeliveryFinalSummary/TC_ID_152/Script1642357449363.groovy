...
println('ExtraInvoice1 count is displayed')

def Actual_ExtraInv = Mobile.getText(findTestObject('Object Repository/Phase2/BISplitDeliverySummary01/ExtraInv1_TextView'),
	0, FailureHandling.STOP_ON_FAILURE)

def Expected_ExtraInv = findTestData('Phase2.1/TY_04/Phase2.1_Sheet3').getValue(16, 12)
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'),
	[('testCaseName') : 'TC_ID_152'], FailureHandling.STOP_ON_FAILURE)
