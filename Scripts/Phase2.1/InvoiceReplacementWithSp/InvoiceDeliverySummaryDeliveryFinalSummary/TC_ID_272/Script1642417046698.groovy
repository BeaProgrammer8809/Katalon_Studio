...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), 
    [('testCaseName') : 'TC_ID_272'], FailureHandling.STOP_ON_FAILURE)

def ChequeNo = Mobile.getText(findTestObject('Phase2/BICollectionScreen01/BIChequesScreen01/ChequeNum_EditText'), 0)

Mobile.comment('Number should be allowed to enter inside the Cheque No field')
...
Mobile.verifyMatch(ChequeNo, findTestData('Phase2.1/TY_06/Invoice, Replacement with Sp/invoice-Delivery Summary-Delivery Final Summary').getValue(
        3, 12), false, FailureHandling.STOP_ON_FAILURE)
