...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), 
    [('testCaseName') : 'TC_ID_122'], FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyMatch(ActualExtraInv1Name, findTestData('Phase2.1/TY_13/Invoice, Replacement with Sp').getValue(2, 9), false)
...
Mobile.verifyMatch(ActualExtraInv2Name , findTestData('Phase2.1/TY_13/Invoice, Replacement with Sp').getValue(3, 9), false)
...
Mobile.verifyMatch(ActualExtraInv3Name, findTestData('Phase2.1/TY_13/Invoice, Replacement with Sp').getValue(4, 9), false)
...
Mobile.verifyMatch(ActualExtraInv4Name, findTestData('Phase2.1/TY_13/Invoice, Replacement with Sp').getValue(5, 9), false)
...
Mobile.verifyMatch(ActualExtraInv5Name, findTestData('Phase2.1/TY_13/Invoice, Replacement with Sp').getValue(6, 9), false)
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), 
    [('testCaseName') : 'TC_ID_122AfterTapCreateInvoice'], FailureHandling.STOP_ON_FAILURE)

println('We can Partially distribute the qty line wise for Grouped SKU\'s')
