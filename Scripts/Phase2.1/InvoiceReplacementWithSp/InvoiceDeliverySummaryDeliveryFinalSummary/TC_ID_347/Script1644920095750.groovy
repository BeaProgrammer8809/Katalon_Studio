...
def Amount=Mobile.getText(findTestObject('Object Repository/Phase2/BIInvoiceSummaryScreen/BICollectionScreen01/Amount_EditText'), 0, FailureHandling.STOP_ON_FAILURE)
...
//	findTestData('Phase2.1/TY_05/Collection').getValue(3, 74), FailureHandling.STOP_ON_FAILURE)

Mobile.verifyMatch(invamt, Amount, false, FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), [('testCaseName') : 'TC_347'], FailureHandling.STOP_ON_FAILURE)
