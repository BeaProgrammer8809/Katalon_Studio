...
Mobile.verifyEqual(actualtoastmessage, findTestData('Phase2.1/TY_01/TestData2').getValue(4, 19), FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), 
    [('testCaseName') : 'TC_ID_331'], FailureHandling.STOP_ON_FAILURE)
