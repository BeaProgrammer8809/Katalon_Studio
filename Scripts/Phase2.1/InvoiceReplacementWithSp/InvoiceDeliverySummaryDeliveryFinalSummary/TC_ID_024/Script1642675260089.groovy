...
Mobile.setText(findTestObject('Phase2/BIEnterTheFolioNoPopup01/FolioNo._EditText'), '123456', 0)

Mobile.tap(findTestObject('Phase2/BIEnterTheFolioNoPopup01/OK_Button'), 0)

not_run: Mobile.tap(findTestObject('Phase2/BIEnterTheFolioNoPopup01/Payment_CheckBox'), 0, FailureHandling.STOP_ON_FAILURE)

not_run: Mobile.tap(findTestObject('Phase2/BICollectionScreen01/Submit_Button'), 0)
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceReplacementWithSp/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'),
	[('testCaseName') : 'TC_ID_024'], FailureHandling.STOP_ON_FAILURE)
