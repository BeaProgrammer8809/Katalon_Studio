...
Mobile.verifyMatch(actualInvAmt, expectedAmt, false, FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_224'], FailureHandling.STOP_ON_FAILURE)
