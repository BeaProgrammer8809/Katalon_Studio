...
Mobile.setText(findTestObject('Phase2/BIInvoiceSummaryScreen/BIEnterTheFolioNoPopup01/FolioNo._EditText'), findTestData(
        'Phase2.1/TestData/Test_Data').getValue(7, 61), 0)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_587'], 
    FailureHandling.STOP_ON_FAILURE)
...
def Expected_Print_Text = findTestData('Phase2.1/TestData/Test_Data').getValue(7, 62)
...
//Mobile.verifyEqual(text, findTestData('Phase2.1/TestData/Test_Data').getValue(7, 61), FailureHandling.STOP_ON_FAILURE)
//Mobile.verifyEqual(text1, findTestData('Phase2.1/TestData/Test_Data').getValue(7, 61), FailureHandling.STOP_ON_FAILURE)
