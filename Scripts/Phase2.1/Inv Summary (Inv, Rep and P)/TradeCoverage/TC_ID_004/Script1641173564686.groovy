...
Mobile.callTestCase(findTestCase('Reusable Cases/Mobile/Phase2.1/OnlyReplacement_Quantity'), [:], FailureHandling.STOP_ON_FAILURE)
 ...
 def InvoiceQuantity = Mobile.getText(findTestObject('Object Repository/Phase2/BIOrderAndInvoiceScreen01/Pieces_EditText'), 0)

 def Pieces =Double.parseDouble(InvoiceQuantity)
 
 def Piecesvalue = Math.round(Pieces)
 
 int InvoiceQuantityInOrderScreen  = (int)Piecesvalue
 
 def ReturnQuantity = Mobile.getText(findTestObject('Object Repository/Phase2/BIOrderAndInvoiceScreen01/Returns_Edit_Text'), 0)

 def Return =Double.parseDouble(ReturnQuantity)
 
 def returnqty = Math.round(Return)
 
 int ReturnQuantityInOrderScreen  = (int)returnqty
...
int UnitpriceInOrderScreen  = (int)pricequantity
...
Mobile.callTestCase(findTestCase('Reusable Cases/Mobile/Phase2.1/OnlyProduct_Buying_Quantity'), [('testData1') : findTestData('Phase2.1/Common_Data/CommonData').getValue(
 ...
 int PBQuantityInPBScreen  = (int)buyingquantity
...
Mobile.verifyElementAttributeValue(findTestObject('Object Repository/Phase2/BIInvoiceSummaryScreen/Summary_ScreenTitle'), 'text',findTestData('Phase2.1/TY_05/Testdata').getValue(
	'Data2', 3) , 0)


/*Verification done to check the collection icon*/

Mobile.verifyElementExist(findTestObject('Object Repository/Phase2/BIInvoiceSummaryScreen/Collection_Icon'), 0, FailureHandling.STOP_ON_FAILURE)
...
def TotalSkuvalue = Mobile.getText(findTestObject('Object Repository/Phase2/BIInvoiceSummaryScreen/BISummaryProductDetails/Price_Value_Indexing'), 0)
...
Mobile.verifyElementText(findTestObject('Object Repository/Phase2/BIInvoiceSummaryScreen/BISummaryProductDetails/Pieces_Value_Indexing'),InvoiceQuantityInOrderScreen.toString() )

Mobile.verifyElementText(findTestObject('Object Repository/Phase2/BIInvoiceSummaryScreen/BISummaryProductDetails/Actual_Return_Value_Indexing'),ReturnQuantityInOrderScreen.toString() )

Mobile.verifyElementText(findTestObject('Object Repository/Phase2/BIInvoiceSummaryScreen/BISummaryProductDetails/Sales_Return_Value_Indexing'),PBQuantityInPBScreen.toString() )
...
int UnitpriceInSummaryScreen  = (int)pricequantityinsummary
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_004'],
