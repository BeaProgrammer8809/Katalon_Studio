...
def pesitoAmount1= InvAmount/2

def pesitoAmount = pesitoAmount1.toString()
...
def pesito = Mobile.getText(findTestObject('Object Repository/Phase2/BIInvoiceSummaryScreen/BICollectionScreen01/Amount_EditText'), 0)
 
def effectivo1 = InvAmount -Double.parseDouble(pesito)

def effectivo = effectivo1.toString()
...
def ActualpesitoCommision = Double.parseDouble(pesitocommision)
...
Mobile.setText(findTestObject('Object Repository/Phase2/BIInvoiceSummaryScreen/BICollectionScreen01/Amount_EditText'), effectivo,
	0)

Mobile.tap(findTestObject('Phase2/BIInvoiceSummaryScreen/BICollectionScreen01/Submit_Button'), 0)

Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_163'],
	FailureHandling.STOP_ON_FAILURE)
...
ExpectedToastMessage = findTestData('Phase2.1/TY_11/TestData').getValue(4, 71) +ActualpesitoCommision
