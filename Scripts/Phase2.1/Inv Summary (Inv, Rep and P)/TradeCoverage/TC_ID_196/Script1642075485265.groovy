...
Mobile.comment('Verifying Edit icon and Preticket icon was hidden After doing collection')

Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_196'], 
    FailureHandling.STOP_ON_FAILURE)

Mobile.verifyElementNotVisible(findTestObject('Phase2/BIInvoiceSummaryScreen/PrintPreticket_Icon'), 5)

Mobile.verifyElementNotExist(findTestObject('Phase2/BIInvoiceSummaryScreen/PrintPreticket_Icon'), 5)

Mobile.verifyElementNotExist(findTestObject('Phase2/BIInvoiceSummaryScreen/Tag_Icon'), 5)

Mobile.verifyElementNotVisible(findTestObject('Phase2/BIInvoiceSummaryScreen/Tag_Icon'), 5)
