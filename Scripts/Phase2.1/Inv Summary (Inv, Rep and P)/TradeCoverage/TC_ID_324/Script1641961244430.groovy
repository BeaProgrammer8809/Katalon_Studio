...
Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_324'],
    FailureHandling.STOP_ON_FAILURE)
...
//Comp_Discount=df.format(Comp_Discount)
...
//Category Discount
def categorydiscountinWeb = findTestData('Phase2.1/TY_04/Phase2.1_Sheet2').getValue(8, 94)
...
Mobile.setText(findTestObject('Phase2/BIInvoiceSummaryScreen/BIEnterTheFolioNoPopup01/FolioNo._EditText'), findTestData(
        'Phase2.1/TY_04/Phase2.1_Sheet2').getValue(10, 62), 0)
...
def IEPS = findTestData('Phase2.1/TY_04/Phase2.1_Sheet2').getValue(16, 62)
...
Mobile.verifyMatch(Actual_Number.toString(),findTestData('Phase2.1/TY_04/Phase2.1_Sheet2').getValue(20, 62), false,FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_324'],
	FailureHandling.STOP_ON_FAILURE)
