...
Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_462'], 
...
def Product_Buying_Amount = U_Price_Value * Double.parseDouble(Return_Value)
...
def Tax_Amount = Double.parseDouble(Price_Value) * 0.08 //8%
...
Mobile.verifyEqual(Tax_Diff_Amount, Tax_Amount, FailureHandling.STOP_ON_FAILURE)

'IEPS tax amount is added in line item total price of the sku'
Mobile.verifyEqual(Product_Buying_Amount, Product_Qty, FailureHandling.STOP_ON_FAILURE)

'Product buying amount is displayed correctly'
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_328'], 
    FailureHandling.STOP_ON_FAILURE)
