...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_186_InvoiceSummary'], 
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_188_collection'], 
    FailureHandling.STOP_ON_FAILURE)
...
def Balance2 = Mobile.getText(findTestObject('Phase2/BICollectionScreen01/BIEfectivoScreen01/Balance_TextView'), 0)

println Balance2

Balance1 = Balance2.split(": ")

Balance3 = Balance1[1]

Balance3 = Balance3.split(" of")

Balance = Balance3[0]

println(Balance)

double Totalpaid1 = Double.parseDouble(Totalpaid)

double InvAmount = Double.parseDouble(InvAmount1)

def ActualBalance= InvAmount - Totalpaid1

ActualBalance = ActualBalance.toString()

Mobile.verifyEqual(Totalpaid, InvAmount1, FailureHandling.STOP_ON_FAILURE)

Mobile.verifyEqual(Balance, ActualBalance, FailureHandling.STOP_ON_FAILURE)
