...
Mobile.verifyEqual(invamt, NetAmount, FailureHandling.STOP_ON_FAILURE)

println "Inv Amt Equal to Net amount (value) displayed in cheque screen"

Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_106'],
