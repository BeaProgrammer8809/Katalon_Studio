...
/*Verification done to check the Select any Branch */
...
Mobile.verifyElementText(findTestObject('Object Repository/Phase2/BIDropdown/Dropdown_Name'), findTestData('Phase2.1/Common_Data/CommonData').getValue('Branch', 3))

Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_115'],
