...
Mobile.comment('User should be used the amount in Pesito Credit mode')

Mobile.verifyEqual(effectivoAmt, pesitoAmt, FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyElementText(findTestObject('Phase2/BIInvoiceSummaryScreen/BIEnterTheFolioNoPopup01/EnterTheFolioNumber_PopupTitle'), 
    findTestData('Phase2.1/TY_06/Inv Summary (Inv, Rep and P)/TradeCoverage').getValue(2, 4), FailureHandling.STOP_ON_FAILURE)
