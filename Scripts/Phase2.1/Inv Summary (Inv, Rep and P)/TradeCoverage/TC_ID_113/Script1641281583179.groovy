...
/*Verification done to check whether able to select Bank from dropdown*/

GlobalVariable.DropdownName = findTestData('Phase2/Common_Data/CommonData').getValue('DropdownName', 1)

Mobile.tap(findTestObject('Object Repository/Phase2/BIDropdown/Dropdown_Name'), 0)

GlobalVariable.DropdownOption = findTestData('Phase2/Common_Data/CommonData').getValue('Bank', 2)

Mobile.tap(findTestObject('Object Repository/Phase2/BIDropdown/Dropdown_Option'), 0)

GlobalVariable.DropdownName = findTestData('Phase2/Common_Data/CommonData').getValue('Bank', 2)

Mobile.verifyElementText(findTestObject('Object Repository/Phase2/BIDropdown/Dropdown_Name'), findTestData('Phase2.1/Common_Data/CommonData').getValue('Bank', 2))

Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_113'],
