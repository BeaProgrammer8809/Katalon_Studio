...
def TotalInvoiceAmount=InvoiceAmount.toString()
...
/*Verification done to check whether able to Submit the invoice amount with max digit in Reference no*/
...
Mobile.setText(findTestObject('Object Repository/Phase2/BICollectionScreen01/BITransferenciasElectronicasScreen01/ReferenceNum_EditText'),
	findTestData('Phase2.1/TY_05/Testdata').getValue('Data1', 24), 0)
...
def text = Mobile.getText(findTestObject('Object Repository/Phase2/BICollectionScreen01/BITransferenciasElectronicasScreen01/ReferenceNum_EditText'), 0)

def Maxlength=text.length()

def MaxReferenceNumberLength=Maxlength.toString()

/*Verifying the maximum length is 20 */

Mobile.verifyMatch(MaxReferenceNumberLength, findTestData('Phase2.1/TY_05/Testdata').getValue('Data2', 24) , false ,FailureHandling.STOP_ON_FAILURE)

Mobile.verifyElementText(findTestObject('Object Repository/Phase2/BICollectionScreen01/BITransferenciasElectronicasScreen01/ReferenceNum_EditText'),
	findTestData('Phase2.1/TY_05/Testdata').getValue('Data1', 24), FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_150'],
