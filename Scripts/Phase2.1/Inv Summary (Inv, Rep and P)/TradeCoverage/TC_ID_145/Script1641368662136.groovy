...
def AmountLessThanInvoiceAmount = totalTransferenciasAmount - 10

Mobile.setText(findTestObject('Object Repository/Phase2/BICollectionScreen01/BITransferenciasElectronicasScreen01/Amount_EditText') , AmountLessThanInvoiceAmount.toString(), 0)
...
def Expected_Toast_Message = findTestData('Phase2.1/TY_05/Testdata').getValue('Data1', 25)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_145'],
