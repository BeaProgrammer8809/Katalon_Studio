...
def expFolioNum = findTestData('Phase2.1/TY_11/TestData').getValue(4, 63)

def expFolioNumlength = expFolioNum.length()

println(expFolioNumlength)

Mobile.sendKeys(findTestObject('Phase2/BIInvoiceSummaryScreen/BIEnterTheFolioNoPopup01/FolioNo._EditText'), findTestData(
        'Phase2.1/TY_11/TestData').getValue(4, 63))



def ActualFolioNum =Mobile.getAttribute(findTestObject('Phase2/BIInvoiceSummaryScreen/BIEnterTheFolioNoPopup01/FolioNo._EditText'), 'text', 0)



def ActualFolioNumlength = ActualFolioNum.length()

println(ActualFolioNumlength)

'by passing a 16 digit folionum verifying the fetched num is 15 digit only, actual and expected length not matching'

Mobile.verifyNotMatch(ActualFolioNum, expFolioNum, false, FailureHandling.STOP_ON_FAILURE)

Mobile.verifyNotEqual(ActualFolioNumlength, expFolioNumlength, FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_178'], 
