...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_224_Actual_Pieces_Value_And_Actual_Return_Qty'], FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_224_Expected_Values'], FailureHandling.STOP_ON_FAILURE)
...
def Expected_Inv_Amt = Mobile.getText(findTestObject('Phase2/BICollectionScreen01/InvAmt_TextView'), 0, FailureHandling.STOP_ON_FAILURE)
boolean Actual_Value = Expected_Inv_Amt.contains(Actual_Net_Amt)

Mobile.verifyMatch(Actual_Value.toString(), findTestData('Phase2.1/TY_02/Test_Data_Phase2').getValue(7, 101), false,FailureHandling.STOP_ON_FAILURE)
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_224_Int_Value'], FailureHandling.STOP_ON_FAILURE)
