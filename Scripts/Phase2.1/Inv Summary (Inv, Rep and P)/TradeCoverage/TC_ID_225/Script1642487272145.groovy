...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_225_Actual_Pieces_Value_And_Actual_Return_Qty'], FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_225_Expected_Values'], FailureHandling.STOP_ON_FAILURE)
...
boolean Actual_Value = Expected_Min_Amt.contains(Actual_Net_Amt)

Mobile.verifyMatch(Actual_Value.toString(),findTestData('Phase2.1/TY_02/Test_Data_Phase2').getValue(7, 102), false,FailureHandling.STOP_ON_FAILURE)
