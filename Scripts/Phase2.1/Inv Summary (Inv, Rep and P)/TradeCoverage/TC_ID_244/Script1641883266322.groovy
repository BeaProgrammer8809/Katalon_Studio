...
println('Collection icon is  hidden after submitting the invoice amount in any collection modes')

Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_244'], 
