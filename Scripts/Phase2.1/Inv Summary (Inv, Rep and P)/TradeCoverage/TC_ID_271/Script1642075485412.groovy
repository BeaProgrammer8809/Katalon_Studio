...
'Provide order quantity for Bimbo'
...
productName = findTestData('Phase2.1/Common_Data/CommonData').getValue(6, 16)

Mobile.setText(findTestObject('Phase2/BIOrderAndInvoiceScreen01/Search_Edit_Text'), productName, 0)

'Provide order quantity for Barcel'
Mobile.tap(findTestObject('Phase2/BIOrderAndInvoiceScreen01/Pieces_EditText'), 0)
...
productName = findTestData('Phase2.1/Common_Data/CommonData').getValue(6, 30)

Mobile.setText(findTestObject('Phase2/BIOrderAndInvoiceScreen01/Search_Edit_Text'), productName, 0)

'Provide order quantity for Recolino'
Mobile.tap(findTestObject('Phase2/BIOrderAndInvoiceScreen01/Pieces_EditText'), 0)
...
Mobile.verifyElementText(findTestObject('Phase2/BIInvoiceSummaryScreen/BICollectionScreen01/Collection_Title'), findTestData(
        'Phase2.1/TY_06/Inv Summary (Inv, Rep and P)/TradeCoverage').getValue(2, 16), FailureHandling.STOP_ON_FAILURE)*/
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_267'], 
    FailureHandling.STOP_ON_FAILURE)

def PesitoAmountText = Mobile.getText(findTestObject('Phase2/BIInvoiceSummaryScreen/BICollectionScreen01/Amount_EditText'), 
    0)

double PesitoAmount = Double.parseDouble(PesitoAmountText)

Mobile.comment('Pesito credit amount should used & user should be able to enter amount in Amount field in pesito credit option')

Mobile.verifyEqual(Amt, PesitoAmount, FailureHandling.STOP_ON_FAILURE)*/
Mobile.comment('Check for Bimbo product')
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_271'], 
    FailureHandling.STOP_ON_FAILURE)
...
Mobile.comment('Check for Barcel product Pesito credit was not visible')
...
Mobile.verifyElementNotVisible(findTestObject('Phase2/BIInvoiceSummaryScreen/BICollectionScreen01/PesitoCredit_TextView'), 
    10, FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('Phase2/BICollectionScreen01/Submit_Button'), 0)

Mobile.comment('Check for Recolino product pesito credit was not visible')
