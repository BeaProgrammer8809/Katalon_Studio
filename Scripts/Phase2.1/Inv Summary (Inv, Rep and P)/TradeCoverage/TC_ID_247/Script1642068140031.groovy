...
Mobile.callTestCase(findTestCase('Reusable Cases/Mobile/Phase2.1/Clear_EffectioAmt_cheque'), [:], FailureHandling.STOP_ON_FAILURE)
...
Mobile.setText(findTestObject('Phase2/BICollectionScreen01/BITransferenciasElectronicasScreen01/ReferenceNum_EditText'),
	findTestData('Phase2.1/TY_01/TestData2').getValue(3, 16), 0)
...
println " User is  able to submit the invoice amount in Cheque mode and RTGS mode"

Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_247'],
