...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_534'],
...
def Expected_Print_Text = findTestData('Phase2.1/TestData/Test_Data').getValue('Expected Result2', 76)
