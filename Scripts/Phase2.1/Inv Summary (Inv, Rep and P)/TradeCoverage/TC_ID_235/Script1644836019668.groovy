...
def Actual_ChequeNumberEntered = Mobile.getAttribute(findTestObject('Phase2/BICollectionScreen01/BITransferenciasElectronicasScreen01/ReferenceNum_EditText'), 
    'text', 0)

println(Actual_ChequeNumberEntered + 'Actual ChequeNumberEntered')

def Expected_ChequeNumberEntered = findTestData('Phase2.1/TY_14/TestData').getValue('Data', 45)

println(Expected_ChequeNumberEntered + 'ExpectedChequeNumberEntered')

Mobile.verifyNotMatch(Actual_ChequeNumberEntered, Expected_ChequeNumberEntered, false, FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_235'], 
    FailureHandling.STOP_ON_FAILURE)
