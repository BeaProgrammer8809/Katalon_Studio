...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_167'],
	FailureHandling.STOP_ON_FAILURE)
'verifying after submitting collection screnn gone and invoice summary screen present'
