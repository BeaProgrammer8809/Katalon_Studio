...
Mobile.setText(findTestObject('Object Repository/Phase2/BIEnterTheFolioNoPopup01/FolioProdBuy_EditText'), findTestData(
	'Phase2.1/TY_04/Phase2.1_Sheet2').getValue(10, 63), 0)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_325'],
	FailureHandling.STOP_ON_FAILURE)
