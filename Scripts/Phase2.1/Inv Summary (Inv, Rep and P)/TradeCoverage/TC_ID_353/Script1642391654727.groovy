...
Mobile.verifyElementNotExist(findTestObject('Phase2/BIInvoiceSummaryScreen/IneComplement_Icon'), 10)

Mobile.verifyElementNotVisible(findTestObject('Phase2/BIInvoiceSummaryScreen/IneComplement_Icon'), 10)

Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_353'], 
    FailureHandling.STOP_ON_FAILURE)
