...
def tax=expectedTotalPrice * 0.16

println " Tax included for the sku is "+tax

Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_282_SummaryScreen'],
	FailureHandling.STOP_ON_FAILURE)
