...
import com.ty.keywords.MobileKeywords
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_332'], 
...
def Sales_Return_Value = Mobile.getText(findTestObject('Phase2/BIInvoiceSummaryScreen/BuySchemeDetails/Buy_Sales_Return_Value'), 
    0)

def Actual_Return_Value = Mobile.getText(findTestObject('Phase2/BIInvoiceSummaryScreen/BuySchemeDetails/Buy_Actual_Return_Value'), 0)

println(Actual_Return_Value)
...
Mobile.verifyEqual(Product_Buying_Amount, Invoice_Qty, FailureHandling.STOP_ON_FAILURE)

println('Invoice amount is 0 for replacement')
//def Return_Amt = 0.00

//Mobile.verifyEqual(Return_Buying_Amount, Return_Amt, FailureHandling.STOP_ON_FAILURE)
