...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/PesitoCommission/Screenshot'), [('testCaseName') : 'TC_ID_435_Actual_Pieces_Value'], FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('Object Repository/Phase2/BIOrderAndInvoiceScreen01/Next_Button'), 0)
Mobile.tap(findTestObject('Object Repository/Phase2/BIProductBuyingScreen01/Next_Button'), 0)

Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/PesitoCommission/Screenshot'), [('testCaseName') : 'TC_ID_435_Expected_Qty_Values'], FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/PesitoCommission/Screenshot'), [('testCaseName') : 'TC_ID_435_Expected_Values'], FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/PesitoCommission/Screenshot'), [('testCaseName') : 'TC_ID_435_Pestio_Checkbox_Checked'], FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/PesitoCommission/Screenshot'), [('testCaseName') : 'TC_ID_435_Partial_Invoice_Amount'], FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/PesitoCommission/Screenshot'), [('testCaseName') : 'TC_ID_435_Invoice_created_successfully'], FailureHandling.STOP_ON_FAILURE)
