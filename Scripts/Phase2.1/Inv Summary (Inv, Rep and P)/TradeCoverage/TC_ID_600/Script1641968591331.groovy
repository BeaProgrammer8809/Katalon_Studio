...
Mobile.setText(findTestObject('Object Repository/Phase2/BIInvoiceSummaryScreen/BIEnterTheFolioNoPopup01/FolioNo._EditText'), findTestData(
		'Phase2.1/TY_01/TestData2').getValue(2, 2), 0)
...
Mobile.setText(findTestObject('Phase2/BIInvoiceSummaryScreen/BIEnterTheFolioNoPopup01/Only_ProductBuying_InvQty/FolioProdBuy_EditText_Indexing'),
	findTestData('Phase2.1/TY_01/TestData2').getValue(3, 2), 0)
...
Mobile.verifyEqual(ActualFolioNowithSpecialcha, findTestData('Phase2.1/TY_01/TestData2').getValue(4, 2), FailureHandling.STOP_ON_FAILURE)

Mobile.verifyEqual(ActualFolioProBuyWithSpecialCha, findTestData('Phase2.1/TY_01/TestData2').getValue(5, 2), FailureHandling.STOP_ON_FAILURE)

println " “Folio No” & “Folio ProdBuy”fields should accept “_” Special Characters."
...
println "Invoice is generated and Given “Folio No” & “Folio ProdBuy” input is present in the Print Preview screen."

Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_600'],
