...
'entering amount in amount field for bimbo product'
...
def AmountEntered = Mobile.getText(findTestObject('Object Repository/Phase2/BIInvoiceSummaryScreen/BICollectionScreen01/Amount_EditText'), 
    0)

ExpectedAmount = findTestData('Phase2.1/TY_11/TestData').getValue(4, 58)

'verifying amount enterd in field is not equal to zero'
Mobile.verifyNotEqual(AmountEntered, ExpectedAmount, FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_159'], 
    FailureHandling.STOP_ON_FAILURE)
