...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_260'], 
    FailureHandling.STOP_ON_FAILURE)

Mobile.comment('Alert pop should come like " Do you want to delete payment transaction ?"')
...
Mobile.verifyElementText(findTestObject('Phase2/BICollectionScreen01/DeletePaymentPopup_Title/DeletePaymentPopup_Title'), 
    findTestData('Phase2.1/TY_06/Inv Summary (Inv, Rep and P)/TradeCoverage').getValue(2, 11))

Mobile.comment('Verification of Cancel Button')
...
Mobile.verifyElementText(findTestObject('Phase2/BICollectionScreen01/DeletePaymentPopup_Title/Cancel_ButtonDeletePaymentPopup'), 
    findTestData('Phase2.1/TY_06/Inv Summary (Inv, Rep and P)/TradeCoverage').getValue(5, 11))

Mobile.comment('Verification of Yes button')
...
Mobile.verifyElementText(findTestObject('Phase2/BICollectionScreen01/DeletePaymentPopup_Title/Yes_ButtonDeletePaymentPopup'), 
    findTestData('Phase2.1/TY_06/Inv Summary (Inv, Rep and P)/TradeCoverage').getValue(4, 11))
