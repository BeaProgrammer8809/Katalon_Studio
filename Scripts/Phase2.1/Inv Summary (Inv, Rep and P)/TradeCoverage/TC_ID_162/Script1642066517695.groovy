...
def creditlimit = Mobile.getText(findTestObject('Phase2/BIInvoiceSummaryScreen/BICollectionScreen01/PesitoCredit_TextView'), 
    0)
...
'Entering pesito amount more than pesito credit available'
Mobile.setText(findTestObject('Object Repository/Phase2/BIInvoiceSummaryScreen/BICollectionScreen01/Amount_EditText'), InvAmount1, 
    0)

Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_162'], 
    FailureHandling.STOP_ON_FAILURE)
...
ExpectedToastMessage = findTestData('Phase2.1/TY_11/TestData').getValue(4, 70) 
