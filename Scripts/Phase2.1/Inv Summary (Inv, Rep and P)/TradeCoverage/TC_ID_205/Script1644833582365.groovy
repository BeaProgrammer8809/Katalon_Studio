...
def expected_SelectedBranch = findTestData('Phase2.1/Common_Data/CommonData').getValue('Bank', 4)

Mobile.verifyMatch(actual_SelectedBranch, expected_SelectedBranch, false, FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_205'], 
    FailureHandling.STOP_ON_FAILURE)
