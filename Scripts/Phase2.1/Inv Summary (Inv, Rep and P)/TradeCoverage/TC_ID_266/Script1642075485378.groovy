...
def productName = findTestData('Phase2.1/Common_Data/CommonData').getValue(6, 30)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_266'],
...
Mobile.verifyMatch(findTestData('Phase2.1/TY_06/Inv Summary (Inv, Rep and P)/TradeCoverage').getValue(4, 16), LegalEntryWithAmountText.substring(
