...
'entering 4 digit folio number'
def expFolioNum = findTestData('Phase2.1/TY_11/TestData').getValue(4, 64)

def expFolioNumlength = expFolioNum.length()

println(expFolioNumlength)

//def ActualFolioNum = Mobile.getText(findTestObject('Phase2/BIInvoiceSummaryScreen/BIEnterTheFolioNoPopup01/FolioNo._EditText'),
//    0)
//
...
Mobile.sendKeys(findTestObject('Phase2/BIInvoiceSummaryScreen/BIEnterTheFolioNoPopup01/FolioNo._EditText'), findTestData(
        'Phase2.1/TY_11/TestData').getValue(4, 64))
...
ExpectedToastMessage = findTestData('Phase2.1/TY_11/TestData').getValue(5, 64)

println(ExpectedToastMessage)

Mobile.verifyMatch(actualtoastmessage, ExpectedToastMessage, false)

Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_180'], 
