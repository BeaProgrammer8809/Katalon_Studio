...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_183_effectivo'], 
...
'verifying collection screen not present to enter partial amount through effectivo  '
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_183_invSummary'], 
    FailureHandling.STOP_ON_FAILURE)
