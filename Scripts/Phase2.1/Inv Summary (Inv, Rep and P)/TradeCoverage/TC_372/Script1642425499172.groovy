...
Mobile.verifyElementNotExist(findTestObject('Phase2/BIDropdown/Dropdown_Name_Indexing'), 0)

GlobalVariable.DropdownName = findTestData('Phase2.1/Common_Data/CommonData').getValue('INE_Ambito', 1)

Mobile.verifyElementNotExist(findTestObject('Phase2/BIDropdown/Dropdown_Name_Indexing'), 0)

Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_372'],
	FailureHandling.STOP_ON_FAILURE)
