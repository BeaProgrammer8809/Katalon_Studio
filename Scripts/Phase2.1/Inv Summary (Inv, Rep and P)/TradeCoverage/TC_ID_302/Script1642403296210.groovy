...
Mobile.verifyEqual(totalPrice, valuePrice, FailureHandling.STOP_ON_FAILURE)

println('Tax mapped but reatiler is detail IEPS mapped So tax amount is zero')

def IEPS = findTestData('Phase2/TY_03/TestData_Phase2.1').getValue(7, 8)
...
Mobile.verifyNotEqual(valuePrice, expectedValuePrice, FailureHandling.STOP_ON_FAILURE)

println "Expected value price is different as Detail IEPS retailer is selected"

Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_302_SummaryScreen'],
	FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_302_printScreen'], 
    FailureHandling.STOP_ON_FAILURE)
...
println(tax)
 ...
 taxPercentage = findTestData('Phase2/TY_03/TestData_Phase2.1').getValue(4, 28)
...
println('Tax amount is not included for as detail IEPS is enabled for retailer')
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_302_printScreen_02'],
	FailureHandling.STOP_ON_FAILURE)
