...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_217'], 
    FailureHandling.STOP_ON_FAILURE)
...
def ExpectedErrormessage = findTestData('Phase2.1/TY_14/TestData').getValue('ToastMessage', 50)
...
expectedCollectionScreenTitle = findTestData('Phase2.1/TY_14/TestData').getValue('Title', 50)
