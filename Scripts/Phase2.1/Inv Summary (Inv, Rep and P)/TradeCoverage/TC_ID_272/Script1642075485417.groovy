...
'Amount Provided in Pesito mode'

def afterProvideamountText=Mobile.getText(findTestObject('Phase2/BIInvoiceSummaryScreen/BICollectionScreen01/Amount_EditText'),
	0)

double afterProvideamount=Double.parseDouble(afterProvideamountText)

Mobile.verifyNotMatch(PesitoAmountText, afterProvideamountText, false,FailureHandling.STOP_ON_FAILURE)

Mobile.verifyNotEqual(afterProvideamount, 0, FailureHandling.STOP_ON_FAILURE)

'Provide amount in Cheque mode'
...
Mobile.setText(findTestObject('Object Repository/Phase2/BICollectionScreen01/BIChequesScreen01/ChequeNum_EditText'), findTestData('Phase2.1/TY_06/Inv Summary (Inv, Rep and P)/TradeCoverage').getValue(
		4, 17), 0, FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_272'],
	FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('Phase2/BICollectionScreen01/Submit_Button'), 0)

Mobile.comment('User was able to submit so screen should be navigate to summary screen')
