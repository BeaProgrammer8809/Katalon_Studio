...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_189_InvoiceSummary'],
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_189_collection'],
	FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyEqual(Totalpaid, NetAmount, FailureHandling.STOP_ON_FAILURE)
