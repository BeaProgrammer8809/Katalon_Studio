...
Mobile.clearText(findTestObject('Object Repository/Phase2/BIInvoiceSummaryScreen/BICollectionScreen01/Amount_EditText'),
	0)
'Entering pesito amount less than  inv amount'
...
'veryfying Invoice summary title is present after pressing submit button on collection popup'
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_160_collection'],
	FailureHandling.STOP_ON_FAILURE)
