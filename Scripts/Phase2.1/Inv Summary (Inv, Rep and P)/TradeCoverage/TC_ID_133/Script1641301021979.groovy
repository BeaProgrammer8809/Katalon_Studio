...
def NetamountInSummary = Mobile.getText(findTestObject('Object Repository/Phase2/BIInvoiceSummaryScreen/Value_Value'), 
    0)
...
/*Verification done to check the Min. Amt displayed in the Transferencias Electronicas mode as same as Net amount in the Summary screen*/

def MinAmountInElectronicas = Mobile.getText(findTestObject('Object Repository/Phase2/BICollectionScreen01/MinAmt_Text'), 0)

Mobile.verifyMatch(NetamountInSummary, MinAmountInElectronicas, false, FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_133'],
