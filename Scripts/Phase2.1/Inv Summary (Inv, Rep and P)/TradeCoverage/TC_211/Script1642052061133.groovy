...
def Actual_ChequeNumberEntered = Mobile.getAttribute(findTestObject('Phase2/BICollectionScreen01/BIChequesScreen01/ChequeNum_EditText'), 
    'text', 0)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_211'],
	FailureHandling.STOP_ON_FAILURE)
