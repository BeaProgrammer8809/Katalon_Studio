...
def InAmount = Mobile.getText(findTestObject('Phase2/BICollectionScreen01/BIEfectivoScreen01/Amount_EditText'), 0)

/*def Invoiceamount =Double.parseDouble(InAmount)

def Actualvalue = Math.round(Invoiceamount)

int ActualInvoiceAmountInSummary  = (int)Actualvalue
*/

Integer length = InAmount.length()
...
/*Verification done to check the Min amount is displaying same as Net Amount in the Summary screen*/


def MinInvAmountInElectronicas = Mobile.getText(findTestObject('Object Repository/Phase2/BICollectionScreen01/InvAmt_TextView'), 0)


Mobile.verifyMatch(NetAmountInSummary, MinInvAmountInElectronicas, false, FailureHandling.STOP_ON_FAILURE)


Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_132'],
