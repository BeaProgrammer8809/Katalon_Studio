...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/TradeCovergae/Screenshot'), [('testCaseName') : 'TC_158_Collection'], FailureHandling.STOP_ON_FAILURE)
