...
def IEPS = findTestData('Phase2.1/TY_04/Phase2.1_Sheet2').getValue(16, 84)
...
Mobile.verifyMatch(Actual_Number.toString(), findTestData('Phase2.1/TY_04/Phase2.1_Sheet2').getValue(20, 84), false, 
    FailureHandling.STOP_ON_FAILURE)

    println('IEPS Tax is not added and not displayed in IEPS Tax section')

Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_346'], 
    FailureHandling.STOP_ON_FAILURE)
