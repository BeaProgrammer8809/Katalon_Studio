...
/*Verification done to check User should be able to select any bank branch from the dropdown (TC_ID_141)*/

GlobalVariable.DropdownName =  findTestData('Phase2.1/Common_Data/CommonData').getValue('Branch', 3)
 
def ExpectedBranchText = Mobile.getText(findTestObject('Object Repository/Phase2/BIDropdown/Dropdown_Name'), 0)

Mobile.verifyMatch(ExpectedBranchText, findTestData('Phase2.1/Common_Data/CommonData').getValue('Branch', 3), false , FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_141'],
	FailureHandling.STOP_ON_FAILURE)

/*Verification done  To check whether able to enter number in Reference no field(TC_ID_142)*/
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_142'],
	FailureHandling.STOP_ON_FAILURE)
