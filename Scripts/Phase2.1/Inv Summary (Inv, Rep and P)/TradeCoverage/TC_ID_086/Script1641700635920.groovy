...
def CompDiscText = CompDiscValue.replace(' ', '')
...
def TotalAmountvalue = Mobile.getText(findTestObject('Object Repository/Phase2/BIInvoiceSummaryScreen/BIAmountSplitUpPopup01/Total_Value'), 0)

def TotalAmount = Double.parseDouble(TotalAmountvalue).round(2)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_086'],
