...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_185_InvoiceSummary'],
...
Mobile.verifyEqual(NetAmount, InvAmount1, FailureHandling.STOP_ON_FAILURE)
