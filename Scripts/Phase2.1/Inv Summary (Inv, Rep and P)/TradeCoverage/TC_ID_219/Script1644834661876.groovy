...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_219'], 
    FailureHandling.STOP_ON_FAILURE)
...
def ExpectedTitle = findTestData('Phase2.1/TY_14/TestData').getValue('Title', 52)
