...
Mobile.setText(findTestObject('Object Repository/Phase2/BICollectionScreen01/BIChequesScreen01/Amount_EditText'), totalcheckamount.toString(), 0, FailureHandling.OPTIONAL)
...
/*Verification done to check the Select Cheque Type dropdown options having Foreign and Local Options*/
...
for(int i=0; i< dropList.size(); i++)
  {
	...
	switch(DropdownText)
	{
		  case findTestData('Phase2.1/Common_Data/CommonData').getValue('ChequeType', 1) :
		
		  Mobile.verifyMatch(DropdownText, findTestData('Phase2.1/Common_Data/CommonData').getValue('ChequeType', 1), false)
		 
	      break;
		  
		  case findTestData('Phase2.1/Common_Data/CommonData').getValue('ChequeType', 2) :
		   
	      Mobile.verifyMatch(DropdownText, findTestData('Phase2.1/Common_Data/CommonData').getValue('ChequeType', 2), false)
  ...
  Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_117'],
