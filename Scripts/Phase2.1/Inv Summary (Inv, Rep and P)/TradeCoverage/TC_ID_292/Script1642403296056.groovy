...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_292_SummaryScreen'],
	FailureHandling.STOP_ON_FAILURE)
...
println('Tax amount is not applied in invoice screen')
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_292_printScreen'], 
    FailureHandling.STOP_ON_FAILURE)
