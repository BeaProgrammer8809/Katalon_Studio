...
Mobile.verifyEqual(CashAmount, findTestData('Phase2.1/TY_05/Collection').getValue(4, 70), FailureHandling.STOP_ON_FAILURE)
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_157_BeforeInvoiceCollection'], FailureHandling.STOP_ON_FAILURE)
