...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_297_SummaryScreen'],
	FailureHandling.STOP_ON_FAILURE)
...
println('Tax amount is not displayed in invoice screen as for retailer detail IEPS flag is enabled')
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_297_printScreen'], 
    FailureHandling.STOP_ON_FAILURE)
