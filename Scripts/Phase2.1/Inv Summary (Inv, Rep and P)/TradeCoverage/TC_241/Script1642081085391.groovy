...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_241'],
	FailureHandling.STOP_ON_FAILURE)
...
def ExpectedErrormessage = findTestData('Phase2.1/TY_14/TestData').getValue('ToastMessage', 60)
...
expectedCollectionScreenTitle= findTestData('Phase2.1/TY_14/TestData').getValue('Title', 60)
