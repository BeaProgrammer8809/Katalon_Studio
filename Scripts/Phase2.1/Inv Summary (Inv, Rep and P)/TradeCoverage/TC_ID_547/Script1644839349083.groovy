...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_547'], 
...
def Expected_Print_Text = findTestData('Phase2.1/TestData/Test_Data').getValue('Expected Result2', 74)
...
Mobile.verifyMatch(RFC.toString(), findTestData('Phase2.1/TestData/Test_Data').getValue(5, 63), false, FailureHandling.STOP_ON_FAILURE)
