...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_221'],
	FailureHandling.STOP_ON_FAILURE)

def actualTitle = Mobile.getText(findTestObject('Phase2/BIEnterTheFolioNoPopup01/EnterTheFolioNumber_PopupTitle'), 
    0)

def ExpectedTitle = findTestData('Phase2.1/TY_14/TestData').getValue('Title', 54)
