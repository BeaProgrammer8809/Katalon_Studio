...
Mobile.verifyEqual(actualtoastmessage, findTestData('Phase2.1/TY_01/TestData2').getValue(4, 5), FailureHandling.STOP_ON_FAILURE)

println "“Folio No” & “Folio ProdBuy”fields is  mandatory"

Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_603'],
