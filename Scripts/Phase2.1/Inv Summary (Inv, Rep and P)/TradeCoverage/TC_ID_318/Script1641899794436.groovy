...
Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_318'], 
    FailureHandling.STOP_ON_FAILURE)
...
def Return_Value = Mobile.getText(findTestObject('Phase2/BIInvoiceSummaryScreen/BuySchemeDetails/Buy_Sales_Return_Value'), 0)
...
//Verification to check the Category Discounts for the SKU
...
//Verification of IEPS Tax in Print Preview screen
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_318'],
	FailureHandling.STOP_ON_FAILURE)
