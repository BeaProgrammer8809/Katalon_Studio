...
/*Verification done to check the error message is displaying or not */
...
def Expected_Toast_Message = findTestData('Phase2.1/TY_05/Testdata').getValue('Data1', 15)

Mobile.verifyMatch(Actual_Toast_Message, Expected_Toast_Message, false , FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_136'],
