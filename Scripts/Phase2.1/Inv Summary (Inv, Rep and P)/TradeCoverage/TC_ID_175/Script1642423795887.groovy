...
Mobile.verifyElementExist(findTestObject('Phase2/BIDeliveryFinalSummaryScreen/Efectivo_CheckBox'), 0, FailureHandling.STOP_ON_FAILURE)

Mobile.verifyElementVisible(findTestObject('Phase2/BIDeliveryFinalSummaryScreen/Efectivo_CheckBox'), 0, FailureHandling.STOP_ON_FAILURE)



Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_175'], 
