...
/*Verification done to check the Select Branch field is displaying after selecting any bank */
...
Mobile.verifyElementText(findTestObject('Object Repository/Phase2/BIDropdown/Dropdown_Name'), findTestData('Phase2.1/Common_Data/CommonData').getValue('DropdownName', 2))

/*Verification done to check Select branch is a mandatory field this can be done by checking the error message */
...
def Expected_Toast_Message = findTestData('Phase2.1/TY_05/Testdata').getValue('Data1', 9)

Mobile.verifyMatch(Actual_Toast_Message, Expected_Toast_Message, false,FailureHandling.STOP_ON_FAILURE)


Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_114'],
