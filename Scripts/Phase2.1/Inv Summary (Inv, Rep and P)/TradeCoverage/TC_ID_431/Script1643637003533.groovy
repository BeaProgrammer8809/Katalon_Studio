...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_431_Actual_Pieces_Value'], FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_431_Actual_Return_Qty'], FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_431_Actual_PB_Qty'], FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_431_Expected_Values'], FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_431_Actual_Folio_Text'], FailureHandling.STOP_ON_FAILURE)
...
def Folio_Text = findTestData('Phase2.1/TY_02/Test_Data_Phase2').getValue(6, 234)
def ProdBuy_Text = findTestData('Phase2.1/TY_02/Test_Data_Phase2').getValue(6, 234)
...
Mobile.verifyMatch(Expected_Folio_Text.toString(), findTestData('Phase2.1/TY_02/Test_Data_Phase2').getValue(7, 234), false, FailureHandling.STOP_ON_FAILURE)
Mobile.verifyMatch(Actual_ProdBuy_Text.toString(), findTestData('Phase2.1/TY_02/Test_Data_Phase2').getValue(7, 234), false, FailureHandling.STOP_ON_FAILURE)
