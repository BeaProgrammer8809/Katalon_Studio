...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/BeforeInvoiceCollection/Screenshot'), [('testCaseName') : 'TC_ID_446_Actual_Pieces_Value'], FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/BeforeInvoiceCollection/Screenshot'), [('testCaseName') : 'TC_ID_446_Expected_Values'], FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/BeforeInvoiceCollection/Screenshot'), [('testCaseName') : 'TC_ID_446_Full_Invoice_Amount'], FailureHandling.STOP_ON_FAILURE)

//Verification to check that "$3 dollar" is automatically displayed in Cheque mode
...
def Actual_Dollar_Amt=Mobile.getText(findTestObject('Phase2/BICollectionScreen01/BIChequesScreen01/Amount_EditText'), 0)
def Expected_Dollar_Amt=findTestData('Phase2.1/TY_02/Test_Data_Phase2').getValue(4, 71)

//Verification to check that Dollar amount displayed in Efectivo mode is as Expected
Mobile.verifyEqual(Actual_Dollar_Amt, Expected_Dollar_Amt, FailureHandling.STOP_ON_FAILURE)
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/BeforeInvoiceCollection/Screenshot'), [('testCaseName') : 'TC_ID_446_$3_Automatically_Displayed_In_Cheque_Mode'], FailureHandling.STOP_ON_FAILURE)
...
def Expected_Dollar_Amt1=findTestData('Phase2.1/TY_02/Test_Data_Phase2').getValue(5, 71)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/BeforeInvoiceCollection/Screenshot'), [('testCaseName') : 'TC_ID_447_$3__Is_Not_Automatically_Displayed_In_TransferenciasElectronicas_Mode'], FailureHandling.STOP_ON_FAILURE)
