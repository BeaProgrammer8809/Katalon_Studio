...
def Changeref= Mobile.getText(findTestObject('Object Repository/Phase2/BICollectionScreen01/BITransferenciasElectronicasScreen01/ReferenceNum_EditText'), 0)


Mobile.verifyNotMatch(refnumtext, Changeref, false)
...
println "User Should able to change the “RTGS Ref No” after submit."

Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/BeforeInvoiceCollection/Screenshot'), [('testCaseName') : 'TC_502_Collection'],
