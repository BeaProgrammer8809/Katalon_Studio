...
Mobile.setText(findTestObject('Object Repository/Phase2/BICollectionScreen01/BITransferenciasElectronicasScreen01/ReferenceNum_EditText'), findTestData('Phase2.1/TY_05/Collection').getValue(3, 76), 0)
...
def refnumber= findTestData('Phase2.1/TY_05/Collection').getValue(3, 76)

Mobile.verifyMatch(refnumber, refnumtext, false, FailureHandling.STOP_ON_FAILURE)
...
println "Reference number field should accepts the Spanish characters with data length less than or equal to 30.."

Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/BeforeInvoiceCollection/Screenshot'), [('testCaseName') : 'TC_497_Collection'],
