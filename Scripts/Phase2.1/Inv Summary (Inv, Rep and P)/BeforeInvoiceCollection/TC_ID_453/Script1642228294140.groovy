...
def Expected_Toast_Message = findTestData('Phase2.1/TY_02/Test_Data_Phase2').getValue(4, 78)
...
Mobile.verifyMatch(value.toString(), findTestData('Phase2.1/TY_02/Test_Data_Phase2').getValue(7, 78), false, FailureHandling.STOP_ON_FAILURE)
