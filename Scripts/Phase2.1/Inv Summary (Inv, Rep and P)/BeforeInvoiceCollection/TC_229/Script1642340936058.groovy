...
Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC_229_AmountSplitUp'], FailureHandling.STOP_ON_FAILURE)
