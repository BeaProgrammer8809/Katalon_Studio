...
def refnumber= findTestData('Phase2.1/TY_05/Collection').getValue(4, 76)
...
println "Reference number” field should not accepts the Spanish characters with data length more than 30."

Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/BeforeInvoiceCollection/Screenshot'), [('testCaseName') : 'TC_498_Collection'],
