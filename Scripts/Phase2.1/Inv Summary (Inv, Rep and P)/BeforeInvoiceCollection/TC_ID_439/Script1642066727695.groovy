...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/BeforeInvoiceCollection/Screenshot'), [('testCaseName') : 'TC_ID_439_Pestio_Radio_Button_Not_Displayed'], FailureHandling.STOP_ON_FAILURE)
