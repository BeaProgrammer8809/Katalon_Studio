...
def refnumber= findTestData('Phase2.1/TY_05/Collection').getValue(3, 68)

Mobile.verifyNotMatch(refnumber, refnumtext, false, FailureHandling.STOP_ON_FAILURE)

//Mobile.verifyElementAttributeValue(findTestObject('Object Repository/Phase2/BICollectionScreen01/BITransferenciasElectronicasScreen01/ReferenceNum_EditText'), 'text', findTestData('Phase2.1/TY_05/Collection').getValue(3, 67), 0, FailureHandling.STOP_ON_FAILURE)

println "Reference number field should not accepts more than 30 characters."

Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/BeforeInvoiceCollection/Screenshot'), [('testCaseName') : 'TC_495_Collection'],
