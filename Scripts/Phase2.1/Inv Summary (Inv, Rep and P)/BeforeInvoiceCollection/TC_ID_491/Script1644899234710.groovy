...
def RefNumber= findTestData('Phase2.1/TY_05/Collection').getValue(3, 62)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/BeforeInvoiceCollection/Screenshot'), [('testCaseName') : 'TC_491_Collection'],
