...
//Mobile.setText(findTestObject('Object Repository/Phase2/BICollectionScreen01/BITransferenciasElectronicasScreen01/ReferenceNum_EditText'), findTestData('Phase2.1/TY_05/Collection').getValue(3, 68), 0)
...
def Expectedtoastmessage = findTestData('Phase2.1/TY_05/Collection').getValue(3, 65)
...
println "Reference number” field should not accepts Empty spaces as input."

Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/BeforeInvoiceCollection/Screenshot'), [('testCaseName') : 'TC_496_Collection'],
