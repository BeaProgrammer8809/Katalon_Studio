...
//Verification to check that Current day Retailer is not planned for the route.
Mobile.verifyElementVisible(findTestObject('Object Repository/Phase2/BITradeCoverage01/Arrow_iconInStore'), 0, FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/PesitoCommission/Screenshot'), [('testCaseName') : 'TC_ID_437_Actual_Pieces_Value'], FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('Object Repository/Phase2/BIOrderAndInvoiceScreen01/Next_Button'), 0)
Mobile.tap(findTestObject('Object Repository/Phase2/BIProductBuyingScreen01/Next_Button'), 0)

Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/PesitoCommission/Screenshot'), [('testCaseName') : 'TC_ID_437_Expected_Qty_Values'], FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/PesitoCommission/Screenshot'), [('testCaseName') : 'TC_ID_437_Expected_Values'], FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/PesitoCommission/Screenshot'), [('testCaseName') : 'TC_ID_437_Pesito_Radio_Button_Selected'], FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/PesitoCommission/Screenshot'), [('testCaseName') : 'TC_ID_437_Partial_Invoice_Amount'], FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/PesitoCommission/Screenshot'), [('testCaseName') : 'TC_ID_437_3_Dollar'], FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyElementVisible(findTestObject('Object Repository/Phase2/BIInvoiceSummaryScreen/Invoice_Summary_Save_PopUp_Ok_Button'), 0, FailureHandling.STOP_ON_FAILURE)
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/PesitoCommission/Screenshot'), [('testCaseName') : 'TC_ID_437_Invoice_Created_Successfully_Popup'], FailureHandling.STOP_ON_FAILURE)
