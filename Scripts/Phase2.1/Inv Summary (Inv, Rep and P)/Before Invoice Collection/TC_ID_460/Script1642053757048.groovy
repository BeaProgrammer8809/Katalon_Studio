...
Mobile.verifyMatch(actualtoastmessage, findTestData('Phase2.1/TY_01/TestData2').getValue(4, 9), false, FailureHandling.STOP_ON_FAILURE)

println "Tost message is verified"


Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/Before Invoice Collection/Screenshot'), [('testCaseName') : 'TC_ID_460'],
	FailureHandling.STOP_ON_FAILURE)
