...
def transfAmt = Mobile.getText(findTestObject('Phase2/BINumberKeyboardCollection01/1_NumButton'), 0)
...
println('Since cheque and transfercia mode accepted amount submitted and Enter folio popupdisplayed')

String Actual = Mobile.getText(findTestObject('Phase2/BIInvoiceSummaryScreen/BIEnterTheFolioNoPopup01/EnterTheFolioNumber_PopupTitle'), 
    0, FailureHandling.STOP_ON_FAILURE)

Mobile.verifyEqual(Actual, findTestData('Phase2.1/TestData/Test_Data').getValue(2, 58), FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/Collection/Screenshot'), [('testCaseName') : 'TC_515'], 
