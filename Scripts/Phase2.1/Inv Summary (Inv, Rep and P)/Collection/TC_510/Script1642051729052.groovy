...
def refrence = Mobile.getText(findTestObject('Phase2/BICollectionScreen01/BITransferenciasElectronicasScreen01/ReferenceNum_EditText'), 0)
...
def refrence1 = Mobile.getText(findTestObject('Phase2/BICollectionScreen01/BITransferenciasElectronicasScreen01/ReferenceNum_EditText'), 0)


def Expected=findTestData('Phase2.1/TestData/Test_Data').getValue(2, 49)

Mobile.verifyMatch(actualtoastmessage, Expected, false)

Mobile.verifyEqual(refrence, refrence1, FailureHandling.STOP_ON_FAILURE)
println("refrence number filed is empty ")


Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/Collection/Screenshot'), [('testCaseName') : 'TC_510'], 
