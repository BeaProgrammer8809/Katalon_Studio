...
def Amt2 = Mobile.getText(findTestObject('Phase2/BIInvoiceSummaryScreen/BICollectionScreen01/Amount_EditText'),0)


Mobile.tap(findTestObject('Phase2/BIInvoiceSummaryScreen/BICollectionScreen01/Submit_Button'), 0)
println("RTGS amount edited and able to submit ")
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/Collection/Screenshot'), [('testCaseName') : 'TC_522'], 
    FailureHandling.STOP_ON_FAILURE)

Mobile.verifyNotEqual(TransAMt1, Amt2, FailureHandling.STOP_ON_FAILURE)
println('RTGS Amount edited  after submit hence both are not equal')
