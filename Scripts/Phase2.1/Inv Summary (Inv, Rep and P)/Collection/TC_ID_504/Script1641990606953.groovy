...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/Collection/Screenshot'), [('testCaseName') : 'TC_ID_504'], 
    FailureHandling.STOP_ON_FAILURE)

Mobile.comment('Verifying the Alert Msg')

Mobile.verifyMatch(actualtoastmessage, findTestData('Phase2.1/TY_06/Inv Summary (Inv, Rep and P)/Collection').getValue(4, 
