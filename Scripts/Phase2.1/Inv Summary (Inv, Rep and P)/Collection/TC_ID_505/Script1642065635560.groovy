...
Mobile.setText(findTestObject('Object Repository/Phase2/BICollectionScreen01/BITransferenciasElectronicasScreen01/ReferenceNum_EditText'), 
    findTestData('Phase2.1/TY_06/Inv Summary (Inv, Rep and P)/Collection').getValue(4, 2), 0)
...
AmtText = Mobile.getText(findTestObject('Phase2/BICollectionScreen01/BIEfectivoScreen01/Amount_EditText'), 0)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/Collection/Screenshot'), [('testCaseName') : 'TC_ID_505(1)'], 
    FailureHandling.STOP_ON_FAILURE)

def AmountAfterUpdate = Mobile.getText(findTestObject('Phase2/BICollectionScreen01/BITransferenciasElectronicasScreen01/Amount_EditText'), 
    0)
...
Mobile.comment('User Should able to edit the “RTGS Amount” after submit.')

Mobile.verifyNotMatch(AmountBeforeUpdate, AmountAfterUpdate, false)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/Collection/Screenshot'), [('testCaseName') : 'TC_ID_505(2)'], 
    FailureHandling.STOP_ON_FAILURE)
