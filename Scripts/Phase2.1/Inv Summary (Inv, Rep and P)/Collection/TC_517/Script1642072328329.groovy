...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/Collection/Screenshot'), [('testCaseName') : 'TC_517'], 
    FailureHandling.STOP_ON_FAILURE)

Mobile.verifyEqual(InvoiceAmount, TransAMt)
println("Total invoice amount submitted in RTGS mode")
