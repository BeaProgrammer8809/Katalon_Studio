...
def reference2=Mobile.getText(findTestObject('Phase2/BICollectionScreen01/BITransferenciasElectronicasScreen01/ReferenceNum_EditText'), 0)

Mobile.tap(findTestObject('Phase2/BIInvoiceSummaryScreen/BICollectionScreen01/Submit_Button'), 0)
println("Since all reference numbers are different able to do submit RTGS amount")

Mobile.verifyNotEqual(reference, reference1, FailureHandling.STOP_ON_FAILURE)
Mobile.verifyNotEqual(reference2, reference1, FailureHandling.STOP_ON_FAILURE)

//Mobile.verifyEqual(actualtoastmessage, findTestData('Phase2.1/TestData/Test_Data').getValue(4, 47), FailureHandling.STOP_ON_FAILURE)


Mobile.verifyEqual(mode, findTestData('Phase2.1/TestData/Test_Data').getValue(3, 44), FailureHandling.STOP_ON_FAILURE)


Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/Collection/Screenshot'), [('testCaseName') : 'TC_523'],
