...
Mobile.setText(findTestObject('Object Repository/Phase2/BICollectionScreen01/BITransferenciasElectronicasScreen01/ReferenceNum_EditText'), 
    findTestData('Phase2.1/TY_06/Inv Summary (Inv, Rep and P)/Collection').getValue(4, 4), 0)

Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/Collection/Screenshot'), [('testCaseName') : 'TC_ID_507(1)'], 
...
Mobile.verifyMatch(findTestData('Phase2.1/TY_06/Inv Summary (Inv, Rep and P)/Collection').getValue(4, 4), ReferenceNo, false, 
    FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyElementText(findTestObject('Phase2/BIInvoiceSummaryScreen/BIEnterTheFolioNoPopup01/EnterTheFolioNumber_PopupTitle'), 
    findTestData('Phase2.1/TY_06/Inv Summary (Inv, Rep and P)/Collection').getValue(2, 4))
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/Collection/Screenshot'), [('testCaseName') : 'TC_ID_507(2)'], 
    FailureHandling.STOP_ON_FAILURE)
