...
Mobile.checkElement(findTestObject('Phase2/BIOrderAndInvoiceScreen01/Cancel_Button'), 0)
...
Mobile.setText(findTestObject('Phase2/BIInvoiceSummaryScreen/BIEnterTheFolioNoPopup01/FolioProdBuy_Indexing'), findTestData(
		'Phase2.1/TY_13/Inv Summary (Inv, Rep and P').getValue(3, 27), 0)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/Trade coverage/Screenshot'), [('testCaseName') : 'TC_ID_417EnteredfolioNo'],
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/Trade coverage/Screenshot'), [('testCaseName') : 'TC_ID_417PrintPreviewScreen'],
	FailureHandling.STOP_ON_FAILURE)

println('FolioNo and Folio ProdBuy Field is present under each legal entity and it is accepting "-" and "_" special cahracters .')
