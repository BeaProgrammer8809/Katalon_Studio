...
Mobile.verifyNotMatch(ActualFolioNo, findTestData('Phase2.1/TY_13/Inv Summary (Inv, Rep and P').getValue(3, 9), false)
...
Mobile.verifyNotMatch(ActualFolioProdBuy, findTestData('Phase2.1/TY_13/Inv Summary (Inv, Rep and P').getValue(3, 9), false)

Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/Trade coverage/Screenshot'), [('testCaseName') : 'TC_ID_396AcceptedFolioInput'],
	FailureHandling.STOP_ON_FAILURE)
...
// Expected toast msg
def ExpectedToastMsg = findTestData('Phase2.1/TY_13/Inv Summary (Inv, Rep and P').getValue(4, 9)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/Trade coverage/Screenshot'), [('testCaseName') : 'TC_ID_396ToastMsg'],
	FailureHandling.STOP_ON_FAILURE)

println('We cannot enter Space and click on OK button for FolioNo and FolioProdBuy')
