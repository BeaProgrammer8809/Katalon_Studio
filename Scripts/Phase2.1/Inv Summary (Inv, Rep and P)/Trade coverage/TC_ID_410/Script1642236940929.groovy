...
// Expected toast msg
def ExpectedToastMsg = findTestData('Phase2.1/TY_13/Inv Summary (Inv, Rep and P').getValue(4, 23)

println(ExpectedToastMsg + '--Expected toast msg')

Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/Trade coverage/Screenshot'), [('testCaseName') : 'TC_ID_410ToastMsg'],
...
println('We cannot keep the FolioNo and Folio ProdBuy fields empty and click on OK button.')
