...
import com.google.errorprone.annotations.Var as Var
...
Mobile.callTestCase(findTestCase('Reusable Cases/Mobile/Phase2.1/Trade_Coverage_Generic'), [('retailerName') : findTestData(
            'Phase2.1/Common_Data/CommonData').getValue(3, 8)], FailureHandling.STOP_ON_FAILURE)
...
Mobile.setText(findTestObject('Phase2/BIEnterTheFolioNoPopup01/FolioNo._EditText'), findTestData('Phase2.1/TY_12/Inv Summary (Inv, Rep and P)/TestData').getValue(
        2, 5), 0)

Mobile.tap(findTestObject('Phase2/BIEnterTheFolioNoPopup01/FolioProdBuy_EditText'), 0)

Mobile.setText(findTestObject('Phase2/BIEnterTheFolioNoPopup01/FolioProdBuy_EditText'), findTestData('Phase2.1/TY_12/Inv Summary (Inv, Rep and P)/TestData').getValue(
        3, 5), 0)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_552'],
...
def Expected_Print_Text = findTestData('Phase2.1/TY_12/Inv Summary (Inv, Rep and P)/TestData').getValue(4, 5)

println(Expected_Print_Text + 'Expected_Print_Text')

boolean RFC = ActualPrinttext.contains(Expected_Print_Text)

Mobile.verifyMatch(RFC.toString(), findTestData('Phase2.1/TY_12/Inv Summary (Inv, Rep and P)/TestData').getValue(5, 5), 
