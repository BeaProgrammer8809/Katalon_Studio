...
Mobile.setText(findTestObject('Phase2/BIInvoiceSummaryScreen/BIEnterTheFolioNoPopup01/FolioProdBuy_EditText'), findTestData(
		'Phase2.1/TY_13/Inv Summary (Inv, Rep and P').getValue(3, 30), 0)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/Trade coverage/Screenshot'), [('testCaseName') : 'TC_ID_418folioNo&FilioProdBuy'],
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/Trade coverage/Screenshot'), [('testCaseName') : 'TC_ID_418PrintPreviewScreen'],
	FailureHandling.STOP_ON_FAILURE)

println('Folio ProdBuy is present under Ricilino Legal Entity and FolioNo is present under Bimbo Legal entity and it is accepting "-" and "_" special cahracters .')
