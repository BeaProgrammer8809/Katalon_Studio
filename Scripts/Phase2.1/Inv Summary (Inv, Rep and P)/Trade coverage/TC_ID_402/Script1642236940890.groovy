...
Mobile.verifyElementVisible(findTestObject('Phase2/BIInvoiceSummaryScreen/BIEnterTheFolioNoPopup01/FolioProdBuy_Indexing'),
	0)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/Trade coverage/Screenshot'), [('testCaseName') : 'TC_ID_402PrintPreviewScreen'],
	FailureHandling.STOP_ON_FAILURE)

println('FolioNo Field is present under each legal entity in the \'Enter the folio number pop-up\' .')
