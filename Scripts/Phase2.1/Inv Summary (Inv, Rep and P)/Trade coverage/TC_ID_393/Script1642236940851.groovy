...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/Trade coverage/Screenshot'), [('testCaseName') : 'TC_ID_393EnteredFolioInput'],
	FailureHandling.STOP_ON_FAILURE)
...
// Expected toast msg
def ExpectedToastMsg = findTestData('Phase2.1/TY_13/Inv Summary (Inv, Rep and P').getValue(4, 6)
...
println("We cannot keep the FolioNo empty and click on ok Button ")
