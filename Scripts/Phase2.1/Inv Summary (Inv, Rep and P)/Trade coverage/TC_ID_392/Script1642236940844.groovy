...
//
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/Trade coverage/Screenshot'), [('testCaseName') : 'TC_ID_392AcceptedFolioInput'],
	FailureHandling.STOP_ON_FAILURE)

def ExpectedText = findTestData('Phase2.1/TY_13/Inv Summary (Inv, Rep and P').getValue(3, 5)
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_392PrintPreviewScreen'],
	FailureHandling.STOP_ON_FAILURE)
...
def Expected_Print_Text = findTestData('Phase2.1/TY_13/Inv Summary (Inv, Rep and P').getValue(3, 5)

println(Expected_Print_Text + 'Expected_Print_Text')

boolean FOLIO = ActualPrinttext.contains(Expected_Print_Text)

Mobile.verifyMatch(FOLIO.toString(), findTestData('Phase2.1/TY_13/Inv Summary (Inv, Rep and P').getValue(6, 5), false, FailureHandling.STOP_ON_FAILURE)
