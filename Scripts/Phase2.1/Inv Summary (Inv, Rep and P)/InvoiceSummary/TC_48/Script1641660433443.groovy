...
def ItemAndCategoryDiscs = ItemAndCategoryDisc23.replaceAll(' ', '')
println(ItemAndCategoryDiscs)

Double ItemAndCategoryDiscss = ((ItemAndCategoryDiscs) as Double)
...
Mobile.setText(findTestObject('Phase2/BIInvoiceSummaryScreen/BIEnterTheFolioNoPopup01/FolioNo._EditText'), findTestData(
		'Phase2.1/TestData/Test_Data').getValue(2, 47), 0)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC_48'], FailureHandling.STOP_ON_FAILURE)
