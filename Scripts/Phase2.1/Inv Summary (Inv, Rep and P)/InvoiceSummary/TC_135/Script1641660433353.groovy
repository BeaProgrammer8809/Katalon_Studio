...
println('Since DiscountedSKUPrice1 and TotalValue1 are  equal tax is not mapped')

Mobile.verifyNotEqual(SkuGross, DiscountedSKUPrice1, FailureHandling.STOP_ON_FAILURE)
println('Since SkuGross and DiscountedSKUPrice1 are  not equal Item and Category  discounts are   mapped')

Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC_135'], FailureHandling.STOP_ON_FAILURE)
