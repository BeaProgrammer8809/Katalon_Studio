...
println('Since SkuGross and DiscountedSKUPrice1 are not  equal Item   discounts is not  mapped')

Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC_138'], FailureHandling.STOP_ON_FAILURE)
