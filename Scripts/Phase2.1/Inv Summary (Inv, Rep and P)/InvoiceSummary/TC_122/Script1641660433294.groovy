...
String ordervalue11 = Mobile.getText(findTestObject('Phase2/BIInvoiceSummaryScreen/BIAmountSplitUpPopup01/OrderValue_Value'),
	0)

def ordervalue1=Double.parseDouble(ordervalue11)
println(ordervalue1)
...
def ItemDisc9=ItemDisc.split('-')
def ItemDisc01 =ItemDisc9[1]
def ItemDiscs = ItemDisc01.replaceAll(' ', '')
println(ItemDiscs)
...
Mobile.verifyEqual(ordervalue1, OrderValue, FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC_122'], FailureHandling.STOP_ON_FAILURE)
