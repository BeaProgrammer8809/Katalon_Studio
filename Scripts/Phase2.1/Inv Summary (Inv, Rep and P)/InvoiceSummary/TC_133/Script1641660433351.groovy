...
println('Since SkuGross and DiscountedSKUPrice1 are  not equal Item  discounts are   mapped')

Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC_133'], FailureHandling.STOP_ON_FAILURE)
