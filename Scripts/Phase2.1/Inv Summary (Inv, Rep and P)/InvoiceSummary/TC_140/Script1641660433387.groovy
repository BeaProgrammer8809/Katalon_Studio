...
println('Since DiscountedSKUPrice1 and TotalValue1 are not  equal tax  mapped')

Mobile.verifyNotEqual(SkuGross, DiscountedSKUPrice1, FailureHandling.STOP_ON_FAILURE)
println('Since SkuGross and DiscountedSKUPrice1 are not  equal  CategoryAndItem  discounts are   mapped')

Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC_140'], FailureHandling.STOP_ON_FAILURE)
