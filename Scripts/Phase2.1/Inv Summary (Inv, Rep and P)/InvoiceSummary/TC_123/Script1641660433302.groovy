...
GlobalVariable.ProductName = findTestData('Phase2.1/CommonData/CommonData').getValue('ProductName', 22)
...
def Category = Mobile.getText(findTestObject('Object Repository/Phase2/BIInvoiceSummaryScreen/BIAmountSplitUpPopup01/CompDisc_Value'), 
    0)

def Category9=Category.split('-')
def Category90 =Category9[1]
def CategoryDic = Category90.replaceAll(' ', '')
println(CategoryDic)

Double CategoryDicount = ((CategoryDic) as Double)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC_123'], FailureHandling.STOP_ON_FAILURE)
