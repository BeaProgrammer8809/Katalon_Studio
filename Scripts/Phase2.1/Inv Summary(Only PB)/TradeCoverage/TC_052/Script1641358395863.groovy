...
for(int i=0;i<=9;i++){
	...
	Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary(Only PB)/TradeCoverage/Screenshot'), ["testCaseName":"TC_052($i+1)"], FailureHandling.STOP_ON_FAILURE)
	
}

//println(' 0-9 values are allowed to enter into Piece Field')

//Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary(Only PB)/TradeCoverage/Screenshot'), ["testCaseName":"TC_052_invoiceSummary"], FailureHandling.STOP_ON_FAILURE)
