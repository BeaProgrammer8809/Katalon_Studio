...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary(Only PB)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_062'], 
    FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyElementText(findTestObject('Phase2/BIInvoiceSummaryScreen/BIEnterTheFolioNoPopup01/EnterTheFolioNumber_PopupTitle'), 
    findTestData('Phase2.1/TY_06/Trade_Coverage/Invoice_Summary/Invoice_Summary01').getValue(2, 3), FailureHandling.STOP_ON_FAILURE)

Mobile.comment('Verifying  barcel sa de c.v')
...
Mobile.verifyElementText(findTestObject('Phase2/BIInvoiceSummaryScreen/BIEnterPaymentPopup01/LegalEntryName_TextView'), 
    findTestData('Phase2.1/TY_06/Trade_Coverage/Invoice_Summary/Invoice_Summary01').getValue(3, 3), FailureHandling.STOP_ON_FAILURE)
