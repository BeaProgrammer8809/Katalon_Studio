...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary(Only PB)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_384_Expected_Total_Amount'], FailureHandling.STOP_ON_FAILURE)
