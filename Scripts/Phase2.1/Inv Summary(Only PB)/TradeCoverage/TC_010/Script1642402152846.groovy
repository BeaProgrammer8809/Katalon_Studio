...
def Actaul_Unit_Price= Mobile.getText(findTestObject('Object Repository/Phase2/BIInvoiceSummaryScreen/BISummaryProductDetails/U.Price_Value_Indexing'), 0)

//Verification to check the Invoice Qty SRP
Mobile.verifyEqual(Actual_SRP_Value, Actual_PB_SRP_Value, FailureHandling.STOP_ON_FAILURE)

//Verification to check the Invoice Qty SRP
Mobile.verifyEqual(Actual_SRP_Value, Actaul_Unit_Price, FailureHandling.STOP_ON_FAILURE)
