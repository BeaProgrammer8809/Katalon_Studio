...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary(Only PB)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_378_Efectivo Checkbox_Checked'], FailureHandling.STOP_ON_FAILURE)
