...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary(Only PB)/TradeCoverage/Screenshot'), ["testCaseName":"TC_053_invoiceSummary"], FailureHandling.STOP_ON_FAILURE)
