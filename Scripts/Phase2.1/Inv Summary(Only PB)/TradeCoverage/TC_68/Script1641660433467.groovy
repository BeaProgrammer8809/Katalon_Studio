...
//        'Phase2.1/TestData/Test_Data').getValue(2, 31), 0)

Mobile.sendKeys(findTestObject('Phase2/BIInvoiceSummaryScreen/BIEnterTheFolioNoPopup01/Only_ProductBuying_InvQty/FolioProdBuy_EditText'), 
    'aB1 2.1', FailureHandling.STOP_ON_FAILURE)
