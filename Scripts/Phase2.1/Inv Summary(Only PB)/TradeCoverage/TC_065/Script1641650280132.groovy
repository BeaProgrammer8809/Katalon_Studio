...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary(Only PB)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_065'], 
    FailureHandling.STOP_ON_FAILURE)
...
Mobile.setText(findTestObject('Phase2/BIInvoiceSummaryScreen/BIEnterTheFolioNoPopup01/FolioProdBuy_EditText'), findTestData(
        'Phase2.1/TY_06/Trade_Coverage/Invoice_Summary/Invoice_Summary01').getValue(4, 6), 0)

Mobile.delay(2, FailureHandling.STOP_ON_FAILURE)

def folioNo = Mobile.getText(findTestObject('Phase2/BIInvoiceSummaryScreen/BIEnterTheFolioNoPopup01/FolioProdBuy_EditText'), 
    0)

int length = folioNo.length()

def expFolioNo = findTestData('Phase2.1/TY_06/Trade_Coverage/Invoice_Summary/Invoice_Summary01').getValue(3, 6)

int explength = expFolioNo.length()

Mobile.verifyEqual(length, explength, FailureHandling.STOP_ON_FAILURE)

Mobile.verifyMatch(folioNo, expFolioNo, false, FailureHandling.STOP_ON_FAILURE)
