...
def Actual_SIH = Mobile.getText(findTestObject('Phase2/BIUnload/NonSalable/SIH_Indexing'), 0)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary(Only PB)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_048_invoiceSummary'], 
