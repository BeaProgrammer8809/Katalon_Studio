...
productName = findTestData('Phase2.1/Common_Data/CommonData').getValue(6, 27)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary(Only PB)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_063'], 
    FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyElementText(findTestObject('Phase2/BIInvoiceSummaryScreen/BIEnterTheFolioNoPopup01/EnterTheFolioNumber_PopupTitle'), 
    findTestData('Phase2.1/TY_06/Trade_Coverage/Invoice_Summary/Invoice_Summary01').getValue(2, 4), FailureHandling.STOP_ON_FAILURE)

Mobile.comment('Verifying Producto reclino sa PI  de c.v')
...
Mobile.verifyElementText(findTestObject('Phase2/BIInvoiceSummaryScreen/BIEnterPaymentPopup01/LegalEntryName_TextView'), 
    findTestData('Phase2.1/TY_06/Trade_Coverage/Invoice_Summary/Invoice_Summary01').getValue(3, 4), FailureHandling.STOP_ON_FAILURE)
