...
Mobile.tap(findTestObject('Object Repository/Phase2/BIUnload/Salable/Salable_Action_Bar'), 0)
...
Mobile.tap(findTestObject('Object Repository/Phase2/BINumberPad/Num- 9'), 0)

Mobile.tap(findTestObject('Object Repository/Phase2/BINumberPad/Num- 7'), 0)
...
Mobile.tap(findTestObject('Object Repository/Phase2/BIUnload/Back_Button'), 0)

Mobile.verifyElementNotVisible(findTestObject('Object Repository/Phase2/BIUnload/Salable/Product_Name_Specific_Sku'), 0)

Mobile.verifyElementNotExist(findTestObject('Object Repository/Phase2/BIUnload/Salable/Product_Name_Specific_Sku'), 0)

def Expected= findTestData('Phase2.1/TY_05/Collection').getValue(3, 43)
