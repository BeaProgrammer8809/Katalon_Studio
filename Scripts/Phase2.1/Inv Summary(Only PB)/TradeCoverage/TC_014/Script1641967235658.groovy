...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary(Only PB)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_014_Amount_Split_PopUp'], 
    FailureHandling.STOP_ON_FAILURE)

println('Amount split up POPUP is opened')
