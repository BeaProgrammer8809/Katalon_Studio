...
Mobile.setText(findTestObject('Phase2/BIInvoiceSummaryScreen/BIEnterTheFolioNoPopup01/Only_ProductBuying_InvQty/FolioNo._EditText_Indexing'), 
    findTestData('Phase2.1/TestData/Test_Data').getValue(2, 31), 0)
...
Mobile.verifyEqual(actualtoastmessage, findTestData('Phase2.1/TestData/Test_Data').getValue(3, 31), FailureHandling.STOP_ON_FAILURE)

//Mobile.verifyEqual(Actual, findTestData('Phase2.1/TY_08/ScriptsData').getValue(3, 31), FailureHandling.STOP_ON_FAILURE)
//Mobile.verifyEqual(schemeBuyQty, InvQty, FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary(Only PB)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_67'], 
    FailureHandling.STOP_ON_FAILURE)
