...
Mobile.setText(findTestObject('Phase2/BIInvoiceSummaryScreen/BIEnterTheFolioNoPopup01/Only_ProductBuying_InvQty/FolioNo._EditText_Indexing'), 
    findTestData('Phase2.1/TestData/Test_Data').getValue(2, 38), 0)
...
def Expected = findTestData('Phase2.1/TestData/Test_Data').getValue(2, 38)

println(Expected)

Mobile.verifyEqual(SpaceChar, findTestData('Phase2.1/TestData/Test_Data').getValue(4, 38), FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary(Only PB)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_74'], FailureHandling.STOP_ON_FAILURE)
