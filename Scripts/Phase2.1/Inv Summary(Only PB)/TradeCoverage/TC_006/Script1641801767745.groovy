...
def OrderScreen = Mobile.getText(findTestObject('Phase2/BIOrderAndInvoiceScreen01/Order_And_Invoice_Screen_Title'), 0)

println(OrderScreen)

def split = OrderScreen.split(' ')

ActualOrderScreen = (split[0])

println(ActualOrderScreen)

Mobile.verifyEqual(ActualOrderScreen, findTestData('Phase2.1/TY_01/Test_Data').getValue(4, 45), FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary(Only PB)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_006'], 
