...
Mobile.verifyEqual(Entity, findTestData('Phase2.1/TestData/Test_Data').getValue(2, 33), FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary(Only PB)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_70'], FailureHandling.STOP_ON_FAILURE)
