...
Mobile.setText(findTestObject('Phase2/BIInvoiceSummaryScreen/BIEnterTheFolioNoPopup01/Only_ProductBuying_InvQty/FolioNo._EditText_Indexing'), 
    findTestData('Phase2.1/TestData/Test_Data').getValue(2, 40), 0)

def Actual = Mobile.getAttribute(findTestObject('Phase2/BIInvoiceSummaryScreen/BIEnterTheFolioNoPopup01/Only_ProductBuying_InvQty/FolioProdBuy_EditText'), 
    'text', 0)
...
def Undescore = Actual.substring(9, 10)

println(SpaceChar)

println(Undescore)

def Expected = findTestData('Phase2.1/TestData/Test_Data').getValue(2, 40)

println(Expected)

Mobile.verifyEqual(SpaceChar, findTestData('Phase2.1/TestData/Test_Data').getValue(5, 40), FailureHandling.STOP_ON_FAILURE)

Mobile.verifyEqual(Undescore, findTestData('Phase2.1/TestData/Test_Data').getValue(4, 40), FailureHandling.STOP_ON_FAILURE)
