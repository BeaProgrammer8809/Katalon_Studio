...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary(Only Inv And Rep)/Summary/Screenshot'), [('testCaseName') : 'TC_143_AmountSplitUp'], FailureHandling.STOP_ON_FAILURE)
