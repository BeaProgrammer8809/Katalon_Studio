...
def Invoice_amount=Mobile.getText(findTestObject('Object Repository/Phase2/BIInvoiceSummaryScreen/BICollectionScreen01/InvAmt_Value'), 0)
Mobile.verifyGreaterThan(Invoice_amount, Pesito_grand)

println(' user not able to collect the amount toast massage should be generated "Amount ')

Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary(Only Inv And Rep)/Collection/Screenshot'), [('testCaseName') : 'TC_487'], FailureHandling.STOP_ON_FAILURE)
