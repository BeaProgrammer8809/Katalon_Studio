...
Mobile.tap(findTestObject('Object Repository/Phase2/BINumberKeypad01/Num_5'), 0)
...
Mobile.callTestCase(findTestCase('Phase2.1/InvSummaryOnlyReplacementAndPB/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC_350'], FailureHandling.STOP_ON_FAILURE)
