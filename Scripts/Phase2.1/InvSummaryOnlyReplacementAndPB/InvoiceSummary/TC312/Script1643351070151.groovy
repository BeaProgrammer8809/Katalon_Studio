...
Mobile.callTestCase(findTestCase('Phase2.1/InvSummaryOnlyReplacementAndPB/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC312_UUIDPopup'],
...
Mobile.verifyMatch(UUIDlength.toString(), findTestData('Phase2.1/TY_01/TestData3').getValue(3, 25), false, FailureHandling.STOP_ON_FAILURE)
...
def expectedMessage = findTestData('Phase2.1/TY_01/TestData3').getValue(4, 25)

boolean MessageResult = actualMessage.contains(expectedMessage)

def verifytheToastMessage = MessageResult.toString()

Mobile.verifyMatch(verifytheToastMessage, findTestData('Phase2.1/TY_01/TestData3').getValue(5, 25), false, FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2.1/InvSummaryOnlyReplacementAndPB/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC312'],
	FailureHandling.STOP_ON_FAILURE)
