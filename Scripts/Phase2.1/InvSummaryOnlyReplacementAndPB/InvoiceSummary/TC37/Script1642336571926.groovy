...
Mobile.callTestCase(findTestCase('Phase2.1/InvSummaryOnlyReplacementAndPB/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC37'], 
    FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyMatch(SkuTotalPrice.round().toString(), findTestData('Phase2.1/TY_06/Inv summary (Only Replacement and PB)/Invoice summary').getValue(
        4, 5), false, FailureHandling.STOP_ON_FAILURE)
