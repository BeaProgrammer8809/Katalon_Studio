...
Mobile.callTestCase(findTestCase('Reusable Cases/Mobile/Phase2.1/Trade_Coverage_Generic'), [('retailerName') : findTestData(
	'Phase2/Common_Data/CommonData').getValue(2, 12)], FailureHandling.STOP_ON_FAILURE)
...
GlobalVariable.ProductName = findTestData('Phase2/Common_Data/CommonData').getValue(16, 3)
...
Mobile.setText(findTestObject('Phase2/BIInvoiceSummaryScreen/BIEnterTheFolioNoPopup01/Only_ProductBuying_InvQty/FolioNo._EditText_Indexing'),
	findTestData('Phase2/Common_Data/CommonData').getValue(15, 1), 0)
...
Mobile.callTestCase(findTestCase('Phase2.1/InvSummaryOnlyReplacementAndPB/InvoiceSummary/Screenshot'), ['testCaseName':'TC_298_SummaryScreen'], FailureHandling.STOP_ON_FAILURE)
