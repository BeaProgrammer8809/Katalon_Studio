...
println('Legal enity should be bimbo for Replacement and product buying products')

Mobile.callTestCase(findTestCase('Phase2.1/InvSummaryOnlyReplacementAndPB/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC_292'], FailureHandling.STOP_ON_FAILURE)
