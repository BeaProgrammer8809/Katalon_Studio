...
def CalculatedDiscount = (Double.parseDouble(SkuTotalPrice) - (Double.parseDouble(PiecesInSummary) * Double.parseDouble(
    UnitPriceInSummary))).round(2)
...
Mobile.callTestCase(findTestCase('Phase2.1/InvSummaryOnlyReplacementAndPB/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC_199'], 
