...
Mobile.callTestCase(findTestCase('Phase2.1/InvSummaryOnlyReplacementAndPB/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC339_Actual_Return_Qty'], FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2.1/InvSummaryOnlyReplacementAndPB/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC339_Actual_PB_Qty'], FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2.1/InvSummaryOnlyReplacementAndPB/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC339_Expected_Return_Qty'], FailureHandling.STOP_ON_FAILURE)
...
def Expected_Invoice_Popup_Text = findTestData('Phase2.1/TY_02/Test_Data_Phase2').getValue(4, 225)
boolean Invoice_PopUp_Text=Actual_Invoice_And_UUID_PopUp_Text.contains(Expected_Invoice_Popup_Text)

def Expected_UUID_Popup_Text = findTestData('Phase2.1/TY_02/Test_Data_Phase2').getValue(5, 225)
...
Mobile.verifyMatch(Invoice_PopUp_Text.toString(), findTestData('Phase2.1/TY_02/Test_Data_Phase2').getValue(7, 225), false, FailureHandling.STOP_ON_FAILURE)

//Verification to check that UUID is gerenated 
Mobile.verifyMatch(UUID_PopUp_Text.toString(), findTestData('Phase2.1/TY_02/Test_Data_Phase2').getValue(7, 225), false, FailureHandling.STOP_ON_FAILURE)
Mobile.callTestCase(findTestCase('Phase2.1/InvSummaryOnlyReplacementAndPB/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC339_Invoice_Created_Successfully_And_UUID_Generated'], FailureHandling.STOP_ON_FAILURE)
