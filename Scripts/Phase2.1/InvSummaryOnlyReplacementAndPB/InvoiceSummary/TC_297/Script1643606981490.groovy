...
Mobile.callTestCase(findTestCase('Reusable Cases/Mobile/Phase2.1/Trade_Coverage_Generic'), [('retailerName') : findTestData(
	'Phase2/Common_Data/CommonData').getValue(2, 10)], FailureHandling.STOP_ON_FAILURE)
...
GlobalVariable.ProductName = findTestData('Phase2/Common_Data/CommonData').getValue(16, 2)
...
Mobile.callTestCase(findTestCase('Phase2.1/InvSummaryOnlyReplacementAndPB/InvoiceSummary/Screenshot'), ['testCaseName':'TC_297_SummaryScreen'], FailureHandling.STOP_ON_FAILURE)
