...
Mobile.callTestCase(findTestCase('Phase2.1/InvSummaryOnlyReplacementAndPB/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC310_UUIDPopup'],
...
Mobile.verifyMatch(UUIDlength.toString(), findTestData('Phase2.1/TY_01/TestData3').getValue(3, 23), false, FailureHandling.STOP_ON_FAILURE)
...
def expectedMessage = findTestData('Phase2.1/TY_01/TestData3').getValue(4, 23)

boolean MessageResult = actualMessage.contains(expectedMessage)

def verifytheToastMessage = MessageResult.toString()

Mobile.verifyMatch(verifytheToastMessage, findTestData('Phase2.1/TY_01/TestData3').getValue(5, 23), false, FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2.1/InvSummaryOnlyReplacementAndPB/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC310'],
	FailureHandling.STOP_ON_FAILURE)
