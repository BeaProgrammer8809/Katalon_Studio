...
def Tax = Double.parseDouble(findTestData('Phase2.1/TY_05/Testdata').getValue('IVATAX', 1))
...
Mobile.callTestCase(findTestCase('Phase2.1/InvSummaryOnlyReplacementAndPB/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC_121'],
