...
Mobile.callTestCase(findTestCase('Reusable Cases/Mobile/Phase2.1/Trade_Coverage_Generic'), [('retailerName') : findTestData(
	'Phase2/Common_Data/CommonData_03').getValue(2, 10)], FailureHandling.STOP_ON_FAILURE)
...
GlobalVariable.ProductName = findTestData('Phase2/Common_Data/CommonData_03').getValue(16, 1)
