...
def LegalEntityName = Mobile.getText(findTestObject('Object Repository/Phase2/BIInvoiceSummaryScreen/BIEnterTheFolioNoPopup01/LegalEntityName_TextView'),
	0)

Mobile.verifyMatch(LegalEntityName, findTestData('Phase2.1/TY_05/Collection').getValue(5, 69), false, FailureHandling.STOP_ON_FAILURE)
...
Mobile.tap(findTestObject('Object Repository/Phase2/BIInvoiceSummaryScreen/BIEnterTheFolioNoPopup01/Folio_ProdBuy_EditText'),
	0)
...
println('Legal entity should be barcel for product buying products')

Mobile.callTestCase(findTestCase('Phase2.1/InvSummaryOnlyReplacementAndPB/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC_290'], FailureHandling.STOP_ON_FAILURE)
