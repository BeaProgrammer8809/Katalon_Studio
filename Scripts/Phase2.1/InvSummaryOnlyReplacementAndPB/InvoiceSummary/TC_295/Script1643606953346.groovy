...
GlobalVariable.ProductName = findTestData('Phase2/Common_Data/CommonData').getValue(16, 1)
...
Mobile.callTestCase(findTestCase('Phase2.1/InvSummaryOnlyReplacementAndPB/InvoiceSummary/Screenshot'), ['testCaseName':'TC_295_SummaryScreen'], FailureHandling.STOP_ON_FAILURE)
