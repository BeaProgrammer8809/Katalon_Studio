...
Mobile.callTestCase(findTestCase('Reusable Cases/Mobile/Phase2.1/Trade_Coverage_Generic'), [('retailerName') : findTestData(
            'Phase2.1/Common_Data/CommonData').getValue(4, 1)], FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyElementNotExist(findTestObject('Phase2/BIInvoiceSummaryScreen/Collection_Icon'), 0, FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyElementExist(findTestObject('Phase2/BIInvoiceSummaryScreen/BIWildCardRetailer/Reason_TextView'), 0, FailureHandling.STOP_ON_FAILURE)

Mobile.verifyElementVisible(findTestObject('Phase2/BIInvoiceSummaryScreen/BIWildCardRetailer/--Select--DropdownName'), 0, FailureHandling.STOP_ON_FAILURE)

Mobile.verifyElementVisible(findTestObject('Phase2/BIInvoiceSummaryScreen/BIWildCardRetailer/Please_collect_cash_CheckBox'), 
    0, FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2.1/InvSummaryOnlyReplacementAndPB/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC08'],
	FailureHandling.STOP_ON_FAILURE)
