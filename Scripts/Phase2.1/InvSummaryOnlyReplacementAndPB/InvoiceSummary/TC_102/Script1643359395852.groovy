...
GlobalVariable.ProductName = findTestData('Phase2/Common_Data/CommonData').getValue(6, 8)
...
def taxIVA = findTestData('Phase2/Common_Data/CommonData').getValue(5, 17)
...
def zero = findTestData('Phase2/Common_Data/CommonData').getValue(5, 10)
