...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitOnlyRepandPB/ReplacementAndProductBuying/Screenshot'), [('testCaseName') : 'TC_049InvoiceSummaryScreen'], 
...
def ExpectedInvoiceText = findTestData('Phase2.1/TY_13/InvoiceSplitOnlyRepandPB').getValue(3, 1)
...
def ExpectedProdBuyText = findTestData('Phase2.1/TY_13/InvoiceSplitOnlyRepandPB').getValue(3, 2)
...
Mobile.verifyMatch(RepResult.toString(), findTestData('Phase2.1/TY_13/InvoiceSplitOnlyRepandPB').getValue(4, 1), false, FailureHandling.STOP_ON_FAILURE)
Mobile.verifyMatch(ProdBuyResult.toString(), findTestData('Phase2.1/TY_13/InvoiceSplitOnlyRepandPB').getValue(4, 2), false, FailureHandling.STOP_ON_FAILURE)
//

Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitOnlyRepandPB/ReplacementAndProductBuying/Screenshot'), [('testCaseName') : 'TC_049DeliveryFinalSummary'], 
    FailureHandling.STOP_ON_FAILURE)
