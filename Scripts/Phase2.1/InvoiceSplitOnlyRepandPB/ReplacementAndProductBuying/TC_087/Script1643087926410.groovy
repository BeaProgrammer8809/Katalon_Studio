...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitOnlyRepandPB/ReplacementAndProductBuying/Screenshot'), [('testCaseName') : 'TC_087_SummaryScreen'],
...
def expInvName1=findTestData('Phase2/TY_03/TestData_Phase2.1').getValue(2, 24)+'3'

Mobile.verifyMatch(invName1, expInvName1, false, FailureHandling.OPTIONAL)

println "Invoice name as expected"

def expAmt1=Double.parseDouble(SRPBimbo)*Double.parseDouble(skuQty1)
...
def expInvName2=findTestData('Phase2/TY_03/TestData_Phase2.1').getValue(2, 35)+'3'

Mobile.verifyMatch(invName2, expInvName2, false, FailureHandling.OPTIONAL)

println "Invoice name as expected"

def expAmt2=Double.parseDouble(skuQty2)*Double.parseDouble(SRPBimbo)
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitOnlyRepandPB/ReplacementAndProductBuying/Screenshot'), [('testCaseName') : 'TC_087_DeliveryFinalSummaryScreen'],
FailureHandling.STOP_ON_FAILURE)
