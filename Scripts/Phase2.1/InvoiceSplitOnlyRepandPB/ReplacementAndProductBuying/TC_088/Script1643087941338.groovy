...
println "Barcel sku name is "+ SkuName
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitOnlyRepandPB/ReplacementAndProductBuying/Screenshot'), [('testCaseName') : 'TC_088_SummaryScreen'],
...
def expInvName1=findTestData('Phase2/TY_03/TestData_Phase2.1').getValue(2, 24)+'2'
...
def expInvName2=findTestData('Phase2/TY_03/TestData_Phase2.1').getValue(2, 35)+'2'
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitOnlyRepandPB/ReplacementAndProductBuying/Screenshot'), [('testCaseName') : 'TC_088_DeliveryFinalSummaryScreen'],
FailureHandling.STOP_ON_FAILURE)
