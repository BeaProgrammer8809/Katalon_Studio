...
//def ProductName=Mobile.getText(findTestObject('Object Repository/Phase2/BIDeliverySummaryScreen/Product_Name_Text'), 0)
...
//def ProductName1=Mobile.getText(findTestObject('Object Repository/Phase2/BIDeliverySummaryScreen/Product_Name_Text'), 0)

GlobalVariable.index = findTestData('Phase2.1/Common_Data/CommonData').getValue('Number', 3)

GlobalVariable.ProductName = findTestData('Phase2.1/Common_Data/CommonData').getValue('ProductName', 26)

//Mobile.tap(findTestObject('Object Repository/Phase2/BIReturnProductBuyingScreen01/Close_Button'), 0)
//
//Mobile.tap(findTestObject('Object Repository/Phase2/BIOrderAndInvoiceScreen01/Search_Button'), 0)
...
//def ProductName2=Mobile.getText(findTestObject('Object Repository/Phase2/BIDeliverySummaryScreen/Product_Name_Text'), 0)
...
GlobalVariable.ProductName = findTestData('Phase2.1/Common_Data/CommonData').getValue('ProductName', 11)
...
println "Delivery  summary screen Shouldn't load"
...
println "Delivery final summary screen Should load when split is mapped to  different channel for no group sku"

Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitOnlyRepandPB/ReplacementAndProductBuying/Screenshot'), [('testCaseName') : 'TC_025'], FailureHandling.STOP_ON_FAILURE)
