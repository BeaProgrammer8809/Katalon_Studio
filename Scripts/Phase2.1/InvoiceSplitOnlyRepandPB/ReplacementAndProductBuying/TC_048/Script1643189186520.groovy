...
Mobile.verifyMatch(Actual_Invoice_split, findTestData('Phase2.1/TY_01/TestData3').getValue(4, 7), false, FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyMatch(Actual_ProductBuy, findTestData('Phase2.1/TY_01/TestData3').getValue(5, 7), false, FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitOnlyRepandPB/ReplacementAndProductBuying/Screenshot'), [('testCaseName') : 'TC_048'],
