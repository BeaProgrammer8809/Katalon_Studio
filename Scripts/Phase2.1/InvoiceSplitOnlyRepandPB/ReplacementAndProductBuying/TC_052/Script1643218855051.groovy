...
Mobile.verifyMatch(InvoiceResult.toString(), findTestData('Phase2.1/TY_13/InvoiceSplitOnlyRepandPB').getValue(4, 7), false, FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyMatch(ProdBuySplitResult.toString(), findTestData('Phase2.1/TY_13/InvoiceSplitOnlyRepandPB').getValue(4, 8), false, FailureHandling.STOP_ON_FAILURE)
