...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitOnlyRepandPB/ReplacementAndProductBuying/Screenshot'), [('testCaseName') : 'TC_057_Actual_Bimbo_Return_Qty'], FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitOnlyRepandPB/ReplacementAndProductBuying/Screenshot'), [('testCaseName') : 'TC_057_Actual_Barcel_Return_Qty'], FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitOnlyRepandPB/ReplacementAndProductBuying/Screenshot'), [('testCaseName') : 'TC_057_Actual_Ricolino_Return_Qty'], FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitOnlyRepandPB/ReplacementAndProductBuying/Screenshot'), [('testCaseName') : 'TC_057_Actual_Sales_Return'], FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitOnlyRepandPB/ReplacementAndProductBuying/Screenshot'), [('testCaseName') : 'TC_057_Expected_Values'], FailureHandling.STOP_ON_FAILURE)
...
def Expected_Bimbo_Invoice_Split_Name = findTestData('Phase2.1/TY_02/Test_Data_Phase2').getValue(4, 196)
boolean Bimbo_Invoice_Split =Actual_Bimbo_Invoice_Split_Name.contains(Expected_Bimbo_Invoice_Split_Name)
def Actual_Bimbo_Invoice_Split_Line_Value=Mobile.getText(findTestObject('Object Repository/Phase2/BIDeliveryFinalSummaryScreen/Lines_Value_Indexing'), 0)
def Expected_Bimbo_Invoice_Split_Line_Value = findTestData('Phase2.1/TY_02/Test_Data_Phase2').getValue(6, 196)
...
def Expected_Barcel_Invoice_Split_Name = findTestData('Phase2.1/TY_02/Test_Data_Phase2').getValue(4, 196)
boolean Barcel_Invoice_Split =Actual_Barcel_Invoice_Split_Name.contains(Expected_Barcel_Invoice_Split_Name)
def Actual_Barcel_Invoice_Split_Line_Value=Mobile.getText(findTestObject('Object Repository/Phase2/BIDeliveryFinalSummaryScreen/Lines_Value_Indexing'), 0)
def Expected_Barcel_Invoice_Split_Line_Value = findTestData('Phase2.1/TY_02/Test_Data_Phase2').getValue(6, 196)
...
def Expected_Ricolino_Invoice_Split_Name = findTestData('Phase2.1/TY_02/Test_Data_Phase2').getValue(4, 196)
boolean Ricolino_Invoice_Split = Actual_Ricolino_Invoice_Split_Name.contains(Expected_Ricolino_Invoice_Split_Name)
def Actual_Ricolino_Invoice_Split_Line_Value=Mobile.getText(findTestObject('Object Repository/Phase2/BIDeliveryFinalSummaryScreen/Lines_Value_Indexing'), 0)
def Expected_Ricolino_Invoice_Split_Line_Value = findTestData('Phase2.1/TY_02/Test_Data_Phase2').getValue(6, 196)
...
def Expected_Bimbo_PB_Split_Name = findTestData('Phase2.1/TY_02/Test_Data_Phase2').getValue(5, 196)
boolean Bimbo_PB_Split=Actual_Bimbo_PB_Split_Name.contains(Expected_Bimbo_PB_Split_Name)
def Actual_Bimbo_PB_Split_Line_Value=Mobile.getText(findTestObject('Object Repository/Phase2/BIDeliveryFinalSummaryScreen/Lines_Value_Indexing'), 0)
def Expected_Bimbo_PB_Split_Line_Value = findTestData('Phase2.1/TY_02/Test_Data_Phase2').getValue(6, 196)
...
def Expected_Barcel_PB_Split_Name = findTestData('Phase2.1/TY_02/Test_Data_Phase2').getValue(5, 196)
boolean Barcel_PB_Split=Actual_Barcel_PB_Split_Name.contains(Expected_Barcel_PB_Split_Name)
def Actual_Barcel_PB_Split_Line_Value=Mobile.getText(findTestObject('Object Repository/Phase2/BIDeliveryFinalSummaryScreen/Lines_Value_Indexing'), 0)
def Expected_Barcel_PB_Split_Line_Value = findTestData('Phase2.1/TY_02/Test_Data_Phase2').getValue(6, 196)
...
def Expected_Ricolino_PB_Split_Name = findTestData('Phase2.1/TY_02/Test_Data_Phase2').getValue(5, 196)
boolean Ricolino_PB_Split=Actual_Ricolino_PB_Split_Name.contains(Expected_Ricolino_PB_Split_Name)
def Actual_Ricolino_PB_Split_Line_Value=Mobile.getText(findTestObject('Object Repository/Phase2/BIDeliveryFinalSummaryScreen/Lines_Value_Indexing'), 0)
def Expected_Ricolino_PB_Split_Line_Value = findTestData('Phase2.1/TY_02/Test_Data_Phase2').getValue(6, 196)

//Verification to check that Invoice split name is displayed as Expected for Bimbo
Mobile.verifyMatch(Bimbo_Invoice_Split.toString(), findTestData('Phase2.1/TY_02/Test_Data_Phase2').getValue(7, 196), false, FailureHandling.STOP_ON_FAILURE)

//Verification to check that Invoice split name is displayed as Expected for Barcel
Mobile.verifyMatch(Barcel_Invoice_Split.toString(), findTestData('Phase2.1/TY_02/Test_Data_Phase2').getValue(7, 196), false, FailureHandling.STOP_ON_FAILURE)

//Verification to check that Invoice split name is displayed as Expected for Ricolino
Mobile.verifyMatch(Ricolino_Invoice_Split.toString(), findTestData('Phase2.1/TY_02/Test_Data_Phase2').getValue(7, 196), false, FailureHandling.STOP_ON_FAILURE)

//Verification to check that PB split name is displayed as Expected for Bimbo
Mobile.verifyMatch(Bimbo_PB_Split.toString(), findTestData('Phase2.1/TY_02/Test_Data_Phase2').getValue(7, 196), false, FailureHandling.STOP_ON_FAILURE)

//Verification to check that PB split name is displayed as Expected for Barcel
Mobile.verifyMatch(Barcel_PB_Split.toString(), findTestData('Phase2.1/TY_02/Test_Data_Phase2').getValue(7, 196), false, FailureHandling.STOP_ON_FAILURE)

//Verification to check that PB split name is displayed as Expected for Ricolino
Mobile.verifyMatch(Ricolino_PB_Split.toString(), findTestData('Phase2.1/TY_02/Test_Data_Phase2').getValue(7, 196), false, FailureHandling.STOP_ON_FAILURE)

//Verification to check the Line value for Bimbo Invoice split
Mobile.verifyEqual(Actual_Bimbo_Invoice_Split_Line_Value, Expected_Bimbo_Invoice_Split_Line_Value, FailureHandling.STOP_ON_FAILURE)

//Verification to check the Line value for Barcel Invoice split
Mobile.verifyEqual(Actual_Barcel_Invoice_Split_Line_Value, Expected_Barcel_Invoice_Split_Line_Value, FailureHandling.STOP_ON_FAILURE)

//Verification to check the Line value for Ricolino Invoice split
Mobile.verifyEqual(Actual_Ricolino_Invoice_Split_Line_Value, Expected_Ricolino_Invoice_Split_Line_Value, FailureHandling.STOP_ON_FAILURE)

//Verification to check the Line value for Bimbo PB split
Mobile.verifyEqual(Actual_Bimbo_PB_Split_Line_Value, Expected_Bimbo_PB_Split_Line_Value, FailureHandling.STOP_ON_FAILURE)

//Verification to check the Line value for Barcel PB split
Mobile.verifyEqual(Actual_Barcel_PB_Split_Line_Value, Expected_Barcel_PB_Split_Line_Value, FailureHandling.STOP_ON_FAILURE)

//Verification to check the Line value for Ricolino PB split
Mobile.verifyEqual(Actual_Ricolino_PB_Split_Line_Value, Expected_Ricolino_PB_Split_Line_Value, FailureHandling.STOP_ON_FAILURE)
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitOnlyRepandPB/ReplacementAndProductBuying/Screenshot'), [('testCaseName') : 'TC_057_Invoice_Split_&_PB_Split_Name_And_Line_Value'], FailureHandling.STOP_ON_FAILURE)
