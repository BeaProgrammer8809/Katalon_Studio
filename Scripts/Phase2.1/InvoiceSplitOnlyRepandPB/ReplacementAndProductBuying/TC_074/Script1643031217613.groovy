...
productName = findTestData('Phase2.1/Common_Data/CommonData').getValue(6, 8)
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitOnlyRepandPB/ReplacementAndProductBuying/Screenshot'), [('testCaseName') : 'TC_074'], 
...
def ExpSplitName1 = findTestData('Phase2.1/TY_06/InvoiceSplitOnlyRepandPB/ReplacementAndProductBuying').getValue(3, 2)

def ExpSplitName2 = findTestData('Phase2.1/TY_06/InvoiceSplitOnlyRepandPB/ReplacementAndProductBuying').getValue(4, 2)
