...
Mobile.verifyMatch(isKeyboardShown.toString(), findTestData('Phase2.1/TY_12/InvoiceSplitOnlyRepandPB/Testdata').getValue(3, 2), isKeyboardShown, FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitOnlyRepandPB/ReplacementAndProductBuying/Screenshot'), [('testCaseName') : 'TC_002'],
