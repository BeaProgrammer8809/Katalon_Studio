...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitOnlyRepandPB/ReplacementAndProductBuying/Screenshot'), [('testCaseName') : 'TC_081_SummaryScreen'],
...
def expAmt1=Double.parseDouble(skuQty1)*Double.parseDouble(SRPRicolino)

expAmt1=df.format(expAmt1)

Mobile.verifyLessThanOrEqual(amount1, expAmt1, FailureHandling.STOP_ON_FAILURE)

println "Expected amount is less than or equal to actual amount as discount is considered for sku"
...
def expAmt2=Double.parseDouble(skuQty2)*Double.parseDouble(SRPBarcel)
...
def line3=Mobile.getText(findTestObject('Object Repository/Phase2/BIDeliveryFinalSummaryScreen/Lines_Value_Indexing'), 0)

def skuQty3=Mobile.getText(findTestObject('Object Repository/Phase2/BIDeliveryFinalSummaryScreen/SKUs_Qty_Indexing'), 0)

def amount3=Mobile.getText(findTestObject('Object Repository/Phase2/BIDeliveryFinalSummaryScreen/Amount_Value_Indexing'), 0)

def expInvName3=findTestData('Phase2/TY_03/TestData_Phase2.1').getValue(2, 24)+'3'

Mobile.verifyMatch(invName3, expInvName3, false, FailureHandling.OPTIONAL)

println "Invoice name as expected"

def expAmt3=Double.parseDouble(skuQty3)*Double.parseDouble(SRPBimbo)

expAmt3=df.format(expAmt3)

Mobile.verifyGreaterThanOrEqual(amount3, expAmt3, FailureHandling.STOP_ON_FAILURE)
...
def line4=Mobile.getText(findTestObject('Object Repository/Phase2/BIDeliveryFinalSummaryScreen/Lines_Value_Indexing'), 0)

def skuQty4=Mobile.getText(findTestObject('Object Repository/Phase2/BIDeliveryFinalSummaryScreen/SKUs_Qty_Indexing'), 0)

def amount4=Mobile.getText(findTestObject('Object Repository/Phase2/BIDeliveryFinalSummaryScreen/Amount_Value_Indexing'), 0)

def expInvName4=findTestData('Phase2/TY_03/TestData_Phase2.1').getValue(2, 35)+'1'

Mobile.verifyMatch(invName4, expInvName4, false, FailureHandling.OPTIONAL)

println "Invoice name as expected"

def expAmt4=Double.parseDouble(skuQty4)*Double.parseDouble(SRPRicolino)

expAmt4=df.format(expAmt4)

Mobile.verifyLessThanOrEqual(amount4, expAmt4, FailureHandling.STOP_ON_FAILURE)
...
def line5=Mobile.getText(findTestObject('Object Repository/Phase2/BIDeliveryFinalSummaryScreen/Lines_Value_Indexing'), 0)

def skuQty5=Mobile.getText(findTestObject('Object Repository/Phase2/BIDeliveryFinalSummaryScreen/SKUs_Qty_Indexing'), 0)

def amount5=Mobile.getText(findTestObject('Object Repository/Phase2/BIDeliveryFinalSummaryScreen/Amount_Value_Indexing'), 0)

def expInvName5=findTestData('Phase2/TY_03/TestData_Phase2.1').getValue(2, 35)+'2'

Mobile.verifyMatch(invName5, expInvName5, false, FailureHandling.OPTIONAL)

println "Invoice name as expected"

def expAmt5=Double.parseDouble(skuQty5)*Double.parseDouble(SRPBarcel)

expAmt5=df.format(expAmt5)

Mobile.verifyLessThanOrEqual(amount5, expAmt5, FailureHandling.STOP_ON_FAILURE)

println "Amount is as expected"

GlobalVariable.index = findTestData('Phase2/Common_Data/CommonData_03').getValue(5, 6)

def invName6 = Mobile.getText(findTestObject('Object Repository/Phase2/BIDeliveryFinalSummaryScreen/Invoice Split_Indexing'),
	0)

def line6=Mobile.getText(findTestObject('Object Repository/Phase2/BIDeliveryFinalSummaryScreen/Lines_Value_Indexing'), 0)

def skuQty6=Mobile.getText(findTestObject('Object Repository/Phase2/BIDeliveryFinalSummaryScreen/SKUs_Qty_Indexing'), 0)

def amount6=Mobile.getText(findTestObject('Object Repository/Phase2/BIDeliveryFinalSummaryScreen/Amount_Value_Indexing'), 0)

def expInvName6=findTestData('Phase2/TY_03/TestData_Phase2.1').getValue(2, 35)+'3'

Mobile.verifyMatch(invName6, expInvName6, false, FailureHandling.OPTIONAL)

println "Invoice name as expected"

def expAmt6=Double.parseDouble(skuQty6)*Double.parseDouble(SRPBimbo)

expAmt6=df.format(expAmt6)

Mobile.verifyGreaterThanOrEqual(amount6, expAmt6, FailureHandling.STOP_ON_FAILURE)

println "Amount is as expected"

Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitOnlyRepandPB/ReplacementAndProductBuying/Screenshot'), [('testCaseName') : 'TC_081_DeliveryFinalSummaryScreen'], 
    FailureHandling.STOP_ON_FAILURE)
