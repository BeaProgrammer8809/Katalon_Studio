...
productName = findTestData('Phase2.1/Common_Data/CommonData').getValue(6, 31)
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitOnlyRepandPB/ReplacementAndProductBuying/Screenshot'), [('testCaseName') : 'TC_076'], 
...
def ExpSplitName1 = findTestData('Phase2.1/TY_06/InvoiceSplitOnlyRepandPB/ReplacementAndProductBuying').getValue(3, 4)

def ExpSplitName2 = findTestData('Phase2.1/TY_06/InvoiceSplitOnlyRepandPB/ReplacementAndProductBuying').getValue(4, 4)
