...
Mobile.callTestCase(findTestCase('Reusable Cases/Mobile/Phase2.1/Product_Buying_Quantity'), [('testData1') : findTestData('Phase2.1/Common_Data/CommonData').getValue(
	'ProductName', 12)], FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyMatch(DefaultInv1, findTestData('Phase2.1/TY_01/TestData3').getValue(4, 3), false, FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyMatch(DefaultInv2, findTestData('Phase2.1/TY_01/TestData3').getValue(5, 3), false, FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyMatch(DefaultInv3, findTestData('Phase2.1/TY_01/TestData3').getValue(6, 3), false, FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyMatch(productBuy1, findTestData('Phase2.1/TY_01/TestData3').getValue(7, 3), false, FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyMatch(productBuy2, findTestData('Phase2.1/TY_01/TestData3').getValue(8, 3), false, FailureHandling.STOP_ON_FAILURE)
'*******************Product Buy3*********************'
...
Mobile.verifyMatch(productBuy3, findTestData('Phase2.1/TY_01/TestData3').getValue(9, 3), false, FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitOnlyRepandPB/ReplacementAndProductBuying/Screenshot'), [('testCaseName') : 'TC_043'],
