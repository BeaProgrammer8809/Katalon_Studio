...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitOnlyRepandPB/ReplacementAndProductBuying/Screenshot'), [('testCaseName') : 'TC_060_Actual_Return_Qty'], FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitOnlyRepandPB/ReplacementAndProductBuying/Screenshot'), [('testCaseName') : 'TC_060_Actual_Sales_Return'], FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitOnlyRepandPB/ReplacementAndProductBuying/Screenshot'), [('testCaseName') : 'TC_060_Expected_Values'], FailureHandling.STOP_ON_FAILURE)
...
def Expected_Invoice_Split_Name = findTestData('Phase2.1/TY_02/Test_Data_Phase2').getValue(4, 199)
...
def Expected_Invoice_Split_Line_Value = findTestData('Phase2.1/TY_02/Test_Data_Phase2').getValue(6, 199)
...
def Expected_PB_Split_Name = findTestData('Phase2.1/TY_02/Test_Data_Phase2').getValue(5, 199)
...
def Expected_PB_Line_Value = findTestData('Phase2.1/TY_02/Test_Data_Phase2').getValue(6, 199)

//Verification to check that Invoice split name is displayed as Expected
Mobile.verifyMatch(Invoice_Split.toString(), findTestData('Phase2.1/TY_02/Test_Data_Phase2').getValue(7, 199), false, FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyMatch(PB_Split.toString(), findTestData('Phase2.1/TY_02/Test_Data_Phase2').getValue(7, 199), false, FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitOnlyRepandPB/ReplacementAndProductBuying/Screenshot'), [('testCaseName') : 'TC_060_Actual_Invoice_-_PB_Split_Name_And_Line_Values'], FailureHandling.STOP_ON_FAILURE)
