...
def amtDispSummary = Amount.round(1)
def AmtDispSummary = amtDispSummary.toString()

println(AmtDispSummary + 'Value Displayed in Summery Screen Double Format')
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC_280AmtDisplayedInCreditMode'], FailureHandling.STOP_ON_FAILURE)


Mobile.verifyElementText(findTestObject('Phase2/BICollectionScreen01/BICreditNoteScreen01/Amount_EditText'), Amount.toString(), FailureHandling.STOP_ON_FAILURE)

def AmtDisplayedbeforeEdit = Mobile.getText(findTestObject('Phase2/BICollectionScreen01/BICreditNoteScreen01/Amount_EditText'), 
    0)

println(AmtDisplayedbeforeEdit + 'amount displayed in Credit Note ')

Mobile.tap(findTestObject('Phase2/BICollectionScreen01/BICreditNoteScreen01/Amount_EditText'), 0)

Mobile.tap(findTestObject('Phase2/BINumberKeyboardCollection01/BackSpace_NumButton'), 0)

'Verifying if the popup is raised'
Mobile.verifyElementVisible(findTestObject('Phase2/BICollectionScreen01/BICreditNoteScreen01/Please select an Item_Pop-up'), 
    0)

Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC_280AfterTapOnBackSpaceButton'], FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('Phase2/BICollectionScreen01/BICreditNoteScreen01/please select an item_OK_Button'), 0)

Mobile.verifyElementText(findTestObject('Phase2/BICollectionScreen01/BICreditNoteScreen01/Amount_EditText'), AmtDisplayedbeforeEdit, FailureHandling.STOP_ON_FAILURE)

println("We are not able to edit the 'Credit note' mode amount")
