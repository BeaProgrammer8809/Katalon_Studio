...
println(piecesOrdered + 'Pieces Ordered')

// To Fetch value present in TotalQty in summary screen
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/Trade Coverage/Screenshot'), [('testCaseName') : 'TC_265'], 
    FailureHandling.STOP_ON_FAILURE)

Mobile.verifyMatch(piecesOrdered, totalQty, false)

println('Since Only one Sku is being invoiced, TotalQty value is being Displayed as 1.')
