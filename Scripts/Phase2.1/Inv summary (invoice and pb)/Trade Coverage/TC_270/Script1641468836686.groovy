...
Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/Trade Coverage/Screenshot'), [('testCaseName') : 'TC_270InitialVisit'], 
    FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/Trade Coverage/Screenshot'), [('testCaseName') : 'TC_270FinalVisit'], 
    FailureHandling.STOP_ON_FAILURE)

Mobile.verifyMatch(ActualTotalPiecesQty, ExpectedTotalPiecesQty, false, FailureHandling.STOP_ON_FAILURE)

println('Quantity(Salable)  displayed is persisted')
