...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC_293TotalPaidAmt'], 
    FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyElementNotExist(findTestObject('Phase2/BIInvoiceSummaryScreen/Tag_Icon'), 0, FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC_293AfterClickingSubmit'], 
    FailureHandling.STOP_ON_FAILURE)

println('After Clicking on submit button in Collection screen, Edit icon and Print Preview icon is Hidden.')
