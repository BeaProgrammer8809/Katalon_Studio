...
InitialProductName = Mobile.getText(findTestObject('Phase2/BIProductBuyingScreen01/Product_Name_Text_View'), 0)

Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/Trade Coverage/Screenshot'), [('testCaseName') : 'TC_273InitialVisit'], 
    FailureHandling.STOP_ON_FAILURE)
...
'To set a new SKU and to add Qty'
Mobile.setText(findTestObject('Phase2/BIProductBuyingScreen01/Search_Edit_Text'), findTestData('Phase2.1/Common_Data/CommonData').getValue(
        6, 2), 0)
...
def NewProductName = Mobile.getText(findTestObject('Phase2/BIProductBuyingScreen01/Product_Name_Text_View'), 0)
println(NewProductName + "Name Of the newly added product")

Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/Trade Coverage/Screenshot'), [('testCaseName') : 'TC_273FinalVisit'], 
    FailureHandling.STOP_ON_FAILURE)

Mobile.verifyNotMatch(ProductName, NewProductName, false ,FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('Phase2/BIProductBuyingScreen01/Next_Button'), 0)

Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/Trade Coverage/Screenshot'), [('testCaseName') : 'TC_273SummaryScreenProducts'], 
    FailureHandling.STOP_ON_FAILURE)
