...
def CreditNoteAmtDisplayed = Mobile.getText(findTestObject('Phase2/BICollectionScreen01/BICreditNoteScreen01/Amount_EditText'), 
    0)

println(CreditNoteAmtDisplayed + 'amount displayed in Credit Note ')

Mobile.verifyElementText(findTestObject('Phase2/BICollectionScreen01/BICreditNoteScreen01/Amount_EditText'), Amount.toString(), 
    FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/Trade Coverage/Screenshot'), [('testCaseName') : 'TC_279'], 
    FailureHandling.STOP_ON_FAILURE)
