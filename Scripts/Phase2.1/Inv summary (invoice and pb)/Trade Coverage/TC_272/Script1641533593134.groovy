...
Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/Trade Coverage/Screenshot'), [('testCaseName') : 'TC_272InitialVisit'], 
    FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/Trade Coverage/Screenshot'), [('testCaseName') : 'TC_272FinalVisit'], 
    FailureHandling.STOP_ON_FAILURE)

Mobile.verifyMatch(ActualTotalPiecesQty, ExpectedTotalPiecesQty, false, FailureHandling.STOP_ON_FAILURE)

println('Quantity(Salable And Non-Salable) displayed is persisted')
