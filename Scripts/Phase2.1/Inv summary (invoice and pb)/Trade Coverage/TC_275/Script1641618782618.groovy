...
Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/Trade Coverage/Screenshot'), [('testCaseName') : 'TC_275SummaryScreen'], 
    FailureHandling.STOP_ON_FAILURE)

println("Collection icon is not Visible for Credit Retailers")
