...
// TO get the amount from AmountEdit text field before tapping on Backspace in Keyboard
def AmtBeforeDeleting = Mobile.getText(findTestObject('Phase2/BICollectionScreen01/BIEfectivoScreen01/Amount_EditText'), 
    0)

println(AmtBeforeDeleting + '--Amount present before pressing backspace in keyboard')

// To delete the amount in Efectivo Amount field using Backspace in keyboard
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC_290BackSpace'],
	FailureHandling.STOP_ON_FAILURE)

// TO get the amount from AmountEdit text field after tapping on Backspace in Keyboard
def AmtAfterDeleting = Mobile.getText(findTestObject('Phase2/BICollectionScreen01/BIEfectivoScreen01/Amount_EditText'), 
    0)

println(AmtAfterDeleting + '--Amount present before pressing backspace in keyboard')

Mobile.verifyNotMatch(AmtAfterDeleting, AmtBeforeDeleting, false, FailureHandling.STOP_ON_FAILURE)

println("The Backspace button on the keyboard is Functioning as expected")
