...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC_291'],
	FailureHandling.STOP_ON_FAILURE)

// Expected toast msg
def ExpectedToastMsg = findTestData('Phase2.1/TY_13/Inv summary (invoice and pb)').getValue(3, 16) + BalanceAmt
...
println('Please Pay Total balance Amount toast message is dispalyed and we are not able to sumbit the collection ')
