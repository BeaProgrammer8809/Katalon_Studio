...
Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/Trade Coverage/Screenshot'), [('testCaseName') : 'TC_268_beforeEditingPieceValue'],
	FailureHandling.STOP_ON_FAILURE)

def PiecesValueBeforeEditing = Mobile.getText(findTestObject('Phase2/BIOrderAndInvoiceScreen01/Pieces_EditText'), 0)

println("Pieces Value before editing is : " + PiecesValueBeforeEditing)
...
def PiecesValueAfterEditing = Mobile.getText(findTestObject('Phase2/BIOrderAndInvoiceScreen01/Pieces_EditText'), 0)

println("Pieces value after editing is : " + PiecesValueAfterEditing)

Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/Trade Coverage/Screenshot'), [('testCaseName') : 'TC_268_afterEditingPieceValue'],
	FailureHandling.STOP_ON_FAILURE)

Mobile.verifyNotMatch(PiecesValueBeforeEditing, PiecesValueAfterEditing, false, FailureHandling.STOP_ON_FAILURE)

println('The Pieces Value Can be edited')
