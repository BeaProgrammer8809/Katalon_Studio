...
// To fetch data from Summary Screen
//To fetch sku name.
...
// To fetch SKU Pieces Ordered.
def PiecesOrdered = Mobile.getText(findTestObject('Phase2/BIInvoiceSummaryScreen/BISummaryProductDetails/Pieces_Value_Indexing'), 
    0)

println(PiecesOrdered + 'Actual Pieces Ordered')

// To fetch SKU Returns.
def PiecesReturns = Mobile.getText(findTestObject('Phase2/BIInvoiceSummaryScreen/BISummaryProductDetails/Actual_Return_Value_Indexing'), 
    0)

println(PiecesReturns + 'Actual Pieces Returned')

Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/Trade Coverage/Screenshot'), [('testCaseName') : 'TC_266_SummaryScreen'],
	FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyMatch(ScreenTitle, findTestData('Phase2.1/TY_13/Inv summary (invoice and pb)').getValue(3, 7), false)


// To validata the data from Ordered Screen.
GlobalVariable.index = findTestData('Phase2.1/Common_Data/CommonData').getValue('Number', 1)
...
Mobile.verifyElementText(findTestObject('Phase2/BIOrderAndInvoiceScreen01/Pieces_EditText'), PiecesOrdered, FailureHandling.STOP_ON_FAILURE)
Mobile.verifyElementText(findTestObject('Phase2/BIOrderAndInvoiceScreen01/Returns_Edit_Text'), PiecesReturns)

Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/Trade Coverage/Screenshot'), [('testCaseName') : 'TC_266_OrderedScreen'],
	FailureHandling.STOP_ON_FAILURE)

println('All the Products (Pieces And Returns ) are displayed after clicking on Edit icon in Summary Screen ')
