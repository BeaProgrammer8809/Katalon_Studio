...
Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/Trade Coverage/Screenshot'), [('testCaseName') : 'TC_267_SummaryScreen'],
	FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyMatch(ScreenTitle, findTestData('Phase2.1/TY_13/Inv summary (invoice and pb)').getValue(3, 8), false)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/Trade Coverage/Screenshot'), [('testCaseName') : 'TC_267_OrderedScreen'],
	FailureHandling.STOP_ON_FAILURE)

println('Enter Piece Quantity is persisted in Summary Screen and Ordered Screen ')
