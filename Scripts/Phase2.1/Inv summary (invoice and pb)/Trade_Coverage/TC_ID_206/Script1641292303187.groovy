...
Mobile.callTestCase(findTestCase('Phase2/Invoice_Summary/Trade_Coverage/ScreenShot'), [('testCaseName') : 'TC_ID_206_InvoiceSummary'], FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2/Invoice_Summary/Trade_Coverage/ScreenShot'), [('testCaseName') : 'TC_ID_206_SplitPopUp'], FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2/Invoice_Summary/Trade_Coverage/ScreenShot'), [('testCaseName') : 'TC_ID_206_PrintPreview'],
