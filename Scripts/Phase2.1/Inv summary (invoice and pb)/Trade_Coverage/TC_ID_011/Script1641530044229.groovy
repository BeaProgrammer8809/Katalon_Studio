...
// Selecting the different product and changed the code. ( from 42 to 1 )
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/Trade_Coverage/Screenshot'), [('testCaseName') : 'TC_ID_011'],
	FailureHandling.STOP_ON_FAILURE)
