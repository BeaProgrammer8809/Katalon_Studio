...
GlobalVariable.ProductName = findTestData('Phase2.1/TY_11/TestData').getValue(3,44)
...
Mobile.callTestCase(findTestCase('Phase2/Invoice_Summary/Trade_Coverage/ScreenShot'), [('testCaseName') : 'TC_ID_010_invoiceSummary'],
