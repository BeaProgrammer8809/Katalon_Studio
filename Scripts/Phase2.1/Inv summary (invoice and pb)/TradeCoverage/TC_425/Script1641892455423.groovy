...
EnteredInvAmtInTransferenciasElectronicas = Mobile.getText(findTestObject('Object Repository/Phase2/BICollectionScreen01/BIChequesScreen01/Amount_EditText'), 
    0)
...
EnteredInvAmtInChequeMode = Mobile.getText(findTestObject('Object Repository/Phase2/BICollectionScreen01/BIChequesScreen01/Amount_EditText'), 
    0)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_425'], 
    FailureHandling.STOP_ON_FAILURE)
...
EnteredInvAmtInEffectivoMode = Mobile.getText(findTestObject('Object Repository/Phase2/BICollectionScreen01/BIChequesScreen01/Amount_EditText'), 
    0)
...
EnteredInvAmtInCreditNoteMode = Mobile.getText(findTestObject('Object Repository/Phase2/BICollectionScreen01/BIChequesScreen01/Amount_EditText'), 
    0)
...
def ExpectedTitle = findTestData('Phase2.1/TY_14/TestData').getValue('Title', 34)
