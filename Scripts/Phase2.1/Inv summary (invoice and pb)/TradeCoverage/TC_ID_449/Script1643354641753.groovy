...
GlobalVariable.ProductName = findTestData('Phase2/Common_Data/CommonData').getValue(6, 1)
...
Mobile.setText(findTestObject('Object Repository/Phase2/BIInvoiceSummaryScreen/BICollectionScreen01/Amount_EditText'), partialAmt.toString(), 0)

def PesitoAmt = Mobile.getAttribute(findTestObject('Phase2/BIInvoiceSummaryScreen/BICollectionScreen01/Amount_EditText'),'text', 0)

println('Amount in Pesito mode is ' + PesitoAmt)

Mobile.verifyElementAttributeValue(findTestObject('Object Repository/Phase2/BIInvoiceSummaryScreen/BICollectionScreen01/Amount_EditText'), 'text', PesitoAmt, 0, FailureHandling.STOP_ON_FAILURE)

println " User is able to enter partial amount in pesito mode"

Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/TradeCoverage/ScreenShot'), [('testCaseName') : 'TC_ID_449_SummaryScreen'], 
...
println('User is able to pesito credit amount in invoice amount')
