...
println('Since SkuGross and DiscountedSKUPrice1 are not equal Categorydiscounts  is  mapped')

Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_143'], FailureHandling.STOP_ON_FAILURE)
