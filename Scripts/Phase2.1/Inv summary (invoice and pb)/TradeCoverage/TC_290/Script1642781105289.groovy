...
Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/TradeCoverage/Screenshot'),
	[('testCaseName') : 'TC_290_Amount_EditTextBefore'] , FailureHandling.STOP_ON_FAILURE)

'Amount_EditTextBefore'
Amount_EditTextBefore = Mobile.getText(findTestObject('Phase2/BICollectionScreen01/BIEfectivoScreen01/Amount_EditText'), 
    0)

double Amount_ValueBefore = Double.parseDouble(Amount_EditTextBefore)

println(Amount_ValueBefore)
...
Mobile.setText(findTestObject('Phase2/BICollectionScreen01/BIEfectivoScreen01/Amount_EditText'), findTestData('Phase2.1/Common_Data/CommonData').getValue(
        5, 9), 0)

Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/TradeCoverage/Screenshot'),
	[('testCaseName') : 'TC_290_Amount_EditTextAfter'] , FailureHandling.STOP_ON_FAILURE)

'Amount_EditTextAfter'
Amount_EditTextAfter = Mobile.getText(findTestObject('Phase2/BICollectionScreen01/BIEfectivoScreen01/Amount_EditText'), 
    0)

double Amount_ValueAfter = Double.parseDouble(Amount_EditTextAfter)

println(Amount_ValueAfter)

Mobile.verifyNotEqual(Amount_ValueAfter, Amount_ValueBefore, FailureHandling.STOP_ON_FAILURE)

println('Verifying the before and After Edited value')
