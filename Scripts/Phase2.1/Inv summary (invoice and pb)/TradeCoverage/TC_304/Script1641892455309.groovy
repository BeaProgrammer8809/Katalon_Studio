...
def actual_SelectedBranch = Mobile.getText(findTestObject('Phase2/BIDropdown/Dropdown_Name'), 0)

def expected_SelectedBranch = findTestData('Phase2.1/Common_Data/CommonData').getValue('Branch', 4)

Mobile.verifyMatch(actual_SelectedBranch, expected_SelectedBranch, false, FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_304'], FailureHandling.STOP_ON_FAILURE)
