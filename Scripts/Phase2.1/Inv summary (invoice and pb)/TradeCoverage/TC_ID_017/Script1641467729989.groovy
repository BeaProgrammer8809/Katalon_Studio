...
GlobalVariable.ProductName = findTestData('Phase2.1/TY_11/TestData').getValue(3, 47)
...
Mobile.verifyEqual(ActualReturnQTY, ExpectedReturnQty, FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_017_InvoiceSumaary'], 
