...
Mobile.verifyEqual(ActualSalesReturnQuantity, ExpectedSalesReturn, FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_007_invoiceSummary'], 
