...
GlobalVariable.ProductName = findTestData('Phase2.1/TY_11/TestData').getValue(3,46)
...
double ExpectedPbqty = Double.parseDouble(PbqtyText)
...
def ActualOrderQuantity=Mobile.getText(findTestObject('Phase2/BIInvoiceSummaryScreen/BISummaryProductDetails/Pieces_Value_Indexing'), 0)

def ActualSalesReturnQuantity=Mobile.getText(findTestObject('Phase2/BIInvoiceSummaryScreen/BISummaryProductDetails/Sales_Return_Value_Indexing'), 0)
...
//def ActualPiece = Mobile.getText(findTestObject('Object Repository/Phase2/BIInvoiceSummaryScreen/BISummaryProductDetails/Price_Value_Indexing'),
  //  0)

Mobile.verifyEqual(ExpectedSkuName, ActualSkuName, FailureHandling.STOP_ON_FAILURE)

Mobile.verifyEqual(ActualOrderQuantity, ExpectedOrderQuantity, FailureHandling.STOP_ON_FAILURE)

Mobile.verifyEqual(ActualSalesReturnQuantity, ExpectedPbqty, FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_009_invoiceSummary'],
