...
def halfinvAmt = Double.parseDouble(invAmt1) / 2
...
Mobile.setText(findTestObject('Object Repository/Phase2/BICollectionScreen01/BIEfectivoScreen01/Amount_EditText'), halfinvAmt.toString(), 
    0)

Mobile.callTestCase(findTestCase('Reusable Cases/Mobile/Phase2.1/Bank_Branch_ChqueType'), [:], FailureHandling.STOP_ON_FAILURE)

Mobile.setText(findTestObject('Phase2/BICollectionScreen01/BIChequesScreen01/ChequeNum_EditText'), findTestData('Phase2/TY_03/TestData_Phase2.1').getValue(
        2, 14), 0)
...
println "User is able to sumbit the invoice amount in cheque and RTGS mode"

Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/TradeCoverage/ScreenShot'), [('testCaseName') : 'TC_ID_444_SummaryScreen'], 
