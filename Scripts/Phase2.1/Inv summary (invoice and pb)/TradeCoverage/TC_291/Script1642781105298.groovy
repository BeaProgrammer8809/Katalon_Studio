...
double invoiceAmountVal = Double.parseDouble(invamt1)

Mobile.verifyLessThan(invoiceAmountValue, invamt, FailureHandling.STOP_ON_FAILURE)

println('Verifying invoiceAmountValue < invamt')

Mobile.tap(findTestObject('Phase2/BICollectionScreen01/Submit_Button'), 0)
Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/TradeCoverage/Screenshot'),
	[('testCaseName') : 'TC_291_Toast message'] , FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyMatch(verifytheToastMessage, findTestData('Phase2.1/TY_12/Invsummary(invoiceandpb)/TradeCoverage/TradeCoverage').getValue(
		5, 3), false, FailureHandling.STOP_ON_FAILURE)
