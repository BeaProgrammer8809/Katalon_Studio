...
GlobalVariable.ProductName = findTestData('Phase2.1/TY_11/TestData').getValue(3, 48)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_018_InvoiceSumaary'],
