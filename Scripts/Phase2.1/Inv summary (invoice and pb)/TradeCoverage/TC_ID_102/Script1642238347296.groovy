...
double TotalPrice1 = (InvoiceQty * Uprice)
...
double TotalPrice2 = ((InvoiceQty + SalesReturnQty) * Uprice) 

println(TotalPrice2)

TotalPrice2 = TotalPrice2.round(2)

Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_102(1)'], 
    FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyEqual(actualValue.round(2), SkuTotalPrice.round(2), FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_102(2)'], 
    FailureHandling.STOP_ON_FAILURE)
