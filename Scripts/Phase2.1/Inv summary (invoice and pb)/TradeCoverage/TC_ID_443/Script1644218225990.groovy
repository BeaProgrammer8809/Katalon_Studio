...
println "User is able to sumbit the invoice amount in cheque and effectivo mode"

Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/TradeCoverage/ScreenShot'), [('testCaseName') : 'TC_ID_443_SummaryScreen'], 
