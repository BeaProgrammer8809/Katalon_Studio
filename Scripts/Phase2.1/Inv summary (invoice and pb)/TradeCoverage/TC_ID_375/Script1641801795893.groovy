...
Mobile.setText(findTestObject('Phase2/BIInvoiceSummaryScreen/BIEnterTheFolioNoPopup01/FolioNo._EditText_Indexing'), findTestData(
        'Phase2.1/TY_01/Test_Data').getValue(4, 87), 0)
...
Mobile.verifyEqual(actualtoastmessage, findTestData('Phase2.1/TY_01/Test_Data').getValue(5, 87), FailureHandling.STOP_ON_FAILURE)

println "Folio number text field is not allowing less than 6 digits"

Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_375'],
