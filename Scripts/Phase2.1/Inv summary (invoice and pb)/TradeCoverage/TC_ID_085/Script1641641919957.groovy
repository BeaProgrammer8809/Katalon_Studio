...
def catDiscount = CustomKeywords.'com.ty.keywords.MobileKeywords.category15_Percent'(secondGrossAmt)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/TradeCoverage/Screenshot'), 
    [('testCaseName') : 'TC_ID_085_SummaryScreen'], FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/TradeCoverage/Screenshot'),
	[('testCaseName') : 'TC_ID_085_PrintScreen'], FailureHandling.STOP_ON_FAILURE)
