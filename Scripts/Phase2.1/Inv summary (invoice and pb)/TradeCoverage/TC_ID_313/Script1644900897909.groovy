...
Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_313'], FailureHandling.STOP_ON_FAILURE)

AppiumDriver driver = MobileDriverFactory.getDriver()

def ActualErrormessage = driver.findElementByXPath('//android.widget.Toast[1]').getText()

def ExpectedErrormessage = findTestData('Phase2.1/TY_14/TestData').getValue('ToastMessage', 27)
...
expectedCollectionScreenTitle = findTestData('Phase2.1/TY_14/TestData').getValue('Title', 27)
