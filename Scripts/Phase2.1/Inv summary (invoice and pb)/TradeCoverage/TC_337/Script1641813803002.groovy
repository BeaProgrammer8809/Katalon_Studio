...
//
//Mobile.tap(findTestObject('Phase2/BICollectionScreen01/BICalenderPopup/12_Date'), 0)
//
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_347'], 
    FailureHandling.STOP_ON_FAILURE)
