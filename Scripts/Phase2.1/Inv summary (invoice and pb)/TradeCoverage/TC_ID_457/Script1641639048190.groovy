...
def ActualAlertPopUP = Mobile.getText(findTestObject('Phase2/BICollectionScreen01/DeletePaymentPopup_Title/DeletePaymentPopup_Title'), 
    0)

def ExpAlertPopUp = findTestData('Phase2.1/TY_11/TestData').getValue('Expected text', 56)

Mobile.verifyMatch(ActualAlertPopUP, ExpAlertPopUp, false, FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/TradeCoverage/ScreenShot'), [('testCaseName') : 'TC_ID_457'], 
