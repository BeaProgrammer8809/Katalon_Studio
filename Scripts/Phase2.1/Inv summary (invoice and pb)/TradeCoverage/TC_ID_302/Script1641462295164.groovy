...
def Actual_Bank = Mobile.getText(findTestObject('Phase2/BIDropdown/Dropdown_Name'), 0)

Mobile.verifyMatch(Actual_Bank, findTestData('Phase2.1/Common_Data/CommonData').getValue(7, 3), false)
