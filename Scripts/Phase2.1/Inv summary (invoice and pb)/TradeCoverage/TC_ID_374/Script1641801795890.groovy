...
Mobile.setText(findTestObject('Phase2/BIInvoiceSummaryScreen/BIEnterTheFolioNoPopup01/FolioNo._EditText_Indexing'), findTestData(
        'Phase2.1/TY_01/Test_Data').getValue(4, 86), 0)
...
Mobile.verifyEqual(ActualLengthFolioNum, findTestData('Phase2.1/TY_01/Test_Data').getValue(5, 86), FailureHandling.STOP_ON_FAILURE)

println " folio number length is  up to 15 digits"

Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_374'],
