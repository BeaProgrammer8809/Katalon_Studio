...
println('Since SkuGross and DiscountedSKUPrice1 are not equal itemAndcategoryiscounts  is  mapped')

Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_144'], FailureHandling.STOP_ON_FAILURE)
