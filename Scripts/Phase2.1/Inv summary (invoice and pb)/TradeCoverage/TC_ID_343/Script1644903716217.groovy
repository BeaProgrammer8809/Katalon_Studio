...
def ChequAmt = Mobile.getText(findTestObject('Phase2/BIInvoiceSummaryScreen/BICollectionScreen01/Amount_EditText'), 0)
...
Mobile.verifyNotMatch(InvoiceAmt.toString(), ChequAmt, false)

println('Partial invoice amount entered in cheque mode')

Mobile.verifyEqual(CreditNoteMode, findTestData('Phase2.1/TestData/Test_Data').getValue(2, 54), FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyEqual(summary, findTestData('Phase2.1/TestData/Test_Data').getValue(3, 54), FailureHandling.STOP_ON_FAILURE)
println("Invoice Submitted summary screen displays")

Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_343'], 
    FailureHandling.STOP_ON_FAILURE)
