...
Mobile.verifyGreaterThan(Amt, remAmt, FailureHandling.STOP_ON_FAILURE)

println "Amount entering is greater than invoice amount"
...
println "User is not allowed not use pesito amount more than invoice amount"

Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/TradeCoverage/ScreenShot'), [('testCaseName') : 'TC_ID_450_SummaryScreen'], 
