...
Mobile.comment('Verifying the Pop up should not come with folio no')
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_349'], 
