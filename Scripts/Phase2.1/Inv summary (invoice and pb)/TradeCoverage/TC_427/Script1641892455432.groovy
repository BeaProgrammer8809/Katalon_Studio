...
def actual_SelectedBank=Mobile.getText(findTestObject('Phase2/BIDropdown/Dropdown_Name'), 0)

def expected_SelectedBank=findTestData('Phase2.1/Common_Data/CommonData').getValue('Bank', 4)

Mobile.verifyMatch(actual_SelectedBank, expected_SelectedBank, false, FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_427'],
	FailureHandling.STOP_ON_FAILURE)
