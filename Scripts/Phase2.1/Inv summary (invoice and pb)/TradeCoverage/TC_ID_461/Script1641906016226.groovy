...
Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_369'], 
...
def FolioProdBuy_Text = Mobile.setText(findTestObject('Phase2/BIEnterTheFolioNoPopup01/FolioProdBuy_EditText'), findTestData(
        'Phase2.1/TY_04/Phase2.1_Sheet2').getValue(6, 34), 0)
...
def Folio = findTestData('Phase2.1/TY_04/Phase2.1_Sheet2').getValue(5, 34)

println Folio

def Num = findTestData('Phase2.1/TY_04/Phase2.1_Sheet2').getValue(6, 34)
...
Mobile.verifyMatch(Folio_No.toString(),findTestData('Phase2.1/TY_04/Phase2.1_Sheet2').getValue(4, 34), false,FailureHandling.STOP_ON_FAILURE)

//Print_Preview_Page.contains(FolioNo_Text)
//
//Print_Preview_Page.contains(FolioProdBuy_Text)

Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_461'], 
    FailureHandling.STOP_ON_FAILURE)
