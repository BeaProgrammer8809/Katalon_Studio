...
GlobalVariable.ProductName = findTestData('Phase2/Common_Data/CommonData_03').getValue(6, 44)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/TradeCoverage/Screenshot'), 
    [('testCaseName') : 'TC_ID_082_SummaryScreen'], FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/TradeCoverage/Screenshot'),
	[('testCaseName') : 'TC_ID_082_PrintScreen'], FailureHandling.STOP_ON_FAILURE)
