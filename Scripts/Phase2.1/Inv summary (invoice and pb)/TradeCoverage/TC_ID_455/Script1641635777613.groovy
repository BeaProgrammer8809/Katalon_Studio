...
GlobalVariable.ProductName = findTestData('Phase2.1/TY_11/TestData').getValue(3, 54)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/TradeCoverage/ScreenShot'), [('testCaseName') : 'TC_ID_455'],
	FailureHandling.STOP_ON_FAILURE)
...
def ExpectedToastMessage = findTestData('Phase2.1/TY_11/TestData').getValue(4, 54)
