...
Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_115(1)'], 
    FailureHandling.STOP_ON_FAILURE)
...
//value = value.round(2)
Mobile.verifyEqual(actualValueText, SkuTotalPriceText, FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_115(2)'], 
    FailureHandling.STOP_ON_FAILURE)
