...
Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/TradeCoverage/Screenshot'),
	[('testCaseName') : 'TC_433'] , FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyMatch(verifytheToastMessage, findTestData('Phase2.1/TY_12/Invsummary(invoiceandpb)/TradeCoverage/TradeCoverage').getValue(5, 14), false,FailureHandling.STOP_ON_FAILURE)
...
println('Verifying the tost message "Pay Minimum amount to proceed the invoice error message"  ')
