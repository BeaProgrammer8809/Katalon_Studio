...
def OrderSRP_Price = Mobile.getText(findTestObject('Phase2/BIOrderAndInvoiceScreen01/SRP_Price'), 0)

println(OrderSRP_Price)
...
def PBSRP_Price = Mobile.getText(findTestObject('Phase2/BIProductBuyingScreen01/SRP_Price'), 0)
...
Mobile.verifyMatch(OrderSRP_Price, UpriceText, false, FailureHandling.STOP_ON_FAILURE)

println(UpriceText)

Mobile.verifyMatch(PBSRP_Price, UpriceText, false, FailureHandling.STOP_ON_FAILURE)

//Mobile.tap(findTestObject('Object Repository/Phase2/BIInvoiceSummaryScreen/BIAmountSplitUpPopup01/Close_Button'), 0)
Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/Trade_Coverage/Screenshot'), [('testCaseName') : 'TC_ID_013'], 
    FailureHandling.STOP_ON_FAILURE)
