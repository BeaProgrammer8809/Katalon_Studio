...
def ItemDiscc = ItemDisc01.replaceAll(' ', '')
println(ItemDiscc)

Double ItemDiscount = ((ItemDiscc) as Double)
...
def CategoryDiscount = 0 //Since CategoryDiscount disc is not mapped

def SecondGross = SkuGross - ItemDiscount
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_52'], FailureHandling.STOP_ON_FAILURE)
