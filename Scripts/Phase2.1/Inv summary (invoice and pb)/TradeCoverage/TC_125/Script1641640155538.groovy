...
GlobalVariable.ProductName = findTestData('Phase2.1/CommonData/CommonData').getValue('ProductName', 8)
...
println('Since SkuGross and DiscountedSKUPrice1 are  equal  discounts are not mapped')

Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_125'], FailureHandling.STOP_ON_FAILURE)
