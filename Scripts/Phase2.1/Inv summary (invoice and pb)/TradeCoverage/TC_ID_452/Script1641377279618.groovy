...
GlobalVariable.ProductName = findTestData('Phase2.1/TY_11/TestData').getValue(3, 51)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/TradeCoverage/ScreenShot'), [('testCaseName') : 'TC_ID_452_'], 
    FailureHandling.STOP_ON_FAILURE)
...
def ExpectedToastMessage = findTestData('Phase2.1/TY_11/TestData').getValue(4, 51)

actualtoastmessage.contains(ExpectedToastMessage)
println("toast message is matching with expected  ")
