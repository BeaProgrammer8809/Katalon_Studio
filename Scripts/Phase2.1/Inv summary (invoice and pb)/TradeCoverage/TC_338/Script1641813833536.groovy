...
//
//Mobile.tap(findTestObject('Phase2/BICalenderPopup/8_Date'), 0)
//
//Mobile.tap(findTestObject('Phase2/BICalenderPopup/OK_button'), 0)
...
Mobile.verifyEqual(ActualErrormessage, findTestData('Phase2.1/TestData/Test_Data').getValue(2, 49), FailureHandling.STOP_ON_FAILURE)

Mobile.verifyEqual(Title, findTestData('Phase2.1/TestData/Test_Data').getValue(3, 49), FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_338'], 
    FailureHandling.STOP_ON_FAILURE)
