...
GlobalVariable.RetailerName = findTestData('Phase2/Common_Data/CommonData_03').getValue(4, 1)
...
def v2 = Mobile.verifyElementNotVisible(findTestObject('Phase2/BIInvoiceSummaryScreen/Collection_Icon'), 0)
...
def v4 = Mobile.verifyElementNotVisible(findTestObject('Phase2/BIInvoiceSummaryScreen/PrintPreticket_Icon'), 0)
...
def v17=Mobile.verifyElementVisible(findTestObject('Phase2/BIInvoiceSummaryScreen/BIWildCardRetailer/--Select--DropdownName'), 0)

println "Is Reason Select dropdown displayed? "+v17

def v18=Mobile.verifyElementVisible(findTestObject('Phase2/BIInvoiceSummaryScreen/BIWildCardRetailer/Please_collect_cash_CheckBox'), 
    0)

println "Is Please collect cash check box displayed? "+v18

Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/TradeCoverage/Screenshot'), 
    [('testCaseName') : 'TC_ID_005_SummaryScreen'], FailureHandling.STOP_ON_FAILURE)
