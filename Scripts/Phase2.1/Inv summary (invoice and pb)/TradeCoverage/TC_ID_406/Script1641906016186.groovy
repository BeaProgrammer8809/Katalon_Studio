...
Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_406'], FailureHandling.STOP_ON_FAILURE)
...
def Cheque_Num_Before = Mobile.getText(findTestObject('Phase2/BICollectionScreen01/BIChequesScreen01/ChequeNum_EditText'), 
    0)

def Cheque_Num_After = Mobile.setText(findTestObject('Phase2/BICollectionScreen01/BIChequesScreen01/ChequeNum_EditText'), 
    findTestData('Phase2.1/TY_04/Phase2.1_Sheet2').getValue(14, 45), 0)

Mobile.verifyNotEqual(Cheque_Num_Before, Cheque_Num_After, FailureHandling.STOP_ON_FAILURE)

println('Number is allowed to enter inside the Cheque No field')
