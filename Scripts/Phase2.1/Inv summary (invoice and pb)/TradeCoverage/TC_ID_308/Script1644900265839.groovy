...
def Actual_DecimalChequeNumberEntered=Mobile.getAttribute(findTestObject('Phase2/BICollectionScreen01/BIChequesScreen01/ChequeNum_EditText') , 'text', 0)
println(Actual_DecimalChequeNumberEntered+'Actual ChequeNumberEntered')

def Expected_DecimalChequeNumberEntered = findTestData('Phase2.1/TY_14/TestData').getValue('Data', 32)
println(Expected_DecimalChequeNumberEntered+'ExpectedChequeNumberEntered')

Mobile.verifyNotMatch(Actual_DecimalChequeNumberEntered, Expected_DecimalChequeNumberEntered, false)

Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_308'], FailureHandling.STOP_ON_FAILURE)
