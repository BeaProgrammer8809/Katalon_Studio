...
println('Since SkuGross and DiscountedSKUPrice1 are not equal itemAndCategorydiscounts  is  mapped')

Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_148'], FailureHandling.STOP_ON_FAILURE)
