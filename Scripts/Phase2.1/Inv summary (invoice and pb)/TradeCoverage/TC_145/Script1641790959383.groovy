...
GlobalVariable.ProductName = findTestData('Phase2.1/CommonData/CommonData').getValue('ProductName', 38)
...
println('Since DiscountedSKUPrice1 and TotalValue1 are not  equal tax are mapped')

Mobile.verifyEqual(SkuGross, DiscountedSKUPrice1, FailureHandling.STOP_ON_FAILURE)
println('Since SkuGross and DiscountedSKUPrice1 are not equal discounts  are not  mapped')

Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_145'], FailureHandling.STOP_ON_FAILURE)
