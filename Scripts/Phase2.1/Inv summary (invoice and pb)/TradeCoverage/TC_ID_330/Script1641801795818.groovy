...
GlobalVariable.DropdownOption = findTestData('Phase2/Common_Data/CommonData_01').getValue('Branch', 4)

Mobile.tap(findTestObject('Object Repository/Phase2/BIDropdown/Dropdown_Option'), 0)

GlobalVariable.DropdownName = findTestData('Phase2/Common_Data/CommonData_01').getValue('Branch', 4)

def Branch_Name = Mobile.getText(findTestObject('Object Repository/Phase2/BIDropdown/Dropdown_Name'), 0)

println(Branch_Name)

Mobile.verifyEqual(Branch_Name, findTestData('Phase2.1/TY_01/Test_Data').getValue(4, 79), FailureHandling.STOP_ON_FAILURE)

println "User is  able to select any bank branch from the dropdown"

Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_330'],
