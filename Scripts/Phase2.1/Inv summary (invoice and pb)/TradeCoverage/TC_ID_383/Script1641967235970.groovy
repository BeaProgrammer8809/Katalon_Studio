...
Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_383_Expected_Amount'], FailureHandling.STOP_ON_FAILURE)
