...
Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_365'], 
    FailureHandling.STOP_ON_FAILURE)
...
Mobile.comment('Collection popup details should get reset')

Mobile.verifyNotMatch(AmountInEfectivo, AmountInEfectivoAfterReset, false, FailureHandling.STOP_ON_FAILURE)
