...
def Bank_Name = Mobile.getText(findTestObject('Object Repository/Phase2/BIDropdown/Dropdown_Name'), 0)

println(Bank_Name)

Mobile.verifyMatch(Bank_Name, findTestData('Phase2.1/TY_01/Test_Data').getValue(4, 77), false, FailureHandling.STOP_ON_FAILURE)

println "User is  able to select  bank from Select Bank dropdown menu"

Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_328'],
