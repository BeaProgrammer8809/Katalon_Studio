...
GlobalVariable.ProductName = findTestData('Phase2.1/TY_11/TestData').getValue(3, 52)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/TradeCoverage/ScreenShot'), [('testCaseName') : 'TC_ID_453'],
	FailureHandling.STOP_ON_FAILURE)
...
Exppesitocommision = findTestData('Phase2.1/TY_11/TestData').getValue(4, 52)
