...
Mobile.verifyEqual(compDiscSymbol, findTestData('Phase2.1/TY_01/Test_Data').getValue(4, 65))
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_197'],
