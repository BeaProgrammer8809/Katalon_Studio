...
Mobile.verifyMatch(Branch_Name, findTestData('Phase2.1/TY_01/Test_Data').getValue(4, 78), false, FailureHandling.STOP_ON_FAILURE)

println "Select Branch is  displayed after choosing any bank from Select Bank field and It is be mandatory field"

Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_329'],
