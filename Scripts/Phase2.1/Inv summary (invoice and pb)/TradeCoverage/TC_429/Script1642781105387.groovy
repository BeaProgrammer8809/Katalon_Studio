...
Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/TradeCoverage/Screenshot'),
	[('testCaseName') : 'TC_429_toastMSG'] , FailureHandling.STOP_ON_FAILURE)
...
println('Verifying the Select Branch Toast message')
...
Mobile.verifyElementExist(findTestObject('Object Repository/Phase2/BIDropdown/Dropdown_Option'), 0)

Mobile.verifyElementVisible(findTestObject('Object Repository/Phase2/BIDropdown/Dropdown_Option'), 0)
