...
Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_404'], FailureHandling.STOP_ON_FAILURE)
...
//def Expected = findTestData('Phase2/TY_01/Test_Data').getValue(16, 39)

def Expected = findTestData('Phase2.1/TY_04/Phase2.1_Sheet2').getValue(16, 39)
...
println('Select Chequetype is dropdown and its an mandatory field')
