...
double Tot_paidText = Double.parseDouble(Tot_paid_txt)

println(Tot_paidText + 'Tot_paid_txt ')

'Calculating the invoiceAmt - TotalPaid_txt'
diffrence = (invoiceAmt - Tot_paidText)
...
def Balance_txt = Mobile.getText(findTestObject('Phase2/BICollectionScreen01/BICreditNoteScreen01/Balance_TextView'), 0)

println(Balance_txt + 'Bal_txt ')
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_283'], 
    FailureHandling.STOP_ON_FAILURE)

Mobile.verifyMatch(Balance_txt, ExpectedBaltxt, false, FailureHandling.STOP_ON_FAILURE)
