...
def Title = Mobile.getText(findTestObject('Phase2/BIInvoiceSummaryScreen/BIEnterTheFolioNoPopup01/EnterTheFolioNumber_PopupTitle'), 
    0)

Mobile.verifyEqual(Title, findTestData('Phase2.1/TestData/Test_Data').getValue(2, 58), FailureHandling.STOP_ON_FAILURE)
