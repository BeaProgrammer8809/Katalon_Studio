...
GlobalVariable.RetailerName = findTestData('Phase2/Common_Data/CommonData_03').getValue(3, 2)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/TradeCoverage/Screenshot'),
		[('testCaseName') : 'TC_ID_004_SummaryScreen'], FailureHandling.STOP_ON_FAILURE)
