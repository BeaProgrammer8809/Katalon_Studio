...
Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_384_Expected_Total_Amount'], FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyEqual(Expected_Inv_Amt, Expected_Total_Amt_Present, FailureHandling.STOP_ON_FAILURE)
