...
def ActualTitle = Mobile.getText(findTestObject('Phase2/BIInvoiceSummaryScreen/PreTicket_Print_Preview_Title'), 0)

def ExpectedTitle= findTestData('Phase2.1/TY_11/TestData').getValue(4, 50)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/TradeCoverage/ScreenShot'), [('testCaseName') : 'TC_ID_460_invoiceSummary'],
