...
Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_093(1)'], 
    FailureHandling.STOP_ON_FAILURE)

Mobile.comment('Verifying the total price')

Mobile.verifyEqual(TotalPrice1, SkuTotalPrice)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_093(2)'], 
    FailureHandling.STOP_ON_FAILURE)
