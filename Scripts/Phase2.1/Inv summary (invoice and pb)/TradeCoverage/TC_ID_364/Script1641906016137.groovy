...
Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_364'], FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyElementExist(findTestObject('Object Repository/Phase2/BICollectionScreen01/DeletePayment_PopupTitle'), 0, FailureHandling.STOP_ON_FAILURE)

println(' Do you want to delete payment transaction ? text is visible and present on the popup')

Mobile.verifyElementExist(findTestObject('Object Repository/Phase2/BICollectionScreen01/Yes_ButtonPopup'), 0, FailureHandling.STOP_ON_FAILURE)

println('Yes button is present on the popup')

Mobile.verifyElementExist(findTestObject('Object Repository/Phase2/BICollectionScreen01/Cancel_ButtonPopup'), 0, FailureHandling.STOP_ON_FAILURE)

println('Cancel button is present on the popup')
