...
Mobile.setText(findTestObject('Phase2/BICollectionScreen01/BIChequesScreen01/ChequeNum_EditText'), findTestData('Phase2.1/TY_12/Invsummary(invoiceandpb)/TradeCoverage/TradeCoverage').getValue(
        2, 7), 0)

Mobile.tap(findTestObject('Phase2/BICollectionScreen01/Submit_Button'), 0)

Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/TradeCoverage/Screenshot'),
	[('testCaseName') : 'TC_301'] , FailureHandling.STOP_ON_FAILURE)
...
def ExpectedToastMessage = findTestData('Phase2.1/TY_12/Invsummary(invoiceandpb)/TradeCoverage/TradeCoverage').getValue(
    3, 7)
...
println('Verifying the tost message "Select Bank "  ')

'Select bank'
GlobalVariable.DropdownName = findTestData('Phase2.1/Common_Data/CommonData').getValue('DropdownName', 1)

Mobile.verifyElementExist(findTestObject('Object Repository/Phase2/BIDropdown/Dropdown_Name'), 0)

Mobile.verifyElementVisible(findTestObject('Object Repository/Phase2/BIDropdown/Dropdown_Name'), 0)
