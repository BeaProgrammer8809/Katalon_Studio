...
def BeforeEnteringNumbers = Mobile.getAttribute(findTestObject('Phase2/BICollectionScreen01/BITransferenciasElectronicasScreen01/ReferenceNum_EditText'), 
    'text', 0)

println(BeforeEnteringNumbers)
...
def AfterEnteringNumbers = Mobile.getAttribute(findTestObject('Phase2/BICollectionScreen01/BITransferenciasElectronicasScreen01/ReferenceNum_EditText'), 
    'text', 0)

println(AfterEnteringNumbers)

Mobile.verifyNotEqual(BeforeEnteringNumbers, AfterEnteringNumbers, FailureHandling.STOP_ON_FAILURE)

println "Number is  allowed to enter inside the Reference No field"

Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_331'], 
