...
Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_ID_463'], FailureHandling.STOP_ON_FAILURE)
...
def FolioProdBuy_Text = Mobile.setText(findTestObject('Phase2/BIEnterTheFolioNoPopup01/FolioProdBuy_EditText'), findTestData(
        'Phase2.1/TY_04/Phase2.1_Sheet2').getValue(4, 36), 0)
...
def Folio = findTestData('Phase2.1/TY_04/Phase2.1_Sheet2').getValue(5, 36)

println Folio

def Num = findTestData('Phase2.1/TY_04/Phase2.1_Sheet2').getValue(6, 36)
...
Mobile.verifyMatch(Folio_No.toString(),findTestData('Phase2.1/TY_04/Phase2.1_Sheet2').getValue(4, 36), false,FailureHandling.STOP_ON_FAILURE)
