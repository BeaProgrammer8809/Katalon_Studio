...
Mobile.setText(findTestObject('Phase2/BICollectionScreen01/BITransferenciasElectronicasScreen01/ReferenceNum_EditText'), 
    findTestData('Phase2/TY_03/TestData_Phase2.1').getValue(2, 22), 0)

def refNum = Mobile.getAttribute(findTestObject('Phase2/BICollectionScreen01/BITransferenciasElectronicasScreen01/ReferenceNum_EditText'), 
    'text', 0)

Mobile.verifyElementAttributeValue(findTestObject('Phase2/BICollectionScreen01/BITransferenciasElectronicasScreen01/ReferenceNum_EditText'), 
    'text', refNum, 0, FailureHandling.STOP_ON_FAILURE)

println('Reference number field is accepting alphanumeric values')

Mobile.callTestCase(findTestCase('Reusable Cases/Mobile/Phase2.1/Bank_Branch'), [:], FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('Object Repository/Phase2/BICollectionScreen01/BITransferenciasElectronicasScreen01/Calendar_Button'), 
    0)

Mobile.tap(findTestObject('Object Repository/Phase2/BICollectionScreen01/BICalenderPopup/10_Date'), 0)

Mobile.tap(findTestObject('Object Repository/Phase2/BICollectionScreen01/BICalenderPopup/OK_button'), 0)

def pastDate = Mobile.getAttribute(findTestObject('Object Repository/Phase2/BICollectionScreen01/BITransferenciasElectronicasScreen01/Calendar_Button'), 
    'text', 0)

println('Actual date entered is ' + pastDate)
...
Mobile.verifyNotMatch(pastDate, PresentDate, false, FailureHandling.STOP_ON_FAILURE)

println('User is able to submit amount with past date')

Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/TradeCoverage/ScreenShot'), [('testCaseName') : 'TC_ID_440_CollectionScreen'], 
    FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('Object Repository/Phase2/BICollectionScreen01/Submit_Button'), 0)

def expTitle = findTestData('Phase2/TY_03/TestData_Phase2.1').getValue(3, 38)

def actualTitle = Mobile.getText(findTestObject('Phase2/BIInvoiceSummaryScreen/BIEnterTheFolioNoPopup01/EnterTheFolioNumber_PopupTitle'), 
    0)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/TradeCoverage/ScreenShot'), [('testCaseName') : 'TC_ID_440_SummaryScreen'], 
    FailureHandling.STOP_ON_FAILURE)
