...
Mobile.tap(findTestObject('Object Repository/Phase2/BIDropdown/Dropdown_Option'), 0)
def Actual_Branch=Mobile.getText(findTestObject('Object Repository/Phase2/BIDropdown/Dropdown_Option'), 0)


Mobile.verifyMatch(Actual_Branch,findTestData('Phase2.1/Common_Data/CommonData').getValue(8,3), false)
