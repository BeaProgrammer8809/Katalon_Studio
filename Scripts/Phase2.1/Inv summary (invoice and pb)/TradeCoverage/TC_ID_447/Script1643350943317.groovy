...
GlobalVariable.ProductName = findTestData('Phase2/Common_Data/CommonData').getValue(6, 17)
...
def expEffAmt = findTestData('Phase2/Common_Data/CommonData').getValue(5, 10)
