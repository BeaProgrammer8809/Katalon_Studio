...
def All_Total_Amt = Double.parseDouble(Efectivo_Amt) + Double.parseDouble(CreditNote_Amt) + Double.parseDouble(PesitoCredit_Amt) + Double.parseDouble(TransferenciasElectronicas_Amt) + Double.parseDouble(Cheque_Amt)
