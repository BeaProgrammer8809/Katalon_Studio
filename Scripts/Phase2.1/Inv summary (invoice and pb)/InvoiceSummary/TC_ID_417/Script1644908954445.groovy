...
Mobile.getText(findTestObject('Object Repository/Phase2/BIInvoiceSummaryScreen/BICollectionScreen01/Amount_EditText'), 0)
...
Mobile.verifyNotEqual(FutureDate, PresentDate, FailureHandling.STOP_ON_FAILURE)
...
def FuturedateAfterSubmittingAmount=Mobile.getText(findTestObject('Phase2/BICollectionScreen01/BIChequesScreen01/Calendar_Button'), 0)

Mobile.verifyEqual(FutureDate, FuturedateAfterSubmittingAmount, FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC_417_Collection'], FailureHandling.STOP_ON_FAILURE)


println "User should be able to submit the invoice amount with future Cheque date"


Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC_417_Summary'], FailureHandling.STOP_ON_FAILURE)
