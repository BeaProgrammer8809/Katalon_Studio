...
//  Double DiscountItem = ((discountitem) as Double)
 ...
 def  Discountitem1= discountitem.split('-')
 def Discountitem2= Discountitem1[1]
 def Discountitem3 = Discountitem2.replaceAll(' ', '')
 
  Double DiscountItem = ((Discountitem3) as Double)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC_061_AmountSplitUp'], FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC_061_printScreen'], FailureHandling.STOP_ON_FAILURE)
