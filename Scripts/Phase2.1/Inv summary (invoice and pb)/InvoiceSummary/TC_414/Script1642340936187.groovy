...
Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC_414_Collection'], FailureHandling.STOP_ON_FAILURE)
...
def Expectedtoastmessage = findTestData('Phase2.1/TY_05/Collection').getValue(3, 52)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC_414_Summary'], FailureHandling.STOP_ON_FAILURE)
