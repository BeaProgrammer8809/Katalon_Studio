...
Double ordervalue = ((OrderValue) as Double)
 ...
 def compDiscSymbol = Compdic2.replaceAll(' ', '')
...
def item = value - Buyprice
def skuGross= SkuGross + item


def SecondGross = skuGross - CompDisc

println "$SecondGross"

def category= ordervalue - SkuGross
println "$category"
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC_067_AmountSplitUp'], FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv summary (invoice and pb)/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC_067'], FailureHandling.STOP_ON_FAILURE)
