...
Mobile.verifyEqual(invAmtText, TranAmt, FailureHandling.STOP_ON_FAILURE)
println("Complete invoice amount is entered in Transfercia mode ")

Mobile.verifyEqual(TransMode, findTestData('Phase2.1/TestData/Test_Data').getValue(3, 2), FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/Collection/Screenshot'), [('testCaseName') : 'TC_311'], 
