...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/Collection/Screenshot'), [('testCaseName') : 'TC_334'], 
    FailureHandling.STOP_ON_FAILURE)

Mobile.verifyNotEqual(TransAMt, TransAMt1, FailureHandling.STOP_ON_FAILURE)

println('Transfercio amount is edited so both are  not equal')
