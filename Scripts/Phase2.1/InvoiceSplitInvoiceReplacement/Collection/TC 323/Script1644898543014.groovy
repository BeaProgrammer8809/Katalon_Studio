...
def Refere1 = Mobile.getText(findTestObject('Phase2/BICollectionScreen01/BITransferenciasElectronicasScreen01/ReferenceNum_EditText'), 
    0)
def Length=Refere1.length()

def Expected = findTestData('Phase2.1/TestData/Test_Data').getValue(5, 73)

Mobile.verifyLessThanOrEqual(Length, Expected, FailureHandling.STOP_ON_FAILURE)
println(Length+ 'refrence filed accepting lenth of characters is upto 30 only')
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/Collection/Screenshot'), [('testCaseName') : 'TC_323'], 
