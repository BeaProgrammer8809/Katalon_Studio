...
def refere2 = Mobile.getText(findTestObject('Phase2/BICollectionScreen01/BITransferenciasElectronicasScreen01/ReferenceNum_EditText'), 
    0)
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/Collection/Screenshot'), [('testCaseName') : 'TC_315'], 
    FailureHandling.STOP_ON_FAILURE)

Mobile.verifyNotEqual(TransAMt, TransAMt1, FailureHandling.STOP_ON_FAILURE)
println('Transfercio amount is edited hence both are not equal')

//Mobile.verifyEqual(Refere, refere2, FailureHandling.STOP_ON_FAILURE)
//println('Reference number same ')
