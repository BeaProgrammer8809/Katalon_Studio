...
Mobile.verifyEqual(Reference, findTestData('Phase2.1/TestData/Test_Data').getValue(6, 61), FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/Collection/Screenshot'), [('testCaseName') : 'TC_301'], 
