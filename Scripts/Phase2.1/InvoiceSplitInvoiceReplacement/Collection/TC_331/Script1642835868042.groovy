...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/Collection/Screenshot'), [('testCaseName') : 'TC_331'], 
    FailureHandling.STOP_ON_FAILURE)

Mobile.verifyNotEqual(Refere, refere2, FailureHandling.STOP_ON_FAILURE)
