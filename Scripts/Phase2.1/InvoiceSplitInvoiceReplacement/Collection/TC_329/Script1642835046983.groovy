...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/Collection/Screenshot'), [('testCaseName') : 'TC_329'], 
...
Mobile.verifyEqual(TranAmt.toString(), invAmtText.toString(), FailureHandling.STOP_ON_FAILURE)

println('Total paid  amount is paid in Transfercio mode  ')
