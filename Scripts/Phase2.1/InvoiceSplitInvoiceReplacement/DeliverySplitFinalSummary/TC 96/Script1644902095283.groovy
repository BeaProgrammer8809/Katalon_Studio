...
Mobile.callTestCase(findTestCase('Reusable Cases/Mobile/Phase2.1/Invoice Qty'), [('testData1') : findTestData('Phase2.1/Common_Data/CommonData').getValue(
            6, 17)], FailureHandling.STOP_ON_FAILURE)
...
def Expected_Invoice_Name1 = findTestData('Phase2.1/TY_04/Phase2.1_Sheet3').getValue(16, 79)
...
def Expected_Invoice_Name2 = findTestData('Phase2.1/TY_04/Phase2.1_Sheet3').getValue(17, 79)
...
def Expected_Invoice_Name3 = findTestData('Phase2.1/TY_04/Phase2.1_Sheet3').getValue(18, 79)

def Actual_Invoice_Name3 = Mobile.getText(findTestObject('Phase2/BIDeliveryFinalSummaryScreen/Invoice Split_Indexing'), 0)

Mobile.verifyMatch(Actual_Invoice_Name1, Expected_Invoice_Name1, false, FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/DeliverySplitFinalSummary/Screenshot'), [('testCaseName') : 'TC_96'], 
