...
int ActualNetAmount  = (int)NetValue
...
Mobile.verifyMatch(ActualNetAmount.toString(), ExpectedInvoiceAmount.toString(), false, FailureHandling.STOP_ON_FAILURE)

println "Inv Amt Equal to Net amount (value) displayed in summary screen"
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/SplitInvoiceReplacementAndProductBuying/Screenshot'),
	[('testCaseName') : 'TC_175'], FailureHandling.STOP_ON_FAILURE)
