...
def ExpectedToastMsg = findTestData('Phase2.1/TY_13/SplitInvoiceReplacementAndProductBuying').getValue(3, 1)
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/SplitInvoiceReplacementAndProductBuying/Screenshot'), 
    [('testCaseName') : 'TC_237'], FailureHandling.STOP_ON_FAILURE)

Mobile.verifyMatch(ActualToastMessage, ExpectedToastMsg, false, FailureHandling.STOP_ON_FAILURE)

println('We cannot Subbmit the payment without entering the RTGS Reference number.')
