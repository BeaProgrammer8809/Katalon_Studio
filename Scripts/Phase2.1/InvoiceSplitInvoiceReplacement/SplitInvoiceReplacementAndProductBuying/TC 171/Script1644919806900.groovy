...
Mobile.verifyEqual(Actual_Invoice_split, findTestData('Phase2.1/TY_01/TestData2').getValue(4, 68), FailureHandling.STOP_ON_FAILURE)

GlobalVariable.index = findTestData('Phase2.1/Common_Data/CommonData').getValue('Number', 2)

Mobile.verifyElementNotVisible(findTestObject('Phase2/BIDeliveryFinalSummaryScreen/Payment_CheckBox_Indexing'), 0)

Mobile.verifyElementNotExist(findTestObject('Phase2/BIDeliveryFinalSummaryScreen/Payment_CheckBox_Indexing'), 0)

Mobile.verifyElementNotVisible(findTestObject('Phase2/BIDeliveryFinalSummaryScreen/Efectivo_CheckBox_Indexing'), 0)

Mobile.verifyElementNotExist(findTestObject('Phase2/BIDeliveryFinalSummaryScreen/Efectivo_CheckBox_Indexing'), 0)

println " Replacement and product buying amount is not displaying in collection screen"
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/SplitInvoiceReplacementAndProductBuying/Screenshot'),
	[('testCaseName') : 'TC_171'], FailureHandling.STOP_ON_FAILURE)
