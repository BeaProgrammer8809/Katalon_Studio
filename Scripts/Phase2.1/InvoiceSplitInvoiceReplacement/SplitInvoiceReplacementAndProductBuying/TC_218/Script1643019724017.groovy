...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/Before Invoice Collection/Screenshot'), [('testCaseName') : 'TC_218_Delivery_Final_Summary_Screen_Payment_Checkbox_Checked'], FailureHandling.STOP_ON_FAILURE)
