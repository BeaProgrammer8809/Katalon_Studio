...
Mobile.verifyEqual(Actual_DefaultInvoice, findTestData('Phase2.1/TY_01/TestData2').getValue(4, 66), FailureHandling.STOP_ON_FAILURE)

println('Invoice Name is verified')

Mobile.verifyElementVisible(findTestObject('Phase2/BIDeliveryFinalSummaryScreen/Payment_CheckBox_Indexing'), 0, FailureHandling.STOP_ON_FAILURE)

Mobile.verifyElementExist(findTestObject('Phase2/BIDeliveryFinalSummaryScreen/Efectivo_CheckBox_Indexing'), 0, FailureHandling.STOP_ON_FAILURE)
...
println "payment and efectivo option for extra invoice are displaying in Delivery final summary when extra invoice is generated"
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/SplitInvoiceReplacementAndProductBuying/Screenshot'),
	[('testCaseName') : 'TC_167'], FailureHandling.STOP_ON_FAILURE)
