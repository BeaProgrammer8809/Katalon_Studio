...
def Expected_Toast_Message = findTestData('Phase2.1/TY_01/TestData2').getValue(4, 74)

Mobile.verifyMatch(Actual_Toast_Message, Expected_Toast_Message, false,FailureHandling.STOP_ON_FAILURE)

/*Verification done to check Amount text field is  not allowing to enter amount greater than Invoice amount in Total paid field */
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/SplitInvoiceReplacementAndProductBuying/Screenshot'),
	[('testCaseName') : 'TC_187'], FailureHandling.STOP_ON_FAILURE)
