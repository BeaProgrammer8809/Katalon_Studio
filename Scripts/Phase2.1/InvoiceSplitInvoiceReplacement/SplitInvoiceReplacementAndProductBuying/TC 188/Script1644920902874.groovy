...
def BalanceText=findTestData('Phase2.1/TY_01/TestData2').getValue(4, 75)

def ExpectedBalanceText3= BalanceText + ' ' + Totallesservalue.toString() + ' of ' + InvoiceAmountText.toString()
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/SplitInvoiceReplacementAndProductBuying/Screenshot'),
	[('testCaseName') : 'TC_188'], FailureHandling.STOP_ON_FAILURE)
