...
Mobile.verifyElementAttributeValue(findTestObject('Phase2/BICollectionScreen01/BICreditNoteScreen01/Amount_EditText'), 'enabled', findTestData('Phase2.1/TY_01/TestData2').getValue(4, 77),
	 0, FailureHandling.STOP_ON_FAILURE)

println "Credit note amount is  not editable in collection screen"
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/SplitInvoiceReplacementAndProductBuying/Screenshot'),
	[('testCaseName') : 'TC_179'], FailureHandling.STOP_ON_FAILURE)
