...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/SplitInvoiceReplacementAndProductBuying/Screenshot'), [('testCaseName') : 'TC_202_Actual_Pieces_Value_And_Actual_Return_Qty'], FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/SplitInvoiceReplacementAndProductBuying/Screenshot'), [('testCaseName') : 'TC_202_Actual_PB_Qty'], FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/SplitInvoiceReplacementAndProductBuying/Screenshot'), [('testCaseName') : 'TC_202_Expected_Values'], FailureHandling.STOP_ON_FAILURE)
...
//Verification to check that Select Branch is not displaying its option before selecting the bank
GlobalVariable.DropdownName = findTestData('Phase2.1/Common_Data/CommonData').getValue(10, 2)
Mobile.tap(findTestObject('Object Repository/Phase2/BIDropdown/Dropdown_Name'), 0)
Mobile.verifyElementAttributeValue(findTestObject('Object Repository/Phase2/BIDropdown/Dropdown_Name'), 'enabled', 'false', 0, FailureHandling.STOP_ON_FAILURE)
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Inv, Rep and P)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_202_Select_Branch_Options_Not_Displayed'], FailureHandling.STOP_ON_FAILURE)

//Verification to check that bank is selected
...
//Verification to check that select branch is a Mandatory field
GlobalVariable.DropdownName = findTestData('Phase2.1/Common_Data/CommonData').getValue(10, 2)
Mobile.tap(findTestObject('Object Repository/Phase2/BIDropdown/Dropdown_Name'), 0)
...
for (WebElement ele : dropdown1)
{
	...
	if (val.equals(GlobalVariable.DropdownOption)) {
		ele.click()
		break
	}
}
println "Select branch its a madatory field"

//Verification to check that Select Branch is displaying its option before selecting the bank
GlobalVariable.DropdownName = findTestData('Phase2.1/Common_Data/CommonData').getValue(10, 2)
Mobile.tap(findTestObject('Object Repository/Phase2/BIDropdown/Dropdown_Name'), 0)
Mobile.verifyElementAttributeValue(findTestObject('Object Repository/Phase2/BIDropdown/Dropdown_Name'), 'enabled', 'true', 0, FailureHandling.STOP_ON_FAILURE)
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/SplitInvoiceReplacementAndProductBuying/Screenshot'), [('testCaseName') : 'TC_202_Select_Branch_Options_Is_Displayed'], FailureHandling.STOP_ON_FAILURE)
