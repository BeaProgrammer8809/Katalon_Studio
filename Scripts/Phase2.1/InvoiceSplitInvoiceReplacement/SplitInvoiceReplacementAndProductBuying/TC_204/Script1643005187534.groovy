...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/SplitInvoiceReplacementAndProductBuying/Screenshot'), [('testCaseName') : 'TC_204_Actual_Pieces_Value_And_Actual_Return_Qty'], FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/SplitInvoiceReplacementAndProductBuying/Screenshot'), [('testCaseName') : 'TC_204_Actual_PB_Qty'], FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/SplitInvoiceReplacementAndProductBuying/Screenshot'), [('testCaseName') : 'TC_204_Expected_Values'], FailureHandling.STOP_ON_FAILURE)
...
//Verification to check that select bank is a dropdown and mandatory field
...
//Verification to check that select Cheque type is a dropdown
AppiumDriver driver = MobileDriverFactory.getDriver()
List<WebElement> dropdown = driver.findElementsByClassName('android.widget.CheckedTextView')
def num=dropdown.size()
for(WebElement ele:dropdown)
{
	println ele.getText()
}
Mobile.verifyGreaterThanOrEqual(num, '1', FailureHandling.STOP_ON_FAILURE)
println "Select Cheque type is a dropDown"

//Verification to check that select cheque type is a Mandatory field
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/SplitInvoiceReplacementAndProductBuying/Screenshot'), [('testCaseName') : 'TC_204_Select_Cheque_Type_Dropdown'], FailureHandling.STOP_ON_FAILURE)
println "Select Cheque type is a madatory field"
