...
Mobile.verifyElementNotExist(findTestObject('Phase2/BIDeliveryFinalSummaryScreen/Payment_CheckBox'), 0, FailureHandling.STOP_ON_FAILURE)

println " Collection option is not displaying when invoice generated with pure replacement"
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/SplitInvoiceReplacementAndProductBuying/Screenshot'),
	[('testCaseName') : 'TC_163'], FailureHandling.STOP_ON_FAILURE)
