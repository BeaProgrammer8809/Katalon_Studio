...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/SplitInvoiceReplacementAndProductBuying/Screenshot'), [('testCaseName') : 'TC_193_Actual_Pieces_Value_And_Actual_Return_Qty'], FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/SplitInvoiceReplacementAndProductBuying/Screenshot'), [('testCaseName') : 'TC_193_Actual_PB_Qty'], FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/SplitInvoiceReplacementAndProductBuying/Screenshot'), [('testCaseName') : 'TC_193_Expected_Values'], FailureHandling.STOP_ON_FAILURE)
...
def Expected_Collection_Title = findTestData('Phase2.1/TY_02/Test_Data_Phase2').getValue(5, 147)
...
//Verification to check 3. Cheque mode is selected
...
def Balance = Actual_Balance_Amt.split(Full_Invoice_Amount)
def New_Balance = Balance[0]
def Expected_Balance_Amt = New_Balance + Full_Invoice_Amount  
...
def Cheque_Amount= Mobile.getText(findTestObject('Object Repository/Phase2/BICollectionScreen01/BIChequesScreen01/Amount_EditText'), 0)
...
//Verification to check 6. Select Bank, Select Branch and Select Cheque dropdown should be displayed.
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/SplitInvoiceReplacementAndProductBuying/Screenshot'), [('testCaseName') : 'TC_193_Display_Of_Cheque_Modes'], FailureHandling.STOP_ON_FAILURE)
