...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/SplitInvoiceReplacementAndProductBuying/Screenshot'), [('testCaseName') : 'TC_201_Actual_Pieces_Value_And_Actual_Return_Qty'], FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/SplitInvoiceReplacementAndProductBuying/Screenshot'), [('testCaseName') : 'TC_201_Actual_PB_Qty'], FailureHandling.STOP_ON_FAILURE)
...
def Expected_Bank_Name = findTestData('Phase2.1/Common_Data/CommonData').getValue(10, 1)
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/SplitInvoiceReplacementAndProductBuying/Screenshot'), [('testCaseName') : 'TC_201_Expected_Values'], FailureHandling.STOP_ON_FAILURE)
...
//Verification to check that select bank is a dropdown
...
//Verification to check that user is able to select any option in select bank dropdown
...
//Verification to check that select select bank
Mobile.verifyElementAttributeValue(findTestObject('Object Repository/Phase2/BIDropdown/Dropdown_Option'), 'text', GlobalVariable.DropdownOption, 0, FailureHandling.STOP_ON_FAILURE)
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/SplitInvoiceReplacementAndProductBuying/Screenshot'), [('testCaseName') : 'TC_201_Select_Bank_Dropdown'], FailureHandling.STOP_ON_FAILURE)
