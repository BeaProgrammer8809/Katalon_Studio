...
Mobile.verifyEqual(Actual_Invoice_split, findTestData('Phase2.1/TY_01/TestData2').getValue(4, 69), FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/SplitInvoiceReplacementAndProductBuying/Screenshot'),
	[('testCaseName') : 'TC_172'], FailureHandling.STOP_ON_FAILURE)
