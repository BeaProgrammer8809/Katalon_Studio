...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/Invoice Summary/Screenshot'), [('testCaseName') : 'TC_149'], 
    FailureHandling.STOP_ON_FAILURE)
...
def Expected_Invoice_Popup_Text = findTestData('Phase2.1/TY_04/Phase2.1_Sheet3').getValue(16, 118)

boolean Invoice_PopUp_Text = Actual_Invoice_And_UUID_PopUp_Text.contains(Expected_Invoice_Popup_Text)

def Expected_UUID_Popup_Text = findTestData('Phase2.1/TY_04/Phase2.1_Sheet3').getValue(17, 118)
...
Mobile.verifyMatch(Invoice_PopUp_Text.toString(), findTestData('Phase2.1/TY_04/Phase2.1_Sheet3').getValue(18, 118), false, 
    FailureHandling.STOP_ON_FAILURE)

//Verification to check that UUID is gerenated 
Mobile.verifyMatch(UUID_PopUp_Text.toString(), findTestData('Phase2.1/TY_04/Phase2.1_Sheet3').getValue(18, 118), false, 
    FailureHandling.STOP_ON_FAILURE)
