...
0, FailureHandling.STOP_ON_FAILURE)) {
	...
	Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_394_SchemeScreen'],
...
def expRFC = findTestData('Phase2/TY_03/TestData_Phase2.1').getValue(2, 32)
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_394_printScreen'],
FailureHandling.STOP_ON_FAILURE)
