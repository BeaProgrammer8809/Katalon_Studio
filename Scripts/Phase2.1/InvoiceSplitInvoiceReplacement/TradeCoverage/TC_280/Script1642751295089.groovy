...
//without entering ivoice amount we won't get collection screen
GlobalVariable.index = findTestData('Phase2.1/Common_Data/CommonData').getValue('Number', 1)
...
def expectedFolioNum=findTestData('Phase2.1/TY_14/TestData').getValue('Data', 64)

Mobile.verifyMatch(folioNum, expectedFolioNum, false, FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_280'],
	FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('Phase2/BIDeliveryFinalSummaryScreen/Create_Final_Invoice_Button'), 0)

Mobile.tap(findTestObject('Phase2/BIDeliveryFinalSummaryScreen/Preticket_PopUp_OK_Button'), 0, FailureHandling.OPTIONAL)
