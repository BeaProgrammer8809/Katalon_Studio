...
def splitRetailer1=actualRetailerName.split("STORE NAME:")

splitRetailer1=splitRetailer1[1]

def splitRetailer2=splitRetailer1.split("CUSTOMER CODE:")

actualRetailerName=splitRetailer2[0]

actualRetailerName=actualRetailerName.trim()

println actualRetailerName
...
Mobile.verifyMatch(actualRetailerName, expRetailerName, false, FailureHandling.STOP_ON_FAILURE)

println "Invoice can be generated for store name with special character"

Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_414_printScreen'], 
