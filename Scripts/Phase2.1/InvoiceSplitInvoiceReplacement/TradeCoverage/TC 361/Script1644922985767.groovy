...
Mobile.callTestCase(findTestCase('Reusable Cases/Mobile/Phase2.1/OnlyInvoceFor3LegalEntryScheme_Reusable'), [:], FailureHandling.STOP_ON_FAILURE)
...
Mobile.tap(findTestObject('Phase2/BIDeliveryFinalSummaryScreen/Efectivo_CheckBox'), 0)*/
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_361'], 
...
def RFCID = findTestData('Phase2.1/TY_06/InvoiceSplitInvoiceReplacement/TradeCoverage').getValue(3, 22)
...
date_text = RFCID.substring(8, RFCID.length() -3)
println( date_text )
