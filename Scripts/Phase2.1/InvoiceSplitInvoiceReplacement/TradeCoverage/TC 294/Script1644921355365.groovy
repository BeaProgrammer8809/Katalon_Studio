...
def onsitExpectedMessage = findTestData('Phase2.1/TY_14/TestData').getValue(5, 73)
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_294'],
	FailureHandling.STOP_ON_FAILURE)
