...
Mobile.callTestCase(findTestCase('Reusable Cases/Mobile/Phase2.1/Trade_Coverage_Generic'), [('retailerName') : findTestData(
	'Phase2/Common_Data/CommonData_03').getValue(2, 22)], FailureHandling.STOP_ON_FAILURE)
...
for (def i = 0; i < 3; i++) {
	if (i == 0) {
		...
		GlobalVariable.ProductName = findTestData('Phase2/Common_Data/CommonData_03').getValue(6, 61)
	} else {
...
0, FailureHandling.STOP_ON_FAILURE)) {
	...
	Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_392_SchemeScreen'],
...
Mobile.waitForElementPresent(findTestObject('Phase2/BIDeliveryFinalSummaryScreen/Splitted_Invoice_Saved_Successfully._TextView'), 20, FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyElementVisible(findTestObject('Phase2/BIDeliveryFinalSummaryScreen/Splitted_Invoice_Saved_Successfully._TextView'),
		40, FailureHandling.STOP_ON_FAILURE)
...
def expRFC = findTestData('Phase2/TY_03/TestData_Phase2.1').getValue(2, 28)
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_392_printScreen'],
FailureHandling.STOP_ON_FAILURE)
