...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_245'], 
    FailureHandling.STOP_ON_FAILURE)

println("Folio No field is present against invoice split and Default invoice in Delivery Final Summary Screen.")
