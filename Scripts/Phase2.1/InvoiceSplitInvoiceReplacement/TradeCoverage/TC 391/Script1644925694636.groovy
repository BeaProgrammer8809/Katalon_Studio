...
0, FailureHandling.STOP_ON_FAILURE)) {
	...
	Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_391_SchemeScreen'],
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_391_printScreen'],
FailureHandling.STOP_ON_FAILURE)
