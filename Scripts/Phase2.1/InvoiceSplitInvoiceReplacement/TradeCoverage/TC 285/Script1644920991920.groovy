...
Mobile.callTestCase(findTestCase('Reusable Cases/Mobile/Phase2.1/Trade_Coverage_Generic'), [('retailerName') : findTestData(
			'Phase2.1/Common_Data/CommonData').getValue('RetailerCash', 32)], FailureHandling.STOP_ON_FAILURE)
...
def verifyMessage = MessageResult.toString()

Mobile.verifyMatch(verifyMessage, findTestData('Phase2.1/TY_14/TestData').getValue('Data', 73), false, FailureHandling.STOP_ON_FAILURE)
...
def verifyMessage1 = MessageResult1.toString()

Mobile.verifyMatch(verifyMessage1, findTestData('Phase2.1/TY_14/TestData').getValue('Data', 73), false, FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_285'],
	FailureHandling.STOP_ON_FAILURE)
