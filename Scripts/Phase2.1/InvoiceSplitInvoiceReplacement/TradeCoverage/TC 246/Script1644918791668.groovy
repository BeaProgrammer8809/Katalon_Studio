...
Mobile.tap(findTestObject('Phase2/BIDeliverySummaryScreen/Create_Ticket_Invoice_Button'), 0, FailureHandling.OPTIONAL)
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_246'],
	FailureHandling.STOP_ON_FAILURE)

println("Folio No field is present against Product Buying split and Default Prod Buy in Delivery Final Summary Screen.")
