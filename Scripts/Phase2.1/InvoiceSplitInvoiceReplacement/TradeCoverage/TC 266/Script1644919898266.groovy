...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_266'], 
    FailureHandling.STOP_ON_FAILURE)

println('Folio NO Field is Displayed in Delivery Final Summary Screen, against invoice split and default invoice ')
