...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_250EnteredFolioNo'],
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_250PrintPreviewScreen'],
	FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyMatch(FOLIO.toString(), findTestData('Phase2.1/TY_13/SplitInvoiceReplacementAndProductBuying').getValue(5,
		6), false, FailureHandling.STOP_ON_FAILURE)
