...
def expectedFolioNum = findTestData('Phase2.1/TY_14/TestData').getValue('Folio_Number', 68)

Mobile.verifyNotMatch(folioNum, expectedFolioNum, false, FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_273'], 
