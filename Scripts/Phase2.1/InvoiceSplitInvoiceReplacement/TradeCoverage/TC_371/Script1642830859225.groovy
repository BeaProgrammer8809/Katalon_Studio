...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_371'], 
...
def RFCID = findTestData('Phase2.1/TY_06/InvoiceSplitInvoiceReplacement/TradeCoverage').getValue(3, 32)
