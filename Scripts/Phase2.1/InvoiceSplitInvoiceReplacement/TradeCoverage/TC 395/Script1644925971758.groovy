...
0, FailureHandling.STOP_ON_FAILURE)) {
	...
	Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_395_SchemeScreen'],
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_395_DeliveryFinalSummaryScreen'],
	FailureHandling.STOP_ON_FAILURE)
...
def expRFC = findTestData('Phase2/TY_03/TestData_Phase2.1').getValue(2, 29)
...
date_text = expRFC.substring(3, expRFC.length() -3)
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/TradeCoverage/Screenshot'), [('testCaseName') : 'TC_395_printScreen'],
FailureHandling.STOP_ON_FAILURE)
