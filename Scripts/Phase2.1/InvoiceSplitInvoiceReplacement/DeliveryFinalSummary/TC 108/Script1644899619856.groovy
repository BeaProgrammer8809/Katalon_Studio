...
Mobile.verifyMatch(Actual_DefaultInvoice, findTestData('Phase2.1/TY_01/TestData2').getValue(4, 82), false, FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyMatch(Actual_ExtraInvoice, findTestData('Phase2.1/TY_01/TestData2').getValue(5, 82), false, FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyMatch(Actual_ProductBuy, findTestData('Phase2.1/TY_01/TestData2').getValue(6, 82), false, FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/DeliveryFinalSummary/Screenshot'), [('testCaseName') : 'TC_108'],
