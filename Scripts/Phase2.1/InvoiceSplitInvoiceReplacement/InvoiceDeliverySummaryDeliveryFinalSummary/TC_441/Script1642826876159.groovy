...
def Pesitocommission= Pesitocomm.substring(20, 25)
 ...
 Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), [('testCaseName') : 'TC_441'], FailureHandling.STOP_ON_FAILURE)
