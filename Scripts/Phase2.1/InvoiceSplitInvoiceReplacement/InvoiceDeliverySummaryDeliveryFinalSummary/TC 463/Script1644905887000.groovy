...
println("Pesito Commission '3' should pay in Efectivo Toast message should not display if user pay ‘2’ in cash mode and remaining amount Electronic Transfer and Cheque mode.")
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'),
	[('testCaseName') : 'TC_463'], FailureHandling.STOP_ON_FAILURE)
