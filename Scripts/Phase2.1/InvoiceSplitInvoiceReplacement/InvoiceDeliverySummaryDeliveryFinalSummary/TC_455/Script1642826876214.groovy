...
println("Pesito Commission '3' should pay in Efectivo Toast message should not display if user pay full amount in Electronic Transfer mode.")
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), [('testCaseName') : 'TC_455'], FailureHandling.STOP_ON_FAILURE)
