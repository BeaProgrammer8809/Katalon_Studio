...
println('Pesito radio button is available as route retailer credit is defined for the retailer')
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), 
    ['testCaseName':'TC_417_CollectionScreen'], FailureHandling.STOP_ON_FAILURE)
