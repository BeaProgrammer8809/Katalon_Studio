...
Mobile.verifyNotEqual(actualPesitoCommissionAmt, actualEffectivoAmt, FailureHandling.STOP_ON_FAILURE)

println('Pesito commission is not displaying under effectivo mode when amount is not cleared in effectivo mode and switching from pesito mode')
...
Mobile.verifyEqual(actualEffectivoAmt, expEffectivoAmt, FailureHandling.STOP_ON_FAILURE)

println "invoice amount is displaying under effectivo mode"
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), 
    ['testCaseName':'TC_424_CollectionScreen'], FailureHandling.STOP_ON_FAILURE)
