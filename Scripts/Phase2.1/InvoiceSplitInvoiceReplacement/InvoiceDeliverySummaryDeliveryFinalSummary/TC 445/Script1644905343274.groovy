...
def EffAmount = Mobile.getText(findTestObject("Object Repository/Phase2/BIInvoiceSummaryScreen/BICollectionScreen01/Amount_EditText"), 0)
 ...
 Mobile.verifyNotEqual(PesitioAmt, EffAmount, FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyElementNotExist(findTestObject("Object Repository/Phase2/BICollectionScreen01/Collection_Title"), 0)
 ...
 Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), [('testCaseName') : 'TC_445'], FailureHandling.STOP_ON_FAILURE)
