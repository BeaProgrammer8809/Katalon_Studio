...
Mobile.callTestCase(findTestCase('Reusable Cases/Mobile/Phase2.1/Trade_Coverage_Generic'), [('retailerName') : findTestData(
			'Phase2.1/Common_Data/CommonData').getValue('RetailerCash', 4)], FailureHandling.STOP_ON_FAILURE)
...
Mobile.setText(findTestObject('Object Repository/Phase2/BIInvoiceSummaryScreen/BICollectionScreen01/Amount_EditText'), findTestData('Phase2.1/TY_05/Collection').getValue(5, 66), 0)
...
Mobile.verifyNotMatch(ChequeAmount, TransAmount, false, FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyNotEqual(PesitoCommission, EffAmount, FailureHandling.STOP_ON_FAILURE)
...
def Expectedtoastmsg = findTestData('Phase2.1/TY_05/Collection').getValue(3, 55)+PesitoCommission

println(Expectedtoastmsg)

Mobile.verifyNotEqual(Actualtoastmessage, Expectedtoastmsg, FailureHandling.STOP_ON_FAILURE)

println "Please Pay Total Balance Amount  Toast message should not display"

Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), [('testCaseName') : 'TC_462'], FailureHandling.STOP_ON_FAILURE)
