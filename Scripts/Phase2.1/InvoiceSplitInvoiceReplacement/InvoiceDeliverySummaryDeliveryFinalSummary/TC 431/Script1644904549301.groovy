...
def Expectedtoast = findTestData('Phase2.1/TY_05/Collection').getValue(3, 59)

Mobile.verifyNotEqual(Actualtoastmessage, Expectedtoast, FailureHandling.STOP_ON_FAILURE)

println "Please Pay Total Balance Amount : Toast message should not enable "

Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), [('testCaseName') : 'TC_431'], FailureHandling.STOP_ON_FAILURE)
