...
println "Pesito Commission '3' should pay in Efectivo.” Toast message should not enable"

Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), [('testCaseName') : 'TC_437'], FailureHandling.STOP_ON_FAILURE)
