...
def PartialCommission = PesitoCommission-1
...
def ChequeAmt= Double.parseDouble(Amount)-Double.parseDouble(TransAmount)

Mobile.tap(findTestObject("Object Repository/Phase2/BICollectionScreen01/Cheques_RadioButton"), 0)

//Mobile.setText(findTestObject('Object Repository/Phase2/BIInvoiceSummaryScreen/BICollectionScreen01/Amount_EditText'), remaining.toString() , 0)


Mobile.setText(findTestObject('Object Repository/Phase2/BIInvoiceSummaryScreen/BICollectionScreen01/Amount_EditText'), ChequeAmt.toString() , 0)
...
println("Pesito Commission '3' should pay in Efectivo Toast message should not display because if user Enter remaining amount  and commission in Electronic Transfer and Cheque mode.")
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'),
	[('testCaseName') : 'TC_464'], FailureHandling.STOP_ON_FAILURE)
