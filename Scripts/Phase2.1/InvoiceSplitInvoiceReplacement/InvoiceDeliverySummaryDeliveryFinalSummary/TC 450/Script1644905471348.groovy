...
println("Pesito Commission '3' should pay in Efectivo Toast message should not display if user pay full amount in Cheque mode.")


Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), [('testCaseName') : 'TC_450'], FailureHandling.STOP_ON_FAILURE)
