...
def ChequeAmt = Double.parseDouble(findTestData('Phase2.1/TY_05/Collection').getValue(5, 14))
...
Mobile.verifyMatch(ChequeAmount, ChequeAmt.toString(), false, FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyGreaterThanOrEqual(EffAmount, ChequeAmt, FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'),
	[('testCaseName') : 'TC_460'], FailureHandling.STOP_ON_FAILURE)
