...
def actualText=Mobile.getText(findTestObject('Phase2/BIInvoiceSummaryScreen/BICollectionScreen01/PesitoCommission_TextView'), 0, FailureHandling.STOP_ON_FAILURE)

def expText=findTestData('Phase2/TY_03/TestData_Phase2.1').getValue(2, 34)

Mobile.verifyMatch(actualText, expText, false, FailureHandling.STOP_ON_FAILURE)

println('Pesito commission label 0 of 0 is available under effectivo radio button as route retailer credit is not defined')
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), 
    ['testCaseName':'TC_421_CollectionScreen'], FailureHandling.STOP_ON_FAILURE)
