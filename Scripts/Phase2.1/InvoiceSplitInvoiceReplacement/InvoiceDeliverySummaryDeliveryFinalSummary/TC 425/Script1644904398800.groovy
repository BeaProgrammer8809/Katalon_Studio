...
def effAmt=Mobile.getText(findTestObject('Object Repository/Phase2/BICollectionScreen01/BIEfectivoScreen01/Amount_EditText'), 0)
...
def creditAmt=Mobile.getText(findTestObject('Object Repository/Phase2/BICollectionScreen01/BICreditNoteScreen01/Amount_EditText'), 0)

Mobile.tap(findTestObject('Phase2/BIInvoiceSummaryScreen/BICollectionScreen01/PesitoCredit_RadioButton'), 0)

Mobile.verifyElementChecked(findTestObject('Phase2/BIInvoiceSummaryScreen/BICollectionScreen01/PesitoCredit_RadioButton'), 0, FailureHandling.STOP_ON_FAILURE)

def actualPesitoAmt=Mobile.getText(findTestObject('Object Repository/Phase2/BICollectionScreen01/BIEfectivoScreen01/Amount_EditText'), 0)
...
Mobile.setText(findTestObject('Object Repository/Phase2/BICollectionScreen01/BIEfectivoScreen01/Amount_EditText'), effAmt.toString(), 0)

Mobile.tap(findTestObject('Object Repository/Phase2/BICollectionScreen01/Cheques_RadioButton'), 0)

Mobile.verifyElementChecked(findTestObject('Object Repository/Phase2/BICollectionScreen01/Cheques_RadioButton'), 0, FailureHandling.STOP_ON_FAILURE)

def actualChequeAmt=Mobile.getText(findTestObject('Object Repository/Phase2/BICollectionScreen01/BIChequesScreen01/Amount_EditText'), 0)

def expChequeAmt=Double.parseDouble(invAmt) - Double.parseDouble(actualPesitoAmt) -Double.parseDouble(creditAmt)

Mobile.verifyEqual(actualChequeAmt, expChequeAmt, FailureHandling.STOP_ON_FAILURE)

println "Balance invoice amount is displaying in cheque mode"

Mobile.verifyNotEqual(actualChequeAmt, actualPesitoCommissionAmt, FailureHandling.STOP_ON_FAILURE)

println "Pesito commission amount is not displaying under cheque mode"
...
def actualEffectivoAmt=Mobile.getText(findTestObject('Object Repository/Phase2/BICollectionScreen01/BIEfectivoScreen01/Amount_EditText'), 0)
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), 
    ['testCaseName':'TC_425_CollectionScreen'], FailureHandling.STOP_ON_FAILURE)
