...
GlobalVariable.ProductName = findTestData('Phase2.1/Common_Data/CommonData').getValue('ProductName', 37)
...
//def Amount = remaining - PesitoCommission
...
Mobile.verifyEqual(remaining.toString(), EffAmount, FailureHandling.STOP_ON_FAILURE)
...
def Expectedtoastmessage = findTestData('Phase2.1/TY_05/Collection').getValue(3, 59)+PesitoCommission
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), [('testCaseName') : 'TC_465'], FailureHandling.STOP_ON_FAILURE)
