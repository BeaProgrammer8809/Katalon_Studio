...
Mobile.setText(findTestObject('Object Repository/Phase2/BIInvoiceSummaryScreen/BICollectionScreen01/Amount_EditText'), findTestData(
        'Phase2.1/TY_05/Collection').getValue(4, 66), 0)

def PesitioAmt = Mobile.getText(findTestObject('Object Repository/Phase2/BIInvoiceSummaryScreen/BICollectionScreen01/Amount_EditText'), 
    0)
...
Mobile.setText(findTestObject('Object Repository/Phase2/BIInvoiceSummaryScreen/BICollectionScreen01/Amount_EditText'), findTestData(
        'Phase2.1/TY_05/Collection').getValue(5, 66), 0)
...
Mobile.callTestCase(findTestCase('Reusable Cases/Mobile/Phase2.1/ElectronicTransferMode'), [('ReferenceNum') : findTestData(
            'Phase2.1/TY_05/Collection').getValue(3, 63)], FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Reusable Cases/Mobile/Phase2.1/ChequeMode'), [('ChequeNum') : findTestData('Phase2.1/TY_05/Collection').getValue(
            3, 53)], FailureHandling.STOP_ON_FAILURE)
...
def EffAmount = Mobile.getText(findTestObject('Object Repository/Phase2/BIInvoiceSummaryScreen/BICollectionScreen01/Amount_EditText'), 
    0)
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), 
    [('testCaseName') : 'TC_458'], FailureHandling.STOP_ON_FAILURE)
