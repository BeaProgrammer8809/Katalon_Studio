...
def TransAmt = Double.parseDouble(findTestData('Phase2.1/TY_05/Collection').getValue(5, 14))

Mobile.setText(findTestObject('Object Repository/Phase2/BIInvoiceSummaryScreen/BICollectionScreen01/Amount_EditText'), TransAmt.toString(), 0)
...
Mobile.verifyMatch(TransAmount, TransAmt.toString(), false, FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyGreaterThanOrEqual(EffAmount, TransAmt, FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'),
	[('testCaseName') : 'TC_461'], FailureHandling.STOP_ON_FAILURE)
