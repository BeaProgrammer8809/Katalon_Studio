...
def actualPesitoCommissionAmt=Mobile.getText(findTestObject('Object Repository/Phase2/BICollectionScreen01/BIEfectivoScreen01/Amount_EditText'), 0)

def expPesitoCommissionAmt=findTestData('Phase2/Common_Data/CommonData_03').getValue(5, 3)

expPesitoCommissionAmt=Double.parseDouble(expPesitoCommissionAmt)

DecimalFormat df=new DecimalFormat('0.0')

expPesitoCommissionAmt=df.format(expPesitoCommissionAmt)

Mobile.verifyEqual(actualPesitoCommissionAmt, expPesitoCommissionAmt, FailureHandling.STOP_ON_FAILURE)

println('Pesito commission is automatically displaying under effectivo mode')
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), 
    ['testCaseName':'TC_423_CollectionScreen'], FailureHandling.STOP_ON_FAILURE)
