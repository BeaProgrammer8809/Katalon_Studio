...
def Expected = findTestData('Phase2.1/TY_05/Collection').getValue(4, 67)

Mobile.verifyEqual(Expected, CashAmount, FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyElementNotVisible(findTestObject('Object Repository/Phase2/BIInvoiceSummaryScreen/BICollectionScreen01/PesitoCommission_TextView'), 0, FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyMatch(ChequeAmount, CashAmount, false, FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyMatch(TransAmount, CashAmount, false, FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'),
	[('testCaseName') : 'TC_477'], FailureHandling.STOP_ON_FAILURE)
