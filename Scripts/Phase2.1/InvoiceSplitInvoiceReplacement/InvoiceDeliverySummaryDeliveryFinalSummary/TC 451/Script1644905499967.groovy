...
//findTestData('Phase2.1/TY_05/Collection').getValue(4, 67), FailureHandling.STOP_ON_FAILURE)
Mobile.verifyMatch(PesitioAmt, CashAmount, false, FailureHandling.STOP_ON_FAILURE)
...
println("Pesito Commission amount should not be allowed to enter in Electronic Transfer mode")
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/InvoiceDeliverySummaryDeliveryFinalSummary/Screenshot'), [('testCaseName') : 'TC 451'], FailureHandling.STOP_ON_FAILURE)
