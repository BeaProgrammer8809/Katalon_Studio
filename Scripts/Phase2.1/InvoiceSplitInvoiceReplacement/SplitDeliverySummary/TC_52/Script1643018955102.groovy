...
def number1 = findTestData('Phase2.1/TY_11/TestData').getValue(3, 77)
...
Mobile.verifyElementExist(findTestObject('Phase2/BISplitDeliverySummary01/SchemeBuySKU_TextView'), 0, FailureHandling.STOP_ON_FAILURE)

Mobile.verifyElementVisible(findTestObject('Phase2/BISplitDeliverySummary01/SchemeBuySKU_TextView'), 0, FailureHandling.STOP_ON_FAILURE)
...
'invoice count given as 2, so 2 extrainvoice should be created '
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/SplitDeliverySummary/Screenshot'), [('testCaseName') : 'TC_52'], 
