...
ExpLinesQty= findTestData('Phase2.1/TY_11/TestData').getValue(2, 80)

Mobile.verifyMatch(ActualLinesQty, ExpLinesQty, false, FailureHandling.STOP_ON_FAILURE)
...
def ActualLinesQty2=Mobile.getText(findTestObject('Phase2/BIDeliveryFinalSummaryScreen/Lines_Value_Indexing'), 0)

ExpLinesQty2= findTestData('Phase2.1/TY_11/TestData').getValue(2, 80)

Mobile.verifyMatch(ActualLinesQty2, ExpLinesQty2, false, FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/SplitDeliverySummary/Screenshot'), [('testCaseName') : 'TC_29'], 
