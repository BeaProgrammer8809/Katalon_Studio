...
ExpectedInvSplit = findTestData('Phase2.1/TY_12/InvoiceSplitInvoiceReplacement/Tesedata').getValue(2, 1)
...
ExpectedProdSplit = findTestData('Phase2.1/TY_12/InvoiceSplitInvoiceReplacement/Tesedata').getValue(3, 1)
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/SplitDeliverySummary/Screenshot'),
	[('testCaseName') : 'TC_20'], FailureHandling.STOP_ON_FAILURE)
