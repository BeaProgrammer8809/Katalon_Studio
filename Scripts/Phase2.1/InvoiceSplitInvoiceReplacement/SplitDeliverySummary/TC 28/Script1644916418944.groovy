...
//Phase2.1/Common_Data/CommonData
...
ExpectedInvSplit = findTestData('Phase2.1/TY_12/InvoiceSplitInvoiceReplacement/Tesedata').getValue(2, 4)
...
ExpectedProdSplit = findTestData('Phase2.1/TY_12/InvoiceSplitInvoiceReplacement/Tesedata').getValue(3, 4)
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/SplitDeliverySummary/Screenshot'),
	[('testCaseName') : 'TC_28'], FailureHandling.STOP_ON_FAILURE)
