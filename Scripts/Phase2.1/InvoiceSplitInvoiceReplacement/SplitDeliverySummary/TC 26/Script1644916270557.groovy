...
prodQtyTxt = Mobile.getText(findTestObject('Phase2/BIReturnProductBuyingScreen01/Pieces_Edit_Text'), TotPieceAndReturn)

int prodQtyVal = Integer.parseInt(prodQtyTxt)
...
'Verifying the Sku\'s Qty '
GlobalVariable.index = findTestData('Phase2.1/Common_Data/CommonData').getValue('Number', 1)

Sku1QTY1 = Mobile.getText(findTestObject('Object Repository/Phase2/BIDeliveryFinalSummaryScreen/SKUs_Qty_Indexing'), TotPieceAndReturn)

println(Sku1QTY1 + '  Sku1QTY1')

Mobile.verifyEqual(Sku1QTY1, TotPieceAndReturn, FailureHandling.STOP_ON_FAILURE)

GlobalVariable.index = findTestData('Phase2.1/Common_Data/CommonData').getValue('Number', 2)

prodbyQTY1 = Mobile.getText(findTestObject('Object Repository/Phase2/BIDeliveryFinalSummaryScreen/SKUs_Qty_Indexing'), TotPieceAndReturn)

int prodbyQTY1Val = Integer.parseInt(prodbyQTY1)

Mobile.verifyEqual(prodbyQTY1Val, prodQtyVal, FailureHandling.STOP_ON_FAILURE)

println(prodbyQTY1)

Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/SplitDeliverySummary/Screenshot'),
	[('testCaseName') : 'TC_26'], FailureHandling.STOP_ON_FAILURE)
