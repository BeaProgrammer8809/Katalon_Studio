...
import com.kms.katalon.core.keyword.builtin.VerifyNotEqualKeyword
...
"Stock Delevered Val "
Stock_DeliveredvalText = Mobile.getText(findTestObject('Object Repository/Phase2/BIDeliverySummaryScreen/Stock_Delivered_Text') , 0)
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/SplitDeliverySummary/Screenshot'),
	[('testCaseName') : 'TC_09'], FailureHandling.STOP_ON_FAILURE)
