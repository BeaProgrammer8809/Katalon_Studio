...
Expsku= findTestData('Phase2.1/TY_11/TestData').getValue(2, 82)
...
ExpSku2= findTestData('Phase2.1/TY_11/TestData').getValue(3, 82)
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/SplitDeliverySummary/Screenshot'), [('testCaseName') : 'TC_36'],
