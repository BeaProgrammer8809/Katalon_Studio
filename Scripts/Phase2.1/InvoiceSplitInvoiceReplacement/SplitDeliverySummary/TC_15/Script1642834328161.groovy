...
'O&I SRP Val'
SRPValText1 = Mobile.getText(findTestObject('Object Repository/Phase2/BIOrderAndInvoiceScreen01/SRP_Price'), 0)

double SRPVal1 = Double.parseDouble(SRPValText1).round(2)
...
'Stock Delevered Val '
Stock_DeliveredvalText = Mobile.getText(findTestObject('Object Repository/Phase2/BIDeliverySummaryScreen/Stock_Delivered_Text'), 
    0)

println(Stock_DeliveredvalText)

int Stock_DeliveredVal = Integer.parseInt(Stock_DeliveredvalText)
...
SumTotal = (SRPVal2 * Stock_DeliveredVal)
...
Mobile.verifyEqual(TotalVal, SumTotal.round(2), FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/SplitDeliverySummary/Screenshot'), [('testCaseName') : 'TC_15'], 
