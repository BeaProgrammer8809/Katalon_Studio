...
double SRPVal1 = Double.parseDouble(SRPValText1)
...
Mobile.verifyEqual(SRPVal2, SRPVal1, FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/SplitDeliverySummary/Screenshot'), [('testCaseName') : 'TC_14'], 
