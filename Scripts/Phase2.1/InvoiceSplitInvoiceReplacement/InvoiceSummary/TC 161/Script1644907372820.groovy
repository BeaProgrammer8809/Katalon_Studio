...
def expectedMessage1 = findTestData('Phase2.1/TY_01/TestData3').getValue(4, 20)

boolean MessageResult = actualMessage.contains(expectedMessage1)

def verifytheToastMessage = MessageResult.toString()

Mobile.verifyMatch(verifytheToastMessage, findTestData('Phase2.1/TY_01/TestData3').getValue(6, 20), false, FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitInvoiceReplacement/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC_161'], 
