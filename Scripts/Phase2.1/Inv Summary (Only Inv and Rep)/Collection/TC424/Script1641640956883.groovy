...
def actualChequeType=Mobile.getText(findTestObject('Object Repository/Phase2/BICollectionScreen01/BIChequesScreen01/Foreign_ChequeType'), 0)

def expChequeType=findTestData('Phase2/Common_Data/CommonData_03').getValue(9, 1)

Mobile.verifyMatch(actualChequeType, expChequeType, false, FailureHandling.STOP_ON_FAILURE)

actualChequeType=Mobile.getText(findTestObject('Object Repository/Phase2/BICollectionScreen01/BIChequesScreen01/Local_ChequeType'), 0)

expChequeType=findTestData('Phase2/Common_Data/CommonData_03').getValue(9, 2)

Mobile.verifyMatch(actualChequeType, expChequeType, false, FailureHandling.STOP_ON_FAILURE)

println('Select cheque type drop down has local and foreign drop down options')

Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/Collection/ScreenShot'), [('testCaseName') : 'TC424_CollectionScreen'],
