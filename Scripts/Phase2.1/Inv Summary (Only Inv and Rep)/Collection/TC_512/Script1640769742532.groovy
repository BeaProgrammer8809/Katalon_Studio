...
Mobile.verifyElementText(findTestObject('Phase2/BIInvoiceSummaryScreen/BIEnterTheFolioNoPopup01/EnterTheFolioNumber_PopupTitle'), 
    findTestData('Phase2.1/TY_06/Collection/Collection').getValue(2, 22), FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/Collection/Screenshot'), [('testCaseName') : 'TC_512'], 
    FailureHandling.STOP_ON_FAILURE)

Mobile.comment('Verifying the Legal Entity name as Bimbo SA. de C.V')
...
Mobile.verifyElementText(findTestObject('Phase2/BIInvoiceSummaryScreen/BIEnterTheFolioNoPopup01/LegalEntityName_TextView'), 
    findTestData('Phase2.1/TY_06/Collection/Collection').getValue(3, 22), FailureHandling.STOP_ON_FAILURE)
