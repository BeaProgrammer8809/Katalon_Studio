...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/Collection/Screenshot'), [('testCaseName') : 'TC391_Legal_Entity_Name'], FailureHandling.STOP_ON_FAILURE)
