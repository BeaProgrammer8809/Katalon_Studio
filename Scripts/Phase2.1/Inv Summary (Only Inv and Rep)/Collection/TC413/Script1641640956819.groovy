...
println('Invoice amount is ' + invAmt)

Mobile.verifyElementAttributeValue(findTestObject('Phase2/BIInvoiceSummaryScreen/BICollectionScreen01/InvAmt_Value'), 'text', 
    netAmt, 0)

Mobile.verifyEqual(netAmt, invAmt, FailureHandling.STOP_ON_FAILURE)

println('Invoice amount is displaying the Net amount which is displayed in Summary Screen')

Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/Collection/Screenshot'), [('testCaseName') : 'TC413_CollectionScreen'], 
