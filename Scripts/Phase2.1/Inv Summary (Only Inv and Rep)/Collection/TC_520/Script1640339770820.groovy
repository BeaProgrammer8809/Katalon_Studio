...
def ProductName = findTestData('Phase2.1/Common_Data/CommonData').getValue(6, 15)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/Collection/Screenshot'), [('testCaseName') : 'TC_520'], 
    FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyMatch(Title, findTestData('Phase2.1/TY_06/Collection/Collection').getValue(2, 6), false)

Mobile.verifyElementText(findTestObject('Phase2/BIInvoiceSummaryScreen/BICollectionScreen01/Collection_Title'), findTestData(
        'Phase2.1/TY_06/Collection/Collection').getValue(2, 6), FailureHandling.STOP_ON_FAILURE)
...
legalEntry = findTestData('Phase2.1/TY_06/Collection/Collection').getValue(3, 6)
