...
println "user is able to select a branch from Branch Dropdwon"

Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/Collection/Screenshot'), [('testCaseName') : 'TC422_CollectionScreen'],
