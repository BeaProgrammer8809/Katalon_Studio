...
def ExpectedToastMessage = findTestData('Phase2.1/TY_07/Invoice Summary/Execute2').getValue(3, 7)

println(ExpectedToastMessage)

Mobile.verifyMatch(actualtoastmessage, ExpectedToastMessage, false)

Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/Collection/Screenshot'), [('testCaseName') : 'TC428_CollectionScreen'], 
