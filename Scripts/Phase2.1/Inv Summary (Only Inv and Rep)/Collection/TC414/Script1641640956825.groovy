...
println('Invoice amount is ' + minAmt)

Mobile.verifyElementAttributeValue(findTestObject('Phase2/BIInvoiceSummaryScreen/BICollectionScreen01/MinAmt_Value'), 'text', 
    netAmt, 0)

Mobile.verifyEqual(netAmt, minAmt, FailureHandling.STOP_ON_FAILURE)

println('Minimum amount is displaying the Net amount which is displayed in Summary Screen')

Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/Collection/Screenshot'), [('testCaseName') : 'TC414_CollectionScreen'], 
