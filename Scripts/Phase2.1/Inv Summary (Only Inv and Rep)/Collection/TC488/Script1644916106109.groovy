...
def Pesito_credit=Mobile.getText(findTestObject('Object Repository/Phase2/BIInvoiceSummaryScreen/BICollectionScreen01/PesitoCredit_TextView'), 0)

def Pesito_credit_Available= Pesito_credit.substring(21, 24)

Mobile.verifyLessThanOrEqual(Pesito_grand,Pesito_credit_Available)

Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/Collection/Screenshot'), [('testCaseName') : 'TC_488'], FailureHandling.STOP_ON_FAILURE)
