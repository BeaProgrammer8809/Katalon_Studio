...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/Collection/Screenshot'), [('testCaseName') : 'TC_519'], 
    FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyMatch(Title, findTestData('Phase2.1/TY_06/Collection/Collection').getValue(2, 5), false)
...
legalEntry = findTestData('Phase2.1/TY_06/Collection/Collection').getValue(3, 5)
