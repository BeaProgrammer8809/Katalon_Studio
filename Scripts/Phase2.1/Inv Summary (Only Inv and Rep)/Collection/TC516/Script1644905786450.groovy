...
Returnqty1 = Mobile.getText(findTestObject('Phase2/BIInvoiceSummaryScreen/BISummaryProductDetails/Actual_Return_Value_Indexing'), 
    0)
...
Mobile.verifyMatch(Returnqty, Returnqty1, false, FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/Collection/Screenshot'), [('testCaseName') : 'TC_516'], 
    FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyMatch(Title, findTestData('Phase2.1/TY_06/Collection/Collection').getValue(2, 2), false)

Mobile.comment('Verifying the Colelction icon should not be displayed')
