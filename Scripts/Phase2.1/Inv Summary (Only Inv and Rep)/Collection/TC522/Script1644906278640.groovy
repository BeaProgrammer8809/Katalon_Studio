...
ProductName = findTestData('Phase2.1/Common_Data/CommonData').getValue(6, 17)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/Collection/Screenshot'), [('testCaseName') : 'TC_522'], 
    FailureHandling.STOP_ON_FAILURE)

Mobile.comment('Verifying the Colelction screen should be displayed')
...
def Title = Mobile.getText(findTestObject('Phase2/BIInvoiceSummaryScreen/BICollectionScreen01/Collection_Title'), 0)

Mobile.verifyMatch(Title, findTestData('Phase2.1/TY_06/Collection/Collection').getValue(2, 8), false)

Mobile.verifyElementText(findTestObject('Phase2/BIInvoiceSummaryScreen/BICollectionScreen01/Collection_Title'), findTestData(
        'Phase2.1/TY_06/Collection/Collection').getValue(2, 8), FailureHandling.STOP_ON_FAILURE)

Mobile.comment('Sales center legal entity should be displayed')

Mobile.verifyElementExist(findTestObject('Phase2/BIInvoiceSummaryScreen/BICollectionScreen01/LegalEntry_TextView'), 0, FailureHandling.STOP_ON_FAILURE)

Mobile.verifyElementVisible(findTestObject('Phase2/BIInvoiceSummaryScreen/BICollectionScreen01/LegalEntry_TextView'), 0, 
    FailureHandling.STOP_ON_FAILURE)

legalEntryName = Mobile.getText(findTestObject('Phase2/BIInvoiceSummaryScreen/BICollectionScreen01/LegalEntry_TextView'), 
    0)

legalEntry = findTestData('Phase2.1/TY_06/Collection/Collection').getValue(3, 8)

boolean res = legalEntryName.contains(legalEntry)

Mobile.verifyEqual(res, true, FailureHandling.STOP_ON_FAILURE)
