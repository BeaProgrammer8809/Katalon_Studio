...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/Collection/Screenshot'), [('testCaseName') : 'TC_521'], 
    FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyMatch(Title, findTestData('Phase2.1/TY_06/Collection/Collection').getValue(2, 7), false, FailureHandling.STOP_ON_FAILURE)

Mobile.verifyElementText(findTestObject('Phase2/BIInvoiceSummaryScreen/BICollectionScreen01/Collection_Title'), findTestData(
        'Phase2.1/TY_06/Collection/Collection').getValue(2, 7), FailureHandling.STOP_ON_FAILURE)
...
legalEntry = findTestData('Phase2.1/TY_06/Collection/Collection').getValue(3, 7)
