...
Mobile.verifyMatch(invamt, InvoiceAmount, false, FailureHandling.STOP_ON_FAILURE)
...
EXPBalance = df1.format(Balance1)
def ExpectedBalance = (('Balance : ' + EXPBalance) + ' of ') + "$InvoiceAmount"
