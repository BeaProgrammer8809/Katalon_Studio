...
Mobile.verifyGreaterThanOrEqual(num, '2', FailureHandling.STOP_ON_FAILURE)

println "Select Bank is a dropDown"

Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/Collection/Screenshot'), [('testCaseName') : 'TC419_CollectionScreen'],
