...
def Expected=Mobile.getText(findTestObject('Object Repository/Phase2/BIInvoiceSummaryScreen/BICollectionScreen01/InvAmt_Value'), 0)//since we get clarified with mayuri, invoice number not come inside collection popup

def PesitoAmount=Mobile.getText(findTestObject('Object Repository/Phase2/BIInvoiceSummaryScreen/BICollectionScreen01/Amount_EditText'), 0)


Mobile.verifyEqual(CashAmount, PesitoAmount)

Mobile.verifyEqual(Actual, Expected)
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/Collection/Screenshot'), [('testCaseName') : 'TC_493'], FailureHandling.STOP_ON_FAILURE)
