...
def expectedFutureDate = findTestData('Phase2.1/TY_14/TestData').getValue('Data1', 13)

boolean ActualDate = ActualFutureDate.contains(expectedFutureDate)

def FutureDate=ActualDate.toString()

Mobile.verifyMatch(FutureDate, findTestData('Phase2.1/TY_14/Testdata').getValue('Data', 13), false,FailureHandling.STOP_ON_FAILURE)
