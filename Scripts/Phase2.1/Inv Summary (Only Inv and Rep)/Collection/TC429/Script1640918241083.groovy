...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/Collection/Screenshot'), [('testCaseName') : 'TC429_CollectionScreen'], FailureHandling.STOP_ON_FAILURE)
...
def ExpectedToastMessage = findTestData('Phase2.1/TY_07/Invoice Summary/Execute2').getValue(3, 6)
