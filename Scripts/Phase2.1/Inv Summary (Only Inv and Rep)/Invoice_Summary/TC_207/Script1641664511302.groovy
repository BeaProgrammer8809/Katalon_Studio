...
def productName = findTestData('Phase2.1/Common_Data/CommonData').getValue(6, 33)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/Invoice_Summary/Screenshot'), [('testCaseName') : 'TC_207'], 
    FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyElementText(findTestObject('Phase2/BIInvoiceSummaryScreen/BIAmountSplitUpPopup01/AmountSplitUp_PopUpTitle'), 
    findTestData('Phase2.1/TY_12/InvoiceSummary/Summary').getValue(2, 4))
...
def expected = findTestData('Phase2.1/TY_12/InvoiceSummary/Summary').getValue(3, 4)
...
Mobile.verifyMatch(expresult, findTestData('Phase2.1/TY_12/InvoiceSummary/Summary').getValue(4, 4), false)
...
Mobile.verifyEqual(TaxText, findTestData('Phase2.1/TY_12/InvoiceSummary/Summary').getValue(6, 4))
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/Invoice_Summary/Screenshot'), [('testCaseName') : 'TC_207 PrintPreviewScreen'], 
    FailureHandling.STOP_ON_FAILURE)
