...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/Invoice_Summary/Screenshot'), [('testCaseName') : 'TC_204 AmtSplitPopUp'], 
    FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyElementText(findTestObject('Phase2/BIInvoiceSummaryScreen/BIAmountSplitUpPopup01/AmountSplitUp_PopUpTitle'), 
    findTestData('Phase2.1/TY_12/InvoiceSummary/Summary').getValue(2, 1))
...
def expected = findTestData('Phase2.1/TY_12/InvoiceSummary/Summary').getValue(3, 1)
...
Mobile.verifyMatch(expresult, findTestData('Phase2.1/TY_12/InvoiceSummary/Summary').getValue(4, 1), false)
...
'screenshot for print preview screen'
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/Invoice_Summary/Screenshot'), [('testCaseName') : 'TC_204 PrintPreviewScreen'], 
    FailureHandling.STOP_ON_FAILURE)
