...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/Invoice_Summary/Screenshot'), [('testCaseName') : 'TC_208'], 
    FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyElementText(findTestObject('Phase2/BIInvoiceSummaryScreen/BIAmountSplitUpPopup01/AmountSplitUp_PopUpTitle'), 
    findTestData('Phase2.1/TY_12/InvoiceSummary/Summary').getValue(2, 5))
...
def expected = findTestData('Phase2.1/TY_12/InvoiceSummary/Summary').getValue(3, 5)
...
Mobile.verifyMatch(expresult, findTestData('Phase2.1/TY_12/InvoiceSummary/Summary').getValue(4, 5), false)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/Invoice_Summary/Screenshot'), [('testCaseName') : 'TC_208 PrintPreviewScreen'], 
    FailureHandling.STOP_ON_FAILURE)
