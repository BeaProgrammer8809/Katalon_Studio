...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/Invoice_Summary/Screenshot'), 
    [('testCaseName') : 'TC_111_Summary'] , FailureHandling.STOP_ON_FAILURE)
