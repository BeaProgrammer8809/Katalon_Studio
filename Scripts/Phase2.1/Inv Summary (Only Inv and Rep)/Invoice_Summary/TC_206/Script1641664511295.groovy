...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/Invoice_Summary/Screenshot'), [('testCaseName') : 'TC_206'], 
    FailureHandling.STOP_ON_FAILURE)
...
def expected = findTestData('Phase2.1/TY_12/InvoiceSummary/Summary').getValue(3, 3)
...
Mobile.verifyMatch(expresult, findTestData('Phase2.1/TY_12/InvoiceSummary/Summary').getValue(4, 3), false)
...
Mobile.verifyEqual(TaxText, findTestData('Phase2.1/TY_12/InvoiceSummary/Summary').getValue(6, 3))
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/Invoice_Summary/Screenshot'), [('testCaseName') : 'TC_206 PrintPreviewScreen'], 
    FailureHandling.STOP_ON_FAILURE)
