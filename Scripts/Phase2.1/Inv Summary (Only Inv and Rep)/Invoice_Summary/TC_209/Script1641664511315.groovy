...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/Invoice_Summary/Screenshot'), [('testCaseName') : 'TC_209'], 
    FailureHandling.STOP_ON_FAILURE)
...
def val_1 = Comp_Disc.substring(2, 3)

double Comp_val = Double.parseDouble(val_1)

'Formula: total=order value-comp discount'
Expected_total = (Oder_Val - Comp_val)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/Invoice_Summary/Screenshot'), [('testCaseName') : 'TC_209 PrintPreviewScreen'], 
    FailureHandling.STOP_ON_FAILURE)
