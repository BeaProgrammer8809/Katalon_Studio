...
Mobile.callTestCase(findTestCase('null'), [('testCaseName') : 'TC376(1)'], 
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC376(2)'], 
    FailureHandling.STOP_ON_FAILURE)
