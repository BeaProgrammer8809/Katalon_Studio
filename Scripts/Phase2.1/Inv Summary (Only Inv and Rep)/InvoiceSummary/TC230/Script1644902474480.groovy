...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC_230_AmtSplitup'], FailureHandling.STOP_ON_FAILURE)
...
ExpectedOrderprice = findTestData('Phase2.1/TY_13/TY_13').getValue(8, 19)
...
Exptdgrossprice = findTestData('Phase2.1/TY_13/TY_13').getValue(9, 19)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC_230_preticket'], FailureHandling.STOP_ON_FAILURE)
