...
double TotalDiscount = (SKUGrossAmount - (TotalPieces * UnitPrice)).round(1)
...
ExpectedSign = findTestData('Phase2.1/TY_13/TY_13').getValue(10, 34)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC_245_Preticket'], 
    FailureHandling.STOP_ON_FAILURE)
