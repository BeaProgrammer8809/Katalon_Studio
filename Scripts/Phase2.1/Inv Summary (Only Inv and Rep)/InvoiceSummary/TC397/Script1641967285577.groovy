...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC397_Actual_Pieces_Value'], FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC397_Actual_Return_Qty'], FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC397_Expected_Pieces -Return_Qty'], 
    FailureHandling.STOP_ON_FAILURE)
...
//Verification to check Efectivo is selected.
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC397_Efectivo_Radio_Button_Selected'], 
    FailureHandling.STOP_ON_FAILURE)

println('Effectivo mode is selected')

//
Mobile.tap(findTestObject('Object Repository/Phase2/BICollectionScreen01/Submit_Button'), 0, FailureHandling.STOP_ON_FAILURE)

//Verification to check whether Legal_Entry popup is displayed after submitting the full invoice amount
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC397_Enter_Folio_Number_PopUp'], 
    FailureHandling.STOP_ON_FAILURE)

//Verification of Actual-Expected pieces and return values
...
println('User is able to pay full amount in cash mode by selecting Effective option')
