...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC_250_AmtSplitup'], 
    FailureHandling.STOP_ON_FAILURE)
...
ExpectedSign = findTestData('Phase2.1/TY_13/TY_13').getValue(10, 14)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC_250_Preticket'], 
    FailureHandling.STOP_ON_FAILURE)
