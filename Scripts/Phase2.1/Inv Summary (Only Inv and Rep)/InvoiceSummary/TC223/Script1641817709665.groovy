...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC223'], FailureHandling.STOP_ON_FAILURE)
...
def Expected_Order_Value = Double.parseDouble(OrderValue_Value) + Discount
