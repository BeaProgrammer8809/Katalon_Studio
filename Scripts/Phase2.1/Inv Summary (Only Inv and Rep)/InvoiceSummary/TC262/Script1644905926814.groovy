...
GlobalVariable.Number = findTestData('Phase2/Common_Data/CommonData_03').getValue('Number', 2)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC_262_firstEntry'], 
    FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC_262_OrderAndInvoice'], 
    FailureHandling.STOP_ON_FAILURE)
