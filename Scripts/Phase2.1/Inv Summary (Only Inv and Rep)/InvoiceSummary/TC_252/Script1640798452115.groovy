...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC_252_AmtSplitup'], 
    FailureHandling.STOP_ON_FAILURE)
...
println(CompDisc + 'Comp Discount with negative sign')
...
ExpectedSign = findTestData('Phase2.1/TY_13/TY_13').getValue(10, 16)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC_252_Preticket'], 
    FailureHandling.STOP_ON_FAILURE)
