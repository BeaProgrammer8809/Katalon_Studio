...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC_235_AmtSplitup'], FailureHandling.STOP_ON_FAILURE)
...
ExpectedOrderprice = findTestData('Phase2.1/TY_13/TY_13').getValue(8, 24)
...
Exptdgrossprice = findTestData('Phase2.1/TY_13/TY_13').getValue(9, 24)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC_235_Preticket'], FailureHandling.STOP_ON_FAILURE)
