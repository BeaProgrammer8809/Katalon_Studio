...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC185_InvoiceSummary'], FailureHandling.STOP_ON_FAILURE)
