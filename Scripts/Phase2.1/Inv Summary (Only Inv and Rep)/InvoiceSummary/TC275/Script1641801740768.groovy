...
def ExpectedEntity = findTestData('Phase2.1/TY_01/Test_Data').getValue(4, 14)
println ExpectedEntity

Mobile.verifyMatch(legalEntity, ExpectedEntity, false, FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC_275'],
