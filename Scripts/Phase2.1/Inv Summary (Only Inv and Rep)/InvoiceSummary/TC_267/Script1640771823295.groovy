...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC_267'], FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyMatch(Actual, findTestData('Phase2.1/TY_13/TY_13').getValue(5, 2), false)

Mobile.setText(findTestObject('Phase2/BIInvoiceSummaryScreen/BIEnterTheFolioNoPopup01/FolioNo._EditText'), findTestData(
        'Phase2.1/TY_13/TY_13').getValue(6, 2), 0)

'To Tap on Efectivo Check Box'
