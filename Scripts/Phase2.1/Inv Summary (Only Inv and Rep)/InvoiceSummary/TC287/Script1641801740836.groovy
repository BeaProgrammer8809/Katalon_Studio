...
Mobile.verifyMatch(legalEntity, findTestData('Phase2.1/TY_01/Test_Data').getValue(4, 7), false, FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC_287'], 
    FailureHandling.STOP_ON_FAILURE)
