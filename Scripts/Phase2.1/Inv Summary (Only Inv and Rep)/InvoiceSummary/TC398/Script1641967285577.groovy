...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC398_Full_Invoice_Amount_Displayed_In_Print_Preview_Screen'], FailureHandling.STOP_ON_FAILURE)
