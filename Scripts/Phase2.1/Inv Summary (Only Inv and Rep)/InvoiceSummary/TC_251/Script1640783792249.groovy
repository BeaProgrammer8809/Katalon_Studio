...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC_251_AmtSplitup'], 
    FailureHandling.STOP_ON_FAILURE)
...
println(CompDisc + 'CompDisc with negitive sign')
...
ExpectedSign = findTestData('Phase2.1/TY_13/TY_13').getValue(10, 15)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC_251_Preticket'], 
    FailureHandling.STOP_ON_FAILURE)
