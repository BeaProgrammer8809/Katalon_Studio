...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC_237_AmtSplitup'], FailureHandling.STOP_ON_FAILURE)
...
ExpectedOrderprice = findTestData('Phase2.1/TY_13/TY_13').getValue(8, 26)
...
Exptdgrossprice = findTestData('Phase2.1/TY_13/TY_13').getValue(9, 26)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC_237_Preticket'], FailureHandling.STOP_ON_FAILURE)
