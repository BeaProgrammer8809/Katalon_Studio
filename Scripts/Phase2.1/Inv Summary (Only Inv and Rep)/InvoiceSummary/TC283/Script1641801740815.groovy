...
def ExpectedEntity = findTestData('Phase2.1/TY_01/Test_Data').getValue(4, 19)

Mobile.verifyMatch(legalEntity, ExpectedEntity, false, FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC_283_FolioPopup'],
...
Mobile.verifyEqual(PrintPreviewscreen, findTestData('Phase2.1/TY_01/Test_Data').getValue(5, 19), FailureHandling.STOP_ON_FAILURE)

println('Invoice is  generated when folio number flag is enabled')

Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC_283'],
	FailureHandling.STOP_ON_FAILURE)
