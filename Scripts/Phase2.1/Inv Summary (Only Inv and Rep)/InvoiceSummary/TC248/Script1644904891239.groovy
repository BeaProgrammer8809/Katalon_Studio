...
double TotalDiscount = (SKUGrossAmount - (TotalPieces * UnitPrice)).round(2)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC_248_AmtSplitup'], 
    FailureHandling.STOP_ON_FAILURE)
...
ExpectedSign = findTestData('Phase2.1/TY_13/TY_13').getValue(10, 37)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC_248_Preticket'], 
    FailureHandling.STOP_ON_FAILURE)
