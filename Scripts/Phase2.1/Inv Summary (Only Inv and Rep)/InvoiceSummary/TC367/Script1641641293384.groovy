...
GlobalVariable.RetailerName = findTestData('Phase2/Common_Data/CommonData_03').getValue(2, 12)
...
GlobalVariable.ProductName = findTestData('Phase2/Common_Data/CommonData_03').getValue(16, 11)
...
Mobile.setText(findTestObject('Object Repository/Phase2/BIOrderAndInvoiceScreen01/Search_Edit_Text'), findTestData('Phase2/Common_Data/CommonData_03').getValue(
		16, 20), 0)
...
Mobile.setText(findTestObject('Phase2/BIEnterTheFolioNoPopup01/FolioNo._EditText'), findTestData('Phase2/Common_Data/CommonData_03').getValue(
	15, 1), 0)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC367_UUID'],
FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('Phase2/BIInvoiceSummaryScreen/BI_UUID/OK_Button_Uuid'), 0)

Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC367_PrintPreviewScreen'],
FailureHandling.STOP_ON_FAILURE)
