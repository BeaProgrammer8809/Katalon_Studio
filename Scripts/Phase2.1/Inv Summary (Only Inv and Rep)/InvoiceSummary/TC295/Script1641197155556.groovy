...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC295_Actual_Pieces_Value'], FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC295_Expected_Values'], FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC295_Amount_Split_PopUp'], FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC295_Print_Preview_Page'], FailureHandling.STOP_ON_FAILURE)
...
def Invoice_Status = findTestData('Phase2.1/TY_07/Invoice Summary/Execute2').getValue(8, 14)
...
Mobile.verifyMatch(Expected_Invoice_Status.toString(),findTestData('Phase2.1/TY_07/Invoice Summary/Execute2').getValue(9, 14), false, FailureHandling.STOP_ON_FAILURE)
