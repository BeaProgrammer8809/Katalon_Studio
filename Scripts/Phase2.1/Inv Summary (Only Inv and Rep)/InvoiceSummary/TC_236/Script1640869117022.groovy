...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC_236_AmtSplitup'], FailureHandling.STOP_ON_FAILURE)
...
ExpectedOrderprice = findTestData('Phase2.1/TY_13/TY_13').getValue(8, 25)
...
Exptdgrossprice = findTestData('Phase2.1/TY_13/TY_13').getValue(9, 25)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC_236_preticket'], FailureHandling.STOP_ON_FAILURE)
