...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC_234_AmtSplitup'], FailureHandling.STOP_ON_FAILURE)
...
ExpectedOrderprice = findTestData('Phase2.1/TY_13/TY_13').getValue(8, 23)
...
Exptdgrossprice = findTestData('Phase2.1/TY_13/TY_13').getValue(9, 23)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC_234_Preticket'], FailureHandling.STOP_ON_FAILURE)
