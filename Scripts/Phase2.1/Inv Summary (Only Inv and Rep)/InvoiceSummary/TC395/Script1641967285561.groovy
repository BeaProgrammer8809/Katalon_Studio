...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC395_Elements_Verification'], FailureHandling.STOP_ON_FAILURE)
