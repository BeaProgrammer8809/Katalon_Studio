...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC454'], FailureHandling.STOP_ON_FAILURE)
...
//Mobile.(Actual_Toast_Message, Expected_Toast_Message, false, FailureHandling.STOP_ON_FAILURE)
...
println('Pay Minimum amount to proceed the invoice" error message should be displayed')
