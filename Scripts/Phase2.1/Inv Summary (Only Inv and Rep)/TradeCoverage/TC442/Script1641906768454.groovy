...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC442'], FailureHandling.STOP_ON_FAILURE)
...
println('Total Paid is displayed in TransferenciasElectronicas Mode')
