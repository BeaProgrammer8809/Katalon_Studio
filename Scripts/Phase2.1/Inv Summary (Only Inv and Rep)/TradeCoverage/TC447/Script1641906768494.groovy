...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC447'], FailureHandling.STOP_ON_FAILURE)
...
def Expected = findTestData('Phase2.1/TY_04/Phase2.1').getValue(11, 7)
