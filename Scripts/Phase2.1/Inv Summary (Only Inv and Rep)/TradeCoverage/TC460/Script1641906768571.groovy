...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/TradeCoverage/Screenshot'), [('testCaseName') : 'TC460'], FailureHandling.STOP_ON_FAILURE)
...
println('User is able to submit the invoice amount with max digit in Reference no field')
