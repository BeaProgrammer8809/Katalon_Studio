...
Mobile.verifyEqual(Cheques, findTestData('Phase2.1/TestData/Test_Data').getValue(2, 28), FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/BeforeInvoiceCollection/Screenshot'), [('testCaseName') : 'TC_566'], FailureHandling.STOP_ON_FAILURE)
