...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC_545'], 
...
println(Pesitoommission_Label)

Mobile.verifyMatch(Pesitoommission_Label, findTestData('Phase2.1/TY_12/InvoiceSummary/Invoice_Summary').getValue(8, 20), 
    false)
