...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/BeforeInvoiceCollection/Screenshot'), ["testCaseName":"TC542_CollectionScreen"], FailureHandling.STOP_ON_FAILURE)
