...
'To Enter full amount in Pesito mode'
...
'To click on Cheque Radio button'
Mobile.tap(findTestObject('Phase2/BICollectionScreen01/TransferenciasElectronicas_RadioButton'), 0)

Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/BeforeInvoiceCollection/Screenshot'), [('testCaseName') : 'TC_550'], FailureHandling.STOP_ON_FAILURE)

'To get the Balance_Amount present in Amount_EditText'
Actual = Mobile.getText(findTestObject('Phase2/BIInvoiceSummaryScreen/BICollectionScreen01/Amount_EditText'), 0)

'To verify that Pesito Comission \'3.0\' is not displayed in Amount_EditTExt field on selecting RTGS  mode after entering full amount in Pesito mode'
Mobile.verifyNotMatch(Actual, findTestData('Phase2.1/TY_13/TY_13').getValue(5, 8), false)

'Since full amount is being entered in Pesito mode, the balance amount Displayed shoulkd be zero.\r\nthis is being Verified.'
Mobile.verifyMatch(Actual, findTestData('Phase2.1/TY_13/TY_13').getValue(5, 9), false)

'To click on Efectivo radio button'
Mobile.tap(findTestObject('Phase2/BICollectionScreen01/Efectivo_RadioButton'), 0)

'To get the text displayed in the Amount_EditText field on selecting Efectivo mode from cheque mode. '
efectivoAmountEditText = Mobile.getText(findTestObject('Phase2/BIInvoiceSummaryScreen/BICollectionScreen01/Amount_EditText'), 
    0)

'To Verify if Pesito Comission is being Displayed on selecting Efectivo mode'
Mobile.verifyMatch(efectivoAmountEditText, findTestData('Phase2.1/TY_13/TY_13').getValue(5, 8), false)
