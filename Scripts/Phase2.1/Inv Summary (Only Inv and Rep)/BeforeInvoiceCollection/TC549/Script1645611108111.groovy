...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/Before Invoice Collection/Screenshot'), [('testCaseName') : 'TC_549'], FailureHandling.STOP_ON_FAILURE)
...
'To verify that Pesito Comission \'3.0\' is not displayed in Amount_EditTExt field on selecting Cheque Mode after entering full amount in Pesito mode'
Mobile.verifyNotMatch(Actual, findTestData('Phase2.1/TY_13/TY_13').getValue(5, 6), false)

'Since full amount is being entered in Pesito mode, the balance amount Displayed should be zero.\r\nthis is being Verified.'
Mobile.verifyMatch(Actual, findTestData('Phase2.1/TY_13/TY_13').getValue(5, 7), false)
...
Mobile.verifyMatch(efectivoAmountEditText, findTestData('Phase2.1/TY_13/TY_13').getValue(5, 6), false)
