...
Mobile.verifyEqual(actual, findTestData('Phase2.1/TestData/Test_Data').getValue(2, 1), FailureHandling.STOP_ON_FAILURE)

String Actual = Mobile.getText(findTestObject('Phase2/BICollectionScreen01/Cheques_RadioButton'), 0)

println(Actual)

Mobile.verifyEqual(Actual, findTestData('Phase2.1/TestData/Test_Data').getValue(3, 1), FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/BeforeInvoiceCollection/Screenshot'), [('testCaseName') : 'TC_564'], FailureHandling.STOP_ON_FAILURE)
