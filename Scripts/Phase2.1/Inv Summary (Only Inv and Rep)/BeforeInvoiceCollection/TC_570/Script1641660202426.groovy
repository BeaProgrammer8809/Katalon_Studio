...
Mobile.verifyEqual(ActualErrormessage, findTestData('Phase2.1/TestData/Test_Data').getValue(2, 11), FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/BeforeInvoiceCollection/Screenshot'), [('testCaseName') : 'TC_570'], FailureHandling.STOP_ON_FAILURE)
