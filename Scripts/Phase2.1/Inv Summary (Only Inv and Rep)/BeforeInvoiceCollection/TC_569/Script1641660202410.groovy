...
String Actual = Mobile.getText(findTestObject('Phase2/BIInvoiceSummaryScreen/BICollectionScreen01/Collection_Title'), 0)
...
Mobile.verifyNotEqual(Actual, findTestData('Phase2.1/TestData/Test_Data').getValue(3, 9), FailureHandling.STOP_ON_FAILURE)

String actual = Mobile.getText(findTestObject('Phase2/BIInvoiceSummaryScreen/Summary_ScreenTitle'), 0)

Mobile.verifyEqual(actual, findTestData('Phase2.1/TestData/Test_Data').getValue(3, 9), FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/BeforeInvoiceCollection/Screenshot'), [('testCaseName') : 'TC_569'], FailureHandling.STOP_ON_FAILURE)
