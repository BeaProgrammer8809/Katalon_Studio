...
Mobile.verifyNotEqual(Actual, findTestData('Phase2.1/TestData/Test_Data').getValue(4, 24), FailureHandling.STOP_ON_FAILURE)

Mobile.verifyEqual(Actual, findTestData('Phase2.1/TestData/Test_Data').getValue(2, 24), FailureHandling.STOP_ON_FAILURE)
...
Mobile.setText(findTestObject('Phase2/BIInvoiceSummaryScreen/BIEnterTheFolioNoPopup01/FolioNo._EditText'), findTestData(
        'Phase2.1/CommonData/CommonData').getValue(15, 1), 0)

Mobile.tap(findTestObject('Phase2/BIInvoiceSummaryScreen/BIEnterTheFolioNoPopup01/OK_Button'), 0)

Mobile.tap(findTestObject('Phase2/BIInvoiceSummaryScreen/Invoice_Created_Successfully_PopUp_OK_Button'), 0)

String Actual01 = Mobile.getText(findTestObject('Phase2/BIPrintPreviewScreen/Print_Preview_TextView'), 0)

println(Actual01)

Mobile.verifyEqual(Actual01, findTestData('Phase2.1/TestData/Test_Data').getValue(3, 24), FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/BeforeInvoiceCollection/Screenshot'), [('testCaseName') : 'TC_583'], FailureHandling.STOP_ON_FAILURE)
