...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/BeforeInvoiceCollection/Screenshot'), [('testCaseName') : 'TC_552'], FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyMatch(Actual_ToastMessage, Expected_ToastMessage, true, FailureHandling.STOP_ON_FAILURE)
