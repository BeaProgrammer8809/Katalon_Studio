...
String ComissionAmount = Mobile.getText(findTestObject('Phase2/BINumberKeyboardCollection01/3_NumButton'), 0)
...
Mobile.setText(findTestObject('Phase2/BICollectionScreen01/BITransferenciasElectronicasScreen01/ReferenceNum_EditText'), 
    findTestData('Phase2.1/TestData/Test_Data').getValue(6, 23), 0)

//def collectiontitle =Mobile.getText(findTestObject('Phase2/BIInvoiceSummaryScreen/BICollectionScreen01/Collection_Title'), 0)
Mobile.tap(findTestObject('Phase2/BIInvoiceSummaryScreen/BICollectionScreen01/Submit_Button'), 0)

Mobile.verifyEqual(ComissionAmount, findTestData('Phase2.1/TestData/Test_Data').getValue(3, 23), FailureHandling.STOP_ON_FAILURE)

String Actual = Mobile.getText(findTestObject('Phase2/BIInvoiceSummaryScreen/Summary_ScreenTitle'), 0)

Mobile.verifyNotEqual(Actual, findTestData('Phase2.1/TestData/Test_Data').getValue(4, 23), FailureHandling.STOP_ON_FAILURE)

Mobile.verifyEqual(Actual, findTestData('Phase2.1/TestData/Test_Data').getValue(2, 23), FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/BeforeInvoiceCollection/Screenshot'),[('testCaseName') : 'TC_582'], FailureHandling.STOP_ON_FAILURE)
