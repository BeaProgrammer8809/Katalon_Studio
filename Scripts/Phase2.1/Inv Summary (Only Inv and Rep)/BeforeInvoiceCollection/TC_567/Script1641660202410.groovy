...
def Transferencia = Mobile.getText(findTestObject('Phase2/BICollectionScreen01/TransferenciasElectronicas_RadioButton'), 
    0)
...
Mobile.verifyEqual(Transferencia, findTestData('Phase2.1/TestData/Test_Data').getValue(2, 29), FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/BeforeInvoiceCollection/Screenshot'), [('testCaseName') : 'TC_567'], FailureHandling.STOP_ON_FAILURE)
