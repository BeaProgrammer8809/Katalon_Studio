...
Mobile.verifyElementText(findTestObject('Phase2/BIInvoiceSummaryScreen/BIAmountSplitUpPopup01/AmountSplitUp_PopUpTitle'), 
    findTestData('Phase2.1/TY_06/Summary/Summary').getValue(2, 4), FailureHandling.STOP_ON_FAILURE)

//Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/Summary/Screenshot'), [('testCaseName') : 'TC_168'], FailureHandling.STOP_ON_FAILURE)
...
//def expected = '- ' + findTestData('Phase2.1/TY_06/Summary/Summary').getValue(3, 4)
...
Mobile.verifyMatch(expresult, findTestData('Phase2.1/TY_06/Summary/Summary').getValue(4, 4), false)
...
double CategoryDiscAmt = (pieces * Uprice) * (CategoryDiscPercentage / 100)
...
Mobile.verifyEqual(CompDiscvalue.round(2), -(CategoryDiscAmt.round(2)))
