...
def productName = findTestData('Phase2.1/Common_Data/CommonData').getValue(6, 11)
...
//def expected = '- ' + findTestData('Phase2.1/TY_06/Summary/Summary').getValue(3, 2)
...
Mobile.verifyMatch(expresult, findTestData('Phase2.1/TY_06/Summary/Summary').getValue(4, 2), false)
