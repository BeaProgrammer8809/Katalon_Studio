...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/Summary/Screenshot'), [('testCaseName') : 'TC_167(1)'],
	FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyElementText(findTestObject('Phase2/BIInvoiceSummaryScreen/BIAmountSplitUpPopup01/AmountSplitUp_PopUpTitle'), 
    findTestData('Phase2.1/TY_06/Summary/Summary').getValue(2, 3), FailureHandling.STOP_ON_FAILURE)

//Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/Summary/Screenshot'), [('testCaseName') : 'TC_167'], FailureHandling.STOP_ON_FAILURE)
...
double CompDiscvalue = Double.parseDouble('-' + CompDisc.substring(2))

//def expected = '- ' + findTestData('Phase2.1/TY_06/Summary/Summary').getValue(3, 3)
...
Mobile.verifyMatch(expresult, findTestData('Phase2.1/TY_06/Summary/Summary').getValue(4, 3), false)
...
Mobile.verifyEqual(TaxText, findTestData('Phase2.1/TY_06/Summary/Summary').getValue(5, 3))
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/Summary/Screenshot'), [('testCaseName') : 'TC_167(2)'], 
    FailureHandling.STOP_ON_FAILURE)
