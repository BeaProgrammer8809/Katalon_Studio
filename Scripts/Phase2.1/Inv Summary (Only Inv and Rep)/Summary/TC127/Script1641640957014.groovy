...
println "Category discount included for sku "
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/Summary/Screenshot'), [('testCaseName') : 'TC127_InvoiceSummary'],
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/Summary/Screenshot'), [('testCaseName') : 'TC127_PrintPreviewScreen'],
	FailureHandling.STOP_ON_FAILURE)
