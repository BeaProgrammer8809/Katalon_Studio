...
//Mobile.verifyEqual(SkuGross, findTestData('Phase2.1/TY_05/Collection').getValue(3, 31), FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/Collection/Screenshot'), [('testCaseName') : 'TC_145_Amount'], FailureHandling.STOP_ON_FAILURE)
