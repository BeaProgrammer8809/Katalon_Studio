...
TaxPercentageText = findTestData('Phase2.1/TY_06/Summary/Summary').getValue(6, 7)
...
Ordervalueexp = Ordervalueexp.round()
...
Mobile.verifyEqual(actualOrderValue.round(), Ordervalueexp)
