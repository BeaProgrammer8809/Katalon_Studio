...
//Mobile.verifyEqual(SkuGross, findTestData('Phase2.1/TY_05/Collection').getValue(4, 32), FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/Collection/Screenshot'), [('testCaseName') : 'TC_146_Amount'], FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/Summary/Screenshot'), [('testCaseName') : 'TC_146_printScreen'], FailureHandling.STOP_ON_FAILURE)
