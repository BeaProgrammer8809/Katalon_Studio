...
GlobalVariable.ProductName=findTestData('Phase2/Common_Data/CommonData_03').getValue( 6, 2)
...
Mobile.verifyNotEqual(totalPriceAgainstInvoicedSKU1, DiscountedPriceSKU1, FailureHandling.STOP_ON_FAILURE)

println "Item and Category discount included for sku "
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/Summary/Screenshot'), [('testCaseName') : 'TC128_InvoiceSummary'],
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/Summary/Screenshot'), [('testCaseName') : 'TC128_PrintPreviewScreen'],
	FailureHandling.STOP_ON_FAILURE)
