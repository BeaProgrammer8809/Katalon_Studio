...
def productName = findTestData('Phase2.1/Common_Data/CommonData').getValue(6, 31)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/Summary/Screenshot'), [('testCaseName') : 'TC_169(1)'],
	FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyElementText(findTestObject('Phase2/BIInvoiceSummaryScreen/BIAmountSplitUpPopup01/AmountSplitUp_PopUpTitle'), 
    findTestData('Phase2.1/TY_06/Summary/Summary').getValue(2, 5), FailureHandling.STOP_ON_FAILURE)

//Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/Summary/Screenshot'), [('testCaseName') : 'TC_169'], FailureHandling.STOP_ON_FAILURE)
...
//def expected = findTestData('Phase2.1/TY_06/Summary/Summary').getValue(3, 5)
...
Mobile.verifyMatch(expresult, findTestData('Phase2.1/TY_06/Summary/Summary').getValue(4, 5), false)
...
def CategoryText=findTestData('Phase2.1/TY_06/Trade_Coverage/Invoice_Summary/Invoice_Summary02').getValue(7, 3)
...
int Tax = TaxPercentage.round(2)

def TaxText = Tax + ''

Mobile.comment('verifying  TAX Percentage')

Mobile.verifyEqual(TaxText, findTestData('Phase2.1/TY_06/Summary/Summary').getValue(5, 5))
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/Summary/Screenshot'), [('testCaseName') : 'TC_169(2)'], 
    FailureHandling.STOP_ON_FAILURE)
