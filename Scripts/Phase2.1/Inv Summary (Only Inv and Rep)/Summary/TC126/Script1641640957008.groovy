...
println "Item discount included for sku "
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/Summary/Screenshot'), [('testCaseName') : 'TC126_InvoiceSummary'],
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/Summary/Screenshot'), [('testCaseName') : 'TC126_PrintPreviewScreen'],
	FailureHandling.STOP_ON_FAILURE)
