...
GlobalVariable.ProductName = findTestData('Phase2/Common_Data/CommonData_03').getValue(6, 37)
...
Mobile.verifyEqual(discountForSku1, actualTotalDiscountForSKU, FailureHandling.STOP_ON_FAILURE)

println " Discount is not included for sku "
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/Summary/Screenshot'), [('testCaseName') : 'TC104_InvoiceSummary'], 
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/Summary/Screenshot'), [('testCaseName') : 'TC104_PrintPreviewScreen'],
	FailureHandling.STOP_ON_FAILURE)
