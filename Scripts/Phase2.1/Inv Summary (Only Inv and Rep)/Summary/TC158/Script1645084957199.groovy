...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/Summary/Screenshot'), [('testCaseName') : 'TC158'],
	FailureHandling.STOP_ON_FAILURE)
...
println "Tax IEPS and IVA is not applied for sku"
