...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/INEComplement/Screenshot'), [('testCaseName') : 'TC_532'],
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/INEComplement/Screenshot'), [('testCaseName') : 'TC_532(0)'],
	FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/INEComplement/Screenshot'), [('testCaseName') : 'TC_532(1)'],
	FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/INEComplement/Screenshot'), [('testCaseName') : 'TC_532(2)'],
	FailureHandling.STOP_ON_FAILURE)
