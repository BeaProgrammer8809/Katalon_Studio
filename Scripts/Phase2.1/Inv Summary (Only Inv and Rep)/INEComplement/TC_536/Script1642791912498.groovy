...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/INEComplement/Screenshot'), [('testCaseName') : 'TC_536(1)'], FailureHandling.STOP_ON_FAILURE)
"INE_TipoComite"
//"INE_TipoComite"
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/INEComplement/Screenshot'), [('testCaseName') : 'TC_536(2)'], FailureHandling.STOP_ON_FAILURE)
