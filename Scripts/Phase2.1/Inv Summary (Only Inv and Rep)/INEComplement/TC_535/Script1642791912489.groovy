...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/INEComplement/Screenshot'), [('testCaseName') : 'TC_535(1)'],
	FailureHandling.STOP_ON_FAILURE)
//"INE_TipoComite"
'INE_TipoComite'
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/INEComplement/Screenshot'), [('testCaseName') : 'TC_535(2)'],
	FailureHandling.STOP_ON_FAILURE)
...
def Expected_Toast_Message = findTestData('Phase2.1/TY_12/InvoiceSummary/Invoice_Summary').getValue(12, 28)
...
Mobile.verifyMatch(verifytheToastMessage, findTestData('Phase2.1/TY_12/InvoiceSummary/Invoice_Summary').getValue(13, 28),
