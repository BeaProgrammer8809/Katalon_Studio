...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/InvoiceSummary/Screenshot'), [('testCaseName') : 'TC_532'], 
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitOnlyPB/InvoiceSplitProductBuying/Screenshot'), [('testCaseName') : 'TC_532'], 
    FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitOnlyPB/InvoiceSplitProductBuying/Screenshot'), [('testCaseName') : 'TC_532(1)'], 
    FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyMatch(length.toString(), findTestData('Phase2.1/TY_12/InvoiceSummary/Invoice_Summary').getValue(
        14, 30), false, FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyElementText(findTestObject('Phase2/BIPrintPreviewScreen/Print_Preview_TextView'), findTestData('Phase2.1/TY_12/InvoiceSummary/Invoice_Summary').getValue(
        15, 30), FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Phase2.1/InvoiceSplitOnlyPB/InvoiceSplitProductBuying/Screenshot'), [('testCaseName') : 'TC_532(2)'], 
    FailureHandling.STOP_ON_FAILURE)

def invSheet = Mobile.getText(findTestObject('Phase2/BIPrintPreviewScreen/Invoice_Sheet'), 0)

def status = findTestData('Phase2.1/TY_12/InvoiceSummary/Invoice_Summary').getValue(16, 30)

boolean res = invSheet.contains(status)

Mobile.comment('Verifying status as success')

Mobile.verifyMatch(res.toString(), findTestData('Phase2.1/TY_12/InvoiceSummary/Invoice_Summary').getValue(17,30), false, 
    FailureHandling.STOP_ON_FAILURE)
