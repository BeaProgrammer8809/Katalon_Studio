...
def productReturnText = Mobile.getText(findTestObject('Phase2/BIProductBuyingScreen01/Total_Pieces_Qty'), 0)

double productReturn = Double.parseDouble(productReturnText)
...
def PBqtyText = Mobile.getText(findTestObject('Phase2/BIInvoiceSummaryScreen/BISummaryProductDetails/Sales_Return_Value_Indexing'), 
    0)

double PBqty = Double.parseDouble(PBqtyText)

//Mobile.verifyMatch(productReturnText, InvoiceQty, false, FailureHandling.STOP_ON_FAILURE)
Mobile.verifyEqual(productReturn, PBqtyText, FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/Invoice Summary/Screenshot'), [('testCaseName') : 'TC313(1)'], 
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/Invoice Summary/Screenshot'), [('testCaseName') : 'TC313(2)'], 
    FailureHandling.STOP_ON_FAILURE)
