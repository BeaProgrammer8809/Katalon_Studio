...
GlobalVariable.ProductName = findTestData('Phase2.1/Common_Data/CommonData').getValue(6, 18)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/Invoice Summary/Screenshot'), [('testCaseName') : 'TC171'], FailureHandling.STOP_ON_FAILURE)
...
//Verification to check the comp discount with the order value
