...
if (Mobile.verifyElementExist(findTestObject('Phase2/BIOdometer01/End_Journey_Button'), 5, FailureHandling.OPTIONAL)) {
    ...
    Mobile.setText(findTestObject('Phase2/BIOdometer01/Start_Trip_Reading_EditText'), findTestData('Phase2/Common_Data/CommonData_04').getValue(
            'OdometerReading', 1), 0)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/Invoice Summary/Screenshot'), [('testCaseName') : 'TC_033'], FailureHandling.STOP_ON_FAILURE)
