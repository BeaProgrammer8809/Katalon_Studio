...
def productName = findTestData('Phase2.1/Common_Data/CommonData').getValue(16, 11)
...
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/Invoice Summary/Screenshot'), [('testCaseName') : 'TC320(2)'], 
    FailureHandling.STOP_ON_FAILURE)
