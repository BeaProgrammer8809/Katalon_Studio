...
def ExpectedTitle = findTestData('Phase2.1/TY_11/TestData').getValue(4, 36)

ActualTitle.contains(ExpectedTitle)

println('uuid message is matching with expected  ')

Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/Invoice Summary/Screenshot'), [('testCaseName') : 'TC328'], FailureHandling.STOP_ON_FAILURE)
