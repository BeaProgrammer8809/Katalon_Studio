...
'To get the Pesito comission (Amount_EditText) present after selecting Efectivo mode '
PesitoAmountBeforeEdit = Mobile.getText(findTestObject('Phase2/BIInvoiceSummaryScreen/BICollectionScreen01/Amount_EditText'), 
    0)

Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/Before Invoice Collection/Screenshot'), [('testCaseName') : 'TC_551_BeforeEdit'], FailureHandling.STOP_ON_FAILURE)
...
'To get the Pesito comission (Amount_EditText) present after selecting Efectivo mode '
PesitoAmountAfterEdit = Mobile.getText(findTestObject('Phase2/BIInvoiceSummaryScreen/BICollectionScreen01/Amount_EditText'), 
    0)
Mobile.callTestCase(findTestCase('Phase2.1/Inv Summary (Only Inv and Rep)/Before Invoice Collection/Screenshot'), [('testCaseName') : 'TC_551AfterEdit'], FailureHandling.STOP_ON_FAILURE)

'To Verify if the Amount_TextEdit field is not equal before and after editing'
Mobile.verifyNotMatch(PesitoAmountBeforeEdit, PesitoAmountAfterEdit, false)
