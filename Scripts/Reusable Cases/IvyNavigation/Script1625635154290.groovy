...
for (def index : (0..Nav.size() - 1)) {
	...
	if ((Nav[index]) == (Nav[previousIndex])) {
		...
		List<WebElement> NavLinks = WebUiCommonHelper.findWebElements(findTestObject('Phase_2/AMadhu/IvySalesOrder/Page_IvyDMS/a_NavigationLink'),
			5)
		...
		if (NavLinks.size() > 0) {
			...
			GlobalVariable.mAttributetext = "Collection Accept (Mobile)"
				...
				WebUI.scrollToElement(findTestObject('Phase_2/AMadhu/IvySalesOrder/Page_IvyDMS/a_NavigationLink'),0)
	...
	if ((Nav[index]) == 'Receivables') {
		WebUI.scrollToElement(findTestObject('Phase_2/AMadhu/IvySalesOrder/Page_IvyDMS/a_Receivables'),0)
		WebUI.click(findTestObject('Phase_2/AMadhu/IvySalesOrder/Page_IvyDMS/a_Receivables'))
	} else if ((Nav[index]) != (Nav[previousIndex])) {
	WebUI.scrollToElement(findTestObject('Phase_2/AMadhu/IvySalesOrder/Page_IvyDMS/a_NavigationLink'),0)
		WebUI.click(findTestObject('Phase_2/AMadhu/IvySalesOrder/Page_IvyDMS/a_NavigationLink'))
	}
}
