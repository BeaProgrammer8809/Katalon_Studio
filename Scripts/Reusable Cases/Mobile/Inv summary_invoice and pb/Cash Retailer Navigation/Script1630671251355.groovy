...
Mobile.waitForElementPresent(findTestObject('Phase 1.1/Resource1/Van Seller/Home Screen/Menu Button'), 180)

Mobile.tap(findTestObject('Phase 1.1/Resource1/Van Seller/Home Screen/Menu Button'), 0)

Mobile.delay(3, FailureHandling.STOP_ON_FAILURE)

Mobile.waitForElementPresent(findTestObject('Phase 1.1/Resource1/Van Seller/Menus/Trade Coverage'), 60)
