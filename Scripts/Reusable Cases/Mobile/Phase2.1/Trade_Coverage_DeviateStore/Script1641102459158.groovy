...
Mobile.tap(findTestObject('Object Repository/Phase2/BITradeCoverage01/Arrow_Button'), 0)
...
Mobile.waitForElementPresent(findTestObject('Phase2/BIStoreScreen01/AddToPlan_Button'), 0)

Mobile.verifyElementVisible(findTestObject('Phase2/BIStoreScreen01/AddToPlan_Button'), 0)

Mobile.tap(findTestObject('Phase2/BIStoreScreen01/AddToPlan_Button'), 0)

if (Mobile.verifyElementVisible(findTestObject('Phase2/BIDeviateStoreAddScreen01/DeviateStoreAddReason_Title'), 0, FailureHandling.OPTIONAL)) {
    Mobile.tap(findTestObject('Phase2/BIDeviateStoreAddScreen01/UrgentDemand_RadioButton'), 0)

    Mobile.tap(findTestObject('Phase2/BIDeviateStoreAddScreen01/Add_Button'), 0)
}

if (Mobile.verifyElementVisible(findTestObject('Object Repository/Phase2/BIDeviateStoreAddScreen01/SavedSuccessfully_Popup_Title'), 
...
if (Mobile.verifyElementVisible(findTestObject('Object Repository/Phase2/BIBlueLabelProcess01/Blue_Label_Process_Screen_Title'), 
