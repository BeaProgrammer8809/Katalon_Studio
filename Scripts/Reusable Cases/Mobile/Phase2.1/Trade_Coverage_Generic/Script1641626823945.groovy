...
if (Mobile.verifyElementVisible(findTestObject('Object Repository/Phase2/BIBlueLabelProcess01/Blue_Label_Process_Screen_Title'), 5, FailureHandling.OPTIONAL)) {
