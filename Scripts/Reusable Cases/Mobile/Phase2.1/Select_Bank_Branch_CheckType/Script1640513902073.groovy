...
//Mobile.tap(findTestObject('Object Repository/Phase2.1/BIDropdown/Dropdown_Name'), 0)

//Mobile.tap(findTestObject('Object Repository/Phase2.1/BIDropdown/Dropdown_Option'), 0)
