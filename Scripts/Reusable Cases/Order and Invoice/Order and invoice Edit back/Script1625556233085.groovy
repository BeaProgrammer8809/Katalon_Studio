...
if (Mobile.verifyElementVisible(findTestObject('Phase 1.1/Resource2/Order and Invoice/Summary Screen/Button - Edit'), 0, 
    ...
    Mobile.tap(findTestObject('Phase 1.1/Resource2/Order and Invoice/Profile BackIcon'), 0)
