...
WebUI.callTestCase(findTestCase('Order and Invoice/Trade coverage/Order and Invoice screen/Web Screenshot'), [('testCaseName') : 'TC_013_Web_01'], 
...
WebUI.callTestCase(findTestCase('Order and Invoice/Trade coverage/Order and Invoice screen/Web Screenshot'), [('testCaseName') : 'TC_013_Web_02'], 
    FailureHandling.STOP_ON_FAILURE)
...
WebUI.setText(findTestObject('Phase 1.1/Resource3/Web/Price Management/Price Group/SKU Price List/input_Search_SKU'), 'FN_MUMB_PRO_002')
...
WebUI.callTestCase(findTestCase('Order and Invoice/Trade coverage/Order and Invoice screen/Web Screenshot'), [('testCaseName') : 'TC_013_Web_03'], 
    FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Order and Invoice/Trade coverage/Order and Invoice screen/Screenshot'), [('testCaseName') : 'TC_013_Mobile'], 
    FailureHandling.STOP_ON_FAILURE)
