...
if (Mobile.verifyElementVisible(findTestObject('Phase 1.1/Resource3/Product Buying/Product Buying'), 0, FailureHandling.OPTIONAL)) {
    println('Application should allow the seller to proceed to Product Buying screen without taking any Invoice or replacement in Order and Invoice screen')

    Mobile.callTestCase(findTestCase('Order and Invoice/Trade coverage/Order and Invoice screen/Screenshot'), [('testCaseName') : 'TC_088'], 
