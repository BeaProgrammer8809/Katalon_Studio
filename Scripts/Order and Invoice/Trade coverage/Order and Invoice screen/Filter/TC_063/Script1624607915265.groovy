...
Mobile.callTestCase(findTestCase('Order and Invoice/Trade coverage/Order and Invoice screen/Screenshot'), [('testCaseName') : 'TC_063_BeforeSelect'], 
...
Mobile.callTestCase(findTestCase('Order and Invoice/Trade coverage/Order and Invoice screen/Screenshot'), [('testCaseName') : 'TC_063_AfterSelect'], 
    FailureHandling.STOP_ON_FAILURE)
...
txtNewCategory = Mobile.getText(findTestObject('Phase 1.1/Resource3/Order and Invoice/Trade Coverage/Store Activities Screeen/Order And Invoice Screen/Normal Filter/Green Tick Icon/second Data'), 
    0)

println('previously selected skus category should be unselected and the new skus category should be selected. ' + txtNewCategory)

Mobile.verifyNotMatch(txtcategoryData, txtNewCategory, false, FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Order and Invoice/Trade coverage/Order and Invoice screen/Screenshot'), [('testCaseName') : 'TC_063_SelectOtherBrand'], 
    FailureHandling.STOP_ON_FAILURE)
