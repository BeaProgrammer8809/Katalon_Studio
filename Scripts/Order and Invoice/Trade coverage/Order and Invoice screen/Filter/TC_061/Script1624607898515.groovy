...
txtMarcaData = Mobile.getText(findTestObject('Phase 1.1/Resource3/Order and Invoice/Trade Coverage/Store Activities Screeen/Order And Invoice Screen/Normal Filter/Green Tick Icon/first Data'), 
    0)

println(txtMarcaData)
...
Mobile.callTestCase(findTestCase('Order and Invoice/Trade coverage/Order and Invoice screen/Screenshot'), [('testCaseName') : 'TC_061_BeforeSelect'], 
...
Mobile.callTestCase(findTestCase('Order and Invoice/Trade coverage/Order and Invoice screen/Screenshot'), [('testCaseName') : 'TC_061_AfterSelect'], 
    FailureHandling.STOP_ON_FAILURE)
...
txtNewBrand = Mobile.getText(findTestObject('Phase 1.1/Resource3/Order and Invoice/Trade Coverage/Store Activities Screeen/Order And Invoice Screen/Normal Filter/Green Tick Icon/second Data'), 
    0)

println('Previously selected brand should be unselected and the new brand should be selected. ' + txtNewBrand)

Mobile.verifyNotMatch(txtMarcaData, txtNewBrand, false, FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Order and Invoice/Trade coverage/Order and Invoice screen/Screenshot'), [('testCaseName') : 'TC_061_SelectOtherBrand'], 
    FailureHandling.STOP_ON_FAILURE)
