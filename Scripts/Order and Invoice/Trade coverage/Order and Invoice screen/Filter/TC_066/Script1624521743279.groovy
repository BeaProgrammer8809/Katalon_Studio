...
txtLineaData = Mobile.getText(findTestObject('Phase 1.1/Resource3/Order and Invoice/Trade Coverage/Store Activities Screeen/Order And Invoice Screen/Normal Filter/Green Tick Icon/first Data'), 
    0)

println(txtLineaData)
...
FileUtils.copyFile(sst, new File('G:\\Bimbo Mobile Testing\\Bimbo Mobile\\Screenshot\\Run Time Images\\Run Time\\LNENGreenTick.png'))
...
CustomKeywords.'com.android.keywords.AndroidKeyword.elementScreenshot'(driver, tickColor, 'LNEN_GreenTick')
...
Mobile.callTestCase(findTestCase('Order and Invoice/Trade coverage/Order and Invoice screen/Screenshot'), [('testCaseName') : 'TC_066'], 
