...
txtLineData = Mobile.getText(findTestObject('Phase 1.1/Resource3/Order and Invoice/Trade Coverage/Store Activities Screeen/Order And Invoice Screen/Normal Filter/Green Tick Icon/first Data'), 
    0)
...
Mobile.callTestCase(findTestCase('Order and Invoice/Trade coverage/Order and Invoice screen/Screenshot'), [('testCaseName') : 'TC_067_BeforeSelect'], 
...
Mobile.callTestCase(findTestCase('Order and Invoice/Trade coverage/Order and Invoice screen/Screenshot'), [('testCaseName') : 'TC_067_AfterSelect'], 
    FailureHandling.STOP_ON_FAILURE)
...
txtNewLineData = Mobile.getText(findTestObject('Phase 1.1/Resource3/Order and Invoice/Trade Coverage/Store Activities Screeen/Order And Invoice Screen/Normal Filter/Green Tick Icon/second Data'), 
    0)

println('previously selected skus line should be unselected and the new skus line should be selected. ' + txtNewLineData)

Mobile.verifyNotMatch(txtLineData, txtNewLineData, false, FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Order and Invoice/Trade coverage/Order and Invoice screen/Screenshot'), [('testCaseName') : 'TC_067_SelectOtherBrand'], 
    FailureHandling.STOP_ON_FAILURE)
