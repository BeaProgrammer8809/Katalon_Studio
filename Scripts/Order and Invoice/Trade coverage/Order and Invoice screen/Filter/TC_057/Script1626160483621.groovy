...
WebUI.verifyElementVisible(findTestObject('Phase 1.1/Resource3/Web/Product Master/Categoria_Category/a_Categoria'))

WebUI.verifyElementText(findTestObject('Phase 1.1/Resource3/Web/Product Master/Categoria_Category/a_Categoria'), 'Categoría')

WebUI.click(findTestObject('Phase 1.1/Resource3/Web/Product Master/Categoria_Category/a_Categoria'))

WebUI.delay(10)

WebUI.waitForElementVisible(findTestObject('Phase 1.1/Resource3/Web/Product Master/Categoria_Category/input_Name_Category'), 
    0)

not_run: WebUI.setText(findTestObject('Phase 1.1/Resource3/Web/Product Master/Categoria_Category/input_Name_Category'), 
    'MUMB_CAT_N_03')

WebUI.setText(findTestObject('Phase 1.1/Resource3/Web/Product Master/Categoria_Category/input_Name_Category'), findTestData(
        'Phase 1/Surendran/Order and Invoice/Filter Data').getValue(2, 1))

WebUI.delay(10)

txtCategoryName = WebUI.getText(findTestObject('Phase 1.1/Resource3/Web/Product Master/Categoria_Category/select_Category'))

println(txtCategoryName)

WebUI.callTestCase(findTestCase('Order and Invoice/Trade coverage/Order and Invoice screen/Web Screenshot'), [('testCaseName') : 'TC_057_Web_01'], 
    FailureHandling.STOP_ON_FAILURE)

WebUI.doubleClick(findTestObject('Phase 1.1/Resource3/Web/Product Master/Categoria_Category/select_Category'))
...
WebUI.callTestCase(findTestCase('Order and Invoice/Trade coverage/Order and Invoice screen/Web Screenshot'), [('testCaseName') : 'TC_057_Web_02'], 
    FailureHandling.STOP_ON_FAILURE)
...
GlobalVariable.filterDataName = txtCategoryName
...
Mobile.callTestCase(findTestCase('Order and Invoice/Trade coverage/Order and Invoice screen/Screenshot'), [('testCaseName') : 'TC_057_Mobile_01'], 
    FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Order and Invoice/Trade coverage/Order and Invoice screen/Screenshot'), [('testCaseName') : 'TC_057_Mobile_02'], 
    FailureHandling.STOP_ON_FAILURE)
