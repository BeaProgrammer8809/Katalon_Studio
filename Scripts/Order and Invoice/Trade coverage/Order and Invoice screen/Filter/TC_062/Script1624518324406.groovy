...
CustomKeywords.'com.android.keywords.AndroidKeyword.elementScreenshot'(driver, tickColor, 'Category_GreenTick')
...
Mobile.callTestCase(findTestCase('Order and Invoice/Trade coverage/Order and Invoice screen/Screenshot'), [('testCaseName') : 'TC_062'], 
