...
not_run: WebUI.setText(findTestObject('Phase 1.1/Resource3/Web/Product Master/Marca_brand/input_Name_Marca'), 'MUMB_BRAND_BN_02')
...
txtWebCategoryName = WebUI.getText(findTestObject('Phase 1.1/Resource3/Web/Product Master/Categoria_Category/td_CategoryName'))

println(txtWebCategoryName)
...
txtWebSegmentName = WebUI.getText(findTestObject('Phase 1.1/Resource3/Web/Product Master/Segmento_Segment/td_SegmentoName'))

println(txtWebSegmentName)
...
txtWebLineName = WebUI.getText(findTestObject('Phase 1.1/Resource3/Web/Product Master/Line/td_LineName'))
...
Mobile.callTestCase(findTestCase('Order and Invoice/Trade coverage/Order and Invoice screen/Screenshot'), [('testCaseName') : 'TC_078_Mobile_01'], 
    FailureHandling.STOP_ON_FAILURE)
...
GlobalVariable.filterDataName = txtWebCategoryName

Mobile.tap(findTestObject('Phase 1.1/Resource3/Order and Invoice/Trade Coverage/Store Activities Screeen/Order And Invoice Screen/Normal Filter/filterScreen_ItemName'), 
    0)

Mobile.callTestCase(findTestCase('Order and Invoice/Trade coverage/Order and Invoice screen/Screenshot'), [('testCaseName') : 'TC_078_Mobile_02'], 
    FailureHandling.STOP_ON_FAILURE)
...
GlobalVariable.filterDataName = txtWebSegmentName

Mobile.tap(findTestObject('Phase 1.1/Resource3/Order and Invoice/Trade Coverage/Store Activities Screeen/Order And Invoice Screen/Normal Filter/filterScreen_ItemName'), 
    0)

Mobile.callTestCase(findTestCase('Order and Invoice/Trade coverage/Order and Invoice screen/Screenshot'), [('testCaseName') : 'TC_078_Mobile_03'], 
    FailureHandling.STOP_ON_FAILURE)
...
txtMobileLineData = Mobile.getText(findTestObject('Phase 1.1/Resource3/Order and Invoice/Trade Coverage/Store Activities Screeen/Order And Invoice Screen/Normal Filter/Green Tick Icon/first Data'), 
    0)

println(txtMobileLineData)

Mobile.verifyMatch(txtWebLineName, txtMobileLineData, false)

Mobile.callTestCase(findTestCase('Order and Invoice/Trade coverage/Order and Invoice screen/Screenshot'), [('testCaseName') : 'TC_078_Mobile_04'], 
    FailureHandling.STOP_ON_FAILURE)
