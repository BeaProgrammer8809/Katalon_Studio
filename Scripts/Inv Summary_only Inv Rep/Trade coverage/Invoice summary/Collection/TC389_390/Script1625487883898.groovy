...
foNumber = Integer.toString(folioNumber)
...
Mobile.verifyElementNotExist(findTestObject('Phase 1.1/Resource2/Order and Invoice/Summary Screen/Delivery Final Summary/Payment - CheckBox'), 
    0)
