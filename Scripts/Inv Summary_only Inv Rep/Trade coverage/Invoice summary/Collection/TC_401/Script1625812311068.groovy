...
int folioNumber = rnd.nextInt(999999)

folioNumber1=Integer.toString(folioNumber)

Mobile.sendKeys(findTestObject('Phase 1.1/Resource2/Order and Invoice/Summary Screen/Delivery Final Summary/EditText - Folio Number text field'), 
    folioNumber1)

Mobile.tap(findTestObject('Phase 1.1/Resource2/Order and Invoice/Summary Screen/Delivery Final Summary/Payment - CheckBox'), 
    0)

Mobile.verifyElementExist(findTestObject('Phase 1.1/Resource2/Order and Invoice/Summary Screen/Delivery Final Summary/Collection Pop-up/Label - Min.Amt'), 
    0)

Mobile.verifyElementExist(findTestObject('Phase 1.1/Resource2/Order and Invoice/Summary Screen/Delivery Final Summary/Collection Pop-up/Min Amt value'), 
    0)

inv_Amt = Mobile.getText(findTestObject('Phase 1.1/Resource2/Order and Invoice/Summary Screen/Delivery Final Summary/Collection Pop-up/Inv Amt value'), 
    0)

Min_Amt = Mobile.getText(findTestObject('Phase 1.1/Resource2/Order and Invoice/Summary Screen/Delivery Final Summary/Collection Pop-up/Min Amt value'), 
    0)

Mobile.verifyMatch(inv_Amt, Min_Amt, false)
