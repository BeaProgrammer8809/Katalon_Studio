...
Balance_value = Mobile.getText(findTestObject('Phase 1.1/Resource2/Order and Invoice/Summary Screen/Delivery Final Summary/Collection Pop-up/Balance  value'), 
    0)

if (Balance_value.contains('Balance : 0 of ')) {
    Mobile.verifyMatch('1', '1', false)
} else {
    Mobile.verifyMatch('0', '1', false)
}
