...
Mobile.tap(findTestObject('Phase 1.1/Resource2/Order and Invoice/Summary Screen/Delivery Final Summary/Collection Pop-up/Button - Submit'), 
    0)

Mobile.verifyElementNotExist(findTestObject('Phase 1.1/Resource2/Order and Invoice/Summary Screen/Delivery Final Summary/Button - Create Final Invoice'), 
    0)
