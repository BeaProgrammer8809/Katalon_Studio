...
Mobile.verifyElementText(findTestObject('Phase 1.1/Resource2/Order and Invoice/TextView - No Items Added'), 'No Items Added')

Mobile.verifyElementExist(findTestObject('Phase 1.1/Resource2/Order and Invoice/No items added Button - OK'), 0)
