...
Mobile.sendKeys(findTestObject('Phase 1.1/Resource2/Order and Invoice/EditText - qty'), '5')

updated_qty = Mobile.getText(findTestObject('Phase 1.1/Resource2/Order and Invoice/EditText - qty'), 0)
