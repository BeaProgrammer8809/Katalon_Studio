...
Mobile.callTestCase(findTestCase('Inv Summary_only Inv Rep/Trade coverage/Invoice summary/Inv Summary_only Inv Rep1/Tax And Discount/Common Case/Odometer Verification'), 
    [('local_retailerName') : 'EL PROGRESO'], FailureHandling.STOP_ON_FAILURE)
