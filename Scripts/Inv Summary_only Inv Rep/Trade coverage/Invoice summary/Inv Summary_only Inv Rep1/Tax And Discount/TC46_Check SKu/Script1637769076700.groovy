...
SkuName= findTestData('Phase 1/Surendran/Inv Summary (Only Inv_Rep)/Taxs SKU').getValue(3, 10)

println SkuName

println(GlobalVariable.apk_File)

Mobile.callTestCase(findTestCase('Inv Summary_only Inv Rep/Trade coverage/Invoice summary/Inv Summary_only Inv Rep1/Tax And Discount/Common Case/Trade Coverage_Order and Invoice'), 
...
txtSummaryProductName = Mobile.getText(findTestObject('Phase 1.1/Resource3/Product Buying/Summary/Summary_ProductName'), 
    0, FailureHandling.STOP_ON_FAILURE)

println(txtSummaryProductName)

Mobile.verifyMatch(txtSearchingProduct, txtSummaryProductName, false, FailureHandling.STOP_ON_FAILURE)

txtTotalPrice = Mobile.getText(findTestObject('Phase 1.1/Resource3/Product Buying/Summary/Total Price'), 0, FailureHandling.STOP_ON_FAILURE)

println(txtTotalPrice)

Mobile.verifyMatch('0', txtTotalPrice, false, FailureHandling.STOP_ON_FAILURE)

if (Mobile.verifyMatch('0', txtTotalPrice, false, FailureHandling.STOP_ON_FAILURE)) {
    println('Total Price should be displayed as 0 sku since the replacement quantity will not be considered in invoice calculation')
