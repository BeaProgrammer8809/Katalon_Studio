...
not_run: txtSearchingProduct = Mobile.getText(findTestObject('Phase 1.1/Resource3/Order and Invoice/Trade Coverage/Store Activities Screeen/Order And Invoice Screen/Search/listProductName'), 
    0)

not_run: println(txtSearchingProduct)

not_run: txtPiecesValue = Mobile.getText(findTestObject('Phase 1.1/Resource3/Order and Invoice/Trade Coverage/Store Activities Screeen/Order And Invoice Screen/Product Details/firstProduct_Pieces'), 
    0)

not_run: println(txtPiecesValue)
...
txtEnteredPiecesValue1 = Mobile.getText(findTestObject('Phase 1.1/Resource3/Order and Invoice/Trade Coverage/Store Activities Screeen/Order And Invoice Screen/Product Details/Keypad/001_Total Value'), 
    0)

println(txtEnteredPiecesValue1)
...
txtEnteredReturnValue1 = Mobile.getText(findTestObject('Phase 1.1/Resource3/Order and Invoice/Trade Coverage/Store Activities Screeen/Order And Invoice Screen/Product Details/Keypad/001_Total Value'), 
    0)

println(txtEnteredReturnValue1)
...
Mobile.verifyElementVisible(findTestObject('Phase 1.1/Resource3/Product Buying/Summary/Delivery Summary/Devlivery Final Summary/PayMentCheckBox_2'), 
    0)

Mobile.tap(findTestObject('Phase 1.1/Resource3/Product Buying/Summary/Delivery Summary/Devlivery Final Summary/PayMentCheckBox_2'), 
    0)

Mobile.tap(findTestObject('Phase 1.1/Resource3/Product Buying/Summary/Delivery Summary/Devlivery Final Summary/Collection/Efectivo/Efectivo_CollectionTextbox'), 
    0)

txtPaidAmount1 = Mobile.getText(findTestObject('Phase 1.1/Resource3/Product Buying/Summary/Delivery Summary/Devlivery Final Summary/Collection/Efectivo/Efectivo_CollectionTextbox'), 
    0)

println(txtPaidAmount1)

int lenAmt1 = txtPaidAmount1.length()
...
Mobile.takeScreenshot('.\\Screenshot\\Run Time Images\\Run Time\\toastChequeNoAlreadyEx.png')
...
String testvalues = CustomKeywords.'com.android.keywords.ReadImage.crackingImage'('.\\Screenshot\\Run Time Images\\Run Time\\toastChequeNoAlreadyEx.png')

String checkData = testvalues.trim()

CNAU = checkData.substring(checkData.length() - 26)

println(CNAU)

if (Mobile.verifyMatch('Cheque number already used', CNAU, false, FailureHandling.OPTIONAL)) {
    Mobile.verifyMatch('Cheque number already used', CNAU, false //String testvalues = CustomKeywords.'com.android.keywords.ReadImage.crackingImage'('G:\\Bimbo Mobile Testing\\Bimbo Mobile\\Screenshot\\Run Time Images\\Run Time\\SelectBankTabandhold.png')
        )
} else {
    Mobile.tap(findTestObject('Phase 1.1/Resource3/Product Buying/Summary/Delivery Summary/Devlivery Final Summary/Collection/Cheques/btn_Submit'), 
        0)
    ...
    Mobile.takeScreenshot('.\\Screenshot\\Run Time Images\\Run Time\\toastChequeNoAlreadyEx1.png')
    ...
    String testvalues1 = CustomKeywords.'com.android.keywords.ReadImage.crackingImage'('.\\Screenshot\\Run Time Images\\Run Time\\toastChequeNoAlreadyEx1.png')

    String checkData1 = testvalues1.trim()

    CNAU1 = checkData1.substring(checkData1.length() - 26)

    println(CNAU1)

    Mobile.verifyMatch('Cheque number already used', CNAU1, false, FailureHandling.STOP_ON_FAILURE)
}
