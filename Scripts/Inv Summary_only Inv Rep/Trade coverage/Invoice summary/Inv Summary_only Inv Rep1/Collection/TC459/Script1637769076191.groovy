...
Mobile.takeScreenshot('.\\Screenshot\\Run Time Images\\Run Time\\toastReferenceNoAlreadyEx.png')
...
String testvalues = CustomKeywords.'com.android.keywords.ReadImage.crackingImage'('.\\Screenshot\\Run Time Images\\Run Time\\toastReferenceNoAlreadyEx.png')

String checkData = testvalues.trim()

RNAU = checkData.substring(checkData.length() - 29)

println(RNAU)

if (Mobile.verifyMatch('Reference number already used', RNAU, false, FailureHandling.OPTIONAL)) {
    Mobile.verifyMatch('Reference number already used', RNAU, false)
} else {
    Mobile.tap(findTestObject('Phase 1.1/Resource3/Product Buying/Summary/Delivery Summary/Devlivery Final Summary/Collection/Cheques/btn_Submit'), 
        0)
    ...
    Mobile.takeScreenshot('.\\Screenshot\\Run Time Images\\Run Time\\toastReferenceNoAlreadyEx1.png')
    ...
    String testvalues1 = CustomKeywords.'com.android.keywords.ReadImage.crackingImage'('.\\Screenshot\\Run Time Images\\Run Time\\toastReferenceNoAlreadyEx1.png')

    String checkData1 = testvalues1.trim()

    RNAU1 = checkData1.substring(checkData1.length() - 29)

    println(RNAU1)

    Mobile.verifyMatch('Reference number already used', RNAU1, false, FailureHandling.STOP_ON_FAILURE)
}
