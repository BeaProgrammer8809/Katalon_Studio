...
WebUI.callTestCase(findTestCase('Inv Summary_only Inv Rep/Trade coverage/Invoice summary/Inv Summary_only Inv Rep1/Collection/Inv Summary_Only Inv_Rep_Van Seller_Credit'), 
    [('local_retailerName') : 'Credit'], FailureHandling.STOP_ON_FAILURE)
