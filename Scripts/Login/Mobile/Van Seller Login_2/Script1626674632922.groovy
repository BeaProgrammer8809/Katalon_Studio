...
//GlobalVariable.userName = '012713_1004'
...
if (Mobile.verifyElementVisible(findTestObject('Login/Mobile/Activation Screen/AK_Activation Key'), 0, FailureHandling.OPTIONAL)) {
    ...
    if (Mobile.verifyElementVisible(findTestObject('Login/Mobile/Login/popup_Do you want to continue in this device'), 0, 
