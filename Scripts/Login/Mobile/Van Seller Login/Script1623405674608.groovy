...
GlobalVariable.userName = findTestData('Login Credentials/Mobile/Login Info').getValue(1, 1)
 
println(GlobalVariable.userName)

GlobalVariable.password = findTestData('Login Credentials/Mobile/Login Info').getValue(2, 1)
