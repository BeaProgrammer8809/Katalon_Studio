...
GlobalVariable.userName = findTestData('Login Credentials/Mobile/Login Info').getValue(1, 8)

println(GlobalVariable.userName)

GlobalVariable.password = findTestData('Login Credentials/Mobile/Login Info').getValue(2, 8)
...
if (Mobile.verifyElementVisible(findTestObject('Login/Mobile/Activation Screen/AK_Activation Key'), 15, FailureHandling.OPTIONAL)) {
    ...
    Mobile.waitForElementPresent(findTestObject('Phase2/BIAccessThisDevicesLocationPopup01/While_Using_The_App_Button'), 
