...
List<MobileElement> elementList = new ArrayList<String>()

List<MobileElement> skuList = new ArrayList<String>()

elementList = driver.findElementsByXPath('//*[@resource-id=\'com.ivy.bimbomx.mexico.view:id/productName\']')
...
Mobile.verifyElementVisible(findTestObject('Phase 1.1/Resource1/Van Seller/Porduct Buy Filter/Apply Button'), 0)

Mobile.tap(findTestObject('Phase 1.1/Resource1/Van Seller/Porduct Buy Filter/Apply Button'), 0)

Mobile.verifyElementVisible(findTestObject('Phase 1.1/Resource1/Van Seller/Product Buying/Product Buying Screen Title'), 0)

Mobile.callTestCase(findTestCase('Product Buying/Trade coverage/Product Buying Screen/Screenshot'), [('testCaseName') : 'TC_052'], 
    FailureHandling.STOP_ON_FAILURE)

List<MobileElement> newelementList = new ArrayList<String>()

List<MobileElement> newskuList = new ArrayList<String>()

newelementList = driver.findElementsByXPath('//*[@resource-id=\'com.ivy.bimbomx.mexico.view:id/productName\']')

for (MobileElement ele : newelementList) {
    newval = ele.getText()

    newskuList.add(newval)
}

println(newskuList)

if (skuList.equals(newskuList) == true) {
    Mobile.verifyMatch('1', '0', false)
} else {
    System.out.println(' New set of Sku is displaying')
}
