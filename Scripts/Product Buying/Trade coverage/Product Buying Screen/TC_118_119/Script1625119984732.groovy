...
Mobile.verifyElementVisible(findTestObject('Phase 1.1/Resource1/Van Seller/Retailer Profile Screen/Back Arrow'), 0)
...
Mobile.callTestCase(findTestCase('Product Buying/Trade coverage/Product Buying Screen/Screenshot'), [('testCaseName') : 'TC_118'], 
    FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('Phase 1.1/Resource1/Van Seller/Retailer Profile Screen/Back Arrow'), 0)

Mobile.tap(findTestObject('Phase 1.1/Resource1/Van Seller/Product Buying/Sku name 1st row - Copy'), 0)

SkuName = Mobile.getText(findTestObject('Phase 1.1/Resource1/Van Seller/Product Buying/Search bar after tap sku'), 0)

println(SkuName)

Mobile.callTestCase(findTestCase('Product Buying/Trade coverage/Product Buying Screen/Screenshot'), [('testCaseName') : 'TC_119'], 
    FailureHandling.STOP_ON_FAILURE)
