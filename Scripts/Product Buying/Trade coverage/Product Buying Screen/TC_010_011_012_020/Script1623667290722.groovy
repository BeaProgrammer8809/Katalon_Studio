...
Mobile.verifyElementVisible(findTestObject('Phase 1.1/Resource1/Van Seller/Porduct Buy Filter/LNEA Title'), 0)

Mobile.verifyElementText(findTestObject('Phase 1.1/Resource1/Van Seller/Porduct Buy Filter/LNEA Title'), 'LÍNEA')

Mobile.callTestCase(findTestCase('Product Buying/Trade coverage/Product Buying Screen/Screenshot'), [('testCaseName') : 'TC_010'], 
...
Mobile.tap(findTestObject('Phase 1.1/Resource1/Van Seller/Porduct Buy Filter/Marka 2nd Row'), 0)

Mobile.delay(3, FailureHandling.STOP_ON_FAILURE)

Mobile.verifyElementVisible(findTestObject('Phase 1.1/Resource1/Van Seller/Porduct Buy Filter/Apply Button'), 0)

Mobile.verifyElementText(findTestObject('Phase 1.1/Resource1/Van Seller/Porduct Buy Filter/Apply Button'), 'Apply')

Mobile.callTestCase(findTestCase('Product Buying/Trade coverage/Product Buying Screen/Screenshot'), [('testCaseName') : 'TC_011_012_020'], 
    FailureHandling.STOP_ON_FAILURE)
