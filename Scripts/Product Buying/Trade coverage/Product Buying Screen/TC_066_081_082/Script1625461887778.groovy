...
Mobile.callTestCase(findTestCase('Product Buying/Trade coverage/Product Buying Screen/Screenshot'), [('testCaseName') : 'TC_066'], 
...
Mobile.verifyNotMatch(Tot_piece1, Tot_piece2, false)
...
Mobile.callTestCase(findTestCase('Product Buying/Trade coverage/Product Buying Screen/Screenshot'), [('testCaseName') : 'TC_066_1_081_082'], 
    FailureHandling.STOP_ON_FAILURE)
