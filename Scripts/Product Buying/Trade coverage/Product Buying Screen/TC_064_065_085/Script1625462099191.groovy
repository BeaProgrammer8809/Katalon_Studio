...
Mobile.tap(findTestObject('Phase 1.1/Resource1/Van Seller/Product Buying/Sku name 1st row'), 0)

Mobile.tap(findTestObject('Phase 1.1/Resource1/Van Seller/Product Buying/SRP 1st row'), 0)

Mobile.delay(3, FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Product Buying/Trade coverage/Product Buying Screen/Screenshot'), [('testCaseName') : 'TC_064_065'], 
...
Mobile.callTestCase(findTestCase('Product Buying/Trade coverage/Product Buying Screen/Screenshot'), [('testCaseName') : 'TC_085'], 
    FailureHandling.STOP_ON_FAILURE)
