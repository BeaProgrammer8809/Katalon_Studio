...
Mobile.verifyElementVisible(findTestObject('Phase 1.1/Resource1/Van Seller/Return Screen/Non-Salable'), 0)

Mobile.verifyElementExist(findTestObject('Phase 1.1/Resource1/Van Seller/Return Screen/Non-Salable'), 0)

Mobile.verifyElementText(findTestObject('Phase 1.1/Resource1/Van Seller/Return Screen/Non-Salable'), 'Non-Salable')

Mobile.verifyElementVisible(findTestObject('Phase 1.1/Resource1/Van Seller/Return Screen/Salable'), 0)

Mobile.verifyElementExist(findTestObject('Phase 1.1/Resource1/Van Seller/Return Screen/Salable'), 0)

Mobile.verifyElementText(findTestObject('Phase 1.1/Resource1/Van Seller/Return Screen/Salable'), 'Salable')

Mobile.callTestCase(findTestCase('Product Buying/Trade coverage/Product Buying Screen/Screenshot'), [('testCaseName') : 'TC_070_071'], 
    FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('Phase 1.1/Resource1/Van Seller/Return Screen/Non-Salable'), 0)

Mobile.callTestCase(findTestCase('Product Buying/Trade coverage/Product Buying Screen/Screenshot'), [('testCaseName') : 'TC_072'], 
    FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Product Buying/Trade coverage/Product Buying Screen/Screenshot'), [('testCaseName') : 'TC_073'], 
    FailureHandling.STOP_ON_FAILURE)
