...
Mobile.callTestCase(findTestCase('Product Buying/Trade coverage/Product Buying Screen/Screenshot'), [('testCaseName') : 'TC_097'], 
    FailureHandling.STOP_ON_FAILURE)

Mobile.verifyElementVisible(findTestObject('Phase 1.1/Resource1/Van Seller/Order and Invoice Screen/Order and  Invoice Title'), 
    0)

Mobile.verifyElementExist(findTestObject('Phase 1.1/Resource1/Van Seller/Order and Invoice Screen/Order and  Invoice Title'), 
    0)
...
Mobile.verifyElementVisible(findTestObject('Phase 1.1/Resource1/Van Seller/Product Buying/No Items Added alert'), 0)

Mobile.verifyElementExist(findTestObject('Phase 1.1/Resource1/Van Seller/Product Buying/No Items Added alert'), 0)

Mobile.verifyElementText(findTestObject('Phase 1.1/Resource1/Van Seller/Product Buying/No Items Added alert'), 'No Items Added')

Mobile.callTestCase(findTestCase('Product Buying/Trade coverage/Product Buying Screen/Screenshot'), [('testCaseName') : 'TC_096'], 
    FailureHandling.STOP_ON_FAILURE)
