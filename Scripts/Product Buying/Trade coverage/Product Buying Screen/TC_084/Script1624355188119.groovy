...
salableValue = Mobile.getText(findTestObject('Phase 1.1/Resource1/Van Seller/Return Screen/Input Field'), 0)

println(salableValue)
...
nonSalableValue = Mobile.getText(findTestObject('Phase 1.1/Resource1/Van Seller/Return Screen/Input Field 2 after Typing'), 0)

println(nonSalableValue)

salableValue = Integer.parseInt(salableValue)

nonSalableValue = Integer.parseInt(nonSalableValue)

totalPiece = (salableValue + nonSalableValue)

//String newtotalPiece = String.format('%.2f', totalPiece)
...
Mobile.verifyEqual(Tot_piece2, totalPiece)

Mobile.callTestCase(findTestCase('Product Buying/Trade coverage/Product Buying Screen/Screenshot'), [('testCaseName') : 'TC_084'], 
