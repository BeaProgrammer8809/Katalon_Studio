...
Mobile.verifyElementVisible(findTestObject('Phase 1.1/Resource1/Van Seller/Porduct Buy Filter/SEGMENTO Title'), 0)

Mobile.verifyElementText(findTestObject('Phase 1.1/Resource1/Van Seller/Porduct Buy Filter/SEGMENTO Title'), 'SEGMENTO')

Mobile.callTestCase(findTestCase('Product Buying/Trade coverage/Product Buying Screen/Screenshot'), [('testCaseName') : 'TC_008'], 
...
Mobile.callTestCase(findTestCase('Product Buying/Trade coverage/Product Buying Screen/Screenshot'), [('testCaseName') : 'TC_009_019'], 
    FailureHandling.STOP_ON_FAILURE)
