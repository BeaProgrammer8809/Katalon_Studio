...
Mobile.callTestCase(findTestCase('Product Buying/Trade coverage/Product Buying Screen/Screenshot'), [('testCaseName') : 'TC_091'], 
...
pieces_Value = Mobile.getText(findTestObject('Phase 1.1/Resource1/Van Seller/Product Buying/Total Piece 1st Row'), 0)

println(pieces_Value)

SRP_Value = Double.parseDouble(SRP_Value)

pieces_Value = Double.parseDouble(pieces_Value)

sumTotal = (SRP_Value * pieces_Value)

String newsumTotal = String.format('%.2f', sumTotal)
...
Mobile.callTestCase(findTestCase('Product Buying/Trade coverage/Product Buying Screen/Screenshot'), [('testCaseName') : 'TC_091_1'], 
    FailureHandling.STOP_ON_FAILURE)
