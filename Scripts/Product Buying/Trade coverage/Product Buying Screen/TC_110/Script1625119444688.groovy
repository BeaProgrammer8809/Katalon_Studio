...
SRP_Value = SRP_Value.split('\\.')[1].length()

println(SRP_Value)

Mobile.verifyEqual(SRP_Value, '2', FailureHandling.STOP_ON_FAILURE)

//println(SRP_Value[2])
Mobile.callTestCase(findTestCase('Product Buying/Trade coverage/Product Buying Screen/Screenshot'), [('testCaseName') : 'TC_110'], 
