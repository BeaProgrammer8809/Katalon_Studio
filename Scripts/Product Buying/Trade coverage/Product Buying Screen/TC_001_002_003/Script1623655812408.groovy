...
Mobile.verifyElementVisible(findTestObject('Phase 1.1/Resource1/Van Seller/Product Buying/Funnel Filter'), 0)

Mobile.verifyElementVisible(findTestObject('Phase 1.1/Resource1/Van Seller/Product Buying/Product Name Title'), 0)

Mobile.verifyElementText(findTestObject('Phase 1.1/Resource1/Van Seller/Product Buying/Product Name Title'), 'Product Name')

Mobile.verifyElementVisible(findTestObject('Phase 1.1/Resource1/Van Seller/Product Buying/SRP Title'), 0)

Mobile.verifyElementText(findTestObject('Phase 1.1/Resource1/Van Seller/Product Buying/SRP Title'), 'SRP')

Mobile.verifyElementVisible(findTestObject('Phase 1.1/Resource1/Van Seller/Product Buying/Total Piece Title'), 0)

Mobile.verifyElementText(findTestObject('Phase 1.1/Resource1/Van Seller/Product Buying/Total Piece Title'), 'Total Piece')

Mobile.verifyElementVisible(findTestObject('Phase 1.1/Resource1/Van Seller/Product Buying/Value'), 0)

Mobile.verifyElementText(findTestObject('Phase 1.1/Resource1/Van Seller/Product Buying/Value'), 'Value')

Mobile.verifyElementVisible(findTestObject('Phase 1.1/Resource1/Van Seller/Product Buying/Lines'), 0)

Mobile.verifyElementText(findTestObject('Phase 1.1/Resource1/Van Seller/Product Buying/Lines'), 'Lines')

Mobile.verifyElementVisible(findTestObject('Phase 1.1/Resource1/Van Seller/Product Buying/Next Button'), 0)

Mobile.verifyElementText(findTestObject('Phase 1.1/Resource1/Van Seller/Product Buying/Next Button'), 'Next')

Mobile.callTestCase(findTestCase('Product Buying/Trade coverage/Product Buying Screen/Screenshot'), [('testCaseName') : 'TC_001_002'], 
...
Mobile.verifyElementText(findTestObject('Phase 1.1/Resource1/Van Seller/Porduct Buy Filter/Filter Title'), 'Filter')

Mobile.callTestCase(findTestCase('Product Buying/Trade coverage/Product Buying Screen/Screenshot'), [('testCaseName') : 'TC_003'], 
    FailureHandling.STOP_ON_FAILURE)
